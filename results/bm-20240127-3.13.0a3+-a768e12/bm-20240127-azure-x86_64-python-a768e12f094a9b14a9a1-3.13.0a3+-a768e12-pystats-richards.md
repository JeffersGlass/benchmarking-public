...
|---|---:|---:|---:|---:|
| LOAD_FAST | 370,571,360 | 22.4% | 22.4% |  |
| LOAD_ATTR_INSTANCE_VALUE | 161,655,260 | 9.8% | 32.2% | 38.7% |
...
| CALL_PY_EXACT_ARGS | 77,139,140 | 4.7% | 56.2% | 9.1% |
| RESUME_CHECK | 77,011,340 | 4.7% | 60.9% | 0.0% |
| RETURN_VALUE | 77,010,280 | 4.7% | 65.6% |  |
| STORE_FAST | 66,786,160 | 4.0% | 69.6% |  |
| STORE_ATTR_INSTANCE_VALUE | 59,610,960 | 3.6% | 73.2% | 14.5% |
| LOAD_GLOBAL_MODULE | 59,454,360 | 3.6% | 76.8% |  |
| COPY | 59,438,320 | 3.6% | 80.4% |  |
| LOAD_CONST | 55,962,800 | 3.4% | 83.8% |  |
| POP_TOP | 42,997,680 | 2.6% | 86.4% |  |
| POP_JUMP_IF_NOT_NONE | 30,754,880 | 1.9% | 88.3% |  |
| POP_JUMP_IF_TRUE | 27,586,400 | 1.7% | 90.0% |  |
| POP_JUMP_IF_NONE | 22,455,200 | 1.4% | 91.3% |  |
| LOAD_FAST_LOAD_FAST | 20,469,920 | 1.2% | 92.6% |  |
| UNARY_NOT | 19,888,560 | 1.2% | 93.8% |  |
| JUMP_BACKWARD | 18,549,440 | 1.1% | 94.9% |  |
| COMPARE_OP_INT | 14,132,820 | 0.9% | 95.8% |  |
| JUMP_FORWARD | 10,812,160 | 0.7% | 96.4% |  |
| LOAD_GLOBAL_BUILTIN | 10,526,520 | 0.6% | 97.0% |  |
| CALL_ISINSTANCE | 10,526,320 | 0.6% | 97.7% |  |
| BINARY_OP_ADD_INT | 9,673,340 | 0.6% | 98.3% |  |
| SWAP | 9,097,280 | 0.6% | 98.8% |  |
| BINARY_SUBSCR_LIST_INT | 6,807,160 | 0.4% | 99.2% |  |
...
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 89,941,040 | 5.4% | 13.7% |
...
| COPY TO_BOOL_BOOL | 50,340,880 | 3.0% | 29.6% |
| POP_JUMP_IF_FALSE LOAD_FAST | 49,739,360 | 3.0% | 32.7% |
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 47,043,040 | 2.8% | 35.5% |
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 44,128,080 | 2.7% | 38.2% |
| STORE_FAST LOAD_FAST | 44,032,960 | 2.7% | 40.8% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST | 41,762,620 | 2.5% | 43.4% |
| POP_TOP LOAD_FAST | 38,903,040 | 2.4% | 45.7% |
| LOAD_ATTR_INSTANCE_VALUE COPY | 34,172,420 | 2.1% | 47.8% |
| LOAD_CONST LOAD_FAST | 29,191,840 | 1.8% | 49.6% |
| LOAD_GLOBAL_MODULE TO_BOOL_BOOL | 29,073,640 | 1.8% | 51.3% |
| RETURN_VALUE TO_BOOL_BOOL | 27,586,320 | 1.7% | 53.0% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 27,586,300 | 1.7% | 54.7% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 25,419,040 | 1.5% | 56.2% |
| RETURN_VALUE RETURN_VALUE | 24,772,160 | 1.5% | 57.7% |
| LOAD_ATTR_INSTANCE_VALUE STORE_FAST | 24,749,900 | 1.5% | 59.2% |
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 23,315,520 | 1.4% | 60.6% |
| LOAD_FAST POP_JUMP_IF_NONE | 22,455,200 | 1.4% | 62.0% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST | 21,558,820 | 1.3% | 63.3% |
| LOAD_FAST RETURN_VALUE | 21,297,360 | 1.3% | 64.6% |
| POP_JUMP_IF_FALSE POP_TOP | 19,888,560 | 1.2% | 65.8% |
| TO_BOOL_BOOL UNARY_NOT | 19,888,520 | 1.2% | 67.0% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_BOOL | 19,888,480 | 1.2% | 68.2% |
| LOAD_ATTR_INSTANCE_VALUE CALL_PY_EXACT_ARGS | 17,463,800 | 1.1% | 69.3% |
| POP_JUMP_IF_NONE JUMP_BACKWARD | 17,059,840 | 1.0% | 70.3% |
| JUMP_BACKWARD LOAD_GLOBAL_MODULE | 17,059,820 | 1.0% | 71.3% |
| UNARY_NOT COPY | 16,168,560 | 1.0% | 72.3% |
| POP_JUMP_IF_TRUE POP_TOP | 16,168,560 | 1.0% | 73.3% |
| RETURN_VALUE STORE_FAST | 15,846,720 | 1.0% | 74.2% |
| STORE_ATTR_INSTANCE_VALUE LOAD_CONST | 15,387,440 | 0.9% | 75.2% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_CONST | 14,585,220 | 0.9% | 76.1% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST_LOAD_FAST | 14,245,720 | 0.9% | 76.9% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 14,132,820 | 0.9% | 77.8% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST | 14,116,900 | 0.9% | 78.6% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 13,778,720 | 0.8% | 79.5% |
| POP_JUMP_IF_FALSE RETURN_VALUE | 13,392,480 | 0.8% | 80.3% |
| LOAD_ATTR_INSTANCE_VALUE RETURN_VALUE | 12,933,060 | 0.8% | 81.1% |
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 12,330,840 | 0.7% | 81.8% |
| LOAD_FAST STORE_FAST | 12,201,120 | 0.7% | 82.5% |
| RESUME_CHECK LOAD_CONST | 10,660,440 | 0.6% | 83.2% |
| JUMP_FORWARD LOAD_FAST | 10,625,920 | 0.6% | 83.8% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 10,526,520 | 0.6% | 84.5% |
| POP_JUMP_IF_TRUE LOAD_FAST | 10,526,400 | 0.6% | 85.1% |
| LOAD_FAST_LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 10,526,360 | 0.6% | 85.7% |
| STORE_FAST LOAD_GLOBAL_BUILTIN | 10,526,240 | 0.6% | 86.4% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 10,526,240 | 0.6% | 87.0% |
| LOAD_GLOBAL_MODULE CALL_ISINSTANCE | 10,526,240 | 0.6% | 87.7% |
| COPY LOAD_ATTR_INSTANCE_VALUE | 9,097,080 | 0.6% | 88.2% |
| SWAP STORE_ATTR_INSTANCE_VALUE | 9,097,080 | 0.6% | 88.8% |
| LOAD_CONST BINARY_OP_ADD_INT | 8,184,000 | 0.5% | 89.3% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 7,439,320 | 0.5% | 89.7% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 7,179,240 | 0.4% | 90.1% |
| RETURN_VALUE POP_TOP | 6,939,080 | 0.4% | 90.6% |
| POP_JUMP_IF_FALSE LOAD_CONST | 6,863,520 | 0.4% | 91.0% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 6,808,640 | 0.4% | 91.4% |
| LOAD_FAST BINARY_SUBSCR_LIST_INT | 6,807,120 | 0.4% | 91.8% |
| LOAD_CONST STORE_FAST | 6,806,560 | 0.4% | 92.2% |
| STORE_FAST JUMP_FORWARD | 6,719,840 | 0.4% | 92.6% |
| BINARY_OP_ADD_INT SWAP | 6,696,100 | 0.4% | 93.0% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 6,220,160 | 0.4% | 93.4% |
| LOAD_GLOBAL_MODULE COMPARE_OP_INT | 5,482,120 | 0.3% | 93.7% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_INSTANCE_VALUE | 5,321,360 | 0.3% | 94.1% |
| BINARY_SUBSCR_LIST_INT STORE_FAST | 5,319,180 | 0.3% | 94.4% |
| LOAD_GLOBAL_MODULE COPY | 5,206,840 | 0.3% | 94.7% |
| LOAD_CONST COMPARE_OP_INT | 4,689,280 | 0.3% | 95.0% |
| POP_TOP JUMP_FORWARD | 4,092,320 | 0.2% | 95.2% |
| LOAD_CONST BINARY_OP | 3,998,640 | 0.2% | 95.5% |
| LOAD_ATTR_INSTANCE_VALUE COMPARE_OP_INT | 3,961,200 | 0.2% | 95.7% |
| LOAD_FAST COPY | 3,890,400 | 0.2% | 95.9% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST_LOAD_FAST | 3,848,800 | 0.2% | 96.2% |
| POP_JUMP_IF_NONE LOAD_FAST | 3,774,720 | 0.2% | 96.4% |
| STORE_FAST LOAD_GLOBAL_MODULE | 3,720,400 | 0.2% | 96.6% |
| LOAD_FAST_LOAD_FAST CALL_PY_EXACT_ARGS | 3,720,120 | 0.2% | 96.9% |
| UNARY_NOT RETURN_VALUE | 3,720,000 | 0.2% | 97.1% |
| LOAD_CONST BINARY_OP_SUBTRACT_INT | 3,089,200 | 0.2% | 97.3% |
| BINARY_OP LOAD_CONST | 2,398,580 | 0.1% | 97.4% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_GLOBAL_MODULE | 2,232,560 | 0.1% | 97.6% |
| STORE_ATTR_INSTANCE_VALUE LOAD_GLOBAL_MODULE | 1,916,820 | 0.1% | 97.7% |
| RETURN_VALUE LOAD_FAST | 1,863,200 | 0.1% | 97.8% |
| NOP LOAD_FAST | 1,859,040 | 0.1% | 97.9% |
| POP_JUMP_IF_FALSE NOP | 1,859,040 | 0.1% | 98.0% |
...
| POP_JUMP_IF_FALSE | 49,739,360 | 13.4% |
...
|---|---:|---:|
| Basic | 753,828,700 | 45.7% |
| Not specialized | 188,890,160 | 11.4% |
| Specialized hits | 591,798,940 | 35.8% |
| Specialized misses | 116,323,500 | 7.0% |
...
| Interpreter decrefs | 653,772,620 | 97.5% |
| Increfs | 69,885,567 | 10.6% |
| Decrefs | 16,789,264 | 2.5% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 103,187,973 |  |
| Method cache misses | 6,133,467 |  |
| Method cache collisions | 6,132,895 |  |
