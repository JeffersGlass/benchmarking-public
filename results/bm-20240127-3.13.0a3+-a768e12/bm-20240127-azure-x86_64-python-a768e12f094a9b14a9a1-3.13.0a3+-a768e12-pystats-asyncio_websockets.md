...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,834 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,499,408 | 5.5% | 24.1% |  |
...
| LOAD_ATTR_INSTANCE_VALUE | 830,616 | 3.1% | 54.4% | 0.1% |
| LOAD_GLOBAL_BUILTIN | 747,307 | 2.8% | 57.2% | 0.4% |
...
| COMPARE_OP_INT | 250,728 | 0.9% | 81.2% | 0.1% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,376 | 3.0% | 6.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,648 | 1.5% | 22.5% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 306,828 | 1.1% | 30.1% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,620 | 1.0% | 31.1% |
| LOAD_FAST LOAD_CONST | 261,080 | 1.0% | 32.0% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 248,048 | 0.9% | 33.0% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 105,808 | 0.4% | 60.2% |
...
| LOAD_GLOBAL_BUILTIN | 404,648 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,376 | 16.0% |
...
| LOAD_GLOBAL_BUILTIN | 306,828 | 20.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,808 | 54.0% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,248 | 8.1% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 248,048 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,828 | 41.1% |
...
|---|---:|---:|
| Basic | 13,036,472 | 48.2% |
| Not specialized | 4,448,046 | 16.4% |
| Specialized hits | 9,478,019 | 35.0% |
| Specialized misses | 83,282 | 0.3% |
...
| Allocations | 1,597,200 | 67.3% |
| Allocations to 512 bytes | 1,407,213 | 59.3% |
| Allocations to 4 kbytes | 132,186 | 5.6% |
| Allocations over 4 kbytes | 57,801 | 2.4% |
| Frees | 1,536,509 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,201,357 | 76.6% |
| Interpreter decrefs | 14,017,300 | 78.2% |
| Increfs | 3,723,502 | 23.4% |
| Decrefs | 3,910,188 | 21.8% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,230,434 |  |
| Method cache misses | 30,346 |  |
| Method cache collisions | 33,427 |  |
| Method cache dunder hits | 358,326 |  |
| Method cache dunder misses | 5,494 |  |
