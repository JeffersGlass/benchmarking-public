...
| Increfs | 230,239,239 | 98.9% |
| Decrefs | 320,736,330 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,048,686 |  |
| Method cache misses | 409,814 |  |
| Method cache collisions | 419,562 |  |
| Method cache dunder hits | 809,629 |  |
| Method cache dunder misses | 10,291 |  |
