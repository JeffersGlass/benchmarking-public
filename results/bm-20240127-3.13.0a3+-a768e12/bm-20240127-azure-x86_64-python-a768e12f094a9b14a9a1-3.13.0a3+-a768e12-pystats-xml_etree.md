...
|---|---:|---:|---:|---:|
| LOAD_FAST | 461,974,080 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 159,759,140 | 6.4% | 25.1% |  |
| LOAD_CONST | 135,399,080 | 5.5% | 30.5% |  |
...
| YIELD_VALUE | 40,899,440 | 1.7% | 76.6% |  |
...
| BUILD_TUPLE | 21,958,280 | 0.9% | 86.0% |  |
...
| STORE_ATTR_INSTANCE_VALUE | 10,597,040 | 0.4% | 98.1% | 0.0% |
| LOAD_ATTR_CLASS | 10,558,220 | 0.4% | 98.5% |  |
| STORE_ATTR | 7,237,320 | 0.3% | 98.8% |  |
| CALL | 6,605,800 | 0.3% | 99.1% |  |
...
| CACHE RESUME_CHECK | 59,509,140 | 2.4% | 11.2% |
| STORE_FAST LOAD_FAST | 57,565,120 | 2.3% | 13.5% |
...
| RETURN_CONST INTERPRETER_EXIT | 36,653,300 | 1.5% | 37.8% |
...
| STORE_FAST LOAD_CONST | 12,123,460 | 0.5% | 73.4% |
...
| STORE_FAST LOAD_GLOBAL_MODULE | 10,626,140 | 0.4% | 82.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 57,565,120 | 48.4% |
| LOAD_GLOBAL_BUILTIN | 37,615,820 | 31.6% |
| LOAD_CONST | 12,123,460 | 10.2% |
| LOAD_GLOBAL_MODULE | 10,626,140 | 8.9% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 6,600,900 | 3.8% |
|          hit | 167,112,000 | 96.2% |
|         miss | 12,960 | 0.0% |
...
|---|---:|---:|
| Basic | 1,394,771,660 | 56.3% |
| Not specialized | 372,110,580 | 15.0% |
| Specialized hits | 711,451,860 | 28.7% |
| Specialized misses | 414,640 | 0.0% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 73,525,160 | 44.0% |
| FOR_ITER | 57,303,140 | 34.3% |
| TO_BOOL | 16,759,420 | 10.0% |
| STORE_ATTR | 7,236,620 | 4.3% |
| CALL | 6,600,900 | 3.9% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| TO_BOOL_NONE | 191,120 | 46.1% |
| TO_BOOL_STR | 186,600 | 45.0% |
...
| Allocations | 232,258,580 | 74.6% |
| Allocations to 512 bytes | 232,048,540 | 74.6% |
| Allocations to 4 kbytes | 127,560 | 0.0% |
| Allocations over 4 kbytes | 82,480 | 0.0% |
| Frees | 233,531,687 |  |
| New values | 11,780 |  |
| Interpreter increfs | 785,072,980 | 45.5% |
| Interpreter decrefs | 981,549,740 | 48.4% |
| Increfs | 940,574,408 | 54.5% |
| Decrefs | 1,047,392,860 | 51.6% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 154,262,318 |  |
| Method cache misses | 84,662 |  |
| Method cache collisions | 222,544 |  |
| Method cache dunder hits | 57,385,686 |  |
| Method cache dunder misses | 152,174 |  |
