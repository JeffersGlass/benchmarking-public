...
| Increfs | 230,246,695 | 98.9% |
| Decrefs | 320,743,873 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,041,229 |  |
| Method cache misses | 417,271 |  |
| Method cache collisions | 419,323 |  |
| Method cache dunder hits | 817,327 |  |
| Method cache dunder misses | 2,593 |  |
