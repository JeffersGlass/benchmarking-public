...
| COMPARE_OP_INT | 250,588 | 0.9% | 81.2% | 0.1% |
...
| LOAD_GLOBAL | 31,960 | 0.1% | 97.3% |  |
| BINARY_OP_ADD_INT | 31,580 | 0.1% | 97.5% |  |
| MAKE_CELL | 31,380 | 0.1% | 97.6% |  |
...
| LOAD_FAST_CHECK | 16,740 | 0.1% | 98.9% |  |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,096 | 3.0% | 6.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 784,180 | 2.9% | 9.4% |
| STORE_FAST LOAD_FAST | 729,260 | 2.7% | 12.1% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 454,000 | 1.7% | 19.5% |
| IS_OP POP_JUMP_IF_FALSE | 416,220 | 1.5% | 21.0% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,508 | 1.5% | 22.5% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 378,120 | 1.4% | 23.9% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 306,688 | 1.1% | 30.0% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,620 | 1.0% | 31.1% |
| LOAD_FAST LOAD_CONST | 261,080 | 1.0% | 32.0% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 247,908 | 0.9% | 33.0% |
...
| POP_TOP LOAD_FAST | 178,060 | 0.7% | 42.5% |
| LOAD_ATTR_MODULE PUSH_NULL | 174,320 | 0.6% | 43.2% |
| LOAD_ATTR LOAD_FAST | 173,680 | 0.6% | 43.8% |
...
| LOAD_FAST CALL_PY_EXACT_ARGS | 141,760 | 0.5% | 53.0% |
...
| PUSH_NULL LOAD_FAST | 123,660 | 0.5% | 56.9% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 96,300 | 0.4% | 62.8% |
| NOP LOAD_FAST | 96,220 | 0.4% | 63.2% |
| POP_JUMP_IF_NONE LOAD_FAST | 93,160 | 0.3% | 63.5% |
| CALL_LEN LOAD_FAST | 92,028 | 0.3% | 63.8% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 82,960 | 0.3% | 65.1% |
...
| LOAD_FAST CALL | 72,560 | 0.3% | 68.3% |
...
| BUILD_MAP LOAD_FAST | 67,620 | 0.3% | 70.3% |
| DICT_MERGE CALL_FUNCTION_EX | 67,580 | 0.2% | 70.6% |
...
| LOAD_ATTR | 37,800 | 12.2% |
| LOAD_ATTR_SLOT | 31,980 | 10.3% |
| LOAD_NAME | 560 | 0.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 123,660 | 39.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 784,180 | 15.6% |
| STORE_FAST | 729,260 | 14.5% |
| RESUME_CHECK | 469,160 | 9.3% |
| POP_JUMP_IF_TRUE | 454,000 | 9.0% |
| LOAD_GLOBAL_BUILTIN | 404,508 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,096 | 16.0% |
...
| IS_OP | 416,220 | 27.8% |
| COMPARE_OP_INT | 247,908 | 16.5% |
| TO_BOOL_NONE | 75,540 | 5.0% |
| CONTAINS_OP | 65,300 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 784,180 | 52.3% |
| LOAD_GLOBAL_BUILTIN | 306,688 | 20.5% |
| LOAD_CONST | 151,440 | 10.1% |
| RETURN_CONST | 113,900 | 7.6% |
| LOAD_GLOBAL_MODULE | 82,960 | 5.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 454,000 | 77.8% |
| LOAD_GLOBAL_MODULE | 42,140 | 7.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,668 | 54.0% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,108 | 8.0% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 247,908 | 98.9% |
...
| CALL_LEN | 105,668 | 12.7% |
| LOAD_ATTR_METHOD_NO_DICT | 101,122 | 12.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 101,122 | 36.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,688 | 41.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 378,120 | 42.5% |
| CACHE | 164,540 | 18.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,038 | 32.7% |
| Frees to freelist | 780,198 |  |
| Allocations | 1,597,105 | 67.3% |
| Allocations to 512 bytes | 1,407,115 | 59.3% |
| Allocations to 4 kbytes | 132,186 | 5.6% |
| Allocations over 4 kbytes | 57,804 | 2.4% |
| Frees | 1,536,526 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,200,895 | 76.6% |
| Interpreter decrefs | 14,016,393 | 78.2% |
| Increfs | 3,731,697 | 23.4% |
| Decrefs | 3,918,793 | 21.8% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,222,281 |  |
| Method cache misses | 38,239 |  |
| Method cache collisions | 45,618 |  |
| Method cache dunder hits | 353,414 |  |
| Method cache dunder misses | 10,406 |  |
