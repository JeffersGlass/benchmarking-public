...
|---|---:|---:|---:|---:|
| LOAD_FAST | 121,078,603 | 23.1% | 23.1% |  |
| POP_JUMP_IF_FALSE | 28,467,129 | 5.4% | 28.6% |  |
| STORE_FAST | 27,728,487 | 5.3% | 33.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 24,592,947 | 4.7% | 38.6% |  |
| RESUME_CHECK | 22,261,225 | 4.3% | 42.8% |  |
| TO_BOOL_BOOL | 20,686,293 | 4.0% | 46.8% |  |
| LOAD_ATTR | 16,869,952 | 3.2% | 50.0% |  |
| LOAD_ATTR_METHOD_NO_DICT | 15,853,438 | 3.0% | 53.0% |  |
| LOAD_ATTR_WITH_HINT | 15,611,340 | 3.0% | 56.0% |  |
| LOAD_CONST | 14,262,028 | 2.7% | 58.7% |  |
| POP_TOP | 13,806,577 | 2.6% | 61.4% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 12,646,131 | 2.4% | 63.8% | 0.0% |
| CALL_PY_EXACT_ARGS | 12,492,050 | 2.4% | 66.2% | 0.0% |
| POP_JUMP_IF_TRUE | 11,569,218 | 2.2% | 68.4% |  |
| RETURN_VALUE | 10,579,508 | 2.0% | 70.4% |  |
| RETURN_CONST | 10,058,257 | 1.9% | 72.3% |  |
| CALL | 8,850,174 | 1.7% | 74.0% |  |
| TO_BOOL | 7,574,758 | 1.4% | 75.4% |  |
| JUMP_BACKWARD | 7,552,361 | 1.4% | 76.9% |  |
| LOAD_FAST_LOAD_FAST | 7,451,749 | 1.4% | 78.3% |  |
| POP_JUMP_IF_NONE | 7,405,019 | 1.4% | 79.7% |  |
| LOAD_ATTR_SLOT | 6,916,496 | 1.3% | 81.0% | 0.0% |
| LOAD_GLOBAL_MODULE | 6,869,315 | 1.3% | 82.4% | 0.0% |
| CALL_PY_WITH_DEFAULTS | 5,451,599 | 1.0% | 83.4% |  |
| LOAD_FAST_CHECK | 5,120,300 | 1.0% | 84.4% |  |
| CALL_LIST_APPEND | 4,846,140 | 0.9% | 85.3% |  |
| NOP | 4,701,575 | 0.9% | 86.2% |  |
| STORE_ATTR_SLOT | 4,664,610 | 0.9% | 87.1% | 0.1% |
| COMPARE_OP_INT | 4,662,057 | 0.9% | 88.0% | 0.0% |
| LOAD_GLOBAL_BUILTIN | 4,208,556 | 0.8% | 88.8% | 0.0% |
| TO_BOOL_INT | 3,190,060 | 0.6% | 89.4% |  |
| CALL_LEN | 2,968,860 | 0.6% | 90.0% |  |
| PUSH_NULL | 2,741,995 | 0.5% | 90.5% |  |
| LOAD_ATTR_MODULE | 2,442,977 | 0.5% | 91.0% | 0.0% |
| INTERPRETER_EXIT | 2,345,179 | 0.4% | 91.4% |  |
| BINARY_OP | 2,225,919 | 0.4% | 91.8% |  |
| CALL_METHOD_DESCRIPTOR_O | 2,059,301 | 0.4% | 92.2% | 0.0% |
...
| JUMP_FORWARD | 1,322,038 | 0.3% | 95.4% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 24,568,169 | 4.7% | 4.7% |
| STORE_FAST LOAD_FAST | 19,031,954 | 3.6% | 8.3% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 17,989,034 | 3.4% | 11.8% |
| RESUME_CHECK LOAD_FAST | 16,835,231 | 3.2% | 15.0% |
| POP_JUMP_IF_FALSE LOAD_FAST | 15,325,634 | 2.9% | 17.9% |
| LOAD_FAST LOAD_ATTR_WITH_HINT | 12,682,900 | 2.4% | 20.3% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 12,363,579 | 2.4% | 22.7% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 11,503,471 | 2.2% | 24.9% |
| LOAD_FAST LOAD_ATTR | 10,914,094 | 2.1% | 27.0% |
| LOAD_FAST TO_BOOL_BOOL | 10,570,719 | 2.0% | 29.0% |
| POP_JUMP_IF_TRUE LOAD_FAST | 9,214,621 | 1.8% | 30.8% |
| RETURN_CONST POP_TOP | 8,365,778 | 1.6% | 32.4% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 8,162,979 | 1.6% | 33.9% |
| RETURN_VALUE STORE_FAST | 7,784,456 | 1.5% | 35.4% |
| TO_BOOL POP_JUMP_IF_TRUE | 7,216,779 | 1.4% | 36.8% |
...
| LOAD_FAST LOAD_ATTR_SLOT | 6,899,936 | 1.3% | 42.2% |
| CALL STORE_FAST | 6,816,956 | 1.3% | 43.5% |
| LOAD_FAST TO_BOOL | 6,483,178 | 1.2% | 44.7% |
...
| POP_TOP RETURN_CONST | 4,693,981 | 0.9% | 54.2% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_BOOL | 4,616,639 | 0.9% | 55.1% |
...
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 4,473,558 | 0.9% | 59.4% |
| POP_TOP LOAD_FAST | 4,357,617 | 0.8% | 60.2% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 4,340,257 | 0.8% | 61.1% |
| NOP LOAD_FAST | 4,039,017 | 0.8% | 61.8% |
| LOAD_ATTR CALL_PY_EXACT_ARGS | 3,922,820 | 0.7% | 62.6% |
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 3,812,176 | 0.7% | 63.3% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 3,705,298 | 0.7% | 64.0% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 2,696,819 | 0.5% | 64.5% |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 2,440,497 | 0.5% | 66.5% |
...
| CACHE RESUME_CHECK | 2,020,779 | 0.4% | 68.2% |
...
| CALL_METHOD_DESCRIPTOR_O POP_TOP | 1,729,741 | 0.3% | 71.4% |
...
| PUSH_NULL LOAD_FAST | 1,413,178 | 0.3% | 73.6% |
...
| STORE_FAST_STORE_FAST LOAD_FAST | 1,108,559 | 0.2% | 78.1% |
| POP_TOP JUMP_BACKWARD | 1,079,680 | 0.2% | 78.3% |
| LOAD_ATTR_METHOD_NO_DICT CALL_METHOD_DESCRIPTOR_NOARGS | 1,065,561 | 0.2% | 78.5% |
| CALL_METHOD_DESCRIPTOR_NOARGS STORE_FAST | 1,063,301 | 0.2% | 78.7% |
| COPY TO_BOOL_INT | 1,055,860 | 0.2% | 78.9% |
| LOAD_GLOBAL_MODULE BINARY_OP | 1,055,820 | 0.2% | 79.1% |
| RESUME_CHECK NOP | 1,054,377 | 0.2% | 79.3% |
| LOAD_ATTR LOAD_FAST | 1,048,859 | 0.2% | 79.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RETURN_CONST | 8,365,778 | 60.6% |
| CALL_METHOD_DESCRIPTOR_O | 1,729,741 | 12.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| RETURN_CONST | 4,693,981 | 34.0% |
| LOAD_FAST | 4,357,617 | 31.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 7,216,779 | 95.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 19,031,954 | 15.7% |
| RESUME_CHECK | 16,835,231 | 13.9% |
| POP_JUMP_IF_FALSE | 15,325,634 | 12.7% |
| LOAD_ATTR_METHOD_NO_DICT | 12,363,579 | 10.2% |
| POP_JUMP_IF_TRUE | 9,214,621 | 7.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 24,568,169 | 20.3% |
| LOAD_ATTR_WITH_HINT | 12,682,900 | 10.5% |
| LOAD_ATTR | 10,914,094 | 9.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 17,989,034 | 63.2% |
| COMPARE_OP_INT | 4,340,257 | 15.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL | 7,216,779 | 62.4% |
| TO_BOOL_BOOL | 2,696,819 | 23.3% |
...
| LOAD_ATTR_METHOD_WITH_VALUES | 3,812,176 | 30.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_METHOD_NO_DICT | 8,162,979 | 33.2% |
| TO_BOOL_BOOL | 4,616,639 | 18.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 8,162,979 | 51.5% |
...
| CALL_PY_EXACT_ARGS | 3,812,176 | 30.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 2,440,497 | 99.9% |
| LOAD_ATTR | 2,280 | 0.1% |
| LOAD_FAST | 200 | 0.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_MODULE | 2,440,497 | 35.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 11,503,471 | 51.7% |
...
| LOAD_ATTR_INSTANCE_VALUE | 4,616,639 | 22.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 17,989,034 | 87.0% |
| POP_JUMP_IF_TRUE | 2,696,819 | 13.0% |
| UNARY_NOT | 340 | 0.0% |
...
|---|---:|---:|
| Basic | 249,617,865 | 47.7% |
| Not specialized | 86,743,886 | 16.6% |
| Specialized hits | 187,154,048 | 35.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 2,345,179 | 10.2% |
| Calls to Python functions inlined | 20,580,986 | 89.8% |
| Calls via PyEval_EvalFrame (total) | 2,345,179 | 10.2% |
| Calls via PyEval_EvalFrame (vector) | 2,015,479 | 8.8% |
| Calls via PyEval_EvalFrame (generator) | 329,700 | 1.4% |
| Calls via PyEval_EvalFrame (legacy) | 40 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 2,015,339 | 8.8% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 14,685,170 | 41.2% |
| Frees to freelist | 14,692,569 |  |
| Allocations | 20,964,381 | 58.8% |
| Allocations to 512 bytes | 14,550,716 | 40.8% |
| Allocations to 4 kbytes | 323,040 | 0.9% |
| Allocations over 4 kbytes | 6,090,625 | 17.1% |
| Frees | 21,343,751 |  |
| New values | 1,560 |  |
| Interpreter increfs | 223,468,001 | 76.0% |
| Interpreter decrefs | 248,178,035 | 75.8% |
| Increfs | 70,542,906 | 24.0% |
| Decrefs | 79,294,862 | 24.2% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 160 | 10.3% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 20,443,539 |  |
| Method cache misses | 31,513 |  |
| Method cache collisions | 47,180 |  |
| Method cache dunder hits | 1,030,266 |  |
| Method cache dunder misses | 17,512 |  |
