...
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,524,765,458 | 20.5% | 20.5% |  |
| LOAD_CONST | 366,969,024 | 4.9% | 25.5% |  |
| RESUME_CHECK | 351,233,618 | 4.7% | 30.2% | 0.0% |
| LOAD_GLOBAL_MODULE | 321,008,194 | 4.3% | 34.5% | 0.0% |
| STORE_ATTR_SLOT | 305,609,514 | 4.1% | 38.6% | 21.5% |
| LOAD_FAST_LOAD_FAST | 293,151,040 | 3.9% | 42.6% |  |
| LOAD_GLOBAL_BUILTIN | 287,585,236 | 3.9% | 46.5% | 0.0% |
| POP_JUMP_IF_FALSE | 284,988,258 | 3.8% | 50.3% |  |
| STORE_FAST | 278,237,100 | 3.7% | 54.0% |  |
| LOAD_ATTR_SLOT | 257,473,435 | 3.5% | 57.5% | 1.7% |
| CALL_PY_EXACT_ARGS | 223,519,944 | 3.0% | 60.5% | 10.1% |
| TO_BOOL_BOOL | 214,900,286 | 2.9% | 63.4% | 0.0% |
| RETURN_VALUE | 198,857,442 | 2.7% | 66.1% |  |
| RETURN_CONST | 149,955,880 | 2.0% | 68.1% |  |
| CALL_ISINSTANCE | 146,053,014 | 2.0% | 70.1% |  |
| LOAD_ATTR_METHOD_NO_DICT | 138,321,847 | 1.9% | 71.9% | 21.0% |
| POP_JUMP_IF_TRUE | 119,125,456 | 1.6% | 73.5% |  |
| POP_TOP | 111,057,512 | 1.5% | 75.0% |  |
| FOR_ITER_LIST | 85,694,723 | 1.2% | 76.2% | 1.2% |
| LOAD_ATTR_INSTANCE_VALUE | 83,165,044 | 1.1% | 77.3% | 3.5% |
| JUMP_BACKWARD | 70,394,344 | 0.9% | 78.3% |  |
| LOAD_DEREF | 66,165,244 | 0.9% | 79.1% |  |
| GET_ITER | 61,162,500 | 0.8% | 80.0% |  |
| INTERPRETER_EXIT | 60,472,713 | 0.8% | 80.8% |  |
| BINARY_SUBSCR_DICT | 60,383,720 | 0.8% | 81.6% |  |
| LOAD_ATTR | 58,783,368 | 0.8% | 82.4% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 58,090,515 | 0.8% | 83.2% | 12.4% |
| CONTAINS_OP | 50,748,164 | 0.7% | 83.9% |  |
...
| COMPARE_OP_STR | 27,771,756 | 0.4% | 90.2% | 0.2% |
| NOP | 27,021,880 | 0.4% | 90.6% |  |
| COPY | 25,475,312 | 0.3% | 90.9% |  |
| JUMP_FORWARD | 24,531,680 | 0.3% | 91.3% |  |
| TO_BOOL_LIST | 23,217,080 | 0.3% | 91.6% | 0.7% |
| COMPARE_OP_INT | 21,496,541 | 0.3% | 91.9% | 2.0% |
| COMPARE_OP | 21,480,081 | 0.3% | 92.2% |  |
| BINARY_SUBSCR | 20,449,600 | 0.3% | 92.4% |  |
| CALL_BUILTIN_CLASS | 20,200,376 | 0.3% | 92.7% |  |
| PUSH_NULL | 20,054,020 | 0.3% | 93.0% |  |
| FOR_ITER | 18,988,002 | 0.3% | 93.2% |  |
| EXTENDED_ARG | 18,915,400 | 0.3% | 93.5% |  |
| CALL_LEN | 18,094,940 | 0.2% | 93.7% |  |
| STORE_FAST_STORE_FAST | 18,061,360 | 0.2% | 94.0% |  |
| TO_BOOL_NONE | 17,750,008 | 0.2% | 94.2% | 7.7% |
| FOR_ITER_TUPLE | 17,647,548 | 0.2% | 94.4% | 5.6% |
| MAKE_CELL | 16,642,380 | 0.2% | 94.7% |  |
| BUILD_TUPLE | 16,155,206 | 0.2% | 94.9% |  |
...
| TO_BOOL_ALWAYS_TRUE | 14,602,032 | 0.2% | 96.5% | 13.2% |
| LOAD_FAST_AND_CLEAR | 14,018,780 | 0.2% | 96.7% |  |
| LOAD_ATTR_PROPERTY | 13,765,995 | 0.2% | 96.9% | 6.5% |
...
| YIELD_VALUE | 5,615,076 | 0.1% | 98.9% |  |
...
| SEND_GEN | 230,036 | 0.0% | 100.0% |  |
| STORE_SUBSCR_LIST_INT | 217,380 | 0.0% | 100.0% |  |
| JUMP_BACKWARD_NO_INTERRUPT | 189,736 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_SLOT | 228,035,133 | 3.1% | 3.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 199,686,928 | 2.7% | 5.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 194,446,880 | 2.6% | 8.4% |
| LOAD_FAST STORE_ATTR_SLOT | 179,841,194 | 2.4% | 10.8% |
| RESUME_CHECK LOAD_FAST | 152,917,704 | 2.1% | 12.9% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 147,498,014 | 2.0% | 14.8% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 142,644,614 | 1.9% | 16.8% |
| LOAD_CONST LOAD_FAST | 141,403,220 | 1.9% | 18.7% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 139,281,614 | 1.9% | 20.5% |
| STORE_FAST LOAD_FAST | 139,176,180 | 1.9% | 22.4% |
| POP_JUMP_IF_FALSE LOAD_FAST | 131,935,676 | 1.8% | 24.2% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_SLOT | 124,082,140 | 1.7% | 25.9% |
| LOAD_GLOBAL_MODULE CALL_ISINSTANCE | 121,354,674 | 1.6% | 27.5% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 100,857,720 | 1.4% | 28.9% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 87,745,258 | 1.2% | 30.0% |
...
| RETURN_VALUE RETURN_VALUE | 40,346,249 | 0.5% | 51.6% |
...
| LOAD_FAST LOAD_ATTR | 38,072,108 | 0.5% | 53.7% |
| LOAD_ATTR_METHOD_NO_DICT CALL_PY_EXACT_ARGS | 37,184,320 | 0.5% | 54.2% |
| STORE_FAST LOAD_GLOBAL_MODULE | 35,868,060 | 0.5% | 54.7% |
| LOAD_SUPER_ATTR_METHOD LOAD_FAST_LOAD_FAST | 35,852,400 | 0.5% | 55.1% |
| CACHE RESUME_CHECK | 34,880,893 | 0.5% | 55.6% |
...
| LOAD_ATTR_SLOT LOAD_FAST | 30,560,410 | 0.4% | 57.3% |
| RESUME_CHECK LOAD_FAST_LOAD_FAST | 30,287,000 | 0.4% | 57.7% |
| LOAD_ATTR LOAD_FAST | 27,269,684 | 0.4% | 58.1% |
...
| RETURN_VALUE LOAD_FAST | 25,055,880 | 0.3% | 59.9% |
| RETURN_VALUE INTERPRETER_EXIT | 24,630,533 | 0.3% | 60.2% |
| LOAD_ATTR_SLOT STORE_FAST | 24,427,620 | 0.3% | 60.5% |
| LOAD_FAST CONTAINS_OP | 23,977,560 | 0.3% | 60.8% |
| LOAD_ATTR_SLOT GET_ITER | 23,975,360 | 0.3% | 61.2% |
...
| LOAD_CONST COMPARE_OP_STR | 19,959,520 | 0.3% | 65.3% |
| LOAD_FAST_LOAD_FAST LOAD_FAST | 19,869,960 | 0.3% | 65.6% |
| COPY TO_BOOL_BOOL | 19,282,712 | 0.3% | 65.8% |
| POP_JUMP_IF_TRUE JUMP_BACKWARD | 19,240,004 | 0.3% | 66.1% |
...
| LOAD_ATTR_SLOT RETURN_VALUE | 18,242,438 | 0.2% | 67.4% |
...
| LOAD_ATTR_SLOT LOAD_ATTR_SLOT | 17,359,493 | 0.2% | 68.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 23,975,360 | 39.2% |
...
| FOR_ITER_TUPLE | 9,689,299 | 15.8% |
| FOR_ITER | 7,324,889 | 12.0% |
...
| POP_JUMP_IF_FALSE | 10,358,372 | 9.3% |
| POP_JUMP_IF_TRUE | 8,678,340 | 7.8% |
| RESUME_CHECK | 4,005,720 | 3.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 46,818,592 | 42.2% |
...
| RETURN_VALUE | 40,346,249 | 20.3% |
| RETURN_CONST | 21,420,800 | 10.8% |
| LOAD_ATTR_SLOT | 18,242,438 | 9.2% |
| CALL | 6,285,840 | 3.2% |
...
| RETURN_VALUE | 40,346,249 | 20.3% |
| LOAD_FAST | 25,055,880 | 12.6% |
| INTERPRETER_EXIT | 24,630,533 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 9,126,423 | 42.5% |
| LOAD_GLOBAL_MODULE | 4,324,160 | 20.1% |
| LOAD_CONST | 3,823,959 | 17.8% |
...
|---|---:|---:|
| COPY | 8,444,148 | 39.3% |
| POP_JUMP_IF_FALSE | 6,788,179 | 31.6% |
| RETURN_VALUE | 4,202,547 | 19.6% |
...
| POP_JUMP_IF_TRUE | 8,519,664 | 16.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 8,050,064 | 42.4% |
| GET_ITER | 7,324,889 | 38.6% |
...
| STORE_FAST | 2,970,739 | 15.6% |
| RETURN_CONST | 2,803,100 | 14.8% |
| LOAD_FAST | 2,349,994 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 19,240,004 | 27.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 45,996,102 | 65.3% |
| FOR_ITER | 8,050,064 | 11.4% |
| FOR_ITER_TUPLE | 6,580,374 | 9.3% |
...
| LOAD_FAST | 3,211,224 | 4.9% |
| LOAD_GLOBAL_MODULE | 2,560,200 | 3.9% |
| POP_JUMP_IF_FALSE | 1,318,976 | 2.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 199,686,928 | 13.1% |
| RESUME_CHECK | 152,917,704 | 10.0% |
| LOAD_CONST | 141,403,220 | 9.3% |
| STORE_FAST | 139,176,180 | 9.1% |
| POP_JUMP_IF_FALSE | 131,935,676 | 8.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 228,035,133 | 15.0% |
| STORE_ATTR_SLOT | 179,841,194 | 11.8% |
| LOAD_GLOBAL_MODULE | 139,281,614 | 9.1% |
| LOAD_ATTR_METHOD_NO_DICT | 100,857,720 | 6.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 147,498,014 | 51.8% |
| CONTAINS_OP | 40,393,940 | 14.2% |
| IS_OP | 19,099,360 | 6.7% |
| COMPARE_OP_INT | 12,997,185 | 4.6% |
| TO_BOOL_ALWAYS_TRUE | 12,610,100 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 131,935,676 | 46.3% |
| LOAD_GLOBAL_BUILTIN | 68,046,983 | 23.9% |
| LOAD_GLOBAL_MODULE | 25,165,100 | 8.8% |
| LOAD_FAST_LOAD_FAST | 15,874,740 | 5.6% |
| POP_TOP | 10,358,372 | 3.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 51,273,272 | 43.0% |
| TO_BOOL_LIST | 17,397,760 | 14.6% |
| COMPARE_OP_STR | 16,223,220 | 13.6% |
| CONTAINS_OP | 8,519,664 | 7.2% |
| COMPARE_OP_INT | 6,292,240 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 51,879,684 | 43.6% |
| JUMP_BACKWARD | 19,240,004 | 16.2% |
| LOAD_GLOBAL_MODULE | 13,705,940 | 11.5% |
| POP_TOP | 8,678,340 | 7.3% |
| NOP | 7,043,520 | 5.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| BUILD_TUPLE | 2,834,866 | 31.4% |
| RETURN_GENERATOR | 2,372,800 | 26.2% |
| CALL_STR_1 | 1,224,320 | 13.5% |
| LOAD_FAST | 1,062,920 | 11.8% |
| LOAD_GLOBAL_MODULE | 602,400 | 6.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 3,486,524 | 38.6% |
| LOAD_FAST | 2,478,154 | 27.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 121,354,674 | 83.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 142,644,614 | 97.7% |
| COPY | 2,145,320 | 1.5% |
| YIELD_VALUE | 629,920 | 0.4% |
| RETURN_VALUE | 373,340 | 0.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 12,997,185 | 60.5% |
| POP_JUMP_IF_TRUE | 6,292,240 | 29.3% |
| COPY | 1,052,784 | 4.9% |
| RETURN_VALUE | 640,115 | 3.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 19,959,520 | 71.9% |
| LOAD_FAST | 4,531,740 | 16.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 16,223,220 | 58.4% |
| POP_JUMP_IF_FALSE | 8,950,620 | 32.2% |
| COPY | 1,547,800 | 5.6% |
| RETURN_VALUE | 615,296 | 2.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 46,860,884 | 54.7% |
| LOAD_FAST | 13,546,485 | 15.8% |
| SWAP | 8,945,260 | 10.4% |
| RETURN_CONST | 7,250,540 | 8.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| GET_ITER | 9,689,299 | 54.9% |
| JUMP_BACKWARD | 6,580,374 | 37.3% |
| SWAP | 1,314,320 | 7.4% |
| EXTENDED_ARG | 34,520 | 0.2% |
| FOR_ITER_LIST | 17,933 | 0.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 8,763,381 | 49.7% |
| STORE_FAST | 4,322,737 | 24.5% |
...
| LOAD_ATTR_METHOD_NO_DICT | 7,474,200 | 9.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 100,857,720 | 72.9% |
| LOAD_ATTR_SLOT | 15,260,520 | 11.0% |
| LOAD_ATTR_INSTANCE_VALUE | 7,474,200 | 5.4% |
| LOAD_GLOBAL_MODULE | 5,785,400 | 4.2% |
| LOAD_ATTR_WITH_HINT | 1,811,720 | 1.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 62,553,040 | 45.2% |
| CALL_PY_EXACT_ARGS | 37,184,320 | 26.9% |
| LOAD_CONST | 13,122,460 | 9.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 9,951,001 | 72.3% |
| LOAD_ATTR_SLOT | 3,393,034 | 24.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 12,868,449 | 93.5% |
| RETURN_VALUE | 535,277 | 3.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 228,035,133 | 88.6% |
| LOAD_ATTR_SLOT | 17,359,493 | 6.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 30,560,410 | 11.9% |
| STORE_FAST | 24,427,620 | 9.5% |
| GET_ITER | 23,975,360 | 9.3% |
| RETURN_VALUE | 18,242,438 | 7.1% |
| LOAD_ATTR_SLOT | 17,359,493 | 6.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 87,745,258 | 30.5% |
| POP_JUMP_IF_FALSE | 68,046,983 | 23.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 121,354,674 | 37.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 194,446,880 | 55.4% |
| COPY_FREE_VARS | 46,553,660 | 13.3% |
| CACHE | 34,880,893 | 9.9% |
| CALL_KW | 21,713,260 | 6.2% |
| CALL_BOUND_METHOD_EXACT_ARGS | 13,891,440 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 152,917,704 | 43.5% |
| LOAD_GLOBAL_BUILTIN | 87,745,258 | 25.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD_NO_INTERRUPT | 182,056 | 79.1% |
| LOAD_CONST | 47,920 | 20.8% |
| SEND | 60 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 182,056 | 79.1% |
| POP_TOP | 47,940 | 20.8% |
| RESUME | 40 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 179,841,194 | 58.8% |
| LOAD_FAST_LOAD_FAST | 124,082,140 | 40.6% |
| STORE_ATTR_SLOT | 1,242,140 | 0.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 12,610,100 | 86.4% |
| POP_JUMP_IF_TRUE | 1,469,020 | 10.1% |
| EXTENDED_ARG | 487,160 | 3.3% |
| TO_BOOL_NONE | 18,507 | 0.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 142,644,614 | 66.4% |
| COPY | 19,282,712 | 9.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 147,498,014 | 68.6% |
| POP_JUMP_IF_TRUE | 51,273,272 | 23.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 11,574,940 | 65.2% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 64,152,277 | 11.0% |
|          hit | 516,498,763 | 88.8% |
|         miss | 30,523,821 | 5.2% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 688,424 | 88.2% |
| Failure | 92,260 | 11.8% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 20,921,900 | 16.2% |
|          hit | 108,455,160 | 83.8% |
|         miss | 2,016,831 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 102,472,003 | 15.8% |
|        deopt | 780 | 0.0% |
|          hit | 545,100,523 | 84.0% |
|         miss | 44,850,573 | 6.9% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,000,458 | 86.1% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 71,288,264 | 20.3% |
|          hit | 278,691,910 | 79.3% |
|         miss | 66,746,464 | 19.0% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,281,520 | 98.4% |
| Failure | 20,420 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 13,805,536 | 4.8% |
|          hit | 273,549,430 | 95.1% |
|         miss | 3,712,316 | 1.3% |
...
|---|---:|---:|
| Basic | 3,723,470,611 | 50.1% |
| Not specialized | 676,493,705 | 9.1% |
| Specialized hits | 2,878,871,460 | 38.8% |
| Specialized misses | 148,417,852 | 2.0% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 102,472,003 | 32.1% |
| STORE_ATTR | 71,288,264 | 22.3% |
| CALL | 64,152,277 | 20.1% |
| COMPARE_OP | 21,900,764 | 6.9% |
| FOR_ITER | 20,921,900 | 6.5% |
| BINARY_SUBSCR | 20,416,720 | 6.4% |
| TO_BOOL | 13,805,536 | 4.3% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| STORE_ATTR_SLOT | 65,853,984 | 44.4% |
| LOAD_ATTR_METHOD_NO_DICT | 29,040,772 | 19.6% |
| CALL_PY_EXACT_ARGS | 22,560,121 | 15.2% |
| LOAD_ATTR_METHOD_WITH_VALUES | 7,220,481 | 4.9% |
| LOAD_ATTR_SLOT | 4,292,894 | 2.9% |
...
| TO_BOOL_ALWAYS_TRUE | 1,927,796 | 1.3% |
| TO_BOOL_NONE | 1,374,300 | 0.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 60,499,133 | 17.0% |
| Calls to Python functions inlined | 294,689,965 | 83.0% |
| Calls via PyEval_EvalFrame (total) | 60,499,133 | 17.0% |
| Calls via PyEval_EvalFrame (vector) | 53,288,893 | 15.0% |
| Calls via PyEval_EvalFrame (generator) | 7,210,240 | 2.0% |
| Calls via PyEval_EvalFrame (legacy) | 100 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 53,288,753 | 15.0% |
| Calls via PyEval_EvalFrame (build class) | 40 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 6,954,734 | 2.0% |
| Calls via PyEval_EvalFrame (function ex) | 1,237,660 | 0.3% |
| Calls via PyEval_EvalFrame (api) | 11,828,459 | 3.3% |
| Calls via PyEval_EvalFrame (method) | 100 | 0.0% |
| Frame objects created | 2,373,920 | 0.7% |
| Frames pushed | 243,156,112 | 68.5% |
...
| Frees to freelist | 153,577,546 |  |
| Allocations | 384,694,566 | 71.5% |
| Allocations to 512 bytes | 384,173,284 | 71.4% |
| Allocations to 4 kbytes | 362,062 | 0.1% |
| Allocations over 4 kbytes | 159,220 | 0.0% |
| Frees | 379,268,956 |  |
| New values | 4,435,060 |  |
| Interpreter increfs | 3,598,217,747 | 73.8% |
| Interpreter decrefs | 3,969,015,998 | 74.9% |
| Increfs | 1,279,227,584 | 26.2% |
| Decrefs | 1,333,127,849 | 25.1% |
| Materialize dict (on request) | 340 | 0.0% |
| Materialize dict (new key) | 1,160 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 220 | 0.0% |
| Method cache hits | 210,805,557 |  |
| Method cache misses | 4,845,648 |  |
| Method cache collisions | 5,689,687 |  |
| Method cache dunder hits | 178,171,568 |  |
| Method cache dunder misses | 867,770 |  |
