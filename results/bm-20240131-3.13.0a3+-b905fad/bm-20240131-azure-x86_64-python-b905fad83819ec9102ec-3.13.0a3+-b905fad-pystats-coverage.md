...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,818,684 | 20.6% | 20.6% |  |
| LOAD_CONST | 39,100,680 | 15.9% | 36.5% |  |
...
| COMPARE_OP_INT | 19,432,380 | 7.9% | 75.9% |  |
...
| LOAD_FAST_LOAD_FAST | 940,980 | 0.4% | 96.3% |  |
| POP_JUMP_IF_FALSE | 911,580 | 0.4% | 96.7% |  |
| STORE_FAST | 757,872 | 0.3% | 97.0% |  |
| JUMP_BACKWARD | 502,500 | 0.2% | 97.2% |  |
| FOR_ITER | 435,240 | 0.2% | 97.4% |  |
| STORE_FAST_STORE_FAST | 402,960 | 0.2% | 97.5% |  |
| LOAD_ATTR_MODULE | 391,540 | 0.2% | 97.7% | 3.2% |
| TO_BOOL_BOOL | 346,832 | 0.1% | 97.8% |  |
| CONTAINS_OP | 346,120 | 0.1% | 98.0% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 345,440 | 0.1% | 98.1% |  |
| LOAD_GLOBAL_BUILTIN | 342,220 | 0.1% | 98.2% | 0.6% |
| STORE_SUBSCR_DICT | 342,200 | 0.1% | 98.4% |  |
| RESUME_CHECK | 335,320 | 0.1% | 98.5% | 2.3% |
| CALL | 267,978 | 0.1% | 98.6% |  |
| LOAD_ATTR_METHOD_NO_DICT | 255,612 | 0.1% | 98.7% |  |
...
| POP_JUMP_IF_TRUE | 151,440 | 0.1% | 99.2% |  |
...
| INSTRUMENTED_FOR_ITER | 11,272 | 0.0% | 99.9% |  |
| BUILD_LIST | 10,040 | 0.0% | 99.9% |  |
| INSTRUMENTED_JUMP_BACKWARD | 9,992 | 0.0% | 99.9% |  |
...
| BINARY_OP_ADD_INT INSTRUMENTED_RETURN_VALUE | 9,711,340 | 3.9% | 86.7% |
...
| POP_JUMP_IF_FALSE LOAD_FAST_LOAD_FAST | 471,560 | 0.2% | 94.8% |
| JUMP_BACKWARD FOR_ITER | 383,020 | 0.2% | 95.0% |
| LOAD_FAST_LOAD_FAST LOAD_FAST | 379,840 | 0.2% | 95.1% |
| UNPACK_SEQUENCE_TWO_TUPLE STORE_FAST_STORE_FAST | 344,460 | 0.1% | 95.3% |
| CONTAINS_OP POP_JUMP_IF_FALSE | 342,420 | 0.1% | 95.4% |
| STORE_FAST LOAD_FAST | 337,812 | 0.1% | 95.5% |
| LOAD_FAST STORE_SUBSCR_DICT | 333,700 | 0.1% | 95.7% |
| FOR_ITER UNPACK_SEQUENCE_TWO_TUPLE | 333,340 | 0.1% | 95.8% |
| STORE_SUBSCR_DICT JUMP_BACKWARD | 332,300 | 0.1% | 95.9% |
| STORE_FAST_STORE_FAST LOAD_FAST_LOAD_FAST | 327,220 | 0.1% | 96.1% |
| LOAD_FAST_LOAD_FAST CONTAINS_OP | 326,380 | 0.1% | 96.2% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 313,000 | 0.1% | 96.3% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 244,680 | 0.1% | 96.4% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 240,132 | 0.1% | 96.5% |
| PUSH_NULL LOAD_FAST | 229,400 | 0.1% | 96.6% |
| LOAD_ATTR_MODULE PUSH_NULL | 222,720 | 0.1% | 96.7% |
| POP_JUMP_IF_FALSE LOAD_FAST | 205,520 | 0.1% | 96.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 197,200 | 0.1% | 96.9% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 192,292 | 0.1% | 97.0% |
| LOAD_FAST CALL | 190,892 | 0.1% | 97.0% |
...
| CALL TO_BOOL_BOOL | 109,732 | 0.0% | 97.6% |
...
| TO_BOOL_STR POP_JUMP_IF_FALSE | 104,700 | 0.0% | 97.8% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 59,320 | 0.0% | 98.3% |
...
| LOAD_CONST LOAD_CONST | 49,800 | 0.0% | 98.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 326,380 | 94.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 342,420 | 98.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 333,340 | 76.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_SUBSCR_DICT | 332,300 | 66.1% |
...
| LOAD_FAST_LOAD_FAST | 379,840 | 0.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 38,910,100 | 76.6% |
| INSTRUMENTED_RETURN_VALUE | 9,717,760 | 19.1% |
| STORE_SUBSCR_DICT | 333,700 | 0.7% |
| LOAD_ATTR_METHOD_NO_DICT | 192,292 | 0.4% |
| CALL | 190,892 | 0.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 471,560 | 50.1% |
| STORE_FAST_STORE_FAST | 327,220 | 34.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 379,840 | 40.4% |
| CONTAINS_OP | 326,380 | 34.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 471,560 | 51.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 344,460 | 85.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 327,220 | 81.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 344,460 | 99.7% |
| STORE_FAST | 980 | 0.3% |
...
|---|---:|---:|
| Basic | 152,629,632 | 61.9% |
| Not specialized | 11,780,538 | 4.8% |
| Specialized hits | 82,241,664 | 33.3% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_GLOBAL | 9,768,640 | 91.7% |
| FOR_ITER | 433,440 | 4.1% |
| CALL | 258,812 | 2.4% |
| LOAD_ATTR | 80,260 | 0.8% |
| TO_BOOL | 63,500 | 0.6% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 738,012 | 1.8% |
| Frees to freelist | 735,052 |  |
| Allocations | 40,946,300 | 98.2% |
| Allocations to 512 bytes | 40,934,640 | 98.2% |
| Allocations to 4 kbytes | 6,620 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,923,927 |  |
| New values | 1,420 |  |
| Interpreter increfs | 43,926,176 | 15.7% |
| Interpreter decrefs | 64,278,828 | 24.5% |
| Increfs | 235,613,024 | 84.3% |
| Decrefs | 198,436,436 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,529,665 |  |
| Method cache misses | 10,335 |  |
| Method cache collisions | 9,374 |  |
| Method cache dunder hits | 176,670 |  |
| Method cache dunder misses | 1,270 |  |
