...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,814,860 | 20.6% | 20.6% |  |
...
| POP_JUMP_IF_FALSE | 909,600 | 0.4% | 96.7% |  |
| STORE_FAST | 757,880 | 0.3% | 97.0% |  |
...
| STORE_FAST LOAD_FAST | 337,820 | 0.1% | 95.5% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 240,100 | 0.1% | 96.5% |
...
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 192,300 | 0.1% | 97.0% |
| LOAD_FAST CALL | 190,900 | 0.1% | 97.0% |
...
| CALL TO_BOOL_BOOL | 109,740 | 0.0% | 97.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_SUBSCR_DICT | 330,060 | 66.1% |
...
| LOAD_ATTR_METHOD_NO_DICT | 192,300 | 0.4% |
| CALL | 190,900 | 0.4% |
...
| INSTRUMENTED_POP_JUMP_IF_TRUE | 7,100 | 2.0% |
...
|---|---:|---:|
| Basic | 152,608,100 | 61.9% |
| Not specialized | 11,775,788 | 4.8% |
| Specialized hits | 82,233,640 | 33.3% |
...
| Allocations to 512 bytes | 40,932,260 | 98.2% |
| Allocations to 4 kbytes | 6,620 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,921,384 |  |
| New values | 1,420 |  |
| Interpreter increfs | 43,921,360 | 15.7% |
| Interpreter decrefs | 64,270,860 | 24.5% |
| Increfs | 235,609,133 | 84.3% |
| Decrefs | 198,433,044 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,528,280 |  |
| Method cache misses | 11,760 |  |
| Method cache collisions | 11,045 |  |
| Method cache dunder hits | 175,996 |  |
| Method cache dunder misses | 1,304 |  |
