...
| Increfs | 226,960,188 | 97.8% |
| Decrefs | 239,206,849 | 96.9% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 3,276,872 |  |
| Method cache misses | 819,248 |  |
| Method cache collisions | 860,120 |  |
| Method cache dunder hits | 7,331,815 |  |
| Method cache dunder misses | 40,985 |  |
