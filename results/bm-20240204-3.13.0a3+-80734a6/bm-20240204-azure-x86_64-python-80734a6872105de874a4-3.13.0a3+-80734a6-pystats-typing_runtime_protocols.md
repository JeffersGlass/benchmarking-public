...
| CALL_TYPE_1 | 16,800,276 | 1.7% | 84.0% |  |
| FOR_ITER_TUPLE | 16,578,329 | 1.7% | 85.7% |  |
| TO_BOOL_BOOL | 16,040,909 | 1.7% | 87.4% |  |
...
| CALL_ISINSTANCE | 5,337,411 | 0.6% | 94.7% |  |
...
| IS_OP POP_JUMP_IF_FALSE | 26,938,884 | 2.8% | 26.1% |
...
| LOAD_FAST CALL_TYPE_1 | 16,799,996 | 1.7% | 37.4% |
...
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 5,349,980 | 0.6% | 71.6% |
...
| FOR_ITER STORE_FAST | 4,769,030 | 0.5% | 78.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 26,938,884 | 61.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| IS_OP | 26,938,884 | 66.1% |
| TO_BOOL_BOOL | 5,349,980 | 13.1% |
...
| CALL_ISINSTANCE | 12,391 | 0.1% |
| COPY | 7,880 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 10,690,509 | 66.6% |
| POP_JUMP_IF_FALSE | 5,349,980 | 33.4% |
...
|---|---:|---:|
| Basic | 438,824,494 | 45.7% |
| Not specialized | 163,704,135 | 17.0% |
| Specialized hits | 357,662,429 | 37.2% |
...
| Allocations | 45,888,804 | 42.9% |
| Allocations to 512 bytes | 45,875,164 | 42.9% |
| Allocations to 4 kbytes | 12,680 | 0.0% |
| Allocations over 4 kbytes | 960 | 0.0% |
| Frees | 45,728,104 |  |
| New values | 2,900 |  |
| Interpreter increfs | 410,383,684 | 61.9% |
| Interpreter decrefs | 475,609,510 | 61.8% |
| Increfs | 252,208,666 | 38.1% |
| Decrefs | 293,609,659 | 38.2% |
| Materialize dict (on request) | 1,040 | 35.9% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 31,969,874 |  |
| Method cache misses | 52,306 |  |
| Method cache collisions | 89,399 |  |
| Method cache dunder hits | 45,434,839 |  |
| Method cache dunder misses | 42,052 |  |
