...
| POP_JUMP_IF_FALSE | 73,814,720 | 7.5% | 41.8% |  |
...
| FOR_ITER | 2,336,780 | 0.2% | 95.1% |  |
| NOP | 2,291,580 | 0.2% | 95.4% |  |
...
| FOR_ITER_LIST | 1,497,460 | 0.2% | 97.9% |  |
...
| BUILD_SLICE | 761,660 | 0.1% | 99.4% |  |
| CALL_BUILTIN_FAST | 635,680 | 0.1% | 99.4% | 0.0% |
| BINARY_OP_SUBTRACT_INT | 546,800 | 0.1% | 99.5% |  |
| TO_BOOL_INT | 516,260 | 0.1% | 99.5% |  |
| INTERPRETER_EXIT | 509,340 | 0.1% | 99.6% |  |
| TO_BOOL_NONE | 507,240 | 0.1% | 99.6% | 7.0% |
| CALL_KW | 499,800 | 0.1% | 99.7% |  |
| LOAD_ATTR_MODULE | 453,200 | 0.0% | 99.7% | 0.0% |
| LOAD_DEREF | 449,800 | 0.0% | 99.8% |  |
| COPY_FREE_VARS | 449,060 | 0.0% | 99.8% |  |
| EXIT_INIT_CHECK | 448,280 | 0.0% | 99.9% |  |
| CALL_ALLOC_AND_ENTER_INIT | 448,280 | 0.0% | 99.9% |  |
...
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 11,900 | 0.0% | 100.0% | 1.0% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 56,885,160 | 5.7% | 14.9% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 7,388,860 | 0.7% | 51.8% |
...
| LOAD_ATTR LOAD_FAST | 5,356,340 | 0.5% | 60.3% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 4,898,520 | 0.5% | 65.4% |
| POP_TOP LOAD_FAST | 4,779,620 | 0.5% | 65.8% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 4,725,300 | 0.5% | 66.3% |
...
| LOAD_GLOBAL_MODULE | 1,104,780 | 48.2% |
| NOP | 22,660 | 1.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 1,568,860 | 75.6% |
...
| GET_ITER | 1,038,460 | 44.4% |
| EXTENDED_ARG | 1,560 | 0.1% |
| FOR_ITER | 1,560 | 0.1% |
| SWAP | 220 | 0.0% |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 292,280 | 12.5% |
| RETURN_CONST | 284,240 | 12.2% |
| FOR_ITER | 1,560 | 0.1% |
| LOAD_FAST | 300 | 0.0% |
...
| LOAD_ATTR_INSTANCE_VALUE | 966,460 | 14.1% |
| COPY | 511,400 | 7.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 56,885,160 | 24.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| GET_ITER | 1,096,440 | 73.2% |
| JUMP_BACKWARD | 253,780 | 16.9% |
| EXTENDED_ARG | 147,080 | 9.8% |
| FOR_ITER | 160 | 0.0% |
...
| RETURN_CONST | 131,340 | 8.8% |
| UNPACK_SEQUENCE_TWO_TUPLE | 27,440 | 1.8% |
...
| LOAD_ATTR_INSTANCE_VALUE | 4,725,300 | 35.8% |
...
| FOR_ITER | 292,280 | 30.3% |
| FOR_ITER_LIST | 27,440 | 2.8% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 9,215,740 | 19.0% |
|          hit | 39,128,340 | 80.7% |
|         miss | 7,286,740 | 15.0% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 144,300 | 97.8% |
| Failure | 3,280 | 2.2% |

|Failure kind | Count | Ratio | 
|---|---:|---:|
| meth descr varargs | 820 | 25.0% |
| meth descr method fastcall keywords | 800 | 24.4% |
| class no vectorcall | 540 | 16.5% |
| operator wrapper | 260 | 7.9% |
| code complex parameters | 240 | 7.3% |
| metaclass | 180 | 5.5% |
| no dict | 120 | 3.7% |
| class mutable | 100 | 3.0% |
| out of versions | 60 | 1.8% |
| cfunc noargs | 60 | 1.8% |
| str | 60 | 1.8% |
| other | 40 | 1.2% |
| cfunc varargs keywords | 40 | 1.2% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 6,860,560 | 4.4% |
|        deopt | 40 | 0.0% |
|          hit | 150,061,700 | 95.6% |
|         miss | 31,900 | 0.0% |
...
|---|---:|---:|
| Basic | 481,538,660 | 48.7% |
| Not specialized | 129,686,360 | 13.1% |
| Specialized hits | 370,618,880 | 37.5% |
| Specialized misses | 7,464,860 | 0.8% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 13,792,040 | 27.9% |
| Frees to freelist | 13,808,020 |  |
| Allocations | 35,598,760 | 72.1% |
| Allocations to 512 bytes | 35,307,760 | 71.5% |
| Allocations to 4 kbytes | 279,300 | 0.6% |
| Allocations over 4 kbytes | 11,700 | 0.0% |
| Frees | 34,732,174 |  |
| New values | 17,040 |  |
| Interpreter increfs | 435,133,680 | 82.8% |
| Interpreter decrefs | 484,173,200 | 85.4% |
| Increfs | 90,647,904 | 17.2% |
| Decrefs | 82,935,627 | 14.6% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 9,408,057 |  |
| Method cache misses | 15,223 |  |
| Method cache collisions | 16,237 |  |
| Method cache dunder hits | 2,293,571 |  |
| Method cache dunder misses | 2,809 |  |
...
|---:|---:|---:|---:|
| 0 | 3,500 | 2,300 | 14,069,920 |
| 1 | 320 | 0 | 13,913,840 |
| 2 | 20 | 675,720 | 10,467,000 |
