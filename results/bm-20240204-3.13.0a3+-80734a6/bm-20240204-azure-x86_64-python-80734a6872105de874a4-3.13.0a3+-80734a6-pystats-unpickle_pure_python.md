...
| Increfs | 87,261,074 | 8.9% |
| Decrefs | 83,676,612 | 8.2% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 2,429,197 |  |
| Method cache misses | 61,543 |  |
| Method cache collisions | 65,255 |  |
| Method cache dunder hits | 673,776 |  |
| Method cache dunder misses | 4,864 |  |
