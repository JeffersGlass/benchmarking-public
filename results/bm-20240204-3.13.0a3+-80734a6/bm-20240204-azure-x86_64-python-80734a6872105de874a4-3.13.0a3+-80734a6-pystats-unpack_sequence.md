...
|---|---:|---:|---:|---:|
| STORE_FAST_STORE_FAST | 2,621,440,000 | 71.3% | 71.3% |  |
| LOAD_FAST | 524,288,800 | 14.3% | 85.6% |  |
| UNPACK_SEQUENCE_TUPLE | 262,584,000 | 7.1% | 92.7% | 0.6% |
| UNPACK_SEQUENCE_LIST | 261,752,000 | 7.1% | 99.8% | 0.5% |
| EXTENDED_ARG | 2,621,600 | 0.1% | 99.9% |  |
| STORE_FAST | 1,311,360 | 0.0% | 99.9% |  |
| FOR_ITER_RANGE | 1,310,860 | 0.0% | 100.0% |  |
| JUMP_BACKWARD | 1,310,720 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| STORE_FAST_STORE_FAST STORE_FAST_STORE_FAST | 2,097,152,000 | 57.0% | 57.0% |
| STORE_FAST_STORE_FAST LOAD_FAST | 522,977,280 | 14.2% | 71.3% |
| LOAD_FAST UNPACK_SEQUENCE_TUPLE | 262,552,000 | 7.1% | 78.4% |
| UNPACK_SEQUENCE_TUPLE STORE_FAST_STORE_FAST | 262,552,000 | 7.1% | 85.5% |
| UNPACK_SEQUENCE_LIST STORE_FAST_STORE_FAST | 261,728,000 | 7.1% | 92.7% |
| LOAD_FAST UNPACK_SEQUENCE_LIST | 261,720,000 | 7.1% | 99.8% |
| STORE_FAST LOAD_FAST | 1,310,880 | 0.0% | 99.8% |
| EXTENDED_ARG FOR_ITER_RANGE | 1,310,840 | 0.0% | 99.9% |
| EXTENDED_ARG JUMP_BACKWARD | 1,310,720 | 0.0% | 99.9% |
| JUMP_BACKWARD EXTENDED_ARG | 1,310,720 | 0.0% | 99.9% |
| STORE_FAST_STORE_FAST EXTENDED_ARG | 1,310,720 | 0.0% | 100.0% |
| FOR_ITER_RANGE STORE_FAST | 1,310,700 | 0.0% | 100.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 1,310,720 | 50.0% |
| STORE_FAST_STORE_FAST | 1,310,720 | 50.0% |
| GET_ITER | 160 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_RANGE | 1,310,840 | 50.0% |
| JUMP_BACKWARD | 1,310,720 | 50.0% |
| FOR_ITER | 40 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 522,977,280 | 99.7% |
| STORE_FAST | 1,310,880 | 0.3% |
| PUSH_NULL | 160 | 0.0% |
| CALL | 160 | 0.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TUPLE | 262,552,000 | 50.1% |
| UNPACK_SEQUENCE_LIST | 261,720,000 | 49.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 2,097,152,000 | 80.0% |
| UNPACK_SEQUENCE_TUPLE | 262,552,000 | 10.0% |
| UNPACK_SEQUENCE_LIST | 261,728,000 | 10.0% |
| UNPACK_SEQUENCE | 8,000 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 2,097,152,000 | 80.0% |
| LOAD_FAST | 522,977,280 | 20.0% |
| EXTENDED_ARG | 1,310,720 | 0.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| EXTENDED_ARG | 1,310,840 | 100.0% |
| FOR_ITER | 20 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 1,310,700 | 100.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 261,720,000 | 100.0% |
| UNPACK_SEQUENCE_TUPLE | 32,000 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 261,728,000 | 100.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 262,552,000 | 100.0% |
| UNPACK_SEQUENCE_LIST | 24,000 | 0.0% |
| UNPACK_SEQUENCE | 8,000 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 262,552,000 | 100.0% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 2,920,000 | 0.6% |
|          hit | 521,368,000 | 99.4% |
|         miss | 2,968,000 | 0.6% |
...
|---|---:|---:|
| Basic | 3,150,975,060 | 85.7% |
| Not specialized | 17,580 | 0.0% |
| Specialized hits | 522,681,360 | 14.2% |
| Specialized misses | 2,968,000 | 0.1% |
...
| Allocations | 4,190,700 | 100.0% |
| Allocations to 512 bytes | 4,190,700 | 100.0% |
| Allocations to 4 kbytes | 0 | 0.0% |
| Allocations over 4 kbytes | 0 | 0.0% |
| Frees | 4,190,560 |  |
| New values | 0 |  |
| Interpreter increfs | 524,291,380 | 99.4% |
| Interpreter decrefs | 528,482,100 | 99.5% |
| Increfs | 2,920,360 | 0.6% |
| Decrefs | 2,920,700 | 0.5% |
