...
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 2,860 | 0.9% | 29.1% |
...
| RETURN_CONST INTERPRETER_EXIT | 2,200 | 0.7% | 36.5% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 1,260 | 0.4% | 49.6% |
...
| POP_TOP RETURN_CONST | 1,100 | 0.3% | 51.5% |
| LOAD_FAST_LOAD_FAST BUILD_TUPLE | 1,100 | 0.3% | 51.9% |
| POP_JUMP_IF_FALSE RETURN_CONST | 1,100 | 0.3% | 52.2% |
...
| LOAD_FAST CALL_LEN | 840 | 0.3% | 59.2% |
...
|---|---:|---:|
| Basic | 170,160 | 53.9% |
| Not specialized | 50,480 | 16.0% |
| Specialized hits | 91,620 | 29.0% |
...
|---|---:|---:|
| CALL | 6,420 | 31.0% |
| LOAD_ATTR | 3,840 | 18.6% |
| LOAD_GLOBAL | 3,440 | 16.6% |
| TO_BOOL | 2,440 | 11.8% |
| BINARY_OP | 1,540 | 7.4% |
...
| Frees | 25,700 |  |
| New values | 1,100 |  |
| Interpreter increfs | 114,240 | 65.5% |
| Interpreter decrefs | 134,460 | 64.3% |
| Increfs | 60,067 | 34.5% |
| Decrefs | 74,629 | 35.7% |
...
| Method cache hits | 15,660 |  |
| Method cache misses | 1,680 |  |
| Method cache collisions | 1,587 |  |
| Method cache dunder hits | 6,759 |  |
| Method cache dunder misses | 581 |  |
