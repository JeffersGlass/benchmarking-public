...
| RESUME | 1,920 | 0.0% | 100.0% | 4,765.2% |
...
| CACHE RESUME_CHECK | 113,917,520 | 2.3% | 23.4% |
...
| RETURN_VALUE STORE_FAST | 26,129,760 | 0.5% | 66.2% |
...
| PUSH_NULL CALL | 17,172,580 | 0.4% | 77.4% |
| LOAD_FAST CALL | 17,171,280 | 0.4% | 77.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL | 38,818,300 | 24.3% |
| RETURN_VALUE | 26,129,760 | 16.4% |
...
|---|---:|---:|
| Basic | 2,391,200,720 | 49.0% |
| Not specialized | 502,197,160 | 10.3% |
| Specialized hits | 1,982,434,269 | 40.6% |
| Specialized misses | 4,809,971 | 0.1% |
...
| Frames pushed | 120,943,820 | 42.6% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 114,342,640 | 39.1% |
| Frees to freelist | 114,850,554 |  |
| Allocations | 177,887,915 | 60.9% |
| Allocations to 512 bytes | 177,772,328 | 60.8% |
| Allocations to 4 kbytes | 115,480 | 0.0% |
| Allocations over 4 kbytes | 107 | 0.0% |
| Frees | 179,991,309 |  |
| New values | 420 |  |
| Interpreter increfs | 2,666,253,280 | 78.7% |
| Interpreter decrefs | 2,780,328,926 | 76.5% |
| Increfs | 723,545,416 | 21.3% |
| Decrefs | 855,006,002 | 23.5% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 109,097,071 |  |
| Method cache misses | 824,209 |  |
| Method cache collisions | 819,842 |  |
...
|---:|---:|---:|---:|
| 0 | 92,951 | 2,040 | 649,134,458 |
| 1 | 8,440 | 0 | 709,479,414 |
| 2 | 660 | 0 | 2,273,333,406 |
