...
| PUSH_NULL | 2,080 | 1.7% | 66.8% |  |
| TO_BOOL | 2,040 | 1.7% | 68.5% |  |
| RETURN_VALUE | 1,980 | 1.7% | 70.2% |  |
| TO_BOOL_BOOL | 1,860 | 1.6% | 71.7% |  |
| POP_JUMP_IF_NOT_NONE | 1,680 | 1.4% | 73.1% |  |
| RETURN_CONST | 1,680 | 1.4% | 74.5% |  |
| INTERPRETER_EXIT | 1,560 | 1.3% | 75.8% |  |
| STORE_ATTR | 1,440 | 1.2% | 77.0% |  |
| NOP | 1,360 | 1.1% | 78.2% |  |
| LOAD_DEREF | 1,200 | 1.0% | 79.2% |  |
| COMPARE_OP_INT | 1,140 | 1.0% | 80.1% |  |
| LOAD_ATTR_METHOD_NO_DICT | 1,120 | 0.9% | 81.1% | 14.3% |
| CALL_PY_EXACT_ARGS | 1,060 | 0.9% | 81.9% |  |
| POP_JUMP_IF_NONE | 880 | 0.7% | 82.7% |  |
| CALL_BUILTIN_FAST | 880 | 0.7% | 83.4% |  |
| COMPARE_OP | 860 | 0.7% | 84.1% |  |
| POP_JUMP_IF_TRUE | 840 | 0.7% | 84.8% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 800 | 0.7% | 85.5% |  |
| BUILD_TUPLE | 720 | 0.6% | 86.1% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 720 | 0.6% | 86.7% |  |
...
| DELETE_ATTR | 480 | 0.4% | 91.0% |  |
| BINARY_SLICE | 400 | 0.3% | 91.4% |  |
| COPY | 400 | 0.3% | 91.7% |  |
| MAKE_CELL | 400 | 0.3% | 92.0% |  |
| TO_BOOL_STR | 380 | 0.3% | 92.3% | 21.1% |
| CALL_BUILTIN_CLASS | 380 | 0.3% | 92.7% |  |
| UNPACK_SEQUENCE | 360 | 0.3% | 93.0% |  |
| CALL_METHOD_DESCRIPTOR_FAST | 360 | 0.3% | 93.3% |  |
| BEFORE_WITH | 320 | 0.3% | 93.5% |  |
| BUILD_MAP | 320 | 0.3% | 93.8% |  |
| CALL_KW | 320 | 0.3% | 94.1% |  |
| COPY_FREE_VARS | 320 | 0.3% | 94.3% |  |
| DICT_MERGE | 320 | 0.3% | 94.6% |  |
| CALL_LEN | 300 | 0.3% | 94.9% |  |
| TO_BOOL_NONE | 300 | 0.3% | 95.1% |  |
| GET_ITER | 280 | 0.2% | 95.3% |  |
| SWAP | 260 | 0.2% | 95.6% |  |
| COMPARE_OP_STR | 240 | 0.2% | 95.8% | 33.3% |
| EXTENDED_ARG | 240 | 0.2% | 96.0% |  |
| FOR_ITER | 240 | 0.2% | 96.2% |  |
| STORE_DEREF | 240 | 0.2% | 96.4% |  |
| BINARY_OP_ADD_INT | 240 | 0.2% | 96.6% |  |
| CALL_METHOD_DESCRIPTOR_O | 240 | 0.2% | 96.8% |  |
| CALL_PY_WITH_DEFAULTS | 240 | 0.2% | 97.0% |  |
| TO_BOOL_INT | 240 | 0.2% | 97.2% |  |
| BINARY_SUBSCR | 200 | 0.2% | 97.3% |  |
...
| CACHE RESUME_CHECK | 1,080 | 0.9% | 25.6% |
| LOAD_FAST STORE_ATTR | 1,080 | 0.9% | 26.5% |
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 1,040 | 0.9% | 27.4% |
| LOAD_GLOBAL LOAD_GLOBAL_MODULE | 980 | 0.8% | 28.2% |
| POP_TOP LOAD_FAST | 960 | 0.8% | 29.0% |
| LOAD_CONST STORE_FAST | 960 | 0.8% | 29.8% |
...
| RESUME_CHECK LOAD_GLOBAL_MODULE | 860 | 0.7% | 32.8% |
...
| LOAD_FAST POP_JUMP_IF_NONE | 640 | 0.5% | 38.8% |
| LOAD_ATTR LOAD_ATTR_MODULE | 620 | 0.5% | 39.3% |
...
| LOAD_GLOBAL LOAD_GLOBAL_BUILTIN | 560 | 0.5% | 43.7% |
...
| STORE_ATTR STORE_ATTR_INSTANCE_VALUE | 520 | 0.4% | 46.4% |
...
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 380 | 0.3% | 56.4% |
...
| JUMP_FORWARD LOAD_FAST | 320 | 0.3% | 58.7% |
...
|---|---:|---:|
| CALL | 3,060 | 26.0% |
| LOAD_ATTR | 2,580 | 21.9% |
| LOAD_GLOBAL | 2,360 | 20.1% |
| TO_BOOL | 1,320 | 11.2% |
| STORE_ATTR | 840 | 7.1% |
| BINARY_OP | 560 | 4.8% |
| COMPARE_OP | 540 | 4.6% |
...
| Frees | 11,067 |  |
| New values | 400 |  |
| Interpreter increfs | 40,740 | 59.6% |
| Interpreter decrefs | 49,340 | 60.2% |
| Increfs | 27,661 | 40.4% |
| Decrefs | 32,671 | 39.8% |
...
| Method cache hits | 7,602 |  |
| Method cache misses | 1,378 |  |
| Method cache collisions | 1,246 |  |
| Method cache dunder hits | 2,339 |  |
