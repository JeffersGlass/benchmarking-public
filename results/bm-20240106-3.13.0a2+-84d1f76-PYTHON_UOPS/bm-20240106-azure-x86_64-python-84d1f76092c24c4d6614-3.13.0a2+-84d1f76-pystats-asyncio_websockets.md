...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,995,338 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,140,620 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,137,358 | 5.3% | 29.1% |  |
| RESUME_CHECK | 865,480 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,560 | 3.8% | 36.8% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,160 | 3.6% | 40.4% | 0.1% |
...
| LOAD_GLOBAL_BUILTIN | 615,919 | 2.9% | 56.2% | 0.4% |
...
| COMPARE_OP_INT | 247,360 | 1.1% | 74.6% | 0.1% |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,240 | 3.5% | 3.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,860 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 244,680 | 1.1% | 22.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,200 | 0.8% | 28.9% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,440 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,160 | 0.4% | 54.0% |
...
| LOAD_GLOBAL_BUILTIN | 400,860 | 10.0% |
| LOAD_CONST | 213,298 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,240 | 18.8% |
...
| LOAD_GLOBAL_BUILTIN | 179,200 | 15.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 102,440 | 53.2% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,240 | 8.2% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 244,680 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,200 | 29.1% |
...
|---|---:|---:|
| Basic | 10,679,336 | 49.5% |
| Not specialized | 3,504,338 | 16.2% |
| Specialized hits | 7,323,321 | 33.9% |
...
| Allocations to 512 bytes | 1,407,323 | 59.3% |
| Allocations to 4 kbytes | 132,410 | 5.6% |
| Allocations over 4 kbytes | 57,799 | 2.4% |
| Frees | 1,536,634 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,353,235 | 76.8% |
| Interpreter decrefs | 14,169,166 | 78.4% |
| Increfs | 3,725,508 | 23.2% |
| Decrefs | 3,912,239 | 21.6% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,227,571 |  |
| Method cache misses | 32,729 |  |
| Method cache collisions | 36,448 |  |
| Method cache dunder hits | 357,726 |  |
| Method cache dunder misses | 6,054 |  |
