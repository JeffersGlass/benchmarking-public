...
|---|---:|---:|---:|---:|
| LOAD_FAST | 98,772,861 | 20.8% | 20.8% |  |
| LOAD_CONST | 77,933,334 | 16.4% | 37.2% |  |
| CALL_PY_EXACT_ARGS | 39,063,472 | 8.2% | 45.4% |  |
...
| EXTENDED_ARG | 34,820 | 0.0% | 99.8% |  |
| YIELD_VALUE | 32,660 | 0.0% | 99.8% |  |
| BUILD_TUPLE | 32,460 | 0.0% | 99.9% |  |
| STORE_FAST_STORE_FAST | 31,892 | 0.0% | 99.9% |  |
...
| INSTRUMENTED_FOR_ITER | 11,368 | 0.0% | 99.9% |  |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,855 | 0.1% | 98.3% |
| STORE_FAST LOAD_FAST | 272,599 | 0.1% | 98.3% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 183,432 | 0.0% | 98.5% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 173,460 | 0.0% | 98.5% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 167,792 | 0.0% | 98.6% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 163,700 | 0.0% | 98.6% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 161,988 | 0.0% | 98.6% |
| LOAD_FAST CALL | 155,168 | 0.0% | 98.7% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,303 | 0.0% | 99.1% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 51,292 | 0.0% | 99.3% |
...
| LOAD_ATTR_MODULE LOAD_ATTR_MODULE | 43,752 | 0.0% | 99.4% |
...
| LOAD_CONST MAP_ADD | 20,040 | 0.0% | 99.5% |
| POP_JUMP_IF_FALSE ENTER_EXECUTOR | 20,040 | 0.0% | 99.6% |
| EXTENDED_ARG LOAD_CONST | 19,160 | 0.0% | 99.6% |
...
|---|---:|---:|
| MAP_ADD | 15,060 | 43.3% |
| TO_BOOL_STR | 10,620 | 30.5% |
| LOAD_CONST | 3,160 | 9.1% |
| ENTER_EXECUTOR | 1,640 | 4.7% |
| CONTAINS_OP | 1,000 | 2.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 19,160 | 55.0% |
...
| CALL_PY_EXACT_ARGS | 167,792 | 0.2% |
| CALL | 155,168 | 0.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,855 | 80.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 183,432 | 56.9% |
| CALL | 54,440 | 16.9% |
| CACHE | 39,340 | 12.2% |
| POP_TOP | 13,060 | 4.1% |
...
| INSTRUMENTED_POP_JUMP_IF_TRUE | 7,108 | 2.1% |
...
|---|---:|---:|
| Basic | 295,698,172 | 62.2% |
| Not specialized | 20,595,530 | 4.3% |
| Specialized hits | 158,738,115 | 33.4% |
...
| Calls to Python functions inlined | 39,138,412 | 99.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 738,828 | 0.9% |
| Frees to freelist | 735,868 |  |
| Allocations | 79,822,540 | 99.1% |
| Allocations to 512 bytes | 79,810,380 | 99.1% |
| Allocations to 4 kbytes | 7,120 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 79,800,579 |  |
| New values | 2,340 |  |
| Interpreter increfs | 82,927,292 | 15.0% |
| Interpreter decrefs | 122,733,360 | 23.8% |
| Increfs | 468,689,669 | 85.0% |
| Decrefs | 392,667,853 | 76.2% |
| Materialize dict (on request) | 240 | 10.3% |
| Materialize dict (new key) | 220 | 9.4% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 2.6% |
| Method cache hits | 38,951,969 |  |
| Method cache misses | 10,771 |  |
| Method cache collisions | 10,037 |  |
| Method cache dunder hits | 177,227 |  |
| Method cache dunder misses | 1,433 |  |
...
| Traces executed | 155,328 |  |
| Uops executed | 8,846,043 | 56.95 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,160,955 | 24.4% | 24.4% |  |
| _SET_IP | 1,307,012 | 14.8% | 39.2% |  |
| _CHECK_VALIDITY | 1,246,441 | 14.1% | 53.3% |  |
| STORE_FAST | 835,194 | 9.4% | 62.7% |  |
| _GUARD_IS_FALSE_POP | 414,338 | 4.7% | 67.4% | 0.3% |
| _FOR_ITER_TIER_TWO | 375,700 | 4.2% | 71.7% | 12.4% |
| UNPACK_SEQUENCE_TWO_TUPLE | 329,668 | 3.7% | 75.4% |  |
| _JUMP_TO_TOP | 328,152 | 3.7% | 79.1% |  |
| CONTAINS_OP | 327,137 | 3.7% | 82.8% |  |
| STORE_SUBSCR_DICT | 323,540 | 3.7% | 86.5% |  |
| _GUARD_TYPE_VERSION | 103,769 | 1.2% | 87.6% |  |
| _GUARD_IS_TRUE_POP | 97,988 | 1.1% | 88.7% | 4.7% |
| TO_BOOL_STR | 88,800 | 1.0% | 89.7% |  |
| COMPARE_OP_STR | 85,449 | 1.0% | 90.7% |  |
| _EXIT_TRACE | 81,428 | 0.9% | 91.6% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,429 | 0.9% | 92.5% |  |
| _CHECK_GLOBALS | 61,077 | 0.7% | 93.2% |  |
| _ITER_CHECK_LIST | 58,180 | 0.7% | 93.9% | 1.1% |
| _GUARD_NOT_EXHAUSTED_LIST | 57,520 | 0.7% | 94.5% | 23.2% |
...
| _CHECK_FUNCTION_EXACT_ARGS | 14,428 | 0.2% | 97.8% |  |
| _CHECK_STACK_SPACE | 14,428 | 0.2% | 98.0% |  |
| _INIT_CALL_PY_EXACT_ARGS | 14,428 | 0.2% | 98.1% |  |
| _PUSH_FRAME | 14,428 | 0.2% | 98.3% |  |
| _SAVE_RETURN_OFFSET | 14,428 | 0.2% | 98.5% |  |
| _LOAD_CONST_INLINE | 13,333 | 0.2% | 98.6% |  |
