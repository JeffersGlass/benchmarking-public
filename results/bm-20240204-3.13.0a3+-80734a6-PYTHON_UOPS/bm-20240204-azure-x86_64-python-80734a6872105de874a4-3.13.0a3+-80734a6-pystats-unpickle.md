...
| Increfs | 460,455,113 | 98.9% |
| Decrefs | 641,455,162 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 4,096,692 |  |
| Method cache misses | 819,408 |  |
| Method cache collisions | 819,043 |  |
| Method cache dunder hits | 1,639,019 |  |
