...
| Increfs | 231,916,321 | 97.8% |
| Decrefs | 246,620,068 | 97.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 5,693,577 |  |
| Method cache misses | 860,143 |  |
| Method cache collisions | 860,037 |  |
| Method cache dunder hits | 7,372,720 |  |
