...
| Increfs | 230,248,143 | 98.9% |
| Decrefs | 320,746,597 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,039,823 |  |
| Method cache misses | 418,677 |  |
| Method cache collisions | 425,893 |  |
| Method cache dunder hits | 812,104 |  |
| Method cache dunder misses | 7,816 |  |
