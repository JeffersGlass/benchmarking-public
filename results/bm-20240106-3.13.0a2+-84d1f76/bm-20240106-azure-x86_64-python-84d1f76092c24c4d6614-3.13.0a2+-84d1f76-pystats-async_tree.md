...
| Increfs | 314,248,344 | 21.4% |
| Decrefs | 400,932,502 | 25.0% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 81,385,048 |  |
| Method cache misses | 2,249,152 |  |
| Method cache collisions | 2,292,148 |  |
| Method cache dunder hits | 10,405,040 |  |
| Method cache dunder misses | 47,640 |  |
