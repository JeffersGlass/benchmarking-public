...
| Increfs | 226,552,286 | 98.9% |
| Decrefs | 315,820,636 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 819,710 |  |
| Method cache misses | 409,750 |  |
| Method cache collisions | 409,199 |  |
| Method cache dunder hits | 819,811 |  |
