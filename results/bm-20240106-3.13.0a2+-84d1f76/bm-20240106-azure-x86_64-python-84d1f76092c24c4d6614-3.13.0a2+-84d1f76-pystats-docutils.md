...
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,143,776,020 | 19.9% | 19.9% |  |
| STORE_FAST | 590,711,020 | 5.5% | 25.3% |  |
| LOAD_ATTR_INSTANCE_VALUE | 463,124,600 | 4.3% | 29.6% | 30.2% |
| RESUME_CHECK | 424,298,020 | 3.9% | 33.5% | 0.0% |
| LOAD_FAST_LOAD_FAST | 396,260,800 | 3.7% | 37.2% |  |
| LOAD_CONST | 382,338,700 | 3.5% | 40.8% |  |
| POP_JUMP_IF_FALSE | 341,910,240 | 3.2% | 43.9% |  |
| LOAD_GLOBAL_BUILTIN | 301,985,560 | 2.8% | 46.7% | 0.0% |
| LOAD_ATTR_METHOD_WITH_VALUES | 279,266,400 | 2.6% | 49.3% | 41.6% |
| JUMP_BACKWARD | 277,169,200 | 2.6% | 51.9% |  |
| CALL_PY_EXACT_ARGS | 261,030,760 | 2.4% | 54.3% | 4.9% |
| POP_TOP | 235,362,620 | 2.2% | 56.5% |  |
| TO_BOOL_BOOL | 225,712,340 | 2.1% | 58.6% | 0.0% |
...
| TO_BOOL_STR | 20,274,480 | 0.2% | 96.7% | 4.3% |
...
| COMPARE_OP_STR | 17,864,220 | 0.2% | 97.6% | 1.8% |
| CALL_FUNCTION_EX | 15,529,320 | 0.1% | 97.8% |  |
| TO_BOOL_LIST | 15,283,040 | 0.1% | 97.9% | 9.3% |
...
| JUMP_FORWARD | 9,713,600 | 0.1% | 98.5% |  |
...
| BINARY_SUBSCR | 1,641,240 | 0.0% | 99.9% |  |
...
| STORE_FAST LOAD_FAST | 280,744,440 | 2.6% | 6.2% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 217,329,460 | 2.0% | 8.2% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 210,165,460 | 1.9% | 10.1% |
| RESUME_CHECK LOAD_FAST | 194,883,600 | 1.8% | 11.9% |
| POP_JUMP_IF_FALSE LOAD_FAST | 191,556,240 | 1.8% | 13.7% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 168,067,060 | 1.6% | 15.2% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST | 160,838,060 | 1.5% | 16.7% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 158,740,240 | 1.5% | 18.2% |
...
| POP_JUMP_IF_TRUE JUMP_BACKWARD | 82,301,000 | 0.8% | 36.7% |
...
| LOAD_FAST LOAD_ATTR_SLOT | 68,433,080 | 0.6% | 40.9% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 66,769,600 | 0.6% | 41.5% |
...
| POP_JUMP_IF_FALSE LOAD_FAST_LOAD_FAST | 38,914,840 | 0.4% | 58.9% |
| LOAD_FAST_LOAD_FAST CONTAINS_OP | 38,428,180 | 0.4% | 59.3% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 38,349,600 | 0.4% | 59.6% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 30,089,660 | 0.3% | 65.1% |
| RETURN_VALUE STORE_FAST | 29,906,540 | 0.3% | 65.4% |
...
| POP_JUMP_IF_FALSE | 9,785,340 | 4.2% |
| CALL | 7,376,560 | 3.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 3,407,500 | 63.1% |
| POP_JUMP_IF_TRUE | 1,741,960 | 32.3% |
| TO_BOOL | 134,260 | 2.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 1,110,380 | 36.5% |
| JUMP_FORWARD | 789,860 | 25.9% |
| JUMP_BACKWARD | 423,000 | 13.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 849,160 | 67.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 82,301,000 | 29.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 280,744,440 | 13.1% |
| RESUME_CHECK | 194,883,600 | 9.1% |
| POP_JUMP_IF_FALSE | 191,556,240 | 8.9% |
...
| POP_JUMP_IF_FALSE | 38,914,840 | 9.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 191,556,240 | 56.0% |
| RETURN_CONST | 46,708,480 | 13.7% |
| LOAD_FAST_LOAD_FAST | 38,914,840 | 11.4% |
| LOAD_GLOBAL_BUILTIN | 19,585,160 | 5.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 82,301,000 | 46.4% |
| LOAD_FAST | 30,089,660 | 17.0% |
| NOP | 27,522,660 | 15.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 11,026,640 | 61.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 38,349,600 | 99.6% |
...
| POP_JUMP_IF_FALSE | 19,585,160 | 6.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_MODULE | 38,349,600 | 30.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 210,165,460 | 49.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 158,740,240 | 70.3% |
| POP_JUMP_IF_TRUE | 66,769,600 | 29.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 104,821,240 | 11.9% |
|          hit | 772,380,120 | 88.0% |
|         miss | 23,715,140 | 2.7% |
...
|---|---:|---:|
| Basic | 5,590,983,940 | 51.8% |
| Not specialized | 1,040,790,440 | 9.6% |
| Specialized hits | 3,625,301,320 | 33.6% |
| Specialized misses | 540,748,700 | 5.0% |
...
| Calls to Python functions inlined | 420,214,960 | 88.7% |
...
| Frames pushed | 308,322,400 | 65.1% |
...
| Allocations | 851,662,280 | 69.7% |
| Allocations to 512 bytes | 850,498,700 | 69.6% |
| Allocations to 4 kbytes | 698,800 | 0.1% |
| Allocations over 4 kbytes | 464,780 | 0.0% |
| Frees | 895,294,768 |  |
| New values | 10,550,680 |  |
| Interpreter increfs | 4,352,485,840 | 60.8% |
| Interpreter decrefs | 5,466,801,640 | 67.5% |
| Increfs | 2,808,621,045 | 39.2% |
| Decrefs | 2,636,491,748 | 32.5% |
| Materialize dict (on request) | 113,800 | 1.1% |
| Materialize dict (new key) | 150,400 | 1.4% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 78,600 | 0.7% |
| Method cache hits | 590,351,092 |  |
| Method cache misses | 46,205,408 |  |
| Method cache collisions | 49,730,033 |  |
| Method cache dunder hits | 285,808,067 |  |
| Method cache dunder misses | 3,547,593 |  |
