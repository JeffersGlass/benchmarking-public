...
|---|---:|---:|---:|---:|
| LOAD_FAST | 121,078,589 | 23.1% | 23.1% |  |
| POP_JUMP_IF_FALSE | 28,468,351 | 5.4% | 28.6% |  |
| STORE_FAST | 27,728,507 | 5.3% | 33.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 24,592,965 | 4.7% | 38.6% |  |
| RESUME_CHECK | 22,261,239 | 4.3% | 42.8% | 0.0% |
| TO_BOOL_BOOL | 20,686,303 | 4.0% | 46.8% |  |
| LOAD_ATTR | 16,870,082 | 3.2% | 50.0% |  |
| LOAD_ATTR_METHOD_NO_DICT | 15,853,334 | 3.0% | 53.0% |  |
...
| POP_JUMP_IF_TRUE | 11,567,948 | 2.2% | 68.4% |  |
| RETURN_VALUE | 10,579,512 | 2.0% | 70.4% |  |
| RETURN_CONST | 10,058,267 | 1.9% | 72.3% |  |
| CALL | 8,850,178 | 1.7% | 74.0% |  |
| TO_BOOL | 7,574,724 | 1.4% | 75.4% |  |
...
| INTERPRETER_EXIT | 2,345,181 | 0.4% | 91.4% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 15,326,848 | 2.9% | 17.9% |
| LOAD_FAST LOAD_ATTR_WITH_HINT | 12,682,900 | 2.4% | 20.3% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 12,363,465 | 2.4% | 22.7% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 8,162,863 | 1.6% | 33.9% |
| RETURN_VALUE STORE_FAST | 7,784,456 | 1.5% | 35.4% |
...
| POP_TOP LOAD_FAST | 4,357,681 | 0.8% | 60.2% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 4,340,261 | 0.8% | 61.1% |
| NOP LOAD_FAST | 4,031,082 | 0.8% | 61.8% |
...
| RETURN_CONST INTERPRETER_EXIT | 1,353,341 | 0.3% | 74.9% |
...
| LOAD_ATTR LOAD_FAST | 1,048,981 | 0.2% | 79.5% |
...
| RESUME_CHECK | 1,054,379 | 22.5% |
| POP_JUMP_IF_TRUE | 650,459 | 13.9% |
| STORE_FAST | 645,460 | 13.8% |
| NOP | 641,980 | 13.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 4,031,082 | 85.9% |
| NOP | 641,980 | 13.7% |
...
| POP_JUMP_IF_FALSE | 15,326,848 | 12.7% |
| LOAD_ATTR_METHOD_NO_DICT | 12,363,465 | 10.2% |
...
| INTERPRETER_EXIT | 1,353,341 | 13.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_METHOD_NO_DICT | 8,162,863 | 33.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 8,162,863 | 51.5% |
...
|---|---:|---:|
| Basic | 249,609,810 | 47.7% |
| Not specialized | 86,743,954 | 16.6% |
| Specialized hits | 187,154,018 | 35.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 2,345,181 | 10.2% |
| Calls to Python functions inlined | 20,580,998 | 89.8% |
| Calls via PyEval_EvalFrame (total) | 2,345,181 | 10.2% |
| Calls via PyEval_EvalFrame (vector) | 2,015,481 | 8.8% |
| Calls via PyEval_EvalFrame (generator) | 329,700 | 1.4% |
| Calls via PyEval_EvalFrame (legacy) | 40 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 2,015,341 | 8.8% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 14,685,186 | 41.2% |
| Frees to freelist | 14,693,225 |  |
| Allocations | 20,964,422 | 58.8% |
| Allocations to 512 bytes | 14,550,757 | 40.8% |
| Allocations to 4 kbytes | 323,040 | 0.9% |
| Allocations over 4 kbytes | 6,090,625 | 17.1% |
| Frees | 21,346,318 |  |
| New values | 1,560 |  |
| Interpreter increfs | 223,467,977 | 76.0% |
| Interpreter decrefs | 248,178,155 | 75.8% |
| Increfs | 70,657,984 | 24.0% |
| Decrefs | 79,415,532 | 24.2% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 160 | 10.3% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 20,362,763 |  |
| Method cache misses | 112,419 |  |
| Method cache collisions | 177,143 |  |
| Method cache dunder hits | 980,938 |  |
| Method cache dunder misses | 66,842 |  |
