...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,324 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,501,712 | 5.6% | 24.2% |  |
...
| LOAD_ATTR_INSTANCE_VALUE | 830,264 | 3.1% | 54.4% | 0.1% |
| LOAD_GLOBAL_BUILTIN | 747,132 | 2.8% | 57.2% | 0.4% |
...
| COMPARE_OP_INT | 250,552 | 0.9% | 81.2% | 0.1% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,024 | 3.0% | 6.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,472 | 1.5% | 22.5% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 306,692 | 1.1% | 30.1% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,620 | 1.0% | 31.1% |
| LOAD_FAST LOAD_CONST | 261,080 | 1.0% | 32.0% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 247,872 | 0.9% | 33.0% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 105,632 | 0.4% | 60.2% |
...
| CALL_LEN LOAD_FAST | 91,992 | 0.3% | 63.9% |
...
| LOAD_GLOBAL_BUILTIN | 404,472 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,024 | 16.0% |
...
| LOAD_GLOBAL_BUILTIN | 306,692 | 20.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,632 | 54.0% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,072 | 8.0% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 247,872 | 98.9% |
...
| CALL_LEN | 105,632 | 12.7% |
| LOAD_ATTR_METHOD_NO_DICT | 100,880 | 12.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,692 | 41.0% |
...
|---|---:|---:|
| Basic | 13,035,164 | 48.2% |
| Not specialized | 4,447,512 | 16.4% |
| Specialized hits | 9,477,260 | 35.0% |
...
| Allocations | 1,596,943 | 67.3% |
| Allocations to 512 bytes | 1,406,936 | 59.3% |
| Allocations to 4 kbytes | 132,202 | 5.6% |
| Allocations over 4 kbytes | 57,805 | 2.4% |
| Frees | 1,536,445 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,200,400 | 76.6% |
| Interpreter decrefs | 14,016,172 | 78.2% |
| Increfs | 3,728,342 | 23.4% |
| Decrefs | 3,915,110 | 21.8% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,225,661 |  |
| Method cache misses | 35,099 |  |
| Method cache collisions | 40,100 |  |
| Method cache dunder hits | 356,309 |  |
| Method cache dunder misses | 7,471 |  |
