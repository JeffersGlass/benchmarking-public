...
|---|---:|---:|---:|---:|
| LOAD_FAST | 287,358,480 | 11.6% | 11.6% |  |
| LOAD_CONST | 182,252,360 | 7.3% | 18.9% |  |
| RESUME_CHECK | 181,849,320 | 7.3% | 26.2% | 0.0% |
| STORE_FAST | 158,024,240 | 6.4% | 32.6% |  |
| POP_TOP | 157,780,120 | 6.4% | 39.0% |  |
...
| POP_JUMP_IF_FALSE | 56,464,900 | 2.3% | 82.2% |  |
...
| POP_JUMP_IF_TRUE | 134,500 | 0.0% | 99.9% |  |
| LOAD_ATTR_MODULE | 123,820 | 0.0% | 99.9% | 7.5% |
| NOP | 121,020 | 0.0% | 99.9% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 42,989,040 | 1.7% | 67.0% |
...
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 8,137,160 | 0.3% | 81.4% |
...
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 85,320 | 0.0% | 99.7% |
...
| POP_JUMP_IF_FALSE | 42,989,040 | 15.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 85,320 | 63.4% |
| CONTAINS_OP | 12,940 | 9.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 38,660 | 28.7% |
| JUMP_BACKWARD | 32,780 | 24.4% |
| LOAD_GLOBAL_BUILTIN | 17,880 | 13.3% |
| LOAD_GLOBAL_MODULE | 15,560 | 11.6% |
| POP_TOP | 9,580 | 7.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 8,137,160 | 98.9% |
| POP_JUMP_IF_TRUE | 85,320 | 1.0% |
...
| Allocations | 236,282,200 | 47.7% |
| Allocations to 512 bytes | 236,241,700 | 47.7% |
| Allocations to 4 kbytes | 37,580 | 0.0% |
| Allocations over 4 kbytes | 2,920 | 0.0% |
| Frees | 235,699,006 |  |
| New values | 10,260 |  |
| Interpreter increfs | 1,008,942,000 | 58.7% |
| Interpreter decrefs | 1,463,455,240 | 62.1% |
| Increfs | 710,332,670 | 41.3% |
| Decrefs | 891,853,699 | 37.9% |
| Materialize dict (on request) | 140 | 1.4% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 80 | 0.8% |
| Method cache hits | 184,601 |  |
| Method cache misses | 57,439 |  |
| Method cache collisions | 66,071 |  |
| Method cache dunder hits | 8,314,993 |  |
| Method cache dunder misses | 23,207 |  |
