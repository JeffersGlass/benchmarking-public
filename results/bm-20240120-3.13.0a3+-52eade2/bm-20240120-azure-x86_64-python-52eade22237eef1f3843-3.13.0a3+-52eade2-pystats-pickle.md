...
| Increfs | 231,875,403 | 97.9% |
| Decrefs | 246,578,372 | 97.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 5,734,454 |  |
| Method cache misses | 819,266 |  |
| Method cache collisions | 819,104 |  |
| Method cache dunder hits | 7,372,643 |  |
