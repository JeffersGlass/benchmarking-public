...
| Increfs | 248,463,090 | 37.0% |
| Decrefs | 205,328,940 | 28.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 233,994 |  |
| Method cache misses | 9,746 |  |
| Method cache collisions | 13,210 |  |
| Method cache dunder hits | 595,700 |  |
| Method cache dunder misses | 3,760 |  |
