...
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,524,763,162 | 20.5% | 20.5% |  |
| LOAD_CONST | 366,969,542 | 4.9% | 25.5% |  |
| RESUME_CHECK | 351,235,360 | 4.7% | 30.2% | 0.0% |
| LOAD_GLOBAL_MODULE | 321,007,208 | 4.3% | 34.5% | 0.0% |
| STORE_ATTR_SLOT | 305,609,567 | 4.1% | 38.6% | 21.5% |
| LOAD_FAST_LOAD_FAST | 293,151,040 | 3.9% | 42.6% |  |
| LOAD_GLOBAL_BUILTIN | 287,583,404 | 3.9% | 46.5% | 0.0% |
| POP_JUMP_IF_FALSE | 286,113,542 | 3.9% | 50.3% |  |
| STORE_FAST | 278,237,084 | 3.7% | 54.1% |  |
| LOAD_ATTR_SLOT | 257,473,860 | 3.5% | 57.5% | 1.7% |
| CALL_PY_EXACT_ARGS | 223,519,946 | 3.0% | 60.5% | 10.1% |
| TO_BOOL_BOOL | 214,898,178 | 2.9% | 63.4% | 0.0% |
| RETURN_VALUE | 198,856,952 | 2.7% | 66.1% |  |
| RETURN_CONST | 149,955,872 | 2.0% | 68.1% |  |
| CALL_ISINSTANCE | 146,052,016 | 2.0% | 70.1% |  |
| LOAD_ATTR_METHOD_NO_DICT | 138,321,792 | 1.9% | 71.9% | 21.0% |
| POP_JUMP_IF_TRUE | 117,998,438 | 1.6% | 73.5% |  |
| POP_TOP | 111,029,726 | 1.5% | 75.0% |  |
| FOR_ITER_LIST | 85,693,424 | 1.2% | 76.2% | 1.2% |
| LOAD_ATTR_INSTANCE_VALUE | 83,165,064 | 1.1% | 77.3% | 3.5% |
| JUMP_BACKWARD | 70,394,400 | 0.9% | 78.3% |  |
| LOAD_DEREF | 66,165,100 | 0.9% | 79.1% |  |
| GET_ITER | 61,162,492 | 0.8% | 80.0% |  |
| INTERPRETER_EXIT | 60,472,682 | 0.8% | 80.8% |  |
| BINARY_SUBSCR_DICT | 60,383,720 | 0.8% | 81.6% |  |
| LOAD_ATTR | 58,783,544 | 0.8% | 82.4% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 58,090,504 | 0.8% | 83.2% | 12.4% |
...
| POP_JUMP_IF_NONE | 43,772,640 | 0.6% | 86.3% |  |
...
| TO_BOOL_ALWAYS_TRUE | 14,602,142 | 0.2% | 96.5% | 13.2% |
| LOAD_FAST_AND_CLEAR | 14,018,780 | 0.2% | 96.7% |  |
| LOAD_ATTR_PROPERTY | 13,764,363 | 0.2% | 96.9% | 6.5% |
...
| CALL_BUILTIN_O | 9,042,596 | 0.1% | 97.8% | 7.3% |
...
| YIELD_VALUE | 5,617,316 | 0.1% | 98.9% |  |
...
| SEND_GEN | 232,276 | 0.0% | 100.0% |  |
| STORE_SUBSCR_LIST_INT | 217,380 | 0.0% | 100.0% |  |
| JUMP_BACKWARD_NO_INTERRUPT | 191,976 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_SLOT | 228,035,539 | 3.1% | 3.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 199,686,120 | 2.7% | 5.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 194,446,856 | 2.6% | 8.4% |
| LOAD_FAST STORE_ATTR_SLOT | 179,841,198 | 2.4% | 10.8% |
| RESUME_CHECK LOAD_FAST | 152,918,190 | 2.1% | 12.9% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 147,486,064 | 2.0% | 14.8% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 142,643,236 | 1.9% | 16.8% |
| LOAD_CONST LOAD_FAST | 141,403,220 | 1.9% | 18.7% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 139,280,616 | 1.9% | 20.5% |
| STORE_FAST LOAD_FAST | 139,176,164 | 1.9% | 22.4% |
| POP_JUMP_IF_FALSE LOAD_FAST | 132,862,966 | 1.8% | 24.2% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_SLOT | 124,082,140 | 1.7% | 25.9% |
| LOAD_GLOBAL_MODULE CALL_ISINSTANCE | 121,353,676 | 1.6% | 27.5% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 100,857,704 | 1.4% | 28.9% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 87,744,274 | 1.2% | 30.0% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 68,046,989 | 0.9% | 35.4% |
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 65,300,924 | 0.9% | 36.2% |
...
| STORE_ATTR_SLOT LOAD_FAST | 56,500,738 | 0.8% | 40.3% |
...
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 51,283,114 | 0.7% | 43.1% |
| POP_JUMP_IF_TRUE LOAD_FAST | 50,952,346 | 0.7% | 43.8% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 47,656,320 | 0.6% | 44.4% |
| FOR_ITER_LIST STORE_FAST | 46,860,104 | 0.6% | 45.1% |
| POP_TOP LOAD_FAST | 46,816,406 | 0.6% | 45.7% |
| COPY_FREE_VARS RESUME_CHECK | 46,553,660 | 0.6% | 46.3% |
| LOAD_GLOBAL_BUILTIN LOAD_DEREF | 46,073,720 | 0.6% | 47.0% |
| JUMP_BACKWARD FOR_ITER_LIST | 45,995,405 | 0.6% | 47.6% |
...
| RETURN_VALUE RETURN_VALUE | 40,345,822 | 0.5% | 51.6% |
...
| LOAD_FAST LOAD_ATTR | 38,072,164 | 0.5% | 53.7% |
| LOAD_ATTR_METHOD_NO_DICT CALL_PY_EXACT_ARGS | 37,184,304 | 0.5% | 54.2% |
| STORE_FAST LOAD_GLOBAL_MODULE | 35,868,056 | 0.5% | 54.7% |
| LOAD_SUPER_ATTR_METHOD LOAD_FAST_LOAD_FAST | 35,852,400 | 0.5% | 55.2% |
| CACHE RESUME_CHECK | 34,880,862 | 0.5% | 55.6% |
...
| LOAD_ATTR_SLOT LOAD_FAST | 30,559,220 | 0.4% | 57.3% |
| RESUME_CHECK LOAD_FAST_LOAD_FAST | 30,287,000 | 0.4% | 57.7% |
| LOAD_ATTR LOAD_FAST | 27,269,832 | 0.4% | 58.1% |
...
| RETURN_VALUE INTERPRETER_EXIT | 24,630,502 | 0.3% | 60.2% |
...
| GET_ITER FOR_ITER_LIST | 22,716,087 | 0.3% | 62.7% |
...
| COPY TO_BOOL_BOOL | 19,281,982 | 0.3% | 65.9% |
...
| LOAD_ATTR_SLOT RETURN_VALUE | 18,244,526 | 0.2% | 67.4% |
...
| LOAD_ATTR_SLOT LOAD_ATTR_SLOT | 17,359,534 | 0.2% | 68.3% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST | 16,669,862 | 0.2% | 69.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 22,716,087 | 37.1% |
| LOAD_FAST_AND_CLEAR | 13,391,480 | 21.9% |
| FOR_ITER_TUPLE | 9,689,882 | 15.8% |
| FOR_ITER | 7,324,883 | 12.0% |
...
| POP_JUMP_IF_FALSE | 10,357,642 | 9.3% |
| POP_JUMP_IF_TRUE | 8,678,324 | 7.8% |
| RESUME_CHECK | 4,005,720 | 3.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 46,816,406 | 42.2% |
...
| RETURN_VALUE | 40,345,822 | 20.3% |
| RETURN_CONST | 21,420,800 | 10.8% |
| LOAD_ATTR_SLOT | 18,244,526 | 9.2% |
| CALL | 6,285,840 | 3.2% |
...
| INTERPRETER_EXIT | 24,630,502 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 9,125,548 | 42.4% |
| LOAD_GLOBAL_MODULE | 4,324,160 | 20.1% |
| LOAD_CONST | 3,863,736 | 18.0% |
...
|---|---:|---:|
| COPY | 8,443,410 | 39.2% |
| POP_JUMP_IF_FALSE | 6,827,976 | 31.7% |
| RETURN_VALUE | 4,202,496 | 19.5% |
...
| POP_JUMP_IF_TRUE | 7,850,880 | 15.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 8,049,985 | 42.4% |
| GET_ITER | 7,324,883 | 38.6% |
...
| STORE_FAST | 2,970,678 | 15.6% |
| RETURN_CONST | 2,803,100 | 14.8% |
| LOAD_FAST | 2,349,970 | 12.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 45,995,405 | 65.3% |
| FOR_ITER | 8,049,985 | 11.4% |
| FOR_ITER_TUPLE | 6,581,134 | 9.3% |
...
| LOAD_GLOBAL_MODULE | 481,064 | 2.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 199,686,120 | 13.1% |
| RESUME_CHECK | 152,918,190 | 10.0% |
| LOAD_CONST | 141,403,220 | 9.3% |
| STORE_FAST | 139,176,164 | 9.1% |
| POP_JUMP_IF_FALSE | 132,862,966 | 8.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 228,035,539 | 15.0% |
| STORE_ATTR_SLOT | 179,841,198 | 11.8% |
| LOAD_GLOBAL_MODULE | 139,280,616 | 9.1% |
| LOAD_ATTR_METHOD_NO_DICT | 100,857,704 | 6.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 147,486,064 | 51.5% |
| CONTAINS_OP | 41,062,580 | 14.4% |
| IS_OP | 19,099,360 | 6.7% |
| COMPARE_OP_INT | 13,469,282 | 4.7% |
| TO_BOOL_ALWAYS_TRUE | 12,610,209 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 132,862,966 | 46.4% |
| LOAD_GLOBAL_BUILTIN | 68,046,989 | 23.8% |
| LOAD_GLOBAL_MODULE | 25,161,580 | 8.8% |
| LOAD_FAST_LOAD_FAST | 15,884,340 | 5.6% |
| POP_TOP | 10,357,642 | 3.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 139,176,164 | 50.0% |
| LOAD_GLOBAL_BUILTIN | 39,219,060 | 14.1% |
| LOAD_GLOBAL_MODULE | 35,868,056 | 12.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| BUILD_TUPLE | 2,834,874 | 31.4% |
| RETURN_GENERATOR | 2,372,800 | 26.2% |
| CALL_STR_1 | 1,224,320 | 13.5% |
| LOAD_FAST | 1,062,920 | 11.8% |
| LOAD_GLOBAL_MODULE | 602,412 | 6.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 3,486,538 | 38.6% |
| LOAD_FAST | 2,478,158 | 27.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 121,353,676 | 83.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 142,643,236 | 97.7% |
| COPY | 2,145,320 | 1.5% |
| YIELD_VALUE | 629,920 | 0.4% |
| RETURN_VALUE | 373,720 | 0.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 13,469,282 | 62.8% |
| POP_JUMP_IF_TRUE | 5,780,900 | 26.9% |
| COPY | 1,052,812 | 4.9% |
| RETURN_VALUE | 640,040 | 3.0% |
...
| LOAD_ATTR_INSTANCE_VALUE | 419,322 | 1.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 45,995,405 | 53.7% |
| GET_ITER | 22,716,087 | 26.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 46,860,104 | 54.7% |
| LOAD_FAST | 13,545,991 | 15.8% |
| SWAP | 8,945,260 | 10.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| GET_ITER | 9,689,882 | 54.9% |
| JUMP_BACKWARD | 6,581,134 | 37.3% |
| SWAP | 1,314,320 | 7.4% |
| EXTENDED_ARG | 34,520 | 0.2% |
| FOR_ITER_LIST | 17,880 | 0.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 8,763,899 | 49.7% |
| STORE_FAST | 4,323,562 | 24.5% |
...
| CALL_PY_EXACT_ARGS | 37,184,304 | 26.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 9,949,393 | 72.3% |
| LOAD_ATTR_SLOT | 3,393,010 | 24.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 12,868,006 | 93.5% |
| RETURN_VALUE | 534,110 | 3.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 228,035,539 | 88.6% |
| LOAD_ATTR_SLOT | 17,359,534 | 6.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 30,559,220 | 11.9% |
| STORE_FAST | 24,427,620 | 9.5% |
| GET_ITER | 23,975,352 | 9.3% |
| RETURN_VALUE | 18,244,526 | 7.1% |
| LOAD_ATTR_SLOT | 17,359,534 | 6.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 87,744,274 | 30.5% |
| POP_JUMP_IF_FALSE | 68,046,989 | 23.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 139,280,616 | 43.4% |
| STORE_FAST | 35,868,056 | 11.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 121,353,676 | 37.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 194,446,856 | 55.4% |
| COPY_FREE_VARS | 46,553,660 | 13.3% |
| CACHE | 34,880,862 | 9.9% |
| CALL_KW | 21,713,260 | 6.2% |
| CALL_BOUND_METHOD_EXACT_ARGS | 13,891,440 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 152,918,190 | 43.5% |
| LOAD_GLOBAL_BUILTIN | 87,744,274 | 25.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD_NO_INTERRUPT | 184,296 | 79.3% |
| LOAD_CONST | 47,920 | 20.6% |
| SEND | 60 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 184,296 | 79.3% |
| POP_TOP | 47,940 | 20.6% |
| RESUME | 40 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 179,841,198 | 58.8% |
| LOAD_FAST_LOAD_FAST | 124,082,140 | 40.6% |
| STORE_ATTR_SLOT | 1,242,189 | 0.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 12,610,209 | 86.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 142,643,236 | 66.4% |
| COPY | 19,281,982 | 9.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 147,486,064 | 68.6% |
| POP_JUMP_IF_TRUE | 51,283,114 | 23.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 11,574,831 | 65.2% |
| POP_JUMP_IF_TRUE | 5,791,920 | 32.6% |
| EXTENDED_ARG | 355,400 | 2.0% |
| TO_BOOL_ALWAYS_TRUE | 18,827 | 0.1% |
| TO_BOOL | 2,980 | 0.0% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 64,153,632 | 11.0% |
|          hit | 516,496,586 | 88.8% |
|         miss | 30,525,202 | 5.3% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 688,450 | 88.2% |
| Failure | 92,260 | 11.8% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 20,921,841 | 16.2% |
|          hit | 108,455,195 | 83.8% |
|         miss | 2,016,858 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 102,476,489 | 15.8% |
|        deopt | 780 | 0.0% |
|          hit | 545,094,879 | 84.0% |
|         miss | 44,854,964 | 6.9% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,000,539 | 86.1% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 71,290,912 | 20.3% |
|          hit | 278,689,266 | 79.3% |
|         miss | 66,749,161 | 19.0% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,281,569 | 98.4% |
| Failure | 20,420 | 1.6% |
...
|---|---:|---:|
| Basic | 3,723,444,020 | 50.1% |
| Not specialized | 676,529,903 | 9.1% |
| Specialized hits | 2,878,842,853 | 38.8% |
| Specialized misses | 148,403,600 | 2.0% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 102,476,489 | 32.1% |
| STORE_ATTR | 71,290,912 | 22.3% |
| CALL | 64,153,632 | 20.1% |
| COMPARE_OP | 21,917,444 | 6.9% |
| FOR_ITER | 20,921,841 | 6.5% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| STORE_ATTR_SLOT | 65,856,681 | 44.4% |
| LOAD_ATTR_METHOD_NO_DICT | 29,045,537 | 19.6% |
| CALL_PY_EXACT_ARGS | 22,561,502 | 15.2% |
| LOAD_ATTR_METHOD_WITH_VALUES | 7,219,892 | 4.9% |
| LOAD_ATTR_SLOT | 4,294,298 | 2.9% |
...
| TO_BOOL_ALWAYS_TRUE | 1,927,886 | 1.3% |
| TO_BOOL_NONE | 1,374,199 | 0.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 60,499,102 | 17.0% |
| Calls to Python functions inlined | 294,691,738 | 83.0% |
| Calls via PyEval_EvalFrame (total) | 60,499,102 | 17.0% |
| Calls via PyEval_EvalFrame (vector) | 53,288,862 | 15.0% |
| Calls via PyEval_EvalFrame (generator) | 7,210,240 | 2.0% |
| Calls via PyEval_EvalFrame (legacy) | 100 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 53,288,722 | 15.0% |
| Calls via PyEval_EvalFrame (build class) | 40 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 6,953,736 | 2.0% |
| Calls via PyEval_EvalFrame (function ex) | 1,237,660 | 0.3% |
| Calls via PyEval_EvalFrame (api) | 11,829,426 | 3.3% |
| Calls via PyEval_EvalFrame (method) | 100 | 0.0% |
| Frame objects created | 2,373,920 | 0.7% |
| Frames pushed | 243,154,290 | 68.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 153,532,240 | 28.5% |
| Frees to freelist | 153,577,554 |  |
| Allocations | 384,696,161 | 71.5% |
| Allocations to 512 bytes | 384,174,360 | 71.4% |
| Allocations to 4 kbytes | 362,581 | 0.1% |
| Allocations over 4 kbytes | 159,220 | 0.0% |
| Frees | 379,270,141 |  |
| New values | 4,435,060 |  |
| Interpreter increfs | 3,598,205,817 | 73.8% |
| Interpreter decrefs | 3,969,007,226 | 74.8% |
| Increfs | 1,280,044,965 | 26.2% |
| Decrefs | 1,333,942,373 | 25.2% |
| Materialize dict (on request) | 340 | 0.0% |
| Materialize dict (new key) | 1,160 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 220 | 0.0% |
| Method cache hits | 211,295,790 |  |
| Method cache misses | 4,362,679 |  |
| Method cache collisions | 6,377,593 |  |
| Method cache dunder hits | 177,002,064 |  |
| Method cache dunder misses | 2,035,790 |  |
