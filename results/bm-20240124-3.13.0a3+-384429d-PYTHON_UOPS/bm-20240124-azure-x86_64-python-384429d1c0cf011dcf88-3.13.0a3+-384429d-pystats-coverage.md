...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,216,259 | 20.8% | 20.8% |  |
| LOAD_CONST | 39,087,350 | 16.2% | 36.9% |  |
| CALL_PY_EXACT_ARGS | 19,640,712 | 8.1% | 45.0% |  |
...
| STORE_FAST_STORE_FAST | 31,892 | 0.0% | 99.7% |  |
| BINARY_SLICE | 29,720 | 0.0% | 99.7% |  |
| COMPARE_OP_STR | 29,089 | 0.0% | 99.8% | 0.1% |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 16,412 | 0.0% | 99.9% |  |
...
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 1,989 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_CONST | 38,900,729 | 16.1% | 16.1% |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,873 | 0.1% | 96.6% |
| STORE_FAST LOAD_FAST | 272,689 | 0.1% | 96.7% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 183,472 | 0.1% | 97.0% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 173,480 | 0.1% | 97.1% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 167,772 | 0.1% | 97.2% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 152,549 | 0.1% | 97.5% |
| STORE_FAST LOAD_GLOBAL_MODULE | 149,869 | 0.1% | 97.6% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 148,989 | 0.1% | 97.6% |
...
| LOAD_FAST STORE_FAST | 108,849 | 0.0% | 97.8% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,321 | 0.0% | 98.2% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 51,292 | 0.0% | 98.6% |
| CALL_BUILTIN_O STORE_FAST | 51,120 | 0.0% | 98.6% |
| LOAD_ATTR_SLOT CALL_BUILTIN_O | 51,120 | 0.0% | 98.6% |
| FOR_ITER STORE_FAST | 50,169 | 0.0% | 98.6% |
...
| LOAD_ATTR_MODULE LOAD_ATTR_MODULE | 43,732 | 0.0% | 98.9% |
...
| COMPARE_OP_STR POP_JUMP_IF_FALSE | 19,149 | 0.0% | 99.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 16,192 | 82.5% |
| EXTENDED_ARG | 1,000 | 5.1% |
| POP_JUMP_IF_TRUE | 929 | 4.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 50,169 | 83.8% |
| UNPACK_SEQUENCE_TWO_TUPLE | 5,092 | 8.5% |
| NOP | 1,540 | 2.6% |
| FOR_ITER | 1,080 | 1.8% |
| RETURN_CONST | 651 | 1.1% |
...
| TO_BOOL_STR | 62,980 | 15.4% |
| TO_BOOL_NONE | 23,080 | 5.7% |
| COMPARE_OP_STR | 19,149 | 4.7% |
| CONTAINS_OP | 16,192 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 152,549 | 37.4% |
| RETURN_CONST | 66,560 | 16.3% |
| LOAD_FAST_LOAD_FAST | 64,580 | 15.8% |
| LOAD_GLOBAL_MODULE | 51,292 | 12.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 55,080 | 38.5% |
| LOAD_GLOBAL_BUILTIN | 48,140 | 33.6% |
| LOAD_GLOBAL_MODULE | 12,462 | 8.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 272,689 | 40.5% |
| LOAD_GLOBAL_MODULE | 149,869 | 22.3% |
| NOP | 106,240 | 15.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 15,432 | 48.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,873 | 80.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 183,472 | 56.9% |
| CALL | 54,440 | 16.9% |
| CACHE | 38,640 | 12.0% |
| POP_TOP | 13,060 | 4.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 15,432 | 94.0% |
| STORE_FAST | 980 | 6.0% |
...
|---|---:|---:|
| Basic | 150,027,327 | 62.0% |
| Not specialized | 10,883,253 | 4.5% |
| Specialized hits | 81,048,769 | 33.5% |
...
| Calls to Python functions inlined | 19,716,612 | 99.7% |
...
| Allocations | 40,947,320 | 98.2% |
| Allocations to 512 bytes | 40,935,200 | 98.2% |
| Allocations to 4 kbytes | 7,080 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,925,528 |  |
| New values | 1,420 |  |
| Interpreter increfs | 44,077,587 | 15.8% |
| Interpreter decrefs | 64,428,347 | 24.5% |
| Increfs | 235,613,069 | 84.2% |
| Decrefs | 198,439,457 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,528,818 |  |
| Method cache misses | 11,162 |  |
| Method cache collisions | 10,249 |  |
| Method cache dunder hits | 176,665 |  |
| Method cache dunder misses | 1,215 |  |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,147,581 | 24.4% | 24.4% |  |
| _SET_IP | 1,298,880 | 14.7% | 39.1% |  |
| _CHECK_VALIDITY | 1,238,311 | 14.1% | 53.2% |  |
| STORE_FAST | 829,898 | 9.4% | 62.6% |  |
| _GUARD_IS_FALSE_POP | 411,682 | 4.7% | 67.3% | 0.3% |
| _FOR_ITER_TIER_TWO | 373,140 | 4.2% | 71.5% | 12.5% |
| UNPACK_SEQUENCE_TWO_TUPLE | 327,108 | 3.7% | 75.2% |  |
| _JUMP_TO_TOP | 325,593 | 3.7% | 78.9% |  |
| CONTAINS_OP | 324,579 | 3.7% | 82.6% |  |
| STORE_SUBSCR_DICT | 320,980 | 3.6% | 86.3% |  |
| _GUARD_TYPE_VERSION | 103,611 | 1.2% | 87.5% |  |
| _GUARD_IS_TRUE_POP | 97,948 | 1.1% | 88.6% | 4.7% |
| TO_BOOL_STR | 88,780 | 1.0% | 89.6% |  |
| COMPARE_OP_STR | 85,411 | 1.0% | 90.5% |  |
| _EXIT_TRACE | 81,368 | 0.9% | 91.5% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,411 | 0.9% | 92.4% |  |
| _GUARD_GLOBALS_VERSION | 73,767 | 0.8% | 93.2% | 0.1% |
| _LOAD_GLOBAL_MODULE | 58,647 | 0.7% | 93.9% |  |
| _ITER_CHECK_LIST | 58,160 | 0.7% | 94.5% | 1.1% |
...
| _CHECK_FUNCTION_EXACT_ARGS | 14,348 | 0.2% | 98.0% |  |
| _CHECK_STACK_SPACE | 14,348 | 0.2% | 98.2% |  |
| _INIT_CALL_PY_EXACT_ARGS | 14,348 | 0.2% | 98.3% |  |
| _PUSH_FRAME | 14,348 | 0.2% | 98.5% |  |
| _SAVE_RETURN_OFFSET | 14,348 | 0.2% | 98.7% |  |
| RESUME_CHECK | 13,020 | 0.1% | 98.8% |  |
| _LOAD_CONST_INLINE_BORROW | 11,062 | 0.1% | 98.9% |  |
| _POP_FRAME | 8,460 | 0.1% | 99.0% |  |
| TO_BOOL_BOOL | 8,140 | 0.1% | 99.1% |  |
| PUSH_NULL | 7,880 | 0.1% | 99.2% |  |
| _CHECK_ATTR_MODULE | 7,795 | 0.1% | 99.3% | 44.1% |
| CALL_BUILTIN_CLASS | 6,320 | 0.1% | 99.4% |  |
| _LOAD_ATTR | 6,060 | 0.1% | 99.4% |  |
| _LOAD_ATTR_MODULE | 4,355 | 0.0% | 99.5% |  |
...
| _LOAD_CONST_INLINE | 2,668 | 0.0% | 99.7% |  |
...
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 71 | 0.0% | 100.0% |  |
