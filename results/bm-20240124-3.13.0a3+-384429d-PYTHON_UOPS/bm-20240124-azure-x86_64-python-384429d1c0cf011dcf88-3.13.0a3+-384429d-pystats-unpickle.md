...
| Increfs | 230,239,280 | 98.9% |
| Decrefs | 320,738,034 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,048,666 |  |
| Method cache misses | 409,834 |  |
| Method cache collisions | 411,283 |  |
| Method cache dunder hits | 818,125 |  |
| Method cache dunder misses | 1,795 |  |
