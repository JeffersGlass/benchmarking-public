...
| POP_JUMP_IF_NONE | 12,691,200 | 0.5% | 92.1% |  |
...
| RESUME | 2,040 | 0.0% | 100.0% | 1,519.4% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 52,626,200 | 2.0% | 25.3% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_BOOL | 50,757,400 | 2.0% | 27.2% |
| CACHE RESUME_CHECK | 45,510,520 | 1.8% | 29.0% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 42,922,700 | 1.7% | 30.7% |
...
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 31,349,480 | 1.2% | 42.4% |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 24,999,700 | 1.0% | 49.9% |
...
| LOAD_ATTR_SLOT TO_BOOL_NONE | 21,270,100 | 0.8% | 54.4% |
| RETURN_VALUE INTERPRETER_EXIT | 20,505,680 | 0.8% | 55.2% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 20,463,620 | 0.8% | 56.0% |
...
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST_LOAD_FAST | 18,288,000 | 0.7% | 59.7% |
| LOAD_FAST LOAD_CONST | 17,916,300 | 0.7% | 60.4% |
| LOAD_ATTR_INSTANCE_VALUE RETURN_VALUE | 16,419,540 | 0.6% | 61.0% |
| CALL_BUILTIN_O STORE_FAST | 16,352,820 | 0.6% | 61.6% |
| LOAD_FAST CALL_BUILTIN_O | 16,352,740 | 0.6% | 62.3% |
| POP_JUMP_IF_FALSE RETURN_CONST | 16,047,360 | 0.6% | 62.9% |
| LOAD_FAST_LOAD_FAST LOAD_FAST_LOAD_FAST | 15,300,660 | 0.6% | 63.5% |
| PUSH_NULL LOAD_FAST_LOAD_FAST | 14,928,200 | 0.6% | 64.1% |
...
| POP_TOP RETURN_CONST | 14,554,940 | 0.6% | 66.4% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 14,554,020 | 0.6% | 66.9% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 14,186,120 | 0.6% | 67.5% |
| LOAD_ATTR_METHOD_NO_DICT CALL_METHOD_DESCRIPTOR_NOARGS | 14,181,840 | 0.6% | 68.0% |
| CALL_METHOD_DESCRIPTOR_NOARGS STORE_FAST | 14,181,440 | 0.6% | 68.6% |
...
| POP_JUMP_IF_NONE LOAD_FAST | 11,943,920 | 0.5% | 71.0% |
...
| LOAD_CONST STORE_FAST | 11,204,760 | 0.4% | 73.7% |
...
| LOAD_FAST POP_JUMP_IF_NONE | 7,465,360 | 0.3% | 85.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 85,443,380 | 58.7% |
| TO_BOOL_NONE | 26,498,000 | 18.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 111,278,340 | 76.5% |
| RETURN_CONST | 16,047,360 | 11.0% |
| LOAD_CONST | 10,827,180 | 7.4% |
...
|---|---:|---:|
| Basic | 1,290,046,340 | 50.0% |
| Not specialized | 292,962,280 | 11.4% |
| Specialized hits | 988,605,765 | 38.3% |
| Specialized misses | 6,243,095 | 0.2% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 56,534,704 | 34.8% |
| Frees to freelist | 56,912,412 |  |
| Allocations | 105,707,190 | 65.2% |
| Allocations to 512 bytes | 104,898,717 | 64.7% |
| Allocations to 4 kbytes | 808,352 | 0.5% |
| Allocations over 4 kbytes | 121 | 0.0% |
| Frees | 105,633,743 |  |
| New values | 320 |  |
| Interpreter increfs | 1,275,028,860 | 79.2% |
| Interpreter decrefs | 1,345,677,479 | 76.8% |
| Increfs | 334,247,411 | 20.8% |
| Decrefs | 405,643,693 | 23.2% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 69,225,853 |  |
| Method cache misses | 70,927 |  |
| Method cache collisions | 70,482 |  |
| Method cache dunder hits | 16,402,057 |  |
| Method cache dunder misses | 463 |  |
...
|---:|---:|---:|---:|
| 0 | 55,371 | 2,040 | 377,987,390 |
| 1 | 5,040 | 0 | 393,802,552 |
| 2 | 460 | 0 | 997,215,352 |
