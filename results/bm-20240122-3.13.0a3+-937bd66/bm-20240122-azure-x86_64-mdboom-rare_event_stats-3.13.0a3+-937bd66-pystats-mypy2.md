...
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,524,762,710 | 20.5% | 20.5% |  |
| LOAD_CONST | 366,969,350 | 4.9% | 25.5% |  |
| RESUME_CHECK | 351,230,124 | 4.7% | 30.2% | 0.0% |
| LOAD_GLOBAL_MODULE | 321,005,484 | 4.3% | 34.5% | 0.0% |
| STORE_ATTR_SLOT | 305,609,650 | 4.1% | 38.6% | 21.6% |
| LOAD_FAST_LOAD_FAST | 293,151,040 | 3.9% | 42.6% |  |
| LOAD_GLOBAL_BUILTIN | 287,580,287 | 3.9% | 46.5% | 0.0% |
| POP_JUMP_IF_FALSE | 286,113,994 | 3.9% | 50.3% |  |
| STORE_FAST | 278,236,988 | 3.7% | 54.1% |  |
| LOAD_ATTR_SLOT | 257,477,292 | 3.5% | 57.5% | 1.7% |
| CALL_PY_EXACT_ARGS | 223,519,826 | 3.0% | 60.5% | 10.1% |
| TO_BOOL_BOOL | 214,897,424 | 2.9% | 63.4% | 0.0% |
| RETURN_VALUE | 198,854,924 | 2.7% | 66.1% |  |
| RETURN_CONST | 149,955,824 | 2.0% | 68.1% |  |
| CALL_ISINSTANCE | 146,050,364 | 2.0% | 70.1% |  |
| LOAD_ATTR_METHOD_NO_DICT | 138,321,607 | 1.9% | 72.0% | 21.0% |
| POP_JUMP_IF_TRUE | 117,997,288 | 1.6% | 73.5% |  |
| POP_TOP | 111,030,118 | 1.5% | 75.0% |  |
| FOR_ITER_LIST | 85,693,443 | 1.2% | 76.2% | 1.2% |
| LOAD_ATTR_INSTANCE_VALUE | 83,165,088 | 1.1% | 77.3% | 3.5% |
| JUMP_BACKWARD | 70,394,224 | 0.9% | 78.3% |  |
| LOAD_DEREF | 66,165,348 | 0.9% | 79.1% |  |
| GET_ITER | 61,162,444 | 0.8% | 80.0% |  |
| INTERPRETER_EXIT | 60,471,282 | 0.8% | 80.8% |  |
| BINARY_SUBSCR_DICT | 60,383,720 | 0.8% | 81.6% |  |
| LOAD_ATTR | 58,783,580 | 0.8% | 82.4% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 58,090,463 | 0.8% | 83.2% | 12.4% |
| CONTAINS_OP | 50,748,268 | 0.7% | 83.9% |  |
...
| COMPARE_OP_STR | 27,771,219 | 0.4% | 90.2% | 0.2% |
| NOP | 26,746,920 | 0.4% | 90.6% |  |
| COPY | 25,474,960 | 0.3% | 90.9% |  |
| JUMP_FORWARD | 24,531,680 | 0.3% | 91.3% |  |
| TO_BOOL_LIST | 23,217,080 | 0.3% | 91.6% | 0.7% |
| COMPARE_OP | 21,506,016 | 0.3% | 91.9% |  |
| COMPARE_OP_INT | 21,470,053 | 0.3% | 92.2% | 1.9% |
| BINARY_SUBSCR | 20,449,600 | 0.3% | 92.4% |  |
| CALL_BUILTIN_CLASS | 20,200,554 | 0.3% | 92.7% |  |
| PUSH_NULL | 20,054,020 | 0.3% | 93.0% |  |
| FOR_ITER | 18,987,061 | 0.3% | 93.2% |  |
| EXTENDED_ARG | 18,915,400 | 0.3% | 93.5% |  |
| CALL_LEN | 18,094,940 | 0.2% | 93.7% |  |
| STORE_FAST_STORE_FAST | 18,061,360 | 0.2% | 94.0% |  |
| TO_BOOL_NONE | 17,749,944 | 0.2% | 94.2% | 7.7% |
| FOR_ITER_TUPLE | 17,649,552 | 0.2% | 94.4% | 5.6% |
| MAKE_CELL | 16,642,380 | 0.2% | 94.7% |  |
| BUILD_TUPLE | 16,155,241 | 0.2% | 94.9% |  |
...
| TO_BOOL_ALWAYS_TRUE | 14,602,096 | 0.2% | 96.5% | 13.2% |
| LOAD_FAST_AND_CLEAR | 14,018,780 | 0.2% | 96.7% |  |
| LOAD_ATTR_PROPERTY | 13,761,950 | 0.2% | 96.9% | 6.5% |
...
| CALL_BUILTIN_O | 9,042,571 | 0.1% | 97.8% | 7.3% |
...
| YIELD_VALUE | 5,614,156 | 0.1% | 98.9% |  |
...
| SEND_GEN | 229,116 | 0.0% | 100.0% |  |
| STORE_SUBSCR_LIST_INT | 217,380 | 0.0% | 100.0% |  |
| JUMP_BACKWARD_NO_INTERRUPT | 188,816 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_SLOT | 228,038,983 | 3.1% | 3.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 199,684,507 | 2.7% | 5.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 194,446,712 | 2.6% | 8.4% |
| LOAD_FAST STORE_ATTR_SLOT | 179,841,213 | 2.4% | 10.8% |
| RESUME_CHECK LOAD_FAST | 152,917,806 | 2.1% | 12.9% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 147,486,612 | 2.0% | 14.8% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 142,642,104 | 1.9% | 16.8% |
| LOAD_CONST LOAD_FAST | 141,403,220 | 1.9% | 18.7% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 139,278,964 | 1.9% | 20.5% |
| STORE_FAST LOAD_FAST | 139,176,068 | 1.9% | 22.4% |
| POP_JUMP_IF_FALSE LOAD_FAST | 132,972,937 | 1.8% | 24.2% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_SLOT | 124,082,140 | 1.7% | 25.9% |
| LOAD_GLOBAL_MODULE CALL_ISINSTANCE | 121,352,024 | 1.6% | 27.5% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 100,857,608 | 1.4% | 28.9% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 87,742,582 | 1.2% | 30.1% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 68,059,122 | 0.9% | 35.4% |
...
| STORE_ATTR_SLOT LOAD_FAST | 56,500,753 | 0.8% | 40.3% |
...
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 51,281,812 | 0.7% | 43.1% |
| POP_JUMP_IF_TRUE LOAD_FAST | 50,952,602 | 0.7% | 43.8% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 47,656,320 | 0.6% | 44.4% |
| FOR_ITER_LIST STORE_FAST | 46,860,380 | 0.6% | 45.1% |
| POP_TOP LOAD_FAST | 46,816,798 | 0.6% | 45.7% |
| COPY_FREE_VARS RESUME_CHECK | 46,553,660 | 0.6% | 46.3% |
| LOAD_GLOBAL_BUILTIN LOAD_DEREF | 46,073,720 | 0.6% | 47.0% |
| JUMP_BACKWARD FOR_ITER_LIST | 45,995,636 | 0.6% | 47.6% |
...
| RETURN_VALUE RETURN_VALUE | 40,345,386 | 0.5% | 51.6% |
...
| LOAD_FAST LOAD_ATTR | 38,072,200 | 0.5% | 53.7% |
| LOAD_ATTR_METHOD_NO_DICT CALL_PY_EXACT_ARGS | 37,184,208 | 0.5% | 54.2% |
| STORE_FAST LOAD_GLOBAL_MODULE | 35,868,059 | 0.5% | 54.7% |
| LOAD_SUPER_ATTR_METHOD LOAD_FAST_LOAD_FAST | 35,852,400 | 0.5% | 55.2% |
| CACHE RESUME_CHECK | 34,879,462 | 0.5% | 55.6% |
...
| LOAD_ATTR_SLOT LOAD_FAST | 30,560,062 | 0.4% | 57.3% |
| RESUME_CHECK LOAD_FAST_LOAD_FAST | 30,287,000 | 0.4% | 57.7% |
| LOAD_ATTR LOAD_FAST | 27,269,850 | 0.4% | 58.1% |
...
| RETURN_VALUE LOAD_FAST | 25,055,740 | 0.3% | 59.9% |
| RETURN_VALUE INTERPRETER_EXIT | 24,629,102 | 0.3% | 60.2% |
| LOAD_ATTR_SLOT STORE_FAST | 24,427,620 | 0.3% | 60.5% |
| LOAD_FAST CONTAINS_OP | 23,977,560 | 0.3% | 60.9% |
| LOAD_ATTR_SLOT GET_ITER | 23,975,304 | 0.3% | 61.2% |
...
| GET_ITER FOR_ITER_LIST | 22,715,876 | 0.3% | 62.7% |
...
| LOAD_ATTR_SLOT RETURN_VALUE | 18,246,472 | 0.2% | 67.4% |
...
| LOAD_ATTR_SLOT LOAD_ATTR_SLOT | 17,359,557 | 0.2% | 68.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 23,975,304 | 39.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 22,715,876 | 37.1% |
| LOAD_FAST_AND_CLEAR | 13,391,480 | 21.9% |
| FOR_ITER_TUPLE | 9,690,341 | 15.8% |
| FOR_ITER | 7,324,587 | 12.0% |
...
| POP_JUMP_IF_FALSE | 10,358,130 | 9.3% |
| POP_JUMP_IF_TRUE | 8,678,228 | 7.8% |
| RESUME_CHECK | 4,005,720 | 3.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 46,816,798 | 42.2% |
...
| RETURN_VALUE | 40,345,386 | 20.3% |
| RETURN_CONST | 21,420,800 | 10.8% |
| LOAD_ATTR_SLOT | 18,246,472 | 9.2% |
| CALL | 6,285,840 | 3.2% |
...
| RETURN_VALUE | 40,345,386 | 20.3% |
| LOAD_FAST | 25,055,740 | 12.6% |
| INTERPRETER_EXIT | 24,629,102 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 9,126,799 | 42.4% |
| LOAD_GLOBAL_MODULE | 4,324,160 | 20.1% |
| LOAD_CONST | 3,850,289 | 17.9% |
...
|---|---:|---:|
| COPY | 8,443,890 | 39.3% |
| POP_JUMP_IF_FALSE | 6,814,529 | 31.7% |
| RETURN_VALUE | 4,203,233 | 19.5% |
...
| POP_JUMP_IF_TRUE | 7,851,128 | 15.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| COMPARE_OP | 8,443,890 | 33.1% |
| LOAD_FAST | 3,112,260 | 12.2% |
| CALL_ISINSTANCE | 2,145,320 | 8.4% |
| SWAP | 1,796,160 | 7.1% |
| COMPARE_OP_STR | 1,547,716 | 6.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 19,282,360 | 75.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 8,049,480 | 42.4% |
| GET_ITER | 7,324,587 | 38.6% |
...
| STORE_FAST | 2,970,168 | 15.6% |
| RETURN_CONST | 2,803,100 | 14.8% |
| LOAD_FAST | 2,349,681 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 19,052,844 | 27.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 45,995,636 | 65.3% |
| FOR_ITER | 8,049,480 | 11.4% |
| FOR_ITER_TUPLE | 6,581,312 | 9.3% |
...
| LOAD_FAST | 3,211,328 | 4.9% |
| LOAD_GLOBAL_MODULE | 2,560,200 | 3.9% |
| POP_JUMP_IF_FALSE | 1,324,312 | 2.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 199,684,507 | 13.1% |
| RESUME_CHECK | 152,917,806 | 10.0% |
| LOAD_CONST | 141,403,220 | 9.3% |
| STORE_FAST | 139,176,068 | 9.1% |
| POP_JUMP_IF_FALSE | 132,972,937 | 8.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 228,038,983 | 15.0% |
| STORE_ATTR_SLOT | 179,841,213 | 11.8% |
| LOAD_GLOBAL_MODULE | 139,278,964 | 9.1% |
| LOAD_ATTR_METHOD_NO_DICT | 100,857,608 | 6.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 147,486,612 | 51.5% |
| CONTAINS_OP | 41,062,580 | 14.4% |
| IS_OP | 19,099,360 | 6.7% |
| COMPARE_OP_INT | 13,482,633 | 4.7% |
| TO_BOOL_ALWAYS_TRUE | 12,610,162 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 132,972,937 | 46.5% |
| LOAD_GLOBAL_BUILTIN | 68,059,122 | 23.8% |
| LOAD_GLOBAL_MODULE | 25,161,580 | 8.8% |
| LOAD_FAST_LOAD_FAST | 15,884,340 | 5.6% |
| POP_TOP | 10,358,130 | 3.6% |
...
| LOAD_GLOBAL_BUILTIN | 2,657,331 | 6.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 51,281,812 | 43.5% |
| TO_BOOL_LIST | 17,441,920 | 14.8% |
| COMPARE_OP_STR | 16,223,108 | 13.7% |
| CONTAINS_OP | 7,851,128 | 6.7% |
| IS_OP | 5,854,640 | 5.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 50,952,602 | 43.2% |
| JUMP_BACKWARD | 19,052,844 | 16.1% |
| LOAD_GLOBAL_MODULE | 13,709,460 | 11.6% |
| POP_TOP | 8,678,228 | 7.4% |
| NOP | 7,043,520 | 6.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| BUILD_TUPLE | 2,834,901 | 31.4% |
| RETURN_GENERATOR | 2,372,800 | 26.2% |
| CALL_STR_1 | 1,224,320 | 13.5% |
| LOAD_FAST | 1,062,920 | 11.8% |
| LOAD_GLOBAL_MODULE | 602,340 | 6.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 3,486,498 | 38.6% |
| LOAD_FAST | 2,478,173 | 27.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 121,352,024 | 83.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 142,642,104 | 97.7% |
| COPY | 2,145,320 | 1.5% |
| YIELD_VALUE | 629,920 | 0.4% |
| RETURN_VALUE | 373,200 | 0.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 13,482,633 | 62.8% |
| POP_JUMP_IF_TRUE | 5,780,900 | 26.9% |
| COPY | 1,052,830 | 4.9% |
| RETURN_VALUE | 639,744 | 3.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 19,959,464 | 71.9% |
| LOAD_FAST | 4,531,628 | 16.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 16,223,108 | 58.4% |
| POP_JUMP_IF_FALSE | 8,950,620 | 32.2% |
| COPY | 1,547,716 | 5.6% |
| RETURN_VALUE | 614,955 | 2.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 45,995,636 | 53.7% |
| GET_ITER | 22,715,876 | 26.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 46,860,380 | 54.7% |
| LOAD_FAST | 13,545,783 | 15.8% |
| SWAP | 8,945,260 | 10.4% |
| RETURN_CONST | 7,250,484 | 8.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| GET_ITER | 9,690,341 | 54.9% |
| JUMP_BACKWARD | 6,581,312 | 37.3% |
| SWAP | 1,314,320 | 7.4% |
| EXTENDED_ARG | 34,520 | 0.2% |
| FOR_ITER_LIST | 17,912 | 0.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 8,764,396 | 49.7% |
| STORE_FAST | 4,323,700 | 24.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 100,857,608 | 72.9% |
| LOAD_ATTR_SLOT | 15,260,464 | 11.0% |
...
| CALL_PY_EXACT_ARGS | 37,184,208 | 26.9% |
| LOAD_CONST | 13,122,404 | 9.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 9,947,018 | 72.3% |
| LOAD_ATTR_SLOT | 3,392,972 | 24.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 12,867,474 | 93.5% |
| RETURN_VALUE | 532,264 | 3.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 228,038,983 | 88.6% |
| LOAD_ATTR_SLOT | 17,359,557 | 6.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 30,560,062 | 11.9% |
| STORE_FAST | 24,427,620 | 9.5% |
| GET_ITER | 23,975,304 | 9.3% |
| RETURN_VALUE | 18,246,472 | 7.1% |
| LOAD_ATTR_SLOT | 17,359,557 | 6.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 87,742,582 | 30.5% |
| POP_JUMP_IF_FALSE | 68,059,122 | 23.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 121,352,024 | 37.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 194,446,712 | 55.4% |
| COPY_FREE_VARS | 46,553,660 | 13.3% |
| CACHE | 34,879,462 | 9.9% |
| CALL_KW | 21,713,260 | 6.2% |
| CALL_BOUND_METHOD_EXACT_ARGS | 13,891,440 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 152,917,806 | 43.5% |
| LOAD_GLOBAL_BUILTIN | 87,742,582 | 25.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD_NO_INTERRUPT | 181,136 | 79.1% |
| LOAD_CONST | 47,920 | 20.9% |
| SEND | 60 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 181,136 | 79.1% |
| POP_TOP | 47,940 | 20.9% |
| RESUME | 40 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 179,841,213 | 58.8% |
| LOAD_FAST_LOAD_FAST | 124,082,140 | 40.6% |
| STORE_ATTR_SLOT | 1,242,257 | 0.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 12,610,162 | 86.4% |
| POP_JUMP_IF_TRUE | 1,469,020 | 10.1% |
| EXTENDED_ARG | 487,160 | 3.3% |
| TO_BOOL_NONE | 18,508 | 0.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 142,642,104 | 66.4% |
| COPY | 19,282,360 | 9.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 147,486,612 | 68.6% |
| POP_JUMP_IF_TRUE | 51,281,812 | 23.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 11,574,878 | 65.2% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 64,154,884 | 11.0% |
|          hit | 516,493,525 | 88.8% |
|         miss | 30,526,478 | 5.3% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 688,474 | 88.2% |
| Failure | 92,260 | 11.8% |
...
|---|---:|---:|
| big int | 26,245 | 50.3% |
| baseobject | 10,780 | 20.6% |
| other | 4,860 | 9.3% |
| different types | 3,660 | 7.0% |
| tuple | 2,180 | 4.2% |
| bool | 2,079 | 4.0% |
| list | 1,900 | 3.6% |
| set | 280 | 0.5% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 20,921,310 | 16.2% |
|          hit | 108,455,582 | 83.8% |
|         miss | 2,017,133 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 102,472,180 | 15.8% |
|        deopt | 780 | 0.0% |
|          hit | 545,100,125 | 84.0% |
|         miss | 44,850,535 | 6.9% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,000,455 | 86.1% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 71,294,474 | 20.3% |
|          hit | 278,685,719 | 79.3% |
|         miss | 66,752,791 | 19.0% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,281,637 | 98.4% |
| Failure | 20,420 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 13,805,550 | 4.8% |
|          hit | 273,546,554 | 95.1% |
|         miss | 3,712,330 | 1.3% |
...
|---|---:|---:|
| Basic | 3,723,159,593 | 50.1% |
| Not specialized | 676,516,479 | 9.1% |
| Specialized hits | 2,878,832,442 | 38.8% |
| Specialized misses | 148,412,753 | 2.0% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 102,472,180 | 32.1% |
| STORE_ATTR | 71,294,474 | 22.3% |
| CALL | 64,154,884 | 20.1% |
| COMPARE_OP | 21,913,432 | 6.9% |
| FOR_ITER | 20,921,310 | 6.5% |
| BINARY_SUBSCR | 20,416,720 | 6.4% |
| TO_BOOL | 13,805,550 | 4.3% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| STORE_ATTR_SLOT | 65,860,311 | 44.4% |
| LOAD_ATTR_METHOD_NO_DICT | 29,043,326 | 19.6% |
| CALL_PY_EXACT_ARGS | 22,562,778 | 15.2% |
| LOAD_ATTR_METHOD_WITH_VALUES | 7,217,699 | 4.9% |
| LOAD_ATTR_SLOT | 4,296,154 | 2.9% |
...
| TO_BOOL_ALWAYS_TRUE | 1,927,868 | 1.3% |
| TO_BOOL_NONE | 1,374,242 | 0.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 60,497,702 | 17.0% |
| Calls to Python functions inlined | 294,687,902 | 83.0% |
| Calls via PyEval_EvalFrame (total) | 60,497,702 | 17.0% |
| Calls via PyEval_EvalFrame (vector) | 53,287,462 | 15.0% |
| Calls via PyEval_EvalFrame (generator) | 7,210,240 | 2.0% |
| Calls via PyEval_EvalFrame (legacy) | 100 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 53,287,322 | 15.0% |
| Calls via PyEval_EvalFrame (build class) | 40 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 6,952,084 | 2.0% |
| Calls via PyEval_EvalFrame (function ex) | 1,237,660 | 0.3% |
| Calls via PyEval_EvalFrame (api) | 11,829,678 | 3.3% |
| Calls via PyEval_EvalFrame (method) | 100 | 0.0% |
| Frame objects created | 2,373,920 | 0.7% |
| Frames pushed | 243,152,362 | 68.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 153,532,266 | 28.5% |
| Frees to freelist | 153,577,581 |  |
| Allocations | 384,695,440 | 71.5% |
| Allocations to 512 bytes | 384,173,890 | 71.4% |
| Allocations to 4 kbytes | 362,330 | 0.1% |
| Allocations over 4 kbytes | 159,220 | 0.0% |
| Frees | 379,269,644 |  |
| New values | 4,435,060 |  |
| Interpreter increfs | 3,598,201,008 | 73.8% |
| Interpreter decrefs | 3,968,997,423 | 74.9% |
| Increfs | 1,279,473,688 | 26.2% |
| Decrefs | 1,333,375,779 | 25.1% |
| Materialize dict (on request) | 340 | 0.0% |
| Materialize dict (new key) | 1,160 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 220 | 0.0% |
| Method cache hits | 211,543,232 |  |
| Method cache misses | 4,114,474 |  |
| Method cache collisions | 5,762,045 |  |
| Method cache dunder hits | 177,365,480 |  |
| Method cache dunder misses | 1,669,134 |  |
