...
| STORE_FAST | 16,360 | 5.2% | 33.0% |  |
| POP_JUMP_IF_FALSE | 14,540 | 4.6% | 37.6% |  |
...
| TO_BOOL | 3,140 | 1.0% | 79.5% |  |
| LOAD_GLOBAL | 3,140 | 1.0% | 80.5% |  |
| CALL_BUILTIN_FAST | 2,700 | 0.9% | 81.4% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 2,480 | 0.8% | 82.2% |  |
| POP_JUMP_IF_NONE | 2,420 | 0.8% | 82.9% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 2,400 | 0.8% | 83.7% |  |
| POP_JUMP_IF_TRUE | 2,240 | 0.7% | 84.4% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 7,260 | 2.3% | 7.2% |
...
| LOAD_CONST STORE_FAST | 2,640 | 0.8% | 34.0% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 2,480 | 0.8% | 34.8% |
| LOAD_FAST CALL | 2,380 | 0.8% | 35.6% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 2,160 | 0.7% | 36.2% |
| LOAD_FAST RETURN_VALUE | 1,980 | 0.6% | 36.9% |
| LOAD_FAST_LOAD_FAST LOAD_FAST | 1,980 | 0.6% | 37.5% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 1,980 | 0.6% | 38.1% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 1,960 | 0.6% | 38.7% |
...
| LOAD_FAST POP_JUMP_IF_NONE | 1,760 | 0.6% | 42.2% |
...
| LOAD_GLOBAL_BUILTIN CALL_ISINSTANCE | 1,420 | 0.4% | 45.7% |
...
| POP_JUMP_IF_NONE LOAD_FAST | 1,320 | 0.4% | 47.8% |
...
| LOAD_FAST STORE_ATTR | 1,220 | 0.4% | 50.2% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 1,200 | 0.4% | 50.6% |
...
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 1,080 | 0.3% | 53.0% |
| LOAD_GLOBAL_MODULE TO_BOOL_BOOL | 1,080 | 0.3% | 53.4% |
| TO_BOOL_STR POP_JUMP_IF_FALSE | 1,080 | 0.3% | 53.7% |
...
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 1,000 | 0.3% | 55.0% |
| LOAD_GLOBAL LOAD_GLOBAL_MODULE | 980 | 0.3% | 55.3% |
...
| Frees | 25,480 |  |
| New values | 480 |  |
| Interpreter increfs | 112,980 | 65.6% |
| Interpreter decrefs | 133,200 | 64.5% |
| Increfs | 59,291 | 34.4% |
| Decrefs | 73,207 | 35.5% |
...
| Method cache hits | 14,298 |  |
| Method cache misses | 3,042 |  |
| Method cache collisions | 2,992 |  |
| Method cache dunder hits | 6,198 |  |
| Method cache dunder misses | 562 |  |
