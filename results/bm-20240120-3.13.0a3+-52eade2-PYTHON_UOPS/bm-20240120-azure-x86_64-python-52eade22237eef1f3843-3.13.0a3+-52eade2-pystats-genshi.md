...
| POP_JUMP_IF_TRUE | 29,142,840 | 1.2% | 82.3% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 114,966,820 | 4.5% | 14.6% |
...
| POP_TOP JUMP_BACKWARD | 57,931,000 | 2.3% | 34.5% |
...
| YIELD_VALUE UNPACK_SEQUENCE_TUPLE | 27,041,840 | 1.1% | 53.5% |
| BUILD_TUPLE YIELD_VALUE | 26,566,660 | 1.1% | 54.5% |
| CACHE RESUME_CHECK | 26,561,140 | 1.1% | 55.6% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 17,928,680 | 0.7% | 66.0% |
| PUSH_NULL LOAD_FAST | 17,777,240 | 0.7% | 66.7% |
| LOAD_ATTR LOAD_FAST | 15,851,300 | 0.6% | 67.3% |
...
| POP_TOP LOAD_FAST | 12,656,060 | 0.5% | 71.2% |
| TO_BOOL POP_JUMP_IF_FALSE | 12,324,300 | 0.5% | 71.6% |
| ENTER_EXECUTOR EXTENDED_ARG | 11,842,120 | 0.5% | 72.1% |
| LOAD_FAST POP_JUMP_IF_NONE | 11,841,700 | 0.5% | 72.6% |
| LOAD_FAST TO_BOOL_LIST | 11,685,300 | 0.5% | 73.0% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 7,056,500 | 0.3% | 82.6% |
...
| POP_JUMP_IF_FALSE | 114,966,820 | 24.0% |
...
|---|---:|---:|
| Basic | 1,525,473,340 | 60.3% |
| Not specialized | 274,858,960 | 10.9% |
| Specialized hits | 728,080,020 | 28.8% |
...
| Increfs | 251,026,639 | 18.7% |
| Decrefs | 311,904,632 | 21.5% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 42,509,263 |  |
| Method cache misses | 368,117 |  |
| Method cache collisions | 365,747 |  |
| Method cache dunder hits | 10,974,736 |  |
| Method cache dunder misses | 2,304 |  |
...
| Uops executed | 263,251,000 | 6.60 |
...
| LOAD_CONST | 7,515,320 | 2.9% | 80.3% |  |
| _GUARD_IS_FALSE_POP | 7,374,540 | 2.8% | 83.1% | 26.1% |
| _LOAD_GLOBAL_MODULE | 7,367,280 | 2.8% | 85.9% |  |
| PUSH_NULL | 6,720,580 | 2.6% | 88.5% |  |
| IS_OP | 5,446,020 | 2.1% | 90.5% |  |
| UNPACK_SEQUENCE_TUPLE | 5,442,100 | 2.1% | 92.6% |  |
| _GUARD_IS_TRUE_POP | 4,002,660 | 1.5% | 94.1% | 52.0% |
| TO_BOOL_LIST | 3,520,220 | 1.3% | 95.5% |  |
| _GUARD_BUILTINS_VERSION | 2,097,540 | 0.8% | 96.3% |  |
| _LOAD_GLOBAL_BUILTINS | 2,097,540 | 0.8% | 97.0% |  |
