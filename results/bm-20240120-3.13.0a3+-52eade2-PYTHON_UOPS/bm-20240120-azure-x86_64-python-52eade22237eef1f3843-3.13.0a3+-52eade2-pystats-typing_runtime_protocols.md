...
|---|---:|---:|---:|---:|
| LOAD_GLOBAL_MODULE | 58,517,090 | 13.9% | 13.9% | 0.0% |
| LOAD_FAST | 48,417,219 | 11.5% | 25.4% |  |
| CALL | 28,040,325 | 6.7% | 32.1% |  |
| STORE_FAST | 26,211,092 | 6.2% | 38.3% |  |
| LOAD_FAST_LOAD_FAST | 22,514,491 | 5.3% | 43.6% |  |
| IS_OP | 21,995,840 | 5.2% | 48.8% |  |
| LOAD_GLOBAL_BUILTIN | 21,010,698 | 5.0% | 53.8% | 0.0% |
| POP_JUMP_IF_FALSE | 20,476,185 | 4.9% | 58.7% |  |
| POP_JUMP_IF_TRUE | 19,913,742 | 4.7% | 63.4% |  |
| RESUME_CHECK | 17,324,247 | 4.1% | 67.5% |  |
| RETURN_VALUE | 16,493,707 | 3.9% | 71.5% |  |
| LOAD_CONST | 13,176,680 | 3.1% | 74.6% |  |
| CALL_PY_EXACT_ARGS | 12,232,832 | 2.9% | 77.5% | 0.0% |
| LOAD_ATTR | 10,677,875 | 2.5% | 80.0% |  |
| CONTAINS_OP | 8,490,295 | 2.0% | 82.0% |  |
...
| NOP | 4,451,101 | 1.1% | 90.8% |  |
| GET_ITER | 4,450,448 | 1.1% | 91.9% |  |
...
| POP_JUMP_IF_NOT_NONE | 11,534 | 0.0% | 99.9% |  |
...
|---|---:|---:|---:|
| LOAD_GLOBAL_MODULE IS_OP | 20,149,520 | 4.8% | 4.8% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 14,075,831 | 3.3% | 8.1% |
| IS_OP POP_JUMP_IF_FALSE | 13,522,104 | 3.2% | 11.3% |
...
| POP_JUMP_IF_TRUE ENTER_EXECUTOR | 5,966,994 | 1.4% | 53.8% |
| LOAD_CONST LOAD_CONST | 5,348,533 | 1.3% | 55.1% |
...
| STORE_FAST NOP | 4,440,701 | 1.1% | 65.6% |
...
| POP_JUMP_IF_TRUE LOAD_GLOBAL_BUILTIN | 2,665,273 | 0.6% | 72.6% |
| LOAD_ATTR LOAD_FAST | 2,515,182 | 0.6% | 73.2% |
| CONTAINS_OP POP_JUMP_IF_FALSE | 2,398,481 | 0.6% | 73.8% |
...
| POP_JUMP_IF_FALSE | 2,398,481 | 28.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 5,966,994 | 85.5% |
| POP_JUMP_IF_NONE | 544,468 | 7.8% |
| FOR_ITER_LIST | 245,080 | 3.5% |
| ENTER_EXECUTOR | 204,574 | 2.9% |
| POP_TOP | 5,534 | 0.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 20,149,520 | 91.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 13,522,104 | 61.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 7,744,807 | 58.8% |
| LOAD_CONST | 5,348,533 | 40.6% |
...
| POP_JUMP_IF_FALSE | 9,579,599 | 19.8% |
| STORE_FAST | 7,397,444 | 15.3% |
| RESUME_CHECK | 2,679,700 | 5.5% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 14,075,831 | 29.1% |
| CALL | 11,401,612 | 23.5% |
| LOAD_CONST | 7,744,807 | 16.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| IS_OP | 13,522,104 | 66.0% |
| TO_BOOL_BOOL | 2,686,280 | 13.1% |
| CONTAINS_OP | 2,398,481 | 11.7% |
| CHECK_EXC_MATCH | 1,844,780 | 9.0% |
| COMPARE_OP_INT | 7,560 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 9,579,599 | 46.8% |
| LOAD_GLOBAL_BUILTIN | 4,515,026 | 22.1% |
| LOAD_GLOBAL_MODULE | 2,055,780 | 10.0% |
...
| ENTER_EXECUTOR | 5,966,994 | 30.0% |
| LOAD_GLOBAL_MODULE | 5,054,088 | 25.4% |
| LOAD_GLOBAL_BUILTIN | 2,665,273 | 13.4% |
...
| POP_JUMP_IF_TRUE | 2,665,273 | 12.7% |
| NOP | 2,388,348 | 11.4% |
...
|---|---:|---:|
| Basic | 196,972,652 | 46.8% |
| Not specialized | 81,883,023 | 19.4% |
| Specialized hits | 142,218,665 | 33.8% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 30,833,099 | 57.0% |
| Frees to freelist | 30,830,159 |  |
| Allocations | 23,228,352 | 43.0% |
| Allocations to 512 bytes | 23,214,532 | 42.9% |
| Allocations to 4 kbytes | 12,860 | 0.0% |
| Allocations over 4 kbytes | 960 | 0.0% |
| Frees | 23,067,505 |  |
| New values | 2,900 |  |
| Interpreter increfs | 213,533,994 | 62.6% |
| Interpreter decrefs | 246,514,584 | 62.5% |
| Increfs | 127,384,032 | 37.4% |
| Decrefs | 148,100,164 | 37.5% |
| Materialize dict (on request) | 1,040 | 35.9% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 15,901,633 |  |
| Method cache misses | 146,627 |  |
| Method cache collisions | 171,305 |  |
| Method cache dunder hits | 22,866,417 |  |
| Method cache dunder misses | 29,594 |  |
...
| Uops executed | 145,027,216 | 20.78 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _GUARD_GLOBALS_VERSION | 17,468,243 | 12.0% | 12.0% | 0.0% |
| LOAD_FAST | 14,076,539 | 9.7% | 21.8% |  |
| _LOAD_GLOBAL_MODULE | 11,101,361 | 7.7% | 29.4% |  |
| _SET_IP | 7,385,990 | 5.1% | 34.5% |  |
| _CHECK_VALIDITY | 7,161,217 | 4.9% | 39.4% |  |
...
| _GUARD_NOT_EXHAUSTED_LIST | 3,119,360 | 2.2% | 91.5% | 7.9% |
| _ITER_NEXT_LIST | 2,872,240 | 2.0% | 93.5% |  |
| POP_TOP | 2,664,820 | 1.8% | 95.3% |  |
| CALL_ISINSTANCE | 2,664,441 | 1.8% | 97.1% |  |
| _JUMP_TO_TOP | 2,494,174 | 1.7% | 98.9% |  |
| _FOR_ITER_TIER_TWO | 571,922 | 0.4% | 99.2% | 36.1% |
...
| _GUARD_IS_FALSE_POP | 24,789 | 0.0% | 99.8% | 6.5% |
| LOAD_CONST | 24,621 | 0.0% | 99.8% |  |
...
| _GUARD_IS_TRUE_POP | 10,601 | 0.0% | 99.9% | 6.2% |
