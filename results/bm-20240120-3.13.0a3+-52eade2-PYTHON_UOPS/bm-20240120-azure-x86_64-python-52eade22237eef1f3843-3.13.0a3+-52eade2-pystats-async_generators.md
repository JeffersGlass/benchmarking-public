...
| LOAD_CONST | 56,629,780 | 2.5% | 77.3% |  |
| POP_JUMP_IF_FALSE | 56,383,600 | 2.5% | 79.8% |  |
...
| LOAD_ATTR_METHOD_NO_DICT | 16,121,080 | 0.7% | 90.7% |  |
...
| TO_BOOL_BOOL | 8,203,460 | 0.4% | 93.9% | 0.0% |
| PUSH_NULL | 8,100,340 | 0.4% | 94.3% |  |
...
| LOAD_ATTR | 112,280 | 0.0% | 99.9% |  |
| POP_JUMP_IF_TRUE | 111,380 | 0.0% | 99.9% |  |
...
| CALL_ISINSTANCE | 38,880 | 0.0% | 100.0% |  |
| JUMP_FORWARD | 35,820 | 0.0% | 100.0% |  |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 21,560 | 0.0% | 100.0% |  |
| STORE_FAST_STORE_FAST | 20,800 | 0.0% | 100.0% |  |
| FOR_ITER_LIST | 20,600 | 0.0% | 100.0% | 3.5% |
| BINARY_SUBSCR_STR_INT | 19,020 | 0.0% | 100.0% | 1.3% |
| TO_BOOL_STR | 18,980 | 0.0% | 100.0% |  |
| JUMP_BACKWARD | 18,960 | 0.0% | 100.0% |  |
| BEFORE_WITH | 18,100 | 0.0% | 100.0% |  |
| FOR_ITER | 17,780 | 0.0% | 100.0% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 42,921,980 | 1.9% | 62.6% |
...
| LOAD_GLOBAL_MODULE LOAD_FAST_LOAD_FAST | 16,023,180 | 0.7% | 74.1% |
...
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 8,134,380 | 0.4% | 78.6% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 8,043,700 | 0.4% | 80.8% |
...
| LOAD_FAST LOAD_ATTR | 66,260 | 0.0% | 99.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 45,420 | 53.1% |
| LOAD_GLOBAL_MODULE | 17,560 | 20.5% |
...
| POP_JUMP_IF_FALSE | 21,400 | 0.0% |
| POP_JUMP_IF_TRUE | 14,800 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 7,660 | 43.1% |
| GET_ITER | 3,100 | 17.4% |
| EXTENDED_ARG | 2,820 | 15.9% |
| LOAD_FAST | 2,140 | 12.0% |
| FOR_ITER | 1,620 | 9.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 7,900 | 44.4% |
| UNPACK_SEQUENCE_TWO_TUPLE | 4,760 | 26.8% |
| FOR_ITER | 1,620 | 9.1% |
| STORE_NAME | 720 | 4.0% |
| RETURN_CONST | 600 | 3.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 7,180 | 100.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_NAME | 3,700 | 51.5% |
| IMPORT_FROM | 2,980 | 41.5% |
...
|---|---:|---:|
| POP_TOP | 4,100 | 21.6% |
| POP_JUMP_IF_TRUE | 2,960 | 15.6% |
| LIST_APPEND | 2,420 | 12.8% |
| POP_JUMP_IF_FALSE | 1,720 | 9.1% |
| MAP_ADD | 1,060 | 5.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER | 7,660 | 40.4% |
| FOR_ITER_TUPLE | 4,940 | 26.1% |
| FOR_ITER_LIST | 1,480 | 7.8% |
| ENTER_EXECUTOR | 1,060 | 5.6% |
| FOR_ITER_RANGE | 1,020 | 5.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 66,260 | 59.0% |
| LOAD_FAST_LOAD_FAST | 10,060 | 9.0% |
| LOAD_ATTR_INSTANCE_VALUE | 7,980 | 7.1% |
| LOAD_NAME | 6,560 | 5.8% |
| LOAD_ATTR | 5,300 | 4.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 20,640 | 18.4% |
| STORE_FAST | 18,940 | 16.9% |
| LOAD_ATTR_METHOD_NO_DICT | 13,860 | 12.3% |
| CALL | 12,140 | 10.8% |
| LOAD_ATTR | 5,300 | 4.7% |
...
| POP_JUMP_IF_FALSE | 42,921,980 | 15.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_NAME | 14,020 | 29.1% |
| LOAD_NAME | 8,200 | 17.0% |
| LOAD_CONST | 7,220 | 15.0% |
| RESUME | 4,220 | 8.8% |
| STORE_FAST | 3,640 | 7.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 9,140 | 19.0% |
| LOAD_NAME | 8,200 | 17.0% |
| LOAD_ATTR | 6,560 | 13.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| COMPARE_OP_INT | 16,036,300 | 28.4% |
| TO_BOOL_BOOL | 8,134,380 | 14.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 65,580 | 58.9% |
| CONTAINS_OP | 11,480 | 10.3% |
| TO_BOOL_INT | 7,240 | 6.5% |
| COMPARE_OP_INT | 7,060 | 6.3% |
| IS_OP | 5,200 | 4.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 34,900 | 31.3% |
| LOAD_GLOBAL_BUILTIN | 16,900 | 15.2% |
| ENTER_EXECUTOR | 14,800 | 13.3% |
| LOAD_GLOBAL_MODULE | 14,020 | 12.6% |
| POP_TOP | 9,580 | 8.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 16,000 | 76.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 10,720 | 51.5% |
| LOAD_FAST_LOAD_FAST | 3,960 | 19.0% |
| STORE_FAST | 2,260 | 10.9% |
| NOP | 2,100 | 10.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 25,220 | 64.9% |
| LOAD_GLOBAL_MODULE | 10,620 | 27.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 8,043,700 | 49.9% |
| LOAD_GLOBAL_MODULE | 8,012,820 | 49.7% |
| LOAD_CONST | 49,860 | 0.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 8,002,480 | 97.6% |
| COPY | 48,640 | 0.6% |
| RETURN_VALUE | 42,220 | 0.5% |
| CALL_ISINSTANCE | 37,660 | 0.5% |
| LOAD_FAST | 22,400 | 0.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 8,134,380 | 99.2% |
| POP_JUMP_IF_TRUE | 65,580 | 0.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 9,220 | 42.8% |
| FOR_ITER_LIST | 6,700 | 31.1% |
| FOR_ITER | 4,760 | 22.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 16,000 | 74.2% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 116,820 | 0.1% |
|        deopt | 360 | 0.0% |
|          hit | 112,495,060 | 99.9% |
|         miss | 14,600 | 0.0% |
...
|---|---:|---:|
| Basic | 1,485,915,120 | 66.7% |
| Not specialized | 254,613,760 | 11.4% |
| Specialized hits | 480,843,120 | 21.6% |
...
| Allocations | 236,283,294 | 47.7% |
| Allocations to 512 bytes | 236,242,280 | 47.7% |
| Allocations to 4 kbytes | 38,094 | 0.0% |
| Allocations over 4 kbytes | 2,920 | 0.0% |
| Frees | 235,699,433 |  |
| New values | 10,260 |  |
| Interpreter increfs | 1,134,550,640 | 61.5% |
| Interpreter decrefs | 1,589,063,720 | 64.1% |
| Increfs | 710,333,847 | 38.5% |
| Decrefs | 891,855,359 | 35.9% |
| Materialize dict (on request) | 140 | 1.4% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 80 | 0.8% |
| Method cache hits | 184,484 |  |
| Method cache misses | 57,556 |  |
| Method cache collisions | 67,604 |  |
| Method cache dunder hits | 8,314,692 |  |
| Method cache dunder misses | 23,488 |  |
...
| Traces executed | 125,608,480 |  |
| Uops executed | 631,419,140 | 5.03 |
...
| _EXIT_TRACE | 125,534,900 | 19.9% | 79.7% | 100.0% |
| GET_ANEXT | 125,514,720 | 19.9% | 99.6% |  |
| LOAD_FAST | 544,540 | 0.1% | 99.7% |  |
| STORE_FAST | 232,000 | 0.0% | 99.7% |  |
...
| _GUARD_IS_TRUE_POP | 34,520 | 0.0% | 99.9% | 6.4% |
