...
| Increfs | 231,916,221 | 97.8% |
| Decrefs | 246,620,087 | 97.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 5,693,675 |  |
| Method cache misses | 860,045 |  |
| Method cache collisions | 941,561 |  |
| Method cache dunder hits | 7,291,130 |  |
| Method cache dunder misses | 81,670 |  |
