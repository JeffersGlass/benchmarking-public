...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,215,996 | 20.8% | 20.8% |  |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,876 | 0.1% | 96.6% |
| STORE_FAST LOAD_FAST | 272,716 | 0.1% | 96.7% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 183,472 | 0.1% | 97.1% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 161,944 | 0.1% | 97.3% |
| LOAD_FAST CALL | 154,764 | 0.1% | 97.4% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 153,580 | 0.1% | 97.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 152,552 | 0.1% | 97.5% |
| STORE_FAST LOAD_GLOBAL_MODULE | 149,872 | 0.1% | 97.6% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 149,016 | 0.1% | 97.6% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 121,620 | 0.1% | 97.7% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 114,120 | 0.0% | 97.7% |
| CALL TO_BOOL_BOOL | 109,744 | 0.0% | 97.8% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,324 | 0.0% | 98.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,876 | 80.0% |
...
|---|---:|---:|
| Basic | 150,024,622 | 62.0% |
| Not specialized | 10,882,966 | 4.5% |
| Specialized hits | 81,048,512 | 33.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 737,384 | 1.8% |
| Frees to freelist | 734,424 |  |
| Allocations | 40,944,120 | 98.2% |
| Allocations to 512 bytes | 40,932,000 | 98.2% |
| Allocations to 4 kbytes | 7,080 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,922,027 |  |
| New values | 1,420 |  |
| Interpreter increfs | 44,074,786 | 15.8% |
| Interpreter decrefs | 64,424,930 | 24.5% |
| Increfs | 235,608,999 | 84.2% |
| Decrefs | 198,432,178 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,529,714 |  |
| Method cache misses | 10,266 |  |
| Method cache collisions | 9,446 |  |
| Method cache dunder hits | 175,943 |  |
| Method cache dunder misses | 1,297 |  |
...
| Traces executed | 155,014 |  |
| Uops executed | 8,804,586 | 56.80 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,145,652 | 24.4% | 24.4% |  |
| _SET_IP | 1,296,948 | 14.7% | 39.1% |  |
| _CHECK_VALIDITY | 1,237,336 | 14.1% | 53.2% |  |
| STORE_FAST | 829,252 | 9.4% | 62.6% |  |
| _GUARD_IS_FALSE_POP | 411,676 | 4.7% | 67.2% | 0.3% |
| _FOR_ITER_TIER_TWO | 373,140 | 4.2% | 71.5% | 12.5% |
| UNPACK_SEQUENCE_TWO_TUPLE | 327,108 | 3.7% | 75.2% |  |
| _JUMP_TO_TOP | 325,266 | 3.7% | 78.9% |  |
| CONTAINS_OP | 324,576 | 3.7% | 82.6% |  |
| STORE_SUBSCR_DICT | 320,980 | 3.6% | 86.2% |  |
| _GUARD_TYPE_VERSION | 103,608 | 1.2% | 87.4% |  |
| _GUARD_IS_TRUE_POP | 97,948 | 1.1% | 88.5% | 4.7% |
...
| _GUARD_GLOBALS_VERSION | 73,124 | 0.8% | 93.2% | 0.1% |
| _LOAD_GLOBAL_MODULE | 58,644 | 0.7% | 93.8% |  |
...
| LOAD_CONST | 13,724 | 0.2% | 97.9% |  |
| _CHECK_PEP_523 | 13,708 | 0.2% | 98.1% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 13,708 | 0.2% | 98.2% |  |
| _CHECK_STACK_SPACE | 13,708 | 0.2% | 98.4% |  |
| _INIT_CALL_PY_EXACT_ARGS | 13,708 | 0.2% | 98.5% |  |
| _PUSH_FRAME | 13,708 | 0.2% | 98.7% |  |
| _SAVE_RETURN_OFFSET | 13,708 | 0.2% | 98.9% |  |
| RESUME_CHECK | 12,380 | 0.1% | 99.0% |  |
| TO_BOOL_BOOL | 8,140 | 0.1% | 99.1% |  |
| _POP_FRAME | 8,140 | 0.1% | 99.2% |  |
| _CHECK_ATTR_MODULE | 7,792 | 0.1% | 99.3% | 44.1% |
| PUSH_NULL | 7,240 | 0.1% | 99.4% |  |
| _LOAD_ATTR | 6,060 | 0.1% | 99.4% |  |
| CALL_BUILTIN_CLASS | 5,680 | 0.1% | 99.5% |  |
| _LOAD_ATTR_MODULE | 4,352 | 0.0% | 99.5% |  |
