...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,995,398 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,138,920 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,137,358 | 5.3% | 29.1% |  |
| RESUME_CHECK | 865,480 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,560 | 3.8% | 36.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,280 | 3.6% | 40.5% | 0.1% |
| LOAD_GLOBAL_MODULE | 749,260 | 3.5% | 44.0% | 0.1% |
| STORE_FAST | 735,720 | 3.4% | 47.4% |  |
| LOAD_ATTR | 662,580 | 3.1% | 50.5% |  |
| TO_BOOL_BOOL | 641,060 | 3.0% | 53.5% |  |
| LOAD_GLOBAL_BUILTIN | 615,979 | 2.9% | 56.3% | 0.4% |
...
| POP_JUMP_IF_TRUE | 259,760 | 1.2% | 73.5% |  |
| COMPARE_OP_INT | 247,420 | 1.1% | 74.6% | 0.1% |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,360 | 3.5% | 3.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 562,500 | 2.6% | 6.1% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,920 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 244,740 | 1.1% | 22.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,220 | 0.8% | 28.1% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 179,180 | 0.8% | 28.9% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,500 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,220 | 0.4% | 54.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 562,500 | 14.1% |
| STORE_FAST | 497,880 | 12.5% |
| RESUME_CHECK | 468,920 | 11.7% |
| LOAD_GLOBAL_BUILTIN | 400,920 | 10.0% |
| LOAD_CONST | 213,298 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,360 | 18.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 562,500 | 49.4% |
| LOAD_GLOBAL_BUILTIN | 179,220 | 15.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 102,500 | 53.2% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,300 | 8.2% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 244,740 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,220 | 29.1% |
...
|---|---:|---:|
| Basic | 10,672,416 | 49.5% |
| Not specialized | 3,470,638 | 16.1% |
| Specialized hits | 7,323,338 | 34.0% |
| Specialized misses | 83,283 | 0.4% |
...
| Allocations | 1,597,673 | 67.3% |
| Allocations to 512 bytes | 1,407,467 | 59.3% |
| Allocations to 4 kbytes | 132,408 | 5.6% |
| Allocations over 4 kbytes | 57,798 | 2.4% |
| Frees | 1,536,570 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,353,558 | 76.8% |
| Interpreter decrefs | 14,169,533 | 78.3% |
| Increfs | 3,732,968 | 23.2% |
| Decrefs | 3,919,732 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,216,661 |  |
| Method cache misses | 43,659 |  |
| Method cache collisions | 50,640 |  |
| Method cache dunder hits | 354,106 |  |
| Method cache dunder misses | 9,714 |  |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,610,580 | 16.3% | 16.3% |  |
| _GUARD_TYPE_VERSION | 1,042,000 | 10.5% | 26.8% |  |
| _SET_IP | 1,016,460 | 10.3% | 37.1% |  |
| _CHECK_VALIDITY | 944,640 | 9.6% | 46.7% |  |
| _LOAD_ATTR_SLOT | 941,200 | 9.5% | 56.2% |  |
| _GUARD_GLOBALS_VERSION | 441,500 | 4.5% | 60.7% | 0.1% |
| _GUARD_IS_TRUE_POP | 344,080 | 3.5% | 64.2% | 9.7% |
| _GUARD_IS_FALSE_POP | 340,140 | 3.4% | 67.6% | 0.2% |
| _LOAD_GLOBAL_MODULE | 309,540 | 3.1% | 70.7% |  |
| IS_OP | 287,040 | 2.9% | 73.7% |  |
| STORE_FAST | 265,340 | 2.7% | 76.3% |  |
| TO_BOOL_BOOL | 209,020 | 2.1% | 78.5% |  |
...
| _EXIT_TRACE | 62,140 | 0.6% | 89.6% | 100.0% |
| _LOAD_ATTR | 58,120 | 0.6% | 90.2% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 54,440 | 0.6% | 90.7% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 54,440 | 0.6% | 91.3% |  |
