...
| Increfs | 248,461,871 | 37.0% |
| Decrefs | 205,327,500 | 28.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 235,261 |  |
| Method cache misses | 8,479 |  |
| Method cache collisions | 10,543 |  |
| Method cache dunder hits | 597,049 |  |
| Method cache dunder misses | 2,411 |  |
