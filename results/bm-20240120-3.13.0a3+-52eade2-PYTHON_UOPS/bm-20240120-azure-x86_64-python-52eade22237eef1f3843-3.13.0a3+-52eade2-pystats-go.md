...
| Increfs | 126,271,362 | 12.3% |
| Decrefs | 79,583,116 | 7.4% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 12,960 | 9,257.1% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 42,745,620 |  |
| Method cache misses | 1,480 |  |
| Method cache collisions | 921 |  |
...
| Uops executed | 907,363,940 | 32.46 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 110,336,920 | 12.2% | 12.2% |  |
| _CHECK_VALIDITY | 100,970,260 | 11.1% | 23.3% |  |
| LOAD_FAST | 92,789,560 | 10.2% | 33.5% |  |
| _GUARD_TYPE_VERSION | 52,541,680 | 5.8% | 39.3% |  |
| STORE_FAST | 48,728,000 | 5.4% | 44.7% |  |
| _CHECK_ATTR_WITH_HINT | 35,566,480 | 3.9% | 48.6% |  |
| _LOAD_ATTR_WITH_HINT | 35,566,480 | 3.9% | 52.5% |  |
...
| _LOAD_GLOBAL_MODULE | 27,714,700 | 3.1% | 66.4% |  |
| COMPARE_OP_INT | 26,441,800 | 2.9% | 69.3% |  |
| _ITER_NEXT_LIST | 26,121,700 | 2.9% | 72.2% |  |
| _GUARD_IS_TRUE_POP | 20,015,920 | 2.2% | 74.4% | 26.2% |
| _GUARD_IS_FALSE_POP | 14,210,360 | 1.6% | 76.0% | 8.9% |
| _EXIT_TRACE | 13,252,880 | 1.5% | 77.4% | 100.0% |
| LOAD_CONST | 10,087,120 | 1.1% | 78.6% |  |
| _CHECK_PEP_523 | 9,023,240 | 1.0% | 79.5% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 9,023,240 | 1.0% | 80.5% |  |
| _CHECK_STACK_SPACE | 9,023,240 | 1.0% | 81.5% |  |
| _INIT_CALL_PY_EXACT_ARGS | 9,023,240 | 1.0% | 82.5% |  |
| _PUSH_FRAME | 9,023,240 | 1.0% | 83.5% |  |
| _SAVE_RETURN_OFFSET | 9,023,240 | 1.0% | 84.5% |  |
| _LOAD_ATTR | 8,905,020 | 1.0% | 85.5% |  |
| _JUMP_TO_TOP | 8,441,740 | 0.9% | 86.4% |  |
| RESUME_CHECK | 8,235,360 | 0.9% | 87.3% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 7,904,840 | 0.9% | 88.2% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 7,904,840 | 0.9% | 89.1% |  |
...
| TO_BOOL_BOOL | 5,738,400 | 0.6% | 92.3% |  |
| _GUARD_BUILTINS_VERSION | 5,216,000 | 0.6% | 92.8% |  |
| _LOAD_GLOBAL_BUILTINS | 5,216,000 | 0.6% | 93.4% |  |
| _GUARD_BOTH_INT | 4,721,840 | 0.5% | 93.9% | 9.6% |
| _BINARY_OP_ADD_INT | 4,235,640 | 0.5% | 94.4% |  |
| PUSH_NULL | 3,517,780 | 0.4% | 94.8% |  |
| _CHECK_ATTR_MODULE | 3,513,860 | 0.4% | 95.2% |  |
| _LOAD_ATTR_MODULE | 3,513,860 | 0.4% | 95.6% |  |
| COPY | 3,272,900 | 0.4% | 95.9% |  |
| SWAP | 3,272,900 | 0.4% | 96.3% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 3,112,880 | 0.3% | 96.6% | 0.9% |
| _ITER_CHECK_RANGE | 3,112,880 | 0.3% | 97.0% |  |
