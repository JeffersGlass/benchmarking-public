...
|---|---:|---:|---:|---:|
| LOAD_FAST | 448,560,214 | 20.3% | 20.3% |  |
| LOAD_ATTR_INSTANCE_VALUE | 129,903,734 | 5.9% | 26.2% |  |
| POP_JUMP_IF_FALSE | 124,346,030 | 5.6% | 31.8% |  |
| RESUME_CHECK | 118,659,792 | 5.4% | 37.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 107,930,653 | 4.9% | 42.0% |  |
| LOAD_CONST | 97,414,537 | 4.4% | 46.4% |  |
| POP_TOP | 92,185,099 | 4.2% | 50.6% |  |
| STORE_FAST | 83,694,928 | 3.8% | 54.4% |  |
...
| TO_BOOL | 11,204,373 | 0.5% | 93.8% |  |
| CALL_FUNCTION_EX | 10,821,540 | 0.5% | 94.3% |  |
| POP_JUMP_IF_TRUE | 10,450,766 | 0.5% | 94.8% |  |
...
| LOAD_GLOBAL_BUILTIN | 6,703,599 | 0.3% | 97.4% | 0.0% |
| TO_BOOL_LIST | 5,228,259 | 0.2% | 97.6% |  |
| CALL_BOUND_METHOD_EXACT_ARGS | 4,493,320 | 0.2% | 97.8% | 16.9% |
| JUMP_FORWARD | 4,480,559 | 0.2% | 98.0% |  |
...
| NOP | 1,495,306 | 0.1% | 99.5% |  |
| BUILD_LIST | 1,493,946 | 0.1% | 99.6% |  |
| GET_ITER | 750,919 | 0.0% | 99.6% |  |
...
| CALL_LEN | 2,686 | 0.0% | 100.0% |  |
| RESUME | 2,040 | 0.0% | 100.0% | 1,513.1% |
| STORE_SUBSCR_DICT | 1,840 | 0.0% | 100.0% |  |
| JUMP_BACKWARD | 1,720 | 0.0% | 100.0% |  |
| COPY | 1,253 | 0.0% | 100.0% |  |
| BINARY_OP | 1,153 | 0.0% | 100.0% |  |
| TO_BOOL_INT | 873 | 0.0% | 100.0% |  |
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 693 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 125,422,434 | 5.7% | 5.7% |
| POP_JUMP_IF_FALSE LOAD_FAST | 90,949,065 | 4.1% | 9.8% |
| RESUME_CHECK LOAD_FAST | 89,568,766 | 4.0% | 13.8% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 65,294,192 | 3.0% | 16.8% |
| STORE_FAST LOAD_FAST | 55,248,657 | 2.5% | 19.3% |
| CACHE RESUME_CHECK | 45,510,520 | 2.1% | 21.3% |
| LOAD_FAST LOAD_ATTR_SLOT | 43,623,865 | 2.0% | 23.3% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 42,548,832 | 1.9% | 25.2% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 31,357,799 | 1.4% | 40.4% |
...
| CALL_METHOD_DESCRIPTOR_O POP_TOP | 27,992,873 | 1.3% | 45.8% |
...
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 23,884,993 | 1.1% | 52.7% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 20,232,093 | 0.9% | 57.5% |
...
| LOAD_FAST CALL_PY_EXACT_ARGS | 14,184,786 | 0.6% | 67.2% |
| LOAD_FAST LOAD_CONST | 14,182,853 | 0.6% | 67.9% |
| LOAD_FAST_LOAD_FAST LOAD_CONST | 12,690,400 | 0.6% | 68.5% |
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 11,945,020 | 0.5% | 69.0% |
| LOAD_CONST COMPARE_OP_INT | 11,944,713 | 0.5% | 69.5% |
| POP_JUMP_IF_NONE LOAD_FAST | 11,943,920 | 0.5% | 70.1% |
| POP_TOP LOAD_CONST | 11,570,353 | 0.5% | 70.6% |
| LOAD_CONST STORE_FAST | 11,200,765 | 0.5% | 71.1% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL | 11,198,073 | 0.5% | 71.6% |
...
| POP_JUMP_IF_FALSE LOAD_CONST | 10,824,526 | 0.5% | 74.1% |
...
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST | 5,973,746 | 0.3% | 83.9% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 5,970,733 | 0.3% | 84.2% |
...
| TO_BOOL_LIST POP_JUMP_IF_FALSE | 5,228,259 | 0.2% | 85.7% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_LIST | 5,228,159 | 0.2% | 86.0% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_WITH_VALUES | 5,226,073 | 0.2% | 86.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_BUILTIN_CLASS | 748,333 | 99.7% |
| LOAD_FAST | 2,366 | 0.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_RANGE | 748,273 | 99.6% |
| FOR_ITER_LIST | 2,306 | 0.3% |
| FOR_ITER | 320 | 0.0% |
...
| STORE_FAST | 372,973 | 24.9% |
| POP_TOP | 400 | 0.0% |
| POP_JUMP_IF_NOT_NONE | 160 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 1,494,746 | 100.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 11,198,073 | 99.9% |
| TO_BOOL | 3,760 | 0.0% |
| LOAD_ATTR | 760 | 0.0% |
...
| POP_JUMP_IF_TRUE | 4,479,653 | 40.0% |
| TO_BOOL | 3,760 | 0.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 4,479,873 | 100.0% |
| LOAD_GLOBAL_BUILTIN | 546 | 0.0% |
| NOP | 80 | 0.0% |
| LOAD_GLOBAL | 40 | 0.0% |
...
| LOAD_FAST | 14,182,853 | 14.6% |
| LOAD_FAST_LOAD_FAST | 12,690,400 | 13.0% |
| POP_TOP | 11,570,353 | 11.9% |
| POP_JUMP_IF_FALSE | 10,824,526 | 11.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 41,797,653 | 42.9% |
| COMPARE_OP_INT | 11,944,713 | 12.3% |
| STORE_FAST | 11,200,765 | 11.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 90,949,065 | 20.3% |
| RESUME_CHECK | 89,568,766 | 20.0% |
| STORE_FAST | 55,248,657 | 12.3% |
| LOAD_CONST | 41,797,653 | 9.3% |
| POP_TOP | 39,936,566 | 8.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 125,422,434 | 28.0% |
...
| COMPARE_OP_INT | 20,232,093 | 16.3% |
| TO_BOOL | 6,719,520 | 5.4% |
| TO_BOOL_LIST | 5,228,259 | 4.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 90,949,065 | 73.1% |
| RETURN_CONST | 16,047,360 | 12.9% |
| LOAD_CONST | 10,824,526 | 8.7% |
...
| TO_BOOL | 4,479,653 | 42.9% |
| TO_BOOL_INT | 553 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 10,076,960 | 96.4% |
| LOAD_CONST | 372,893 | 3.6% |
| STORE_FAST | 513 | 0.0% |
| LOAD_GLOBAL_BUILTIN | 100 | 0.0% |
| POP_TOP | 80 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 2,626 | 97.8% |
| CALL | 60 | 2.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 2,193 | 81.6% |
| COPY | 493 | 18.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 20,232,093 | 100.0% |
...
| LOAD_ATTR_METHOD_NO_DICT | 31,357,799 | 24.1% |
| RETURN_VALUE | 16,419,540 | 12.6% |
| TO_BOOL | 11,198,073 | 8.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 31,357,799 | 87.5% |
...
| LOAD_ATTR_INSTANCE_VALUE | 5,226,073 | 9.4% |
...
| CALL_PY_EXACT_ARGS | 42,548,832 | 35.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 5,228,159 | 100.0% |
| TO_BOOL | 100 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 5,228,259 | 100.0% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 11,200,673 | 9.8% |
|          hit | 102,990,484 | 90.2% |
|         miss | 1,480 | 0.0% |
...
|---|---:|---:|
| Basic | 1,121,909,197 | 50.7% |
| Not specialized | 261,754,081 | 11.8% |
| Specialized hits | 821,781,636 | 37.2% |
| Specialized misses | 6,175,533 | 0.3% |
...
| Calls to Python functions inlined | 73,523,672 | 58.6% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 56,534,572 | 34.8% |
| Frees to freelist | 56,875,185 |  |
| Allocations | 105,708,282 | 65.2% |
| Allocations to 512 bytes | 104,899,614 | 64.7% |
| Allocations to 4 kbytes | 808,538 | 0.5% |
| Allocations over 4 kbytes | 130 | 0.0% |
| Frees | 105,623,237 |  |
| New values | 320 |  |
| Interpreter increfs | 1,290,239,262 | 79.4% |
| Interpreter decrefs | 1,360,835,536 | 77.0% |
| Increfs | 334,074,732 | 20.6% |
| Decrefs | 405,524,167 | 23.0% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 69,222,675 |  |
| Method cache misses | 4,210 |  |
| Method cache collisions | 3,788 |  |
| Method cache dunder hits | 16,402,052 |  |
...
|---:|---:|---:|---:|
| 0 | 55,353 | 2,040 | 379,252,382 |
| 1 | 5,022 | 0 | 392,341,546 |
| 2 | 447 | 0 | 998,464,992 |
...
| Uops executed | 821,353,116 | 54.19 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 113,531,356 | 13.8% | 13.8% |  |
| _CHECK_VALIDITY | 105,318,883 | 12.8% | 26.6% |  |
| _GUARD_TYPE_VERSION | 91,794,197 | 11.2% | 37.8% | 0.4% |
| LOAD_FAST | 86,551,723 | 10.5% | 48.4% |  |
| _LOAD_ATTR_SLOT | 40,670,248 | 5.0% | 53.3% |  |
| STORE_FAST | 25,609,054 | 3.1% | 56.4% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 22,018,208 | 2.7% | 59.1% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 22,018,208 | 2.7% | 61.8% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 20,894,621 | 2.5% | 64.3% |  |
| _GUARD_IS_FALSE_POP | 20,752,587 | 2.5% | 66.9% | 0.2% |
| TO_BOOL_BOOL | 20,149,174 | 2.5% | 69.3% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 14,927,240 | 1.8% | 71.1% | 5.0% |
| _ITER_CHECK_RANGE | 14,927,240 | 1.8% | 72.9% |  |
| _ITER_NEXT_RANGE | 14,179,007 | 1.7% | 74.7% |  |
| _EXIT_TRACE | 13,985,347 | 1.7% | 76.4% | 100.0% |
...
| PUSH_NULL | 10,675,174 | 1.3% | 87.8% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 10,446,887 | 1.3% | 89.0% |  |
| RESUME_CHECK | 10,077,340 | 1.2% | 90.3% |  |
| BUILD_LIST | 10,075,907 | 1.2% | 91.5% |  |
| CALL_INTRINSIC_1 | 10,074,587 | 1.2% | 92.7% |  |
| LIST_EXTEND | 10,074,587 | 1.2% | 93.9% |  |
| _LOAD_ATTR | 10,074,587 | 1.2% | 95.2% |  |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 7,466,993 | 0.9% | 96.1% |  |
| _GUARD_KEYS_VERSION | 7,466,993 | 0.9% | 97.0% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 7,466,993 | 0.9% | 97.9% |  |
| LOAD_CONST | 4,481,127 | 0.5% | 98.4% |  |
| _GUARD_BOTH_INT | 3,732,120 | 0.5% | 98.9% |  |
| _BINARY_OP_SUBTRACT_INT | 3,732,120 | 0.5% | 99.4% |  |
| CALL_BUILTIN_O | 600,587 | 0.1% | 99.4% |  |
| _GUARD_GLOBALS_VERSION | 376,013 | 0.0% | 99.5% |  |
| _GUARD_IS_TRUE_POP | 375,787 | 0.0% | 99.5% | 0.0% |
| _LOAD_GLOBAL_MODULE | 373,260 | 0.0% | 99.6% |  |
| TO_BOOL_LIST | 373,147 | 0.0% | 99.6% |  |
| BINARY_SUBSCR_LIST_INT | 371,900 | 0.0% | 99.7% |  |
| COMPARE_OP_FLOAT | 371,900 | 0.0% | 99.7% |  |
| POP_TOP | 371,827 | 0.0% | 99.7% |  |
| CALL_METHOD_DESCRIPTOR_O | 371,827 | 0.0% | 99.8% |  |
...
| COMPARE_OP_INT | 231,513 | 0.0% | 100.0% |  |
| CALL_LEN | 2,753 | 0.0% | 100.0% |  |
| _GUARD_BUILTINS_VERSION | 2,753 | 0.0% | 100.0% |  |
| _LOAD_GLOBAL_BUILTINS | 2,753 | 0.0% | 100.0% |  |
