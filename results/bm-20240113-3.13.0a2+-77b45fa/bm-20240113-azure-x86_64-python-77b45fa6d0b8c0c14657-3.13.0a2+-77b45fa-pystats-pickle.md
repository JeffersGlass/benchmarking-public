...
| Decrefs | 246,579,493 | 97.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 5,734,458 |  |
| Method cache misses | 819,262 |  |
| Method cache collisions | 860,016 |  |
| Method cache dunder hits | 7,331,757 |  |
| Method cache dunder misses | 41,043 |  |
