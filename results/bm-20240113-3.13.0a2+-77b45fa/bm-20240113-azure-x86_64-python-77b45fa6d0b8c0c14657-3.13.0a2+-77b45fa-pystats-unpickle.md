...
| Increfs | 230,239,201 | 98.9% |
| Decrefs | 320,737,106 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,048,710 |  |
| Method cache misses | 409,790 |  |
| Method cache collisions | 409,095 |  |
| Method cache dunder hits | 819,833 |  |
| Method cache dunder misses | 87 |  |
