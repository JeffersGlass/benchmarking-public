...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,706 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,501,904 | 5.6% | 24.2% |  |
...
| LOAD_ATTR_INSTANCE_VALUE | 830,648 | 3.1% | 54.4% | 0.1% |
| LOAD_GLOBAL_BUILTIN | 747,323 | 2.8% | 57.2% | 0.4% |
...
| COMPARE_OP_INT | 250,744 | 0.9% | 81.2% | 0.1% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,408 | 3.0% | 6.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,664 | 1.5% | 22.5% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 306,884 | 1.1% | 30.1% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,620 | 1.0% | 31.1% |
| LOAD_FAST LOAD_CONST | 261,080 | 1.0% | 32.0% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 248,064 | 0.9% | 33.0% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 105,824 | 0.4% | 60.2% |
...
| CALL_LEN LOAD_FAST | 92,184 | 0.3% | 63.9% |
...
| LOAD_GLOBAL_BUILTIN | 404,664 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,408 | 16.0% |
...
| LOAD_GLOBAL_BUILTIN | 306,884 | 20.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,824 | 54.0% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,264 | 8.1% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 248,064 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,884 | 41.1% |
...
|---|---:|---:|
| Basic | 13,035,544 | 48.2% |
| Not specialized | 4,447,702 | 16.4% |
| Specialized hits | 9,478,221 | 35.0% |
...
| Allocations | 1,597,133 | 67.3% |
| Allocations to 512 bytes | 1,407,129 | 59.3% |
| Allocations to 4 kbytes | 132,204 | 5.6% |
| Allocations over 4 kbytes | 57,800 | 2.4% |
| Frees | 1,536,658 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,201,359 | 76.6% |
| Interpreter decrefs | 14,017,320 | 78.2% |
| Increfs | 3,724,526 | 23.4% |
| Decrefs | 3,911,269 | 21.8% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,229,406 |  |
| Method cache misses | 31,354 |  |
| Method cache collisions | 34,815 |  |
| Method cache dunder hits | 357,779 |  |
| Method cache dunder misses | 6,001 |  |
