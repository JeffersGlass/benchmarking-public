...
| LOAD_ATTR_INSTANCE_VALUE | 126,209,100 | 6.3% | 25.9% |  |
| POP_JUMP_IF_FALSE | 113,627,540 | 5.6% | 31.6% |  |
| RESUME_CHECK | 107,987,460 | 5.3% | 36.9% | 0.0% |
...
| LOAD_GLOBAL_MODULE | 49,713,420 | 2.5% | 71.3% |  |
...
| PUSH_NULL | 33,480,200 | 1.7% | 81.2% |  |
| LOAD_ATTR_METHOD_NO_DICT | 31,743,580 | 1.6% | 82.8% | 0.0% |
| LOAD_ATTR | 31,017,160 | 1.5% | 84.4% |  |
| POP_JUMP_IF_NOT_NONE | 28,007,360 | 1.4% | 85.7% |  |
| CALL_METHOD_DESCRIPTOR_O | 27,809,840 | 1.4% | 87.1% | 0.0% |
| LOAD_ATTR_MODULE | 27,277,280 | 1.4% | 88.5% |  |
| TO_BOOL_NONE | 25,582,500 | 1.3% | 89.7% | 0.0% |
| ENTER_EXECUTOR | 14,677,460 | 0.7% | 90.5% |  |
| COMPARE_OP_INT | 12,363,440 | 0.6% | 91.1% |  |
| RETURN_GENERATOR | 11,951,360 | 0.6% | 91.7% |  |
| STORE_ATTR_INSTANCE_VALUE | 11,946,640 | 0.6% | 92.3% |  |
| POP_JUMP_IF_NONE | 11,944,720 | 0.6% | 92.9% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 11,764,760 | 0.6% | 93.4% | 0.0% |
...
| SEND_GEN | 8,975,840 | 0.4% | 96.4% |  |
| END_SEND | 8,408,120 | 0.4% | 96.8% |  |
...
| LOAD_GLOBAL_BUILTIN | 3,959,660 | 0.2% | 98.2% | 0.0% |
| BINARY_OP_ADD_INT | 3,736,660 | 0.2% | 98.4% |  |
| CALL_BOUND_METHOD_EXACT_ARGS | 2,629,160 | 0.1% | 98.5% | 28.9% |
...
| NOP | 1,129,200 | 0.1% | 99.6% |  |
| BUILD_LIST | 1,127,840 | 0.1% | 99.6% |  |
...
| RESUME | 2,080 | 0.0% | 100.0% | 1,354.9% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 79,693,160 | 3.9% | 14.1% |
...
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 32,311,440 | 1.6% | 36.1% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 29,493,660 | 1.5% | 42.1% |
| LOAD_FAST LOAD_ATTR | 29,317,740 | 1.5% | 43.6% |
| RETURN_CONST INTERPRETER_EXIT | 28,188,600 | 1.4% | 45.0% |
| CALL_METHOD_DESCRIPTOR_O POP_TOP | 27,809,820 | 1.4% | 46.3% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 27,276,120 | 1.4% | 47.7% |
...
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL | 11,198,080 | 0.6% | 69.4% |
| POP_JUMP_IF_FALSE LOAD_CONST | 11,021,840 | 0.5% | 70.0% |
| POP_TOP LOAD_CONST | 11,021,180 | 0.5% | 70.5% |
| LOAD_CONST STORE_FAST | 10,834,680 | 0.5% | 71.1% |
| LOAD_FAST_LOAD_FAST LOAD_CONST | 10,826,240 | 0.5% | 71.6% |
| STORE_ATTR_SLOT LOAD_FAST | 10,462,060 | 0.5% | 72.1% |
| STORE_ATTR_SLOT RETURN_CONST | 10,461,600 | 0.5% | 72.6% |
| LOAD_ATTR_SLOT LOAD_ATTR_METHOD_WITH_VALUES | 10,461,400 | 0.5% | 73.1% |
| RETURN_VALUE TO_BOOL_BOOL | 10,272,680 | 0.5% | 73.6% |
| LOAD_FAST LOAD_CONST | 10,088,420 | 0.5% | 74.1% |
...
| TO_BOOL POP_JUMP_IF_FALSE | 6,719,520 | 0.3% | 83.4% |
| LOAD_FAST POP_JUMP_IF_NONE | 6,718,880 | 0.3% | 83.7% |
...
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 5,604,620 | 0.3% | 85.5% |
...
| TO_BOOL_LIST POP_JUMP_IF_FALSE | 5,228,280 | 0.3% | 86.9% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_LIST | 5,228,180 | 0.3% | 87.1% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_WITH_VALUES | 5,226,080 | 0.3% | 87.4% |
| STORE_ATTR_INSTANCE_VALUE LOAD_CONST | 5,226,060 | 0.3% | 87.7% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NONE | 5,225,580 | 0.3% | 87.9% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 4,885,360 | 0.2% | 88.2% |
| PUSH_NULL LOAD_FAST | 4,720,740 | 0.2% | 88.4% |
| LOAD_ATTR LOAD_FAST | 4,669,380 | 0.2% | 88.6% |
| CALL RESUME_CHECK | 4,668,780 | 0.2% | 88.9% |
| STORE_FAST JUMP_FORWARD | 4,480,320 | 0.2% | 89.1% |
| JUMP_FORWARD LOAD_FAST | 4,479,880 | 0.2% | 89.3% |
| TO_BOOL POP_JUMP_IF_TRUE | 4,479,660 | 0.2% | 89.5% |
...
| POP_JUMP_IF_FALSE | 11,021,840 | 12.7% |
...
| COMPARE_OP_INT | 12,363,440 | 10.9% |
| TO_BOOL | 6,719,520 | 5.9% |
| TO_BOOL_LIST | 5,228,280 | 4.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 79,693,160 | 70.1% |
| RETURN_CONST | 15,498,180 | 13.6% |
| LOAD_CONST | 11,021,840 | 9.7% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 31,370,140 | 10.3% |
|          hit | 272,910,500 | 89.7% |
|         miss | 376,020 | 0.1% |
...
|---|---:|---:|
| Basic | 1,016,407,260 | 50.3% |
| Not specialized | 246,632,720 | 12.2% |
| Specialized hits | 752,372,458 | 37.3% |
| Specialized misses | 3,676,622 | 0.2% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 57,521,195 | 16.8% |
| Frees to freelist | 57,856,620 |  |
| Allocations | 284,515,403 | 83.2% |
| Allocations to 512 bytes | 281,844,669 | 82.4% |
| Allocations to 4 kbytes | 2,670,605 | 0.8% |
| Allocations over 4 kbytes | 129 | 0.0% |
| Frees | 284,430,349 |  |
| New values | 320 |  |
| Interpreter increfs | 1,212,756,764 | 79.9% |
| Interpreter decrefs | 1,284,313,486 | 69.7% |
| Increfs | 305,446,291 | 20.1% |
| Decrefs | 557,049,108 | 30.3% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 63,507,459 |  |
| Method cache misses | 76,921 |  |
| Method cache collisions | 76,427 |  |
| Method cache dunder hits | 13,658,100 |  |
...
|---:|---:|---:|---:|
| 0 | 53,441 | 2,040 | 358,261,534 |
| 1 | 4,860 | 0 | 369,651,656 |
| 2 | 440 | 0 | 949,807,278 |
