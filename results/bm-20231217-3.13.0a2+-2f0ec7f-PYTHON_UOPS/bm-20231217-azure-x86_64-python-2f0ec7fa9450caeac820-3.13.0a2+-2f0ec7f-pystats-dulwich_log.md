...
|---|---:|---:|---:|---:|
| LOAD_FAST | 49,857,760 | 20.4% | 20.4% |  |
| LOAD_CONST | 20,006,540 | 8.2% | 28.6% |  |
| STORE_FAST | 13,046,020 | 5.3% | 34.0% |  |
| POP_JUMP_IF_FALSE | 12,218,400 | 5.0% | 39.0% |  |
| RESUME_CHECK | 10,354,460 | 4.2% | 43.2% |  |
| RETURN_VALUE | 7,982,480 | 3.3% | 46.5% |  |
| LOAD_ATTR_METHOD_NO_DICT | 7,855,340 | 3.2% | 49.7% |  |
| LOAD_GLOBAL_MODULE | 7,250,860 | 3.0% | 52.7% |  |
| LOAD_ATTR_INSTANCE_VALUE | 6,723,960 | 2.8% | 55.5% |  |
| LOAD_FAST_LOAD_FAST | 6,591,040 | 2.7% | 58.2% |  |
...
| POP_JUMP_IF_NOT_NONE | 1,373,980 | 0.6% | 87.9% |  |
...
| ENTER_EXECUTOR | 1,264,820 | 0.5% | 90.7% |  |
| BINARY_OP_MULTIPLY_INT | 1,127,180 | 0.5% | 91.2% |  |
| JUMP_FORWARD | 1,009,960 | 0.4% | 91.6% |  |
...
|---|---:|---:|---:|
| POP_JUMP_IF_FALSE LOAD_FAST | 7,762,700 | 3.2% | 3.2% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 5,107,360 | 2.1% | 15.2% |
...
| LOAD_GLOBAL_MODULE LOAD_FAST | 1,875,220 | 0.8% | 35.1% |
...
| NOP LOAD_FAST | 1,496,420 | 0.6% | 43.4% |
| LOAD_FAST LOAD_ATTR_PROPERTY | 1,493,360 | 0.6% | 44.0% |
| POP_TOP LOAD_FAST | 1,470,720 | 0.6% | 44.6% |
| CALL TO_BOOL_BOOL | 1,376,720 | 0.6% | 45.2% |
| STORE_FAST LOAD_CONST | 1,376,620 | 0.6% | 45.7% |
...
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 999,500 | 0.4% | 56.6% |
...
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 874,000 | 0.4% | 60.3% |
...
| STORE_FAST NOP | 748,980 | 0.3% | 66.5% |
| POP_JUMP_IF_TRUE LOAD_FAST | 748,900 | 0.3% | 66.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 7,762,700 | 15.6% |
...
| LOAD_ATTR_INSTANCE_VALUE | 5,107,360 | 10.2% |
...
|---|---:|---:|
| Basic | 125,252,440 | 51.3% |
| Not specialized | 30,702,020 | 12.6% |
| Specialized hits | 87,962,020 | 36.1% |
...
| Allocations | 20,444,324 | 69.7% |
| Allocations to 512 bytes | 20,061,584 | 68.4% |
| Allocations to 4 kbytes | 132,180 | 0.5% |
| Allocations over 4 kbytes | 250,560 | 0.9% |
| Frees | 20,780,499 |  |
| New values | 124,460 |  |
| Interpreter increfs | 120,611,980 | 85.1% |
| Interpreter decrefs | 135,225,540 | 78.8% |
| Increfs | 21,060,638 | 14.9% |
| Decrefs | 36,431,258 | 21.2% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,387,376 |  |
| Method cache misses | 128,104 |  |
| Method cache collisions | 126,359 |  |
| Method cache dunder hits | 1,500,426 |  |
| Method cache dunder misses | 1,634 |  |
...
| Traces executed | 1,264,820 |  |
| Uops executed | 37,740,960 | 29.84 |
...
| _GUARD_TYPE_VERSION | 1,489,220 | 3.9% | 62.8% |  |
| _BINARY_OP_ADD_INT | 1,450,740 | 3.8% | 66.6% |  |
| _FOR_ITER_TIER_TWO | 874,060 | 2.3% | 68.9% | 28.5% |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 855,620 | 2.3% | 71.2% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 855,620 | 2.3% | 73.5% |  |
| _EXIT_TRACE | 633,540 | 1.7% | 75.2% | 100.0% |
...
| _GUARD_GLOBALS_VERSION | 130,160 | 0.3% | 97.5% |  |
...
| _GUARD_IS_NONE_POP | 124,840 | 0.3% | 99.5% |  |
| CALL_BUILTIN_O | 124,820 | 0.3% | 99.9% |  |
