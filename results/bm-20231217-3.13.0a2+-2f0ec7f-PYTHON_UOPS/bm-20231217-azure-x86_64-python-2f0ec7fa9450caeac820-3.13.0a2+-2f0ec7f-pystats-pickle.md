...
| Increfs | 226,960,220 | 97.8% |
| Decrefs | 239,206,249 | 96.9% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 3,276,886 |  |
| Method cache misses | 819,234 |  |
| Method cache collisions | 859,908 |  |
| Method cache dunder hits | 7,331,920 |  |
| Method cache dunder misses | 40,880 |  |
