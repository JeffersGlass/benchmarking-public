...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,215,998 | 20.8% | 20.8% |  |
| LOAD_CONST | 39,087,372 | 16.2% | 36.9% |  |
| CALL_PY_EXACT_ARGS | 19,640,724 | 8.1% | 45.0% |  |
...
| LOAD_GLOBAL_MODULE | 10,294,122 | 4.3% | 89.4% |  |
| LOAD_GLOBAL | 9,774,140 | 4.0% | 93.5% |  |
| BINARY_OP_ADD_INT | 9,717,500 | 4.0% | 97.5% |  |
| STORE_FAST | 673,024 | 0.3% | 97.8% |  |
| POP_JUMP_IF_FALSE | 413,538 | 0.2% | 97.9% |  |
| LOAD_ATTR_MODULE | 387,226 | 0.2% | 98.1% | 3.2% |
| TO_BOOL_BOOL | 338,696 | 0.1% | 98.2% |  |
| LOAD_GLOBAL_BUILTIN | 326,880 | 0.1% | 98.4% | 0.7% |
| RESUME_CHECK | 322,300 | 0.1% | 98.5% | 2.4% |
| CALL | 267,982 | 0.1% | 98.6% |  |
| PUSH_NULL | 235,920 | 0.1% | 98.7% |  |
| RETURN_VALUE | 198,480 | 0.1% | 98.8% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 177,360 | 0.1% | 98.9% | 0.0% |
| LOAD_ATTR_METHOD_NO_DICT | 176,170 | 0.1% | 99.0% |  |
| NOP | 174,460 | 0.1% | 99.0% |  |
| LOAD_FAST_LOAD_FAST | 166,960 | 0.1% | 99.1% |  |
| ENTER_EXECUTOR | 155,010 | 0.1% | 99.2% |  |
| POP_JUMP_IF_TRUE | 143,430 | 0.1% | 99.2% |  |
| CALL_ISINSTANCE | 132,080 | 0.1% | 99.3% |  |
| TO_BOOL_STR | 100,900 | 0.0% | 99.3% | 0.5% |
| RETURN_CONST | 92,540 | 0.0% | 99.3% |  |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 16,424 | 0.0% | 99.9% |  |
...
| POP_JUMP_IF_NOT_NONE | 11,440 | 0.0% | 99.9% |  |
...
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 1,994 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_CONST | 38,900,734 | 16.1% | 16.1% |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,902 | 0.1% | 96.6% |
| STORE_FAST LOAD_FAST | 272,710 | 0.1% | 96.7% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 183,484 | 0.1% | 97.0% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 173,460 | 0.1% | 97.1% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 167,784 | 0.1% | 97.2% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 163,740 | 0.1% | 97.3% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 161,936 | 0.1% | 97.3% |
| POP_JUMP_IF_FALSE LOAD_FAST | 157,694 | 0.1% | 97.4% |
| LOAD_FAST CALL | 154,756 | 0.1% | 97.5% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 153,560 | 0.1% | 97.5% |
| STORE_FAST LOAD_GLOBAL_MODULE | 149,874 | 0.1% | 97.6% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 149,010 | 0.1% | 97.6% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 121,620 | 0.1% | 97.7% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 114,120 | 0.0% | 97.7% |
| CALL TO_BOOL_BOOL | 109,736 | 0.0% | 97.8% |
| LOAD_FAST STORE_FAST | 108,854 | 0.0% | 97.8% |
| NOP LOAD_FAST | 108,300 | 0.0% | 97.9% |
| STORE_FAST NOP | 106,160 | 0.0% | 97.9% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 55,080 | 0.0% | 98.4% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 51,364 | 0.0% | 98.5% |
...
| FOR_ITER STORE_FAST | 50,174 | 0.0% | 98.6% |
...
| LOAD_ATTR_MODULE LOAD_ATTR_MODULE | 43,744 | 0.0% | 98.9% |
...
| COMPARE_OP_STR POP_JUMP_IF_FALSE | 19,154 | 0.0% | 99.1% |
...
| POP_JUMP_IF_FALSE | 5,480 | 7.4% |
| CALL_BUILTIN_O | 3,640 | 4.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 29,100 | 39.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 16,204 | 82.5% |
| EXTENDED_ARG | 1,000 | 5.1% |
| POP_JUMP_IF_TRUE | 934 | 4.8% |
...
|---|---:|---:|
| MAP_ADD | 14,760 | 38.0% |
| TO_BOOL_STR | 10,620 | 27.3% |
| ENTER_EXECUTOR | 5,700 | 14.7% |
| LOAD_CONST | 3,180 | 8.2% |
| CONTAINS_OP | 1,000 | 2.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 18,860 | 48.6% |
| POP_JUMP_IF_FALSE | 12,200 | 31.4% |
| INSTRUMENTED_POP_JUMP_IF_FALSE | 4,400 | 11.3% |
| FOR_ITER_LIST | 1,120 | 2.9% |
| FOR_ITER | 1,080 | 2.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 3,640 | 59.9% |
| JUMP_BACKWARD | 2,040 | 33.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 38,900,734 | 99.5% |
| LOAD_CONST | 49,660 | 0.1% |
| EXTENDED_ARG | 18,860 | 0.0% |
| STORE_FAST | 17,260 | 0.0% |
...
| STORE_FAST | 272,710 | 0.5% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 38,900,734 | 77.5% |
| INSTRUMENTED_RETURN_VALUE | 9,717,760 | 19.4% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 173,460 | 0.3% |
| CALL_PY_EXACT_ARGS | 167,784 | 0.3% |
| CALL | 154,756 | 0.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 244,020 | 59.0% |
| TO_BOOL_STR | 62,980 | 15.2% |
| TO_BOOL_NONE | 23,080 | 5.6% |
| COMPARE_OP_STR | 19,154 | 4.6% |
| CONTAINS_OP | 16,204 | 3.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 157,694 | 38.1% |
| RETURN_CONST | 66,560 | 16.1% |
| LOAD_FAST_LOAD_FAST | 64,580 | 15.6% |
| LOAD_GLOBAL_MODULE | 51,364 | 12.4% |
| ENTER_EXECUTOR | 20,040 | 4.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 9,060 | 79.2% |
| BINARY_SUBSCR_TUPLE_INT | 1,260 | 11.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 4,320 | 37.8% |
| LOAD_FAST | 3,620 | 31.6% |
| NOP | 1,380 | 12.1% |
| JUMP_BACKWARD | 680 | 5.9% |
| BUILD_MAP | 320 | 2.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 272,710 | 40.5% |
| LOAD_GLOBAL_MODULE | 149,874 | 22.3% |
| NOP | 106,160 | 15.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 15,444 | 48.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 161,936 | 91.9% |
| LOAD_CONST | 6,434 | 3.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,902 | 80.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 183,484 | 56.9% |
| CALL | 54,440 | 16.9% |
| CACHE | 38,640 | 12.0% |
| POP_TOP | 13,060 | 4.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 15,444 | 94.0% |
| STORE_FAST | 980 | 6.0% |
...
|---|---:|---:|
| Basic | 150,028,874 | 62.0% |
| Not specialized | 10,888,850 | 4.5% |
| Specialized hits | 81,048,590 | 33.5% |
...
| Calls to Python functions inlined | 19,716,624 | 99.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 737,956 | 1.8% |
| Frees to freelist | 735,436 |  |
| Allocations | 40,950,900 | 98.2% |
| Allocations to 512 bytes | 40,934,180 | 98.2% |
| Allocations to 4 kbytes | 7,120 | 0.0% |
| Allocations over 4 kbytes | 9,600 | 0.0% |
| Frees | 40,926,761 |  |
| New values | 1,420 |  |
| Interpreter increfs | 44,074,758 | 15.8% |
| Interpreter decrefs | 64,424,894 | 24.5% |
| Increfs | 235,614,388 | 84.2% |
| Decrefs | 198,441,458 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,528,773 |  |
| Method cache misses | 11,207 |  |
| Method cache collisions | 11,039 |  |
| Method cache dunder hits | 175,849 |  |
| Method cache dunder misses | 1,391 |  |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,145,634 | 24.3% | 24.3% |  |
| _SET_IP | 1,310,116 | 14.8% | 39.1% |  |
| _CHECK_VALIDITY | 1,251,942 | 14.2% | 53.3% |  |
| STORE_FAST | 829,224 | 9.4% | 62.7% |  |
| _GUARD_IS_FALSE_POP | 411,672 | 4.7% | 67.4% | 0.3% |
| _FOR_ITER_TIER_TWO | 373,140 | 4.2% | 71.6% | 12.5% |
| UNPACK_SEQUENCE_TWO_TUPLE | 327,096 | 3.7% | 75.3% |  |
| _JUMP_TO_TOP | 325,270 | 3.7% | 79.0% |  |
| CONTAINS_OP | 324,562 | 3.7% | 82.6% |  |
| STORE_SUBSCR_DICT | 320,980 | 3.6% | 86.3% |  |
| _GUARD_TYPE_VERSION | 103,606 | 1.2% | 87.4% |  |
| _GUARD_IS_TRUE_POP | 97,936 | 1.1% | 88.6% | 4.7% |
| TO_BOOL_STR | 88,780 | 1.0% | 89.6% |  |
| COMPARE_OP_STR | 85,406 | 1.0% | 90.5% |  |
| _EXIT_TRACE | 81,356 | 0.9% | 91.4% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,406 | 0.9% | 92.3% |  |
| _GUARD_GLOBALS_VERSION | 73,098 | 0.8% | 93.2% | 0.1% |
| _LOAD_GLOBAL_MODULE | 58,618 | 0.7% | 93.8% |  |
...
| _CHECK_PEP_523 | 13,696 | 0.2% | 97.9% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 13,696 | 0.2% | 98.1% |  |
| _CHECK_STACK_SPACE | 13,696 | 0.2% | 98.2% |  |
| _INIT_CALL_PY_EXACT_ARGS | 13,696 | 0.2% | 98.4% |  |
| _PUSH_FRAME | 13,696 | 0.2% | 98.5% |  |
| _SAVE_RETURN_OFFSET | 13,696 | 0.2% | 98.7% |  |
| _LOAD_CONST_INLINE | 12,552 | 0.1% | 98.8% |  |
| RESUME_CHECK | 12,380 | 0.1% | 99.0% |  |
| _POP_FRAME | 8,140 | 0.1% | 99.1% |  |
| TO_BOOL_BOOL | 8,120 | 0.1% | 99.2% |  |
| _CHECK_ATTR_MODULE | 7,754 | 0.1% | 99.3% | 44.4% |
| PUSH_NULL | 7,240 | 0.1% | 99.3% |  |
| _LOAD_ATTR | 6,060 | 0.1% | 99.4% |  |
| CALL_BUILTIN_CLASS | 5,680 | 0.1% | 99.5% |  |
| _LOAD_ATTR_MODULE | 4,314 | 0.0% | 99.5% |  |
| CALL_ISINSTANCE | 4,300 | 0.0% | 99.6% |  |
| CALL_BUILTIN_FAST | 3,820 | 0.0% | 99.6% |  |
| LIST_APPEND | 3,160 | 0.0% | 99.6% |  |
...
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 66 | 0.0% | 100.0% |  |
