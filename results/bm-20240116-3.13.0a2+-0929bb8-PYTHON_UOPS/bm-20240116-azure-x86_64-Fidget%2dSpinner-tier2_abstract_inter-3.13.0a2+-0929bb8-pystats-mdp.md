...
| Specialized hits | 2,144,574,020 | 30.1% |
| Specialized misses | 2,999,280 | 0.0% |
...
| Frees to freelist | 509,131,860 |  |
| Allocations | 479,323,160 | 48.5% |
| Allocations to 512 bytes | 478,714,100 | 48.4% |
| Allocations to 4 kbytes | 605,380 | 0.1% |
| Allocations over 4 kbytes | 3,680 | 0.0% |
| Frees | 479,747,486 |  |
| New values | 20 |  |
| Interpreter increfs | 5,358,605,080 | 72.5% |
| Interpreter decrefs | 6,296,720,120 | 75.2% |
| Increfs | 2,033,857,516 | 27.5% |
| Decrefs | 2,076,162,183 | 24.8% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 102,310,728 |  |
| Method cache misses | 45,392 |  |
| Method cache collisions | 89,851 |  |
| Method cache dunder hits | 71,180,055 |  |
| Method cache dunder misses | 44,945 |  |
...
| Uops executed | 8,423,478,820 | 22.56 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 1,486,024,900 | 17.6% | 17.6% |  |
| _CHECK_VALIDITY | 1,386,610,340 | 16.5% | 34.1% |  |
| LOAD_FAST | 884,555,220 | 10.5% | 44.6% |  |
| STORE_FAST | 615,027,820 | 7.3% | 51.9% |  |
| _ITER_CHECK_LIST | 390,268,480 | 4.6% | 56.5% | 0.4% |
| _GUARD_NOT_EXHAUSTED_LIST | 388,661,240 | 4.6% | 61.2% | 16.2% |
| _ITER_NEXT_LIST | 325,620,980 | 3.9% | 65.0% |  |
| _EXIT_TRACE | 285,927,060 | 3.4% | 68.4% | 100.0% |
| _BINARY_SUBSCR | 283,967,100 | 3.4% | 71.8% |  |
| LOAD_DEREF | 260,162,200 | 3.1% | 74.9% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 249,972,100 | 3.0% | 77.8% |  |
| _GUARD_BOTH_FLOAT | 239,525,400 | 2.8% | 80.7% |  |
| _BINARY_OP_MULTIPLY_FLOAT | 239,525,400 | 2.8% | 83.5% |  |
| LOAD_CONST | 66,771,260 | 0.8% | 84.3% |  |
| _GUARD_IS_FALSE_POP | 56,959,180 | 0.7% | 85.0% | 18.3% |
| _JUMP_TO_TOP | 51,764,160 | 0.6% | 85.6% |  |
| _GUARD_TYPE_VERSION | 48,691,020 | 0.6% | 86.2% |  |
| COPY | 47,609,800 | 0.6% | 86.8% |  |
| SWAP | 47,609,800 | 0.6% | 87.3% |  |
| _BINARY_OP | 47,168,660 | 0.6% | 87.9% |  |
| _LOAD_CONST_INLINE | 46,198,560 | 0.5% | 88.4% |  |
| _CHECK_PEP_523 | 46,112,220 | 0.5% | 89.0% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 46,112,220 | 0.5% | 89.5% |  |
| _CHECK_STACK_SPACE | 46,112,220 | 0.5% | 90.1% |  |
| _INIT_CALL_PY_EXACT_ARGS | 46,112,220 | 0.5% | 90.6% |  |
| _PUSH_FRAME | 46,112,220 | 0.5% | 91.2% |  |
| _SAVE_RETURN_OFFSET | 46,112,220 | 0.5% | 91.7% |  |
| CONTAINS_OP | 44,620,020 | 0.5% | 92.2% |  |
| _GUARD_GLOBALS_VERSION | 34,444,460 | 0.4% | 92.7% |  |
| _GUARD_BUILTINS_VERSION | 30,197,800 | 0.4% | 93.0% |  |
| _LOAD_GLOBAL_BUILTINS | 30,197,800 | 0.4% | 93.4% |  |
| BINARY_SUBSCR_TUPLE_INT | 29,702,520 | 0.4% | 93.7% |  |
| COMPARE_OP_INT | 28,249,180 | 0.3% | 94.1% |  |
| _GUARD_BOTH_INT | 26,501,540 | 0.3% | 94.4% |  |
| RESUME_CHECK | 25,272,240 | 0.3% | 94.7% |  |
| BUILD_TUPLE | 24,011,680 | 0.3% | 95.0% |  |
| _STORE_SUBSCR | 23,804,900 | 0.3% | 95.2% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 22,831,840 | 0.3% | 95.5% | 2.6% |
| _ITER_CHECK_RANGE | 22,831,840 | 0.3% | 95.8% |  |
| LIST_APPEND | 22,246,400 | 0.3% | 96.0% |  |
| _BINARY_OP_MULTIPLY_INT | 22,246,400 | 0.3% | 96.3% |  |
| _ITER_NEXT_RANGE | 22,246,400 | 0.3% | 96.6% |  |
| GET_ITER | 21,141,020 | 0.3% | 96.8% |  |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 21,025,580 | 0.2% | 97.1% |  |
| _GUARD_KEYS_VERSION | 21,025,580 | 0.2% | 97.3% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 21,025,580 | 0.2% | 97.6% |  |
| MAKE_FUNCTION | 20,839,980 | 0.2% | 97.8% |  |
| SET_FUNCTION_ATTRIBUTE | 20,839,980 | 0.2% | 98.1% |  |
| BINARY_SUBSCR_DICT | 20,839,980 | 0.2% | 98.3% |  |
| _POP_FRAME | 20,839,980 | 0.2% | 98.6% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 20,839,980 | 0.2% | 98.8% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 20,839,980 | 0.2% | 99.1% |  |
| _GUARD_IS_TRUE_POP | 17,224,360 | 0.2% | 99.3% | 58.1% |
| _LOAD_ATTR | 15,009,360 | 0.2% | 99.4% |  |
| _FOR_ITER_TIER_TWO | 9,680,320 | 0.1% | 99.6% | 16.5% |
...
| UNARY_NEGATIVE | 3,875,460 | 0.0% | 99.9% |  |
