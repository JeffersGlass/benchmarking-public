...
|---|---:|---:|---:|---:|
| LOAD_FAST | 319,669,860 | 19.0% | 19.0% |  |
| RESUME_CHECK | 110,272,100 | 6.6% | 25.6% | 0.0% |
| POP_JUMP_IF_FALSE | 110,227,040 | 6.6% | 32.2% |  |
| LOAD_CONST | 96,709,980 | 5.8% | 37.9% |  |
| POP_TOP | 89,134,040 | 5.3% | 43.2% |  |
| INTERPRETER_EXIT | 59,531,760 | 3.5% | 46.8% |  |
| RETURN_CONST | 57,992,960 | 3.5% | 50.2% |  |
| LOAD_GLOBAL_MODULE | 56,747,780 | 3.4% | 53.6% | 0.0% |
| STORE_FAST | 56,257,320 | 3.4% | 57.0% |  |
| ENTER_EXECUTOR | 54,160,940 | 3.2% | 60.2% |  |
| LOAD_ATTR | 44,993,040 | 2.7% | 62.9% |  |
| PUSH_NULL | 44,168,680 | 2.6% | 65.5% |  |
| CALL_BUILTIN_O | 43,143,780 | 2.6% | 68.1% |  |
| YIELD_VALUE | 40,901,040 | 2.4% | 70.5% |  |
| CONTAINS_OP | 37,631,940 | 2.2% | 72.8% |  |
| POP_JUMP_IF_TRUE | 32,942,080 | 2.0% | 74.7% |  |
| BINARY_OP_ADD_UNICODE | 31,820,500 | 1.9% | 76.6% |  |
| LOAD_GLOBAL_BUILTIN | 24,325,000 | 1.4% | 78.1% | 0.0% |
...
| NOP | 11,474,520 | 0.7% | 92.0% |  |
| RETURN_VALUE | 11,396,480 | 0.7% | 92.6% |  |
| LOAD_ATTR_METHOD_NO_DICT | 10,798,040 | 0.6% | 93.3% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 10,746,840 | 0.6% | 93.9% | 0.0% |
| JUMP_FORWARD | 10,722,260 | 0.6% | 94.6% |  |
...
| CACHE RESUME_CHECK | 59,510,720 | 3.5% | 7.8% |
| STORE_FAST LOAD_FAST | 44,386,160 | 2.6% | 10.4% |
| LOAD_FAST LOAD_ATTR | 44,151,800 | 2.6% | 13.1% |
| LOAD_FAST PUSH_NULL | 44,143,920 | 2.6% | 15.7% |
| POP_JUMP_IF_FALSE LOAD_FAST | 43,524,060 | 2.6% | 18.3% |
| CALL_BUILTIN_O POP_TOP | 43,140,220 | 2.6% | 20.9% |
| CONTAINS_OP POP_JUMP_IF_FALSE | 37,631,000 | 2.2% | 23.1% |
| LOAD_FAST CONTAINS_OP | 37,532,980 | 2.2% | 25.3% |
| POP_TOP LOAD_FAST | 37,396,000 | 2.2% | 27.6% |
| RETURN_CONST INTERPRETER_EXIT | 36,651,700 | 2.2% | 29.7% |
...
| POP_JUMP_IF_FALSE LOAD_CONST | 26,223,540 | 1.6% | 39.4% |
| RESUME_CHECK POP_TOP | 24,561,080 | 1.5% | 40.9% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 24,224,400 | 1.4% | 42.3% |
| ENTER_EXECUTOR YIELD_VALUE | 23,728,180 | 1.4% | 43.7% |
| YIELD_VALUE INTERPRETER_EXIT | 22,858,100 | 1.4% | 45.1% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 21,220,380 | 1.3% | 52.8% |
...
| POP_TOP ENTER_EXECUTOR | 18,951,660 | 1.1% | 58.9% |
| LOAD_FAST TO_BOOL | 16,385,360 | 1.0% | 59.9% |
| TO_BOOL POP_JUMP_IF_FALSE | 16,369,800 | 1.0% | 60.9% |
...
| RESUME_CHECK NOP | 11,431,560 | 0.7% | 72.1% |
| LOAD_GLOBAL_MODULE LOAD_FAST | 11,350,880 | 0.7% | 72.8% |
| LOAD_FAST RETURN_VALUE | 11,344,920 | 0.7% | 73.5% |
| NOP LOAD_CONST | 11,319,600 | 0.7% | 74.2% |
| LOAD_FAST TO_BOOL_NONE | 10,990,060 | 0.7% | 74.8% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 10,771,560 | 0.6% | 75.5% |
| LOAD_ATTR_METHOD_NO_DICT CALL_METHOD_DESCRIPTOR_NOARGS | 10,741,520 | 0.6% | 76.1% |
| JUMP_FORWARD LOAD_FAST | 10,717,700 | 0.6% | 76.7% |
...
| POP_JUMP_IF_FALSE RETURN_CONST | 10,632,480 | 0.6% | 79.9% |
...
| POP_TOP LOAD_GLOBAL_BUILTIN | 10,610,120 | 0.6% | 82.4% |
...
| TO_BOOL_STR POP_JUMP_IF_TRUE | 10,425,780 | 0.6% | 96.3% |
...
| FOR_ITER_GEN RESUME_CHECK | 1,712,920 | 0.1% | 98.2% |
...
| POP_JUMP_IF_FALSE | 43,524,060 | 13.6% |
...
| ENTER_EXECUTOR | 11,504,740 | 34.9% |
| LOAD_GLOBAL_BUILTIN | 184,680 | 0.6% |
| LOAD_DEREF | 16,000 | 0.0% |
| LOAD_GLOBAL_MODULE | 3,320 | 0.0% |
...
|---|---:|---:|
| Basic | 971,334,260 | 57.9% |
| Not specialized | 239,940,500 | 14.3% |
| Specialized hits | 467,159,760 | 27.8% |
| Specialized misses | 407,800 | 0.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 78,991,660 | 25.4% |
| Frees to freelist | 79,073,180 |  |
| Allocations | 232,259,180 | 74.6% |
| Allocations to 512 bytes | 232,044,400 | 74.6% |
| Allocations to 4 kbytes | 127,820 | 0.0% |
| Allocations over 4 kbytes | 86,960 | 0.0% |
| Frees | 233,527,348 |  |
| New values | 11,780 |  |
| Interpreter increfs | 839,212,320 | 47.2% |
| Interpreter decrefs | 1,035,689,840 | 49.7% |
| Increfs | 940,491,092 | 52.8% |
| Decrefs | 1,047,291,310 | 50.3% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 154,251,748 |  |
| Method cache misses | 85,632 |  |
| Method cache collisions | 79,046 |  |
| Method cache dunder hits | 57,526,973 |  |
| Method cache dunder misses | 7,607 |  |
...
|---:|---:|---:|---:|
| 0 | 28,080 | 1,360 | 484,026,600 |
| 1 | 2,520 | 5,480 | 190,878,400 |
| 2 | 200 | 10,000 | 53,116,120 |
...
| Uops executed | 1,563,977,420 | 28.88 |
