...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 101,581,060 | 61.9% |
| Frees to freelist | 101,581,060 |  |
| Allocations | 62,403,580 | 38.1% |
| Allocations to 512 bytes | 62,403,240 | 38.1% |
...
| Decrefs | 265,427,123 | 98.1% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 1,638,498 |  |
| Method cache misses | 202 |  |
| Method cache collisions | 193 |  |
