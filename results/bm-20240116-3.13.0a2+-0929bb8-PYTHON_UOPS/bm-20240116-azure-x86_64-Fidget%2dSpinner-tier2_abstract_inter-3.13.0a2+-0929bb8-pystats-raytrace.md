...
|---|---:|---:|---:|---:|
| LOAD_FAST | 641,234,920 | 21.5% | 21.5% |  |
| LOAD_ATTR_INSTANCE_VALUE | 429,777,940 | 14.4% | 35.9% | 0.2% |
| RESUME_CHECK | 199,108,620 | 6.7% | 42.6% |  |
...
| CALL_PY_EXACT_ARGS | 129,162,800 | 4.3% | 63.2% | 2.3% |
| STORE_ATTR_INSTANCE_VALUE | 128,143,400 | 4.3% | 67.5% | 0.0% |
| LOAD_ATTR_METHOD_WITH_VALUES | 121,266,460 | 4.1% | 71.6% | 1.8% |
| RETURN_CONST | 82,153,400 | 2.8% | 74.3% |  |
| BINARY_OP_ADD_FLOAT | 76,639,740 | 2.6% | 76.9% | 10.6% |
| BINARY_OP_SUBTRACT_FLOAT | 62,036,740 | 2.1% | 79.0% | 32.5% |
| STORE_FAST | 60,585,940 | 2.0% | 81.0% |  |
| BINARY_OP | 58,602,340 | 2.0% | 83.0% |  |
| LOAD_GLOBAL_MODULE | 52,240,460 | 1.8% | 84.7% | 0.0% |
| LOAD_CONST | 51,839,280 | 1.7% | 86.5% |  |
| EXIT_INIT_CHECK | 44,517,200 | 1.5% | 88.0% |  |
| CALL_ALLOC_AND_ENTER_INIT | 44,517,200 | 1.5% | 89.5% |  |
| POP_JUMP_IF_FALSE | 40,590,840 | 1.4% | 90.8% |  |
| POP_TOP | 32,535,060 | 1.1% | 91.9% |  |
| INTERPRETER_EXIT | 25,483,520 | 0.9% | 92.8% |  |
| TO_BOOL_BOOL | 24,682,420 | 0.8% | 93.6% |  |
| ENTER_EXECUTOR | 19,109,140 | 0.6% | 94.2% |  |
| BINARY_OP_MULTIPLY_INT | 17,996,880 | 0.6% | 94.8% | 62.6% |
| COMPARE_OP | 13,932,820 | 0.5% | 95.3% |  |
| POP_JUMP_IF_NOT_NONE | 10,548,960 | 0.4% | 95.7% |  |
| CALL_BUILTIN_O | 9,872,600 | 0.3% | 96.0% |  |
| PUSH_NULL | 9,747,600 | 0.3% | 96.3% |  |
| LOAD_GLOBAL_BUILTIN | 9,478,300 | 0.3% | 96.6% |  |
...
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST_LOAD_FAST | 73,326,680 | 2.5% | 42.0% |
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 72,004,120 | 2.4% | 44.4% |
...
| CALL_ALLOC_AND_ENTER_INIT RESUME_CHECK | 44,517,200 | 1.5% | 57.0% |
| BINARY_OP_MULTIPLY_FLOAT LOAD_FAST | 38,785,600 | 1.3% | 58.3% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST | 37,192,520 | 1.2% | 59.6% |
| BINARY_OP_ADD_FLOAT LOAD_FAST | 36,727,880 | 1.2% | 60.8% |
...
| LOAD_FAST RETURN_VALUE | 33,465,480 | 1.1% | 67.9% |
| RETURN_VALUE POP_TOP | 31,699,480 | 1.1% | 69.0% |
| POP_TOP LOAD_FAST | 30,537,320 | 1.0% | 70.0% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 30,196,880 | 1.0% | 71.0% |
| LOAD_GLOBAL_MODULE LOAD_FAST | 26,704,240 | 0.9% | 71.9% |
| CACHE RESUME_CHECK | 25,483,300 | 0.9% | 72.8% |
| RETURN_VALUE INTERPRETER_EXIT | 24,682,480 | 0.8% | 73.6% |
| RETURN_CONST TO_BOOL_BOOL | 24,682,360 | 0.8% | 74.4% |
...
| RETURN_VALUE STORE_FAST | 22,824,100 | 0.8% | 77.6% |
...
| RESUME_CHECK LOAD_GLOBAL_MODULE | 19,173,760 | 0.6% | 80.4% |
...
| LOAD_ATTR_INSTANCE_VALUE BINARY_OP_MULTIPLY_INT | 12,809,400 | 0.4% | 82.2% |
| BINARY_OP_MULTIPLY_FLOAT BINARY_OP_SUBTRACT_FLOAT | 11,829,800 | 0.4% | 82.6% |
| RETURN_VALUE LOAD_FAST_LOAD_FAST | 11,829,480 | 0.4% | 83.0% |
| LOAD_FAST_LOAD_FAST BINARY_OP_MULTIPLY_FLOAT | 11,829,440 | 0.4% | 83.4% |
| BINARY_OP_SUBTRACT_FLOAT STORE_FAST | 11,761,040 | 0.4% | 83.8% |
| BINARY_OP_SUBTRACT_FLOAT BINARY_OP_SUBTRACT_FLOAT | 11,760,960 | 0.4% | 84.2% |
| BINARY_OP LOAD_FAST | 11,359,860 | 0.4% | 84.6% |
| POP_JUMP_IF_FALSE RETURN_CONST | 11,357,080 | 0.4% | 85.0% |
| LOAD_CONST LOAD_FAST | 11,169,640 | 0.4% | 85.3% |
| BINARY_OP_MULTIPLY_INT BINARY_OP_ADD_FLOAT | 11,149,760 | 0.4% | 85.7% |
...
| RETURN_VALUE CALL_BUILTIN_O | 8,392,200 | 0.3% | 90.3% |
| RETURN_VALUE CALL_PY_EXACT_ARGS | 7,480,360 | 0.3% | 90.6% |
| BINARY_OP STORE_FAST | 7,437,620 | 0.2% | 90.8% |
| LOAD_FAST BUILD_TUPLE | 7,319,480 | 0.2% | 91.1% |
| BUILD_TUPLE LIST_APPEND | 7,319,400 | 0.2% | 91.3% |
| LIST_APPEND ENTER_EXECUTOR | 7,319,060 | 0.2% | 91.6% |
| POP_JUMP_IF_NOT_NONE ENTER_EXECUTOR | 6,782,400 | 0.2% | 91.8% |
| ENTER_EXECUTOR CALL_ALLOC_AND_ENTER_INIT | 6,578,980 | 0.2% | 92.0% |
| RETURN_CONST STORE_FAST | 6,326,000 | 0.2% | 92.2% |
| RETURN_CONST LOAD_FAST | 5,825,640 | 0.2% | 92.4% |
| LOAD_ATTR_INSTANCE_VALUE BINARY_OP_ADD_FLOAT | 5,300,080 | 0.2% | 92.6% |
| LOAD_GLOBAL_BUILTIN LOAD_CONST | 5,226,560 | 0.2% | 92.8% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_CONST | 4,949,000 | 0.2% | 93.0% |
| LOAD_CONST LOAD_GLOBAL_BUILTIN | 4,799,760 | 0.2% | 93.1% |
| BINARY_OP_MULTIPLY_INT LOAD_FAST | 4,368,520 | 0.1% | 93.3% |
| ENTER_EXECUTOR FOR_ITER_LIST | 4,106,420 | 0.1% | 93.4% |
| BINARY_OP BINARY_OP_ADD_FLOAT | 4,064,260 | 0.1% | 93.5% |
| LOAD_FAST_LOAD_FAST LOAD_CONST | 3,864,240 | 0.1% | 93.7% |
| BINARY_SUBSCR_TUPLE_INT LOAD_FAST_LOAD_FAST | 3,839,700 | 0.1% | 93.8% |
| BINARY_SUBSCR_TUPLE_INT BINARY_OP | 3,785,880 | 0.1% | 93.9% |
| LOAD_ATTR_INSTANCE_VALUE BINARY_OP_SUBTRACT_INT | 3,675,500 | 0.1% | 94.0% |
| BINARY_OP_SUBTRACT_INT CALL_ALLOC_AND_ENTER_INIT | 3,545,160 | 0.1% | 94.2% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 3,407,800 | 0.1% | 94.3% |
...
| BINARY_OP RETURN_VALUE | 2,999,040 | 0.1% | 94.7% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 2,971,320 | 0.1% | 94.8% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_WITH_VALUES | 2,893,280 | 0.1% | 94.9% |
| STORE_FAST LOAD_GLOBAL_MODULE | 2,874,520 | 0.1% | 95.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LIST_APPEND | 7,319,060 | 38.3% |
| POP_JUMP_IF_NOT_NONE | 6,782,400 | 35.5% |
| POP_JUMP_IF_TRUE | 2,225,920 | 11.6% |
| STORE_FAST | 1,155,400 | 6.0% |
| CALL_LIST_APPEND | 818,540 | 4.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_ALLOC_AND_ENTER_INIT | 6,578,980 | 34.4% |
| FOR_ITER_LIST | 4,106,420 | 21.5% |
| BINARY_OP_MULTIPLY_INT | 2,775,880 | 14.5% |
| LOAD_ATTR_METHOD_WITH_VALUES | 2,039,960 | 10.7% |
| BINARY_OP_MULTIPLY_FLOAT | 2,024,000 | 10.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 23,829,160 | 58.7% |
| COMPARE_OP | 13,109,420 | 32.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 24,682,320 | 60.8% |
| RETURN_CONST | 11,357,080 | 28.0% |
| LOAD_CONST | 2,466,720 | 6.1% |
| NOP | 1,221,200 | 3.0% |
| LOAD_FAST | 863,360 | 2.1% |
...
|---|---:|---:|
| Basic | 1,351,966,560 | 45.3% |
| Not specialized | 133,954,220 | 4.5% |
| Specialized hits | 1,440,418,080 | 48.3% |
| Specialized misses | 55,010,320 | 1.8% |
...
| Frees to freelist | 302,718,240 |  |
| Allocations | 108,324,240 | 26.4% |
| Allocations to 512 bytes | 108,322,720 | 26.4% |
| Allocations to 4 kbytes | 160 | 0.0% |
| Allocations over 4 kbytes | 1,360 | 0.0% |
| Frees | 109,960,518 |  |
| New values | 1,040 |  |
| Interpreter increfs | 2,361,430,740 | 96.5% |
| Interpreter decrefs | 2,573,378,160 | 91.5% |
| Increfs | 85,516,421 | 3.5% |
| Decrefs | 238,484,658 | 8.5% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 4,358,582 |  |
| Method cache misses | 1,158 |  |
| Method cache collisions | 1,041 |  |
| Method cache dunder hits | 24,683,887 |  |
| Method cache dunder misses | 233 |  |
...
| Traces executed | 19,109,140 |  |
| Uops executed | 1,431,329,020 | 74.90 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 211,469,880 | 14.8% | 14.8% |  |
| _GUARD_TYPE_VERSION | 131,054,180 | 9.2% | 23.9% | 1.6% |
| _SET_IP | 113,170,140 | 7.9% | 31.8% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 93,379,060 | 6.5% | 38.4% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 93,379,060 | 6.5% | 44.9% |  |
| _CHECK_VALIDITY | 92,760,200 | 6.5% | 51.4% |  |
| STORE_FAST | 61,403,380 | 4.3% | 55.7% |  |
| _GUARD_BOTH_FLOAT | 37,678,640 | 2.6% | 58.3% | 12.7% |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 35,635,160 | 2.5% | 60.8% |  |
| _GUARD_KEYS_VERSION | 35,635,160 | 2.5% | 63.3% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 35,635,160 | 2.5% | 65.8% |  |
| _BINARY_OP_MULTIPLY_FLOAT | 34,606,560 | 2.4% | 68.2% |  |
| RESUME_CHECK | 30,254,180 | 2.1% | 70.3% |  |
| _CHECK_PEP_523 | 30,254,180 | 2.1% | 72.4% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 30,254,180 | 2.1% | 74.5% |  |
| _CHECK_STACK_SPACE | 30,254,180 | 2.1% | 76.6% |  |
| _INIT_CALL_PY_EXACT_ARGS | 30,254,180 | 2.1% | 78.7% |  |
| _PUSH_FRAME | 30,254,180 | 2.1% | 80.9% |  |
| _SAVE_RETURN_OFFSET | 30,254,180 | 2.1% | 83.0% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 28,226,740 | 2.0% | 84.9% | 14.5% |
| _ITER_CHECK_LIST | 28,226,740 | 2.0% | 86.9% |  |
| _ITER_NEXT_LIST | 24,120,320 | 1.7% | 88.6% |  |
| _POP_FRAME | 18,554,560 | 1.3% | 89.9% |  |
| _LOAD_CONST_INLINE | 16,322,840 | 1.1% | 91.0% |  |
| _BINARY_OP_ADD_FLOAT | 15,705,640 | 1.1% | 92.1% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 14,747,780 | 1.0% | 93.2% |  |
| _BINARY_OP | 14,304,780 | 1.0% | 94.2% |  |
| _JUMP_TO_TOP | 10,298,540 | 0.7% | 94.9% |  |
| POP_TOP | 10,252,760 | 0.7% | 95.6% |  |
| BINARY_SUBSCR_TUPLE_INT | 8,547,560 | 0.6% | 96.2% |  |
| _GUARD_IS_NONE_POP | 8,287,520 | 0.6% | 96.8% | 15.3% |
| _GUARD_GLOBALS_VERSION | 7,035,540 | 0.5% | 97.3% |  |
| _LOAD_GLOBAL_MODULE | 7,027,940 | 0.5% | 97.8% |  |
| _EXIT_TRACE | 6,578,980 | 0.5% | 98.2% | 100.0% |
| _BINARY_OP_SUBTRACT_FLOAT | 5,853,440 | 0.4% | 98.6% |  |
| _GUARD_IS_TRUE_POP | 2,527,080 | 0.2% | 98.8% | 3.0% |
| _COMPARE_OP | 2,527,080 | 0.2% | 99.0% |  |
| BUILD_TUPLE | 2,450,200 | 0.2% | 99.2% |  |
| LIST_APPEND | 2,450,200 | 0.2% | 99.3% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 1,614,800 | 0.1% | 99.4% | 0.5% |
| _ITER_CHECK_RANGE | 1,614,800 | 0.1% | 99.5% |  |
| _ITER_NEXT_RANGE | 1,606,600 | 0.1% | 99.7% |  |
