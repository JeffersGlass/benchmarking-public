...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 14,860 | 36.9% |
| Frees to freelist | 15,040 |  |
| Allocations | 25,460 | 63.1% |
| Allocations to 512 bytes | 24,580 | 61.0% |
| Allocations to 4 kbytes | 220 | 0.5% |
| Allocations over 4 kbytes | 660 | 1.6% |
| Frees | 25,034 |  |
| New values | 480 |  |
| Interpreter increfs | 113,200 | 66.0% |
...
| Method cache hits | 14,532 |  |
| Method cache misses | 2,808 |  |
| Method cache collisions | 2,989 |  |
| Method cache dunder hits | 5,947 |  |
| Method cache dunder misses | 813 |  |
