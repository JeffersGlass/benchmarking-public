...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,995,368 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,140,664 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,137,360 | 5.3% | 29.1% |  |
| RESUME_CHECK | 865,480 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,560 | 3.8% | 36.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,248 | 3.6% | 40.5% | 0.1% |
...
| LOAD_GLOBAL_BUILTIN | 615,964 | 2.9% | 56.2% | 0.4% |
| POP_TOP | 565,760 | 2.6% | 58.9% |  |
| RETURN_VALUE | 519,800 | 2.4% | 61.3% |  |
| CALL_PY_EXACT_ARGS | 415,760 | 1.9% | 63.2% | 0.1% |
| RETURN_CONST | 384,080 | 1.8% | 65.0% |  |
| CALL | 359,360 | 1.7% | 66.6% |  |
...
| COMPARE_OP_INT | 247,404 | 1.1% | 74.7% | 0.1% |
| LOAD_ATTR_METHOD_NO_DICT | 235,960 | 1.1% | 75.8% | 0.4% |
| LOAD_ATTR_WITH_HINT | 229,640 | 1.1% | 76.8% | 3.2% |
| STORE_ATTR | 225,700 | 1.0% | 77.9% |  |
| BINARY_OP | 215,680 | 1.0% | 78.9% |  |
| INTERPRETER_EXIT | 209,580 | 1.0% | 79.8% |  |
| CALL_LEN | 192,504 | 0.9% | 80.7% |  |
| STORE_ATTR_SLOT | 180,220 | 0.8% | 81.6% | 4.7% |
| POP_JUMP_IF_NONE | 165,840 | 0.8% | 82.3% |  |
| RETURN_GENERATOR | 159,800 | 0.7% | 83.1% |  |
...
| POP_JUMP_IF_NOT_NONE | 131,060 | 0.6% | 88.4% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 115,480 | 0.5% | 89.0% | 8.6% |
| JUMP_FORWARD | 106,920 | 0.5% | 89.5% |  |
| CALL_KW | 99,400 | 0.5% | 89.9% |  |
| NOP | 98,520 | 0.5% | 90.4% |  |
| CALL_FUNCTION_EX | 93,760 | 0.4% | 90.8% |  |
| BUILD_TUPLE | 90,580 | 0.4% | 91.3% |  |
| LOAD_DEREF | 88,480 | 0.4% | 91.7% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,328 | 3.5% | 3.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 563,200 | 2.6% | 6.1% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,904 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 244,724 | 1.1% | 22.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,244 | 0.8% | 28.1% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 179,200 | 0.8% | 28.9% |
| POP_TOP LOAD_FAST | 178,120 | 0.8% | 29.7% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 164,560 | 0.8% | 33.6% |
...
| POP_JUMP_IF_FALSE LOAD_CONST | 149,320 | 0.7% | 37.3% |
...
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 117,940 | 0.5% | 46.8% |
...
| LOAD_GLOBAL_BUILTIN LOAD_GLOBAL_BUILTIN | 105,120 | 0.5% | 50.3% |
| PUSH_NULL LOAD_FAST | 103,800 | 0.5% | 50.8% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST_LOAD_FAST | 103,140 | 0.5% | 51.3% |
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,484 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,204 | 0.4% | 54.0% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 81,400 | 0.4% | 55.6% |
...
| TO_BOOL_NONE POP_JUMP_IF_FALSE | 75,540 | 0.4% | 58.5% |
...
| LOAD_FAST BUILD_TUPLE | 62,340 | 0.3% | 64.9% |
...
| JUMP_FORWARD LOAD_FAST | 56,220 | 0.3% | 67.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 28,640 | 29.1% |
| STORE_FAST | 28,120 | 28.5% |
| POP_JUMP_IF_FALSE | 14,600 | 14.8% |
| POP_JUMP_IF_TRUE | 9,520 | 9.7% |
| POP_JUMP_IF_NOT_NONE | 8,760 | 8.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 76,540 | 77.7% |
| LOAD_GLOBAL_MODULE | 15,040 | 15.3% |
...
| POP_JUMP_IF_FALSE | 149,320 | 13.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 563,200 | 14.1% |
| STORE_FAST | 497,880 | 12.5% |
| RESUME_CHECK | 468,920 | 11.7% |
| LOAD_GLOBAL_BUILTIN | 400,904 | 10.0% |
| LOAD_CONST | 213,300 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,328 | 18.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 563,200 | 49.4% |
| LOAD_GLOBAL_BUILTIN | 179,244 | 15.7% |
| LOAD_CONST | 149,320 | 13.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 244,724 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,244 | 29.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 14,680 | 91.3% |
| LOAD_FAST | 1,060 | 6.6% |
| TO_BOOL | 340 | 2.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 15,400 | 95.8% |
...
|---|---:|---:|
| Basic | 10,671,348 | 49.4% |
| Not specialized | 3,504,304 | 16.2% |
| Specialized hits | 7,323,440 | 33.9% |
...
| Allocations | 1,600,459 | 67.3% |
| Allocations to 512 bytes | 1,408,572 | 59.3% |
| Allocations to 4 kbytes | 132,408 | 5.6% |
| Allocations over 4 kbytes | 59,479 | 2.5% |
| Frees | 1,537,200 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,353,478 | 76.8% |
| Interpreter decrefs | 14,169,440 | 78.3% |
| Increfs | 3,734,595 | 23.2% |
| Decrefs | 3,919,004 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,220,020 |  |
| Method cache misses | 40,280 |  |
| Method cache collisions | 46,845 |  |
| Method cache dunder hits | 354,815 |  |
| Method cache dunder misses | 8,965 |  |
...
| Uops executed | 10,046,140 | 66.09 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,610,580 | 16.0% | 16.0% |  |
| _SET_IP | 1,103,380 | 11.0% | 27.0% |  |
| _GUARD_TYPE_VERSION | 1,042,000 | 10.4% | 37.4% |  |
| _CHECK_VALIDITY | 1,033,500 | 10.3% | 47.7% |  |
| _LOAD_ATTR_SLOT | 941,200 | 9.4% | 57.0% |  |
| _GUARD_GLOBALS_VERSION | 441,500 | 4.4% | 61.4% | 0.1% |
| _GUARD_IS_TRUE_POP | 344,080 | 3.4% | 64.9% | 9.7% |
| _GUARD_IS_FALSE_POP | 340,140 | 3.4% | 68.2% | 0.2% |
| _LOAD_GLOBAL_MODULE | 309,540 | 3.1% | 71.3% |  |
| IS_OP | 287,040 | 2.9% | 74.2% |  |
| STORE_FAST | 265,340 | 2.6% | 76.8% |  |
| TO_BOOL_BOOL | 208,940 | 2.1% | 78.9% |  |
...
| _EXIT_TRACE | 62,140 | 0.6% | 89.8% | 100.0% |
| _LOAD_ATTR | 58,120 | 0.6% | 90.4% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 54,440 | 0.5% | 91.0% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 54,440 | 0.5% | 91.5% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 50,420 | 0.5% | 92.0% | 7.3% |
| _ITER_CHECK_RANGE | 50,420 | 0.5% | 92.5% |  |
| _CHECK_PEP_523 | 48,940 | 0.5% | 93.0% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 48,940 | 0.5% | 93.5% |  |
| _CHECK_STACK_SPACE | 48,940 | 0.5% | 94.0% |  |
| _INIT_CALL_PY_EXACT_ARGS | 48,940 | 0.5% | 94.5% |  |
| _PUSH_FRAME | 48,940 | 0.5% | 94.9% |  |
| _SAVE_RETURN_OFFSET | 48,940 | 0.5% | 95.4% |  |
| _ITER_NEXT_RANGE | 46,720 | 0.5% | 95.9% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 40,380 | 0.4% | 96.3% |  |
| _LOAD_CONST_INLINE | 31,520 | 0.3% | 96.6% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 27,180 | 0.3% | 96.9% |  |
| RESUME_CHECK | 23,400 | 0.2% | 97.1% |  |
| MAKE_CELL | 23,040 | 0.2% | 97.3% |  |
| PUSH_NULL | 21,200 | 0.2% | 97.6% |  |
...
| _GUARD_BOTH_INT | 1,500 | 0.0% | 99.9% |  |
