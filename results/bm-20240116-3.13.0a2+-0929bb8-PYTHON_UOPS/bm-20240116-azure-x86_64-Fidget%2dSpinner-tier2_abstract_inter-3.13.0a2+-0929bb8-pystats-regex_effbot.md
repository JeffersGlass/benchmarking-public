...
|---|---:|---:|---:|---:|
| LOAD_FAST | 4,890,800 | 16.7% | 16.7% |  |
| LOAD_GLOBAL_MODULE | 2,414,480 | 8.2% | 24.9% |  |
| LOAD_GLOBAL_BUILTIN | 2,393,760 | 8.2% | 33.1% |  |
| POP_JUMP_IF_FALSE | 1,954,780 | 6.7% | 39.8% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 997,080 | 3.4% | 9.9% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 972,400 | 3.3% | 13.2% |
...
| POP_JUMP_IF_FALSE POP_TOP | 471,940 | 1.6% | 60.3% |
...
| LOAD_GLOBAL_MODULE IS_OP | 12,820 | 0.0% | 97.4% |
...
| EXTENDED_ARG POP_JUMP_IF_FALSE | 5,720 | 0.0% | 98.3% |
| PUSH_NULL LOAD_GLOBAL_MODULE | 5,660 | 0.0% | 98.3% |
| ENTER_EXECUTOR POP_JUMP_IF_FALSE | 5,360 | 0.0% | 98.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 471,940 | 48.8% |
...
| POP_JUMP_IF_FALSE | 5,360 | 8.4% |
| EXTENDED_ARG | 3,560 | 5.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 3,560 | 21.5% |
| CONTAINS_OP | 3,220 | 19.4% |
| POP_TOP | 2,980 | 18.0% |
| GET_ITER | 2,540 | 15.3% |
| COMPARE_OP_STR | 1,340 | 8.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 5,720 | 34.5% |
| FOR_ITER_LIST | 4,860 | 29.3% |
| JUMP_FORWARD | 4,520 | 27.3% |
| FOR_ITER | 1,080 | 6.5% |
| JUMP_BACKWARD | 400 | 2.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 12,820 | 94.3% |
| LOAD_FAST | 340 | 2.5% |
...
| POP_JUMP_IF_FALSE | 997,080 | 20.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 972,400 | 19.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 957,560 | 49.0% |
| TO_BOOL_INT | 475,520 | 24.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 997,080 | 51.0% |
| POP_TOP | 471,940 | 24.1% |
| NOP | 471,300 | 24.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_INT | 3,700 | 31.1% |
| IS_OP | 3,140 | 26.4% |
| TO_BOOL_BOOL | 2,080 | 17.5% |
| TO_BOOL_STR | 1,340 | 11.3% |
| TO_BOOL_LIST | 600 | 5.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 4,780 | 40.2% |
| ENTER_EXECUTOR | 2,920 | 24.5% |
| CALL_LEN | 1,220 | 10.3% |
...
|---|---:|---:|
| Basic | 14,173,100 | 48.4% |
| Not specialized | 2,957,980 | 10.1% |
| Specialized hits | 12,176,380 | 41.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 1,433,500 | 0.7% |
| Frees to freelist | 1,433,060 |  |
| Allocations | 211,659,060 | 99.3% |
| Allocations to 512 bytes | 211,652,840 | 99.3% |
| Allocations to 4 kbytes | 2,220 | 0.0% |
| Allocations over 4 kbytes | 4,000 | 0.0% |
| Frees | 212,084,207 |  |
| New values | 860 |  |
| Interpreter increfs | 12,855,560 | 69.6% |
| Interpreter decrefs | 13,352,020 | 59.9% |
| Increfs | 5,612,836 | 30.4% |
| Decrefs | 8,935,706 | 40.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 8,093 |  |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 239,680 | 22.3% | 22.3% |  |
| STORE_FAST | 129,060 | 12.0% | 34.2% |  |
| _SET_IP | 60,320 | 5.6% | 39.8% |  |
| _ITER_CHECK_LIST | 54,340 | 5.0% | 44.9% | 2.9% |
| _CHECK_VALIDITY | 54,040 | 5.0% | 49.9% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 52,740 | 4.9% | 54.8% | 4.3% |
| _EXIT_TRACE | 52,440 | 4.9% | 59.7% | 100.0% |
| _ITER_NEXT_LIST | 50,480 | 4.7% | 64.3% |  |
| PUSH_NULL | 50,300 | 4.7% | 69.0% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 50,200 | 4.7% | 73.7% |  |
| _GUARD_TYPE_VERSION | 23,340 | 2.2% | 75.8% |  |
| _LOAD_CONST_INLINE | 19,040 | 1.8% | 77.6% |  |
| _GUARD_IS_FALSE_POP | 15,220 | 1.4% | 79.0% | 11.8% |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 11,980 | 1.1% | 80.1% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 11,980 | 1.1% | 81.2% |  |
| _GUARD_GLOBALS_VERSION | 10,880 | 1.0% | 82.3% |  |
| _LOAD_GLOBAL_MODULE | 10,800 | 1.0% | 83.3% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 10,660 | 1.0% | 84.3% | 10.5% |
| _ITER_CHECK_RANGE | 10,660 | 1.0% | 85.2% |  |
| _ITER_NEXT_RANGE | 9,540 | 0.9% | 86.1% |  |
| IS_OP | 7,580 | 0.7% | 86.8% |  |
| CONTAINS_OP | 6,840 | 0.6% | 87.5% |  |
| _CHECK_PEP_523 | 6,400 | 0.6% | 88.1% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 6,400 | 0.6% | 88.7% |  |
...
| RESUME_CHECK | 5,960 | 0.6% | 91.6% |  |
| _JUMP_TO_TOP | 5,820 | 0.5% | 92.1% |  |
| POP_TOP | 5,520 | 0.5% | 92.6% |  |
| BINARY_SUBSCR_LIST_INT | 5,440 | 0.5% | 93.1% |  |
| _GUARD_IS_TRUE_POP | 5,360 | 0.5% | 93.6% | 72.0% |
| _POP_FRAME | 5,320 | 0.5% | 94.1% |  |
| _GUARD_DORV_VALUES | 5,320 | 0.5% | 94.6% |  |
| _STORE_ATTR_INSTANCE_VALUE | 5,320 | 0.5% | 95.1% |  |
| _STORE_SUBSCR | 4,720 | 0.4% | 95.6% |  |
| _GUARD_BOTH_INT | 4,240 | 0.4% | 96.0% |  |
| _BINARY_OP_ADD_INT | 3,960 | 0.4% | 96.3% |  |
| _GUARD_IS_NOT_NONE_POP | 3,620 | 0.3% | 96.7% | 9.4% |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 3,140 | 0.3% | 96.9% |  |
| _GUARD_KEYS_VERSION | 3,140 | 0.3% | 97.2% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 3,140 | 0.3% | 97.5% |  |
