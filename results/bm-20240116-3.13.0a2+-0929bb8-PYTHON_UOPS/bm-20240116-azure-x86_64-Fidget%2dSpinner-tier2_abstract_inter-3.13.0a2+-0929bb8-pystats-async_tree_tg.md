...
| TO_BOOL_LIST | 5,227,460 | 0.3% | 98.6% |  |
| JUMP_FORWARD | 4,480,260 | 0.3% | 98.8% |  |
| COMPARE_OP_INT | 4,480,200 | 0.3% | 99.1% |  |
| LOAD_GLOBAL_BUILTIN | 1,499,760 | 0.1% | 99.2% | 0.0% |
...
| NOP | 750,280 | 0.0% | 99.7% |  |
| BUILD_LIST | 749,000 | 0.0% | 99.8% |  |
...
| RESUME | 1,720 | 0.0% | 100.0% | 1,525.6% |
...
| CACHE RESUME_CHECK | 38,818,080 | 2.3% | 23.1% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_SLOT | 38,817,760 | 2.3% | 25.3% |
| POP_TOP LOAD_FAST | 38,074,440 | 2.2% | 27.6% |
| LOAD_CONST LOAD_FAST | 37,327,780 | 2.2% | 29.8% |
| STORE_FAST LOAD_FAST | 34,350,480 | 2.0% | 31.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 34,348,080 | 2.0% | 33.8% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 27,622,780 | 1.6% | 45.6% |
...
| TO_BOOL_NONE POP_JUMP_IF_FALSE | 24,634,160 | 1.4% | 51.9% |
| RETURN_CONST POP_TOP | 23,893,800 | 1.4% | 53.3% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 23,141,220 | 1.4% | 54.6% |
| LOAD_FAST CALL_METHOD_DESCRIPTOR_O | 23,140,960 | 1.4% | 56.0% |
| STORE_ATTR_SLOT LOAD_CONST | 19,409,120 | 1.1% | 57.1% |
...
| RETURN_VALUE INTERPRETER_EXIT | 14,930,060 | 0.9% | 65.1% |
| RETURN_VALUE STORE_FAST | 14,185,660 | 0.8% | 65.9% |
| LOAD_FAST_LOAD_FAST LOAD_FAST_LOAD_FAST | 14,183,760 | 0.8% | 66.7% |
| PUSH_NULL LOAD_FAST_LOAD_FAST | 14,183,600 | 0.8% | 67.6% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST_LOAD_FAST | 14,183,240 | 0.8% | 68.4% |
...
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL | 11,197,920 | 0.7% | 72.1% |
| LOAD_CONST STORE_FAST | 10,455,360 | 0.6% | 72.7% |
| POP_TOP LOAD_CONST | 10,453,220 | 0.6% | 73.3% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 10,452,980 | 0.6% | 73.9% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 9,707,440 | 0.6% | 74.5% |
| STORE_FAST RETURN_CONST | 9,706,000 | 0.6% | 75.0% |
| POP_JUMP_IF_FALSE LOAD_CONST | 9,705,600 | 0.6% | 75.6% |
| RETURN_VALUE TO_BOOL_BOOL | 9,704,960 | 0.6% | 76.2% |
| LOAD_FAST_LOAD_FAST LOAD_FAST | 9,704,880 | 0.6% | 76.8% |
| POP_JUMP_IF_TRUE LOAD_FAST | 9,704,660 | 0.6% | 77.3% |
| STORE_ATTR_SLOT LOAD_FAST | 9,704,660 | 0.6% | 77.9% |
| STORE_ATTR_SLOT RETURN_CONST | 9,704,660 | 0.6% | 78.5% |
...
| LOAD_FAST POP_JUMP_IF_NONE | 7,465,360 | 0.4% | 85.1% |
| TO_BOOL POP_JUMP_IF_FALSE | 6,719,300 | 0.4% | 85.5% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 6,718,340 | 0.4% | 85.9% |
| LOAD_FAST LOAD_CONST | 5,973,180 | 0.4% | 86.2% |
| GET_AWAITABLE LOAD_CONST | 5,972,080 | 0.4% | 86.6% |
| PUSH_NULL CALL | 5,228,340 | 0.3% | 86.9% |
| TO_BOOL_LIST POP_JUMP_IF_FALSE | 5,227,460 | 0.3% | 87.2% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_LIST | 5,227,380 | 0.3% | 87.5% |
| CALL POP_TOP | 5,226,120 | 0.3% | 87.8% |
| STORE_ATTR_INSTANCE_VALUE LOAD_CONST | 5,226,060 | 0.3% | 88.1% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 5,226,020 | 0.3% | 88.4% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 5,225,980 | 0.3% | 88.7% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_WITH_VALUES | 5,225,960 | 0.3% | 89.0% |
| POP_JUMP_IF_NOT_NONE LOAD_GLOBAL_MODULE | 5,225,760 | 0.3% | 89.3% |
| END_SEND POP_TOP | 5,225,600 | 0.3% | 89.6% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 4,480,200 | 0.3% | 90.8% |
| STORE_FAST JUMP_FORWARD | 4,480,080 | 0.3% | 91.1% |
| LOAD_ATTR LOAD_FAST | 4,479,920 | 0.3% | 91.3% |
| JUMP_FORWARD LOAD_FAST | 4,479,760 | 0.3% | 91.6% |
| LOAD_CONST COMPARE_OP_INT | 4,479,720 | 0.3% | 91.8% |
| TO_BOOL POP_JUMP_IF_TRUE | 4,479,520 | 0.3% | 92.1% |
...
| POP_JUMP_IF_FALSE | 9,705,600 | 13.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 53,007,580 | 56.3% |
| TO_BOOL_NONE | 24,634,160 | 26.2% |
| TO_BOOL | 6,719,300 | 7.1% |
| TO_BOOL_LIST | 5,227,460 | 5.6% |
| COMPARE_OP_INT | 4,480,200 | 4.8% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 68,682,700 | 73.0% |
| RETURN_CONST | 14,930,460 | 15.9% |
| LOAD_CONST | 9,705,600 | 10.3% |
...
|---|---:|---:|
| Basic | 871,303,400 | 51.1% |
| Not specialized | 216,556,460 | 12.7% |
| Specialized hits | 617,432,060 | 36.2% |
| Specialized misses | 787,500 | 0.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 50,789,080 | 35.0% |
| Frees to freelist | 50,957,120 |  |
| Allocations | 94,278,054 | 65.0% |
| Allocations to 512 bytes | 93,472,720 | 64.4% |
| Allocations to 4 kbytes | 804,980 | 0.6% |
| Allocations over 4 kbytes | 354 | 0.0% |
| Frees | 94,234,248 |  |
| New values | 320 |  |
| Interpreter increfs | 1,078,052,480 | 79.6% |
| Interpreter decrefs | 1,135,329,820 | 76.6% |
| Increfs | 276,218,688 | 20.4% |
| Decrefs | 346,494,965 | 23.4% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 57,498,959 |  |
| Method cache misses | 3,701 |  |
| Method cache collisions | 3,406 |  |
| Method cache dunder hits | 11,198,732 |  |
...
|---:|---:|---:|---:|
| 0 | 51,300 | 2,040 | 274,622,960 |
| 1 | 4,660 | 0 | 297,436,880 |
| 2 | 400 | 0 | 844,804,560 |
...
| _LOAD_CONST_INLINE | 3,736,920 | 0.5% | 99.0% |  |
