...
|---|---:|---:|---:|---:|
| LOAD_FAST | 791,208,000 | 19.7% | 19.7% |  |
| RESUME_CHECK | 247,551,840 | 6.1% | 25.8% | 0.0% |
| POP_JUMP_IF_FALSE | 218,440,640 | 5.4% | 31.2% |  |
...
| LOAD_GLOBAL_MODULE | 120,642,300 | 3.0% | 68.8% |  |
...
| RESUME | 1,980 | 0.0% | 100.0% | 3,753.0% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 159,020,880 | 4.0% | 8.9% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 154,981,440 | 3.8% | 12.8% |
...
| LOAD_FAST STORE_ATTR_SLOT | 70,171,440 | 1.7% | 32.6% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 60,917,280 | 1.5% | 34.1% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 60,916,480 | 1.5% | 35.6% |
...
| POP_TOP LOAD_FAST | 53,005,080 | 1.3% | 53.8% |
...
| POP_TOP ENTER_EXECUTOR | 21,647,560 | 0.5% | 74.4% |
| POP_JUMP_IF_FALSE LOAD_CONST | 20,903,360 | 0.5% | 74.9% |
...
| NOP LOAD_FAST | 8,214,960 | 0.2% | 88.6% |
...
| POP_JUMP_IF_FALSE | 20,903,360 | 14.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 154,981,440 | 70.9% |
| TO_BOOL_NONE | 43,296,500 | 19.8% |
| TO_BOOL | 6,719,540 | 3.1% |
| TO_BOOL_LIST | 5,228,340 | 2.4% |
| COMPARE_OP_INT | 4,480,320 | 2.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 151,994,660 | 69.6% |
| RETURN_CONST | 26,127,900 | 12.0% |
| LOAD_CONST | 20,903,360 | 9.6% |
...
|---|---:|---:|
| Basic | 1,952,260,240 | 48.5% |
| Not specialized | 415,597,120 | 10.3% |
| Specialized hits | 1,657,050,851 | 41.2% |
| Specialized misses | 921,209 | 0.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 106,777,117 | 38.1% |
| Frees to freelist | 107,301,300 |  |
| Allocations | 173,514,767 | 61.9% |
| Allocations to 512 bytes | 172,652,302 | 61.6% |
| Allocations to 4 kbytes | 862,040 | 0.3% |
| Allocations over 4 kbytes | 425 | 0.0% |
| Frees | 173,429,025 |  |
| New values | 320 |  |
| Interpreter increfs | 2,599,124,200 | 79.1% |
| Interpreter decrefs | 2,719,865,151 | 77.2% |
| Increfs | 686,844,784 | 20.9% |
| Decrefs | 801,950,900 | 22.8% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 83,716,943 |  |
| Method cache misses | 4,557 |  |
| Method cache collisions | 4,170 |  |
| Method cache dunder hits | 75,847,160 |  |
| Method cache dunder misses | 440 |  |
...
|---:|---:|---:|---:|
| 0 | 95,034 | 2,040 | 678,507,824 |
| 1 | 8,640 | 0 | 729,278,804 |
| 2 | 660 | 0 | 2,408,145,080 |
...
| _LOAD_CONST_INLINE | 11,201,480 | 0.9% | 93.9% |  |
