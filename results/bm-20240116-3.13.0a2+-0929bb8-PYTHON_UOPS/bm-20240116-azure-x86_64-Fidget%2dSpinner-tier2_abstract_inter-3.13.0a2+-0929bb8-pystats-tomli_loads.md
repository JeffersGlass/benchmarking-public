...
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,886,997,700 | 14.8% | 14.8% |  |
| LOAD_FAST_LOAD_FAST | 1,258,420,300 | 9.8% | 24.6% |  |
| STORE_FAST | 1,154,295,560 | 9.0% | 33.6% |  |
...
| RETURN_VALUE | 407,422,680 | 3.2% | 69.6% |  |
| CALL_PY_EXACT_ARGS | 361,485,840 | 2.8% | 72.4% |  |
...
| STORE_FAST_STORE_FAST | 114,407,140 | 0.9% | 87.0% |  |
...
| CALL | 65,357,620 | 0.5% | 93.4% |  |
| LOAD_ATTR_INSTANCE_VALUE | 61,984,980 | 0.5% | 93.9% |  |
| POP_TOP | 61,436,800 | 0.5% | 94.4% |  |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 310,858,780 | 2.4% | 25.6% |
| STORE_FAST LOAD_FAST_LOAD_FAST | 274,052,600 | 2.1% | 27.7% |
...
| LOAD_FAST RETURN_VALUE | 226,778,440 | 1.8% | 34.8% |
...
| LOAD_FAST CALL | 51,767,700 | 0.4% | 81.0% |
...
|---|---:|---:|
| Basic | 7,571,307,300 | 59.2% |
| Not specialized | 1,478,140,080 | 11.6% |
| Specialized hits | 3,741,535,560 | 29.3% |
...
| Allocations | 1,629,725,680 | 86.2% |
| Allocations to 512 bytes | 1,629,312,580 | 86.1% |
| Allocations to 4 kbytes | 410,940 | 0.0% |
| Allocations over 4 kbytes | 2,160 | 0.0% |
| Frees | 1,636,427,640 |  |
| New values | 120 |  |
| Interpreter increfs | 11,145,420,920 | 90.1% |
| Interpreter decrefs | 13,156,577,580 | 91.7% |
| Increfs | 1,224,760,796 | 9.9% |
| Decrefs | 1,196,397,211 | 8.3% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 66,876,313 |  |
| Method cache misses | 1,167 |  |
| Method cache collisions | 1,053 |  |
| Method cache dunder hits | 96,916,592 |  |
| Method cache dunder misses | 148 |  |
...
| _LOAD_CONST_INLINE | 2,951,979,500 | 9.1% | 56.6% |  |
