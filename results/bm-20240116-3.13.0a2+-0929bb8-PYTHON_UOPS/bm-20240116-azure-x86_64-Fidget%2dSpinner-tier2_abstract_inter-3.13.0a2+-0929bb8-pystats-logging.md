...
| RESUME_CHECK | 156,468,280 | 6.4% | 35.9% |  |
...
| STORE_FAST | 64,721,180 | 2.7% | 79.9% |  |
| NOP | 62,259,440 | 2.6% | 82.5% |  |
| BINARY_SUBSCR_DICT | 55,705,540 | 2.3% | 84.8% |  |
| LOAD_FAST_LOAD_FAST | 46,613,120 | 1.9% | 86.7% |  |
| STORE_ATTR_INSTANCE_VALUE | 36,043,920 | 1.5% | 88.2% |  |
| LOAD_ATTR_MODULE | 29,493,020 | 1.2% | 89.4% |  |
| LOAD_GLOBAL_BUILTIN | 19,661,020 | 0.8% | 90.2% | 0.0% |
| PUSH_NULL | 16,385,840 | 0.7% | 90.9% |  |
| POP_JUMP_IF_TRUE | 14,746,240 | 0.6% | 91.5% |  |
| TO_BOOL_NONE | 14,745,240 | 0.6% | 92.1% |  |
...
| POP_TOP LOAD_FAST | 55,214,380 | 2.3% | 52.7% |
| LOAD_FAST CALL | 54,479,480 | 2.2% | 55.0% |
| CALL RESUME_CHECK | 54,067,300 | 2.2% | 57.2% |
| LOAD_FAST BINARY_SUBSCR_DICT | 54,067,080 | 2.2% | 59.4% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_GLOBAL_MODULE | 54,067,080 | 2.2% | 61.7% |
| STORE_FAST LOAD_FAST | 40,143,740 | 1.7% | 63.3% |
| POP_JUMP_IF_FALSE LOAD_FAST | 33,587,560 | 1.4% | 64.7% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 26,213,920 | 1.1% | 65.8% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 23,757,400 | 1.0% | 66.7% |
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 19,659,840 | 0.8% | 67.6% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 16,383,200 | 0.7% | 68.2% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 15,565,740 | 0.6% | 68.9% |
| LOAD_FAST LOAD_CONST | 15,565,280 | 0.6% | 69.5% |
| LOAD_ATTR_MODULE PUSH_NULL | 14,746,500 | 0.6% | 70.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 14,745,640 | 0.6% | 70.7% |
| TO_BOOL_NONE POP_JUMP_IF_FALSE | 14,745,240 | 0.6% | 71.3% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST_LOAD_FAST | 13,106,880 | 0.5% | 71.9% |
| LOAD_FAST LOAD_ATTR | 11,476,120 | 0.5% | 72.4% |
| RETURN_VALUE STORE_FAST | 11,469,440 | 0.5% | 72.8% |
| LOAD_FAST RETURN_VALUE | 11,469,040 | 0.5% | 73.3% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 10,649,880 | 0.4% | 73.7% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 9,831,160 | 0.4% | 74.1% |
| LOAD_CONST LOAD_FAST | 9,830,400 | 0.4% | 74.5% |
| LOAD_CONST STORE_FAST | 9,830,400 | 0.4% | 75.0% |
| STORE_ATTR_INSTANCE_VALUE LOAD_GLOBAL_MODULE | 9,829,920 | 0.4% | 75.4% |
| LOAD_CONST COMPARE_OP_INT | 9,011,200 | 0.4% | 75.7% |
| POP_TOP RETURN_CONST | 8,192,240 | 0.3% | 76.1% |
| RETURN_VALUE RETURN_VALUE | 8,192,240 | 0.3% | 76.4% |
| LOAD_FAST_LOAD_FAST LOAD_FAST_LOAD_FAST | 8,192,000 | 0.3% | 76.7% |
...
| LOAD_FAST STORE_FAST | 6,554,300 | 0.3% | 77.9% |
| CALL STORE_FAST | 6,554,140 | 0.3% | 78.2% |
| STORE_FAST LOAD_GLOBAL_MODULE | 6,554,120 | 0.3% | 78.5% |
| POP_JUMP_IF_TRUE LOAD_FAST | 6,553,920 | 0.3% | 78.8% |
| LOAD_CONST LOAD_CONST | 6,553,720 | 0.3% | 79.0% |
| STORE_FAST LOAD_FAST_LOAD_FAST | 6,553,600 | 0.3% | 79.3% |
| RETURN_VALUE LOAD_FAST | 6,553,560 | 0.3% | 79.6% |
| LOAD_CONST BINARY_OP_ADD_INT | 6,553,320 | 0.3% | 79.8% |
| LOAD_FAST TO_BOOL_NONE | 6,553,280 | 0.3% | 80.1% |
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 6,553,280 | 0.3% | 80.4% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_NONE | 6,553,280 | 0.3% | 80.6% |
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 6,553,280 | 0.3% | 80.9% |
| LOAD_GLOBAL_MODULE TO_BOOL_BOOL | 6,553,280 | 0.3% | 81.2% |
| LOAD_ATTR_MODULE LOAD_ATTR_MODULE | 5,734,760 | 0.2% | 81.4% |
| ENTER_EXECUTOR CALL | 5,405,520 | 0.2% | 81.6% |
| PUSH_NULL LOAD_FAST | 4,916,320 | 0.2% | 81.8% |
| PUSH_NULL CALL | 4,916,000 | 0.2% | 82.0% |
| LOAD_GLOBAL_MODULE LOAD_FAST | 4,915,940 | 0.2% | 82.2% |
...
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST | 4,915,080 | 0.2% | 85.9% |
| TO_BOOL_ALWAYS_TRUE POP_JUMP_IF_FALSE | 4,915,080 | 0.2% | 86.1% |
| LOAD_FAST LOAD_GLOBAL_BUILTIN | 4,915,040 | 0.2% | 86.3% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 4,915,000 | 0.2% | 86.5% |
| LOAD_CONST CALL_BUILTIN_FAST | 4,914,960 | 0.2% | 86.7% |
| LOAD_FAST TO_BOOL_ALWAYS_TRUE | 4,914,960 | 0.2% | 86.9% |
| CACHE RESUME_CHECK | 4,096,260 | 0.2% | 87.1% |
| LOAD_GLOBAL_MODULE LOAD_FAST_LOAD_FAST | 4,096,080 | 0.2% | 87.2% |
| POP_JUMP_IF_FALSE LOAD_FAST_LOAD_FAST | 4,096,060 | 0.2% | 87.4% |
| TO_BOOL POP_JUMP_IF_FALSE | 3,278,060 | 0.1% | 87.5% |
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 3,277,440 | 0.1% | 87.7% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 3,277,440 | 0.1% | 87.8% |
| LOAD_CONST CALL | 3,277,380 | 0.1% | 88.0% |
| CALL POP_TOP | 3,277,300 | 0.1% | 88.1% |
| COPY TO_BOOL_BOOL | 3,277,280 | 0.1% | 88.2% |
| CALL LOAD_FAST | 3,277,080 | 0.1% | 88.4% |
| CALL LOAD_CONST | 3,276,880 | 0.1% | 88.5% |
| STORE_FAST LOAD_GLOBAL_BUILTIN | 3,276,880 | 0.1% | 88.6% |
...
| POP_JUMP_IF_TRUE | 1,638,080 | 15.9% |
...
|---|---:|---:|
| Basic | 1,083,337,400 | 44.6% |
| Not specialized | 294,161,160 | 12.1% |
...
| Allocations | 49,166,650 | 36.4% |
| Allocations to 512 bytes | 49,165,850 | 36.4% |
| Allocations to 4 kbytes | 80 | 0.0% |
| Allocations over 4 kbytes | 720 | 0.0% |
| Frees | 49,165,010 |  |
| New values | 1,638,400 |  |
| Interpreter increfs | 1,079,399,300 | 92.0% |
| Interpreter decrefs | 1,208,014,070 | 92.1% |
| Increfs | 93,388,710 | 8.0% |
| Decrefs | 103,231,768 | 7.9% |
| Materialize dict (on request) | 1,638,400 | 100.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 1,638,360 | 100.0% |
| Method cache hits | 24,603,186 |  |
| Method cache misses | 3,254 |  |
| Method cache collisions | 2,729 |  |
| Method cache dunder hits | 14,747,568 |  |
| Method cache dunder misses | 672 |  |
...
| _LOAD_CONST_INLINE | 1,638,080 | 0.5% | 99.0% |  |
