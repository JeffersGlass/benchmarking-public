...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 67,626,560 | 74.8% |
| Frees to freelist | 67,627,620 |  |
| Allocations | 22,837,220 | 25.2% |
| Allocations to 512 bytes | 22,816,300 | 25.2% |
...
| Increfs | 10,003,114 | 2.5% |
| Decrefs | 30,822,331 | 6.4% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 803,081 |  |
| Method cache misses | 179 |  |
...
| Uops executed | 1,030,527,040 | 114.07 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 212,608,800 | 20.6% | 20.6% |  |
| LOAD_FAST | 171,265,080 | 16.6% | 37.3% |  |
| _CHECK_VALIDITY | 165,302,340 | 16.0% | 53.3% |  |
| _GUARD_TYPE_VERSION | 44,431,560 | 4.3% | 57.6% |  |
| _GUARD_BOTH_INT | 41,895,920 | 4.1% | 61.7% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 40,031,960 | 3.9% | 65.6% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 40,031,960 | 3.9% | 69.4% |  |
| _BINARY_OP_SUBTRACT_INT | 32,000,000 | 3.1% | 72.5% |  |
| STORE_FAST | 29,421,820 | 2.9% | 75.4% |  |
| _GUARD_BOTH_FLOAT | 28,800,000 | 2.8% | 78.2% |  |
| _BINARY_OP_MULTIPLY_FLOAT | 24,000,000 | 2.3% | 80.5% |  |
| _BINARY_OP_ADD_INT | 22,458,700 | 2.2% | 82.7% |  |
| BINARY_SUBSCR_LIST_INT | 20,031,960 | 1.9% | 84.6% |  |
| _BINARY_OP | 16,020,080 | 1.6% | 86.2% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 13,285,980 | 1.3% | 87.5% | 30.2% |
| _ITER_CHECK_RANGE | 13,285,980 | 1.3% | 88.8% |  |
| _BINARY_OP_ADD_FLOAT | 12,000,000 | 1.2% | 89.9% |  |
| _LOAD_CONST_INLINE | 10,182,860 | 1.0% | 90.9% |  |
| _ITER_NEXT_RANGE | 9,278,380 | 0.9% | 91.8% |  |
| LOAD_CONST | 8,000,000 | 0.8% | 92.6% |  |
| _GUARD_GLOBALS_VERSION | 5,810,480 | 0.6% | 93.2% |  |
| _EXIT_TRACE | 4,698,480 | 0.5% | 93.6% | 100.0% |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 4,399,600 | 0.4% | 94.1% |  |
| _GUARD_KEYS_VERSION | 4,399,600 | 0.4% | 94.5% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 4,399,600 | 0.4% | 94.9% |  |
| _LOAD_GLOBAL_MODULE | 4,210,480 | 0.4% | 95.3% |  |
| RESUME_CHECK | 4,000,000 | 0.4% | 95.7% |  |
| _CHECK_PEP_523 | 4,000,000 | 0.4% | 96.1% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 4,000,000 | 0.4% | 96.5% |  |
| _CHECK_STACK_SPACE | 4,000,000 | 0.4% | 96.9% |  |
| _INIT_CALL_PY_EXACT_ARGS | 4,000,000 | 0.4% | 97.3% |  |
| _PUSH_FRAME | 4,000,000 | 0.4% | 97.6% |  |
| _GUARD_IS_NOT_NONE_POP | 4,000,000 | 0.4% | 98.0% |  |
| _SAVE_RETURN_OFFSET | 4,000,000 | 0.4% | 98.4% |  |
| _JUMP_TO_TOP | 2,795,260 | 0.3% | 98.7% |  |
| LIST_APPEND | 2,420,080 | 0.2% | 98.9% |  |
| GET_ITER | 1,600,000 | 0.2% | 99.1% |  |
| CALL_BUILTIN_CLASS | 1,600,000 | 0.2% | 99.2% |  |
| _GUARD_BUILTINS_VERSION | 1,600,000 | 0.2% | 99.4% |  |
| _LOAD_GLOBAL_BUILTINS | 1,600,000 | 0.2% | 99.5% |  |
| _GUARD_IS_TRUE_POP | 1,154,620 | 0.1% | 99.7% | 7.4% |
| _COMPARE_OP | 1,125,560 | 0.1% | 99.8% |  |
