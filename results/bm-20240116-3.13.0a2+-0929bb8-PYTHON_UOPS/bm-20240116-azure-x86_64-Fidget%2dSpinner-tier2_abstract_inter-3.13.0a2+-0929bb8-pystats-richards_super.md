...
| RESUME_CHECK | 81,965,500 | 5.2% | 47.8% |  |
| POP_JUMP_IF_FALSE | 81,573,380 | 5.1% | 52.9% |  |
| RETURN_VALUE | 72,657,020 | 4.6% | 57.5% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 72,039,760 | 4.5% | 62.1% | 44.6% |
...
| POP_JUMP_IF_NOT_NONE | 30,754,880 | 1.9% | 87.1% |  |
| POP_JUMP_IF_TRUE | 22,905,040 | 1.4% | 88.5% |  |
| POP_JUMP_IF_NONE | 22,455,200 | 1.4% | 89.9% |  |
| LOAD_GLOBAL_BUILTIN | 21,053,720 | 1.3% | 91.3% |  |
| ENTER_EXECUTOR | 17,460,400 | 1.1% | 92.4% |  |
| UNARY_NOT | 15,207,200 | 1.0% | 93.3% |  |
| COMPARE_OP_INT | 13,016,100 | 0.8% | 94.1% |  |
| JUMP_FORWARD | 10,812,160 | 0.7% | 94.8% |  |
| RETURN_CONST | 10,531,840 | 0.7% | 95.5% |  |
| LOAD_DEREF | 10,527,520 | 0.7% | 96.1% |  |
| COPY_FREE_VARS | 10,527,440 | 0.7% | 96.8% |  |
| LOAD_SUPER_ATTR_METHOD | 10,527,200 | 0.7% | 97.5% |  |
...
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 59,944,920 | 3.8% | 20.0% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 34,538,880 | 2.2% | 41.5% |
| LOAD_CONST LOAD_FAST | 29,192,800 | 1.8% | 43.3% |
| LOAD_ATTR_INSTANCE_VALUE COPY | 28,600,200 | 1.8% | 45.1% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 25,419,040 | 1.6% | 46.7% |
| RETURN_VALUE RETURN_VALUE | 24,772,160 | 1.6% | 48.3% |
| LOAD_ATTR_INSTANCE_VALUE STORE_FAST | 24,749,900 | 1.6% | 49.8% |
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 23,315,520 | 1.5% | 51.3% |
| RETURN_VALUE TO_BOOL_BOOL | 23,233,060 | 1.5% | 52.8% |
| LOAD_FAST POP_JUMP_IF_NONE | 22,455,200 | 1.4% | 54.2% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 22,014,080 | 1.4% | 55.6% |
| LOAD_FAST RETURN_VALUE | 21,297,360 | 1.3% | 56.9% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST | 20,470,740 | 1.3% | 58.2% |
| POP_JUMP_IF_FALSE POP_TOP | 19,888,560 | 1.3% | 59.4% |
| LOAD_ATTR_INSTANCE_VALUE CALL_PY_EXACT_ARGS | 17,463,800 | 1.1% | 60.5% |
...
| STORE_ATTR_INSTANCE_VALUE LOAD_CONST | 15,387,440 | 1.0% | 64.6% |
| TO_BOOL_BOOL UNARY_NOT | 15,207,160 | 1.0% | 65.6% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_BOOL | 15,207,120 | 1.0% | 66.6% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST_LOAD_FAST | 14,245,720 | 0.9% | 67.4% |
| LOAD_FAST_LOAD_FAST CALL_PY_EXACT_ARGS | 14,245,680 | 0.9% | 68.3% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST | 14,116,900 | 0.9% | 69.2% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 13,778,720 | 0.9% | 70.1% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 13,016,100 | 0.8% | 70.9% |
| LOAD_ATTR_INSTANCE_VALUE RETURN_VALUE | 12,933,060 | 0.8% | 71.7% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_CONST | 12,351,780 | 0.8% | 72.5% |
| LOAD_FAST STORE_FAST | 12,201,120 | 0.8% | 73.3% |
| LOAD_GLOBAL_MODULE TO_BOOL_BOOL | 12,014,120 | 0.8% | 74.0% |
| ENTER_EXECUTOR LOAD_ATTR_METHOD_WITH_VALUES | 11,487,300 | 0.7% | 74.8% |
| UNARY_NOT COPY | 11,487,200 | 0.7% | 75.5% |
| POP_JUMP_IF_TRUE POP_TOP | 11,487,200 | 0.7% | 76.2% |
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 11,242,760 | 0.7% | 76.9% |
| RESUME_CHECK LOAD_CONST | 10,660,440 | 0.7% | 77.6% |
| JUMP_FORWARD LOAD_FAST | 10,625,920 | 0.7% | 78.2% |
| STORE_ATTR_INSTANCE_VALUE RETURN_CONST | 10,530,200 | 0.7% | 78.9% |
| RESUME_CHECK LOAD_FAST_LOAD_FAST | 10,527,640 | 0.7% | 79.6% |
| RETURN_CONST POP_TOP | 10,527,520 | 0.7% | 80.2% |
| LOAD_DEREF LOAD_FAST | 10,527,360 | 0.7% | 80.9% |
| COPY_FREE_VARS RESUME_CHECK | 10,527,260 | 0.7% | 81.6% |
| LOAD_GLOBAL_BUILTIN LOAD_DEREF | 10,527,200 | 0.7% | 82.2% |
| LOAD_SUPER_ATTR_METHOD LOAD_FAST_LOAD_FAST | 10,527,060 | 0.7% | 82.9% |
| LOAD_FAST LOAD_SUPER_ATTR_METHOD | 10,527,040 | 0.7% | 83.5% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 10,526,520 | 0.7% | 84.2% |
| CALL_PY_EXACT_ARGS COPY_FREE_VARS | 10,526,380 | 0.7% | 84.9% |
| LOAD_FAST_LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 10,526,360 | 0.7% | 85.5% |
| POP_JUMP_IF_TRUE LOAD_GLOBAL_BUILTIN | 10,526,240 | 0.7% | 86.2% |
| STORE_FAST LOAD_GLOBAL_BUILTIN | 10,526,240 | 0.7% | 86.9% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 10,526,240 | 0.7% | 87.5% |
| LOAD_GLOBAL_MODULE CALL_ISINSTANCE | 10,526,240 | 0.7% | 88.2% |
| POP_JUMP_IF_FALSE RETURN_VALUE | 9,039,220 | 0.6% | 88.7% |
| COPY LOAD_ATTR_INSTANCE_VALUE | 7,980,360 | 0.5% | 89.2% |
| SWAP STORE_ATTR_INSTANCE_VALUE | 7,980,360 | 0.5% | 89.8% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 7,439,320 | 0.5% | 90.2% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 7,179,920 | 0.5% | 90.7% |
| LOAD_CONST BINARY_OP_ADD_INT | 7,067,280 | 0.4% | 91.1% |
| RETURN_VALUE POP_TOP | 6,939,080 | 0.4% | 91.6% |
| POP_JUMP_IF_FALSE LOAD_CONST | 6,863,520 | 0.4% | 92.0% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 6,807,840 | 0.4% | 92.4% |
| LOAD_FAST BINARY_SUBSCR_LIST_INT | 6,807,120 | 0.4% | 92.8% |
| LOAD_CONST STORE_FAST | 6,806,560 | 0.4% | 93.3% |
| STORE_FAST JUMP_FORWARD | 6,719,840 | 0.4% | 93.7% |
| BINARY_OP_ADD_INT SWAP | 5,579,380 | 0.4% | 94.0% |
| LOAD_GLOBAL_MODULE COMPARE_OP_INT | 5,482,120 | 0.3% | 94.4% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_INSTANCE_VALUE | 5,321,360 | 0.3% | 94.7% |
| BINARY_SUBSCR_LIST_INT STORE_FAST | 5,319,180 | 0.3% | 95.1% |
| LOAD_GLOBAL_MODULE COPY | 5,206,840 | 0.3% | 95.4% |
| ENTER_EXECUTOR POP_JUMP_IF_FALSE | 4,710,000 | 0.3% | 95.7% |
| POP_TOP JUMP_FORWARD | 4,092,320 | 0.3% | 95.9% |
| LOAD_CONST BINARY_OP | 3,998,640 | 0.3% | 96.2% |
| LOAD_ATTR_INSTANCE_VALUE COMPARE_OP_INT | 3,961,200 | 0.2% | 96.4% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST_LOAD_FAST | 3,848,800 | 0.2% | 96.7% |
| POP_JUMP_IF_NONE LOAD_FAST | 3,774,720 | 0.2% | 96.9% |
| STORE_FAST LOAD_GLOBAL_MODULE | 3,720,400 | 0.2% | 97.2% |
| UNARY_NOT RETURN_VALUE | 3,720,000 | 0.2% | 97.4% |
| LOAD_CONST COMPARE_OP_INT | 3,572,560 | 0.2% | 97.6% |
| LOAD_FAST COPY | 2,773,680 | 0.2% | 97.8% |
| BINARY_OP LOAD_CONST | 2,398,580 | 0.2% | 97.9% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_GLOBAL_MODULE | 2,232,560 | 0.1% | 98.1% |
...
| POP_JUMP_IF_FALSE | 34,538,880 | 9.9% |
...
|---|---:|---:|
| Basic | 761,119,220 | 47.9% |
| Not specialized | 161,707,740 | 10.2% |
| Specialized hits | 560,870,360 | 35.3% |
| Specialized misses | 106,085,980 | 6.7% |
...
| Allocations | 9,451,720 | 100.0% |
| Allocations to 512 bytes | 9,451,520 | 100.0% |
...
| Increfs | 104,302,857 | 13.2% |
| Decrefs | 46,500,391 | 5.8% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 93,477,861 |  |
| Method cache misses | 5,606,399 |  |
| Method cache collisions | 5,605,671 |  |
...
| Uops executed | 356,908,940 | 20.44 |
...
| _GUARD_TYPE_VERSION | 32,839,420 | 9.2% | 29.2% | 35.0% |
| LOAD_FAST | 32,810,780 | 9.2% | 38.4% |  |
| _GUARD_IS_FALSE_POP | 28,429,820 | 8.0% | 46.4% | 4.4% |
| _CHECK_VALIDITY | 19,935,940 | 5.6% | 52.0% |  |
| _GUARD_GLOBALS_VERSION | 18,147,600 | 5.1% | 57.0% |  |
| _LOAD_GLOBAL_MODULE | 18,147,600 | 5.1% | 62.1% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 14,663,180 | 4.1% | 66.2% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 14,663,180 | 4.1% | 70.3% |  |
| COPY | 11,370,300 | 3.2% | 73.5% |  |
| RESUME_CHECK | 5,572,220 | 1.6% | 75.1% |  |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 5,572,220 | 1.6% | 76.7% |  |
| _GUARD_KEYS_VERSION | 5,572,220 | 1.6% | 78.2% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 5,572,220 | 1.6% | 79.8% |  |
| _CHECK_PEP_523 | 5,572,220 | 1.6% | 81.3% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 5,572,220 | 1.6% | 82.9% |  |
| _CHECK_STACK_SPACE | 5,572,220 | 1.6% | 84.5% |  |
| _INIT_CALL_PY_EXACT_ARGS | 5,572,220 | 1.6% | 86.0% |  |
| _PUSH_FRAME | 5,572,220 | 1.6% | 87.6% |  |
| _SAVE_RETURN_OFFSET | 5,572,220 | 1.6% | 89.1% |  |
| POP_TOP | 4,681,360 | 1.3% | 90.5% |  |
| UNARY_NOT | 4,681,360 | 1.3% | 91.8% |  |
| _EXIT_TRACE | 4,353,260 | 1.2% | 93.0% | 100.0% |
| _POP_FRAME | 4,353,260 | 1.2% | 94.2% |  |
| _LOAD_CONST_INLINE | 3,321,520 | 0.9% | 95.1% |  |
| _GUARD_BOTH_INT | 2,204,800 | 0.6% | 95.8% |  |
