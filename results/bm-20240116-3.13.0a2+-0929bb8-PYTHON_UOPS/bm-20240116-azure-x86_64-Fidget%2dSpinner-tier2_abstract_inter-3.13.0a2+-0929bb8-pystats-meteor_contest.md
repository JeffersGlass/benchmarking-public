...
| CALL_LEN | 14,676,100 | 4.8% | 61.6% |  |
| COMPARE_OP_INT | 14,675,920 | 4.8% | 66.4% |  |
| FOR_ITER_LIST | 13,875,380 | 4.6% | 71.0% |  |
| POP_JUMP_IF_TRUE | 13,260,900 | 4.4% | 75.3% |  |
| BINARY_SUBSCR_LIST_INT | 9,146,460 | 3.0% | 78.3% |  |
| GET_ITER | 8,844,640 | 2.9% | 81.2% |  |
| BINARY_OP | 8,232,300 | 2.7% | 83.9% |  |
| POP_JUMP_IF_FALSE | 8,232,240 | 2.7% | 86.6% |  |
| BINARY_SLICE | 6,328,520 | 2.1% | 88.7% |  |
| POP_TOP | 5,040,000 | 1.7% | 90.4% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 4,119,620 | 1.4% | 91.7% |  |
...
| LOAD_FAST CALL_LEN | 10,561,120 | 3.5% | 16.3% |
| POP_JUMP_IF_TRUE ENTER_EXECUTOR | 9,443,200 | 3.1% | 19.4% |
| LOAD_FAST GET_ITER | 8,844,640 | 2.9% | 22.3% |
| ENTER_EXECUTOR FOR_ITER_LIST | 8,842,180 | 2.9% | 25.2% |
| STORE_FAST LOAD_FAST_LOAD_FAST | 8,735,240 | 2.9% | 28.1% |
| CALL_LEN LOAD_CONST | 8,232,120 | 2.7% | 30.8% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 8,232,120 | 2.7% | 33.5% |
| LOAD_CONST COMPARE_OP_INT | 8,232,080 | 2.7% | 36.2% |
| STORE_FAST LOAD_GLOBAL_BUILTIN | 8,229,760 | 2.7% | 38.9% |
| CALL_LEN LOAD_FAST | 6,443,800 | 2.1% | 41.0% |
| COMPARE_OP_INT POP_JUMP_IF_TRUE | 6,443,800 | 2.1% | 43.1% |
| LOAD_FAST COMPARE_OP_INT | 6,443,760 | 2.1% | 45.2% |
| FOR_ITER_LIST LOAD_GLOBAL_BUILTIN | 6,441,400 | 2.1% | 47.3% |
| LOAD_CONST LOAD_CONST | 6,333,320 | 2.1% | 49.4% |
| LOAD_FAST LOAD_CONST | 6,331,000 | 2.1% | 51.5% |
| BINARY_SLICE STORE_FAST | 6,328,520 | 2.1% | 53.6% |
| LOAD_CONST BINARY_SLICE | 6,328,520 | 2.1% | 55.7% |
| BINARY_SUBSCR_LIST_INT STORE_FAST | 5,031,600 | 1.7% | 57.3% |
| GET_ITER FOR_ITER_LIST | 5,031,560 | 1.7% | 59.0% |
| LOAD_FAST_LOAD_FAST BINARY_SUBSCR_LIST_INT | 5,031,560 | 1.7% | 60.6% |
| LOAD_FAST LOAD_FAST_LOAD_FAST | 5,031,280 | 1.7% | 62.3% |
| FOR_ITER_LIST STORE_FAST | 4,922,020 | 1.6% | 63.9% |
| ENTER_EXECUTOR POP_JUMP_IF_TRUE | 4,410,960 | 1.4% | 65.3% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 4,119,560 | 1.4% | 66.7% |
| ENTER_EXECUTOR LOAD_GLOBAL_BUILTIN | 4,117,220 | 1.4% | 68.0% |
| BINARY_OP STORE_FAST | 4,114,980 | 1.4% | 69.4% |
| LOAD_FAST_LOAD_FAST BINARY_OP | 4,114,880 | 1.4% | 70.7% |
| POP_JUMP_IF_FALSE LOAD_FAST_LOAD_FAST | 4,114,880 | 1.4% | 72.1% |
| BINARY_SUBSCR_LIST_INT BINARY_OP | 4,114,860 | 1.4% | 73.4% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 4,114,860 | 1.4% | 74.8% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST_LOAD_FAST | 4,114,860 | 1.4% | 76.1% |
| BINARY_OP CALL_LEN | 4,114,840 | 1.4% | 77.5% |
| LOAD_FAST BINARY_SUBSCR_LIST_INT | 4,114,840 | 1.4% | 78.9% |
| FOR_ITER STORE_FAST | 3,813,240 | 1.3% | 80.1% |
| LOAD_FAST STORE_SUBSCR_LIST_INT | 3,813,140 | 1.3% | 81.4% |
| GET_ITER FOR_ITER | 3,813,020 | 1.3% | 82.6% |
| POP_JUMP_IF_TRUE LOAD_FAST | 3,812,920 | 1.3% | 83.9% |
| STORE_SUBSCR_LIST_INT ENTER_EXECUTOR | 3,812,840 | 1.3% | 85.1% |
| ENTER_EXECUTOR ENTER_EXECUTOR | 3,604,540 | 1.2% | 86.3% |
| LOAD_FAST LOAD_FAST | 2,520,400 | 0.8% | 87.1% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 2,520,340 | 0.8% | 88.0% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 2,520,280 | 0.8% | 88.8% |
| POP_JUMP_IF_FALSE LOAD_FAST | 2,515,680 | 0.8% | 89.6% |
| RETURN_CONST POP_TOP | 2,515,680 | 0.8% | 90.4% |
| RESUME_CHECK LOAD_FAST_LOAD_FAST | 2,515,660 | 0.8% | 91.3% |
| CALL_PY_WITH_DEFAULTS RESUME_CHECK | 2,515,640 | 0.8% | 92.1% |
| LOAD_GLOBAL_MODULE LOAD_FAST | 2,515,640 | 0.8% | 92.9% |
| LOAD_FAST CALL_PY_WITH_DEFAULTS | 2,515,600 | 0.8% | 93.7% |
| CALL_METHOD_DESCRIPTOR_O POP_TOP | 2,515,580 | 0.8% | 94.6% |
| POP_TOP LOAD_GLOBAL_MODULE | 2,515,560 | 0.8% | 95.4% |
| LOAD_FAST CALL_METHOD_DESCRIPTOR_O | 2,515,560 | 0.8% | 96.2% |
| POP_TOP ENTER_EXECUTOR | 2,515,260 | 0.8% | 97.0% |
| FOR_ITER_LIST RETURN_CONST | 2,511,920 | 0.8% | 97.9% |
| COMPARE_OP POP_JUMP_IF_TRUE | 2,406,140 | 0.8% | 98.7% |
| LOAD_FAST_LOAD_FAST COMPARE_OP | 2,406,100 | 0.8% | 99.4% |
| POP_JUMP_IF_FALSE ENTER_EXECUTOR | 1,598,940 | 0.5% | 100.0% |
...
| POP_JUMP_IF_TRUE | 3,812,920 | 6.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| COMPARE_OP_INT | 6,443,800 | 48.6% |
| ENTER_EXECUTOR | 4,410,960 | 33.3% |
| COMPARE_OP | 2,406,140 | 18.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 9,443,200 | 71.2% |
| LOAD_FAST | 3,812,920 | 28.8% |
| POP_TOP | 3,760 | 0.0% |
...
| Allocations | 36,421,020 | 84.3% |
| Allocations to 512 bytes | 32,305,460 | 74.8% |
...
| _LOAD_CONST_INLINE | 608,720 | 0.1% | 100.0% |  |
