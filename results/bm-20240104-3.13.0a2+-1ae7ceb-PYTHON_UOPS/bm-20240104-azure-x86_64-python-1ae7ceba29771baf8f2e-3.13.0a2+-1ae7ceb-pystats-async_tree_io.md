...
| POP_JUMP_IF_FALSE | 233,374,760 | 5.5% | 30.2% |  |
...
| RESUME | 1,920 | 0.0% | 100.0% | 4,760.9% |
...
|---|---:|---:|
| Basic | 2,087,416,400 | 49.4% |
| Not specialized | 439,495,040 | 10.4% |
| Specialized hits | 1,693,642,931 | 40.1% |
| Specialized misses | 4,742,489 | 0.1% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 114,342,600 | 39.1% |
| Frees to freelist | 114,850,490 |  |
| Allocations | 177,888,035 | 60.9% |
| Allocations to 512 bytes | 177,772,408 | 60.8% |
| Allocations to 4 kbytes | 115,520 | 0.0% |
| Allocations over 4 kbytes | 107 | 0.0% |
| Frees | 179,990,317 |  |
| New values | 300 |  |
| Interpreter increfs | 2,696,912,720 | 78.8% |
| Interpreter decrefs | 2,810,935,210 | 76.7% |
| Increfs | 723,458,992 | 21.2% |
| Decrefs | 854,971,705 | 23.3% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 109,082,600 |  |
| Method cache misses | 766,200 |  |
| Method cache collisions | 784,090 |  |
| Method cache dunder hits | 75,078,310 |  |
| Method cache dunder misses | 22,770 |  |
...
|---:|---:|---:|---:|
| 0 | 92,959 | 2,040 | 649,914,982 |
| 1 | 8,440 | 0 | 710,007,498 |
| 2 | 660 | 0 | 2,267,910,150 |
...
| Uops executed | 1,392,055,880 | 45.48 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 181,378,920 | 13.0% | 13.0% |  |
| _CHECK_VALIDITY | 173,165,000 | 12.4% | 25.5% |  |
| LOAD_FAST | 161,223,320 | 11.6% | 37.1% |  |
| _GUARD_TYPE_VERSION | 148,533,640 | 10.7% | 47.7% | 2.5% |
| _LOAD_ATTR_SLOT | 57,471,440 | 4.1% | 51.8% |  |
| STORE_FAST | 52,994,920 | 3.8% | 55.7% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 45,530,160 | 3.3% | 58.9% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 45,530,160 | 3.3% | 62.2% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 34,334,080 | 2.5% | 64.7% |  |
| _GUARD_IS_FALSE_POP | 34,333,880 | 2.5% | 67.1% | 0.0% |
| TO_BOOL_BOOL | 30,601,800 | 2.2% | 69.3% |  |
| _EXIT_TRACE | 24,632,640 | 1.8% | 71.1% | 100.0% |
...
| _CHECK_PEP_523 | 17,168,400 | 1.2% | 79.9% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 17,168,400 | 1.2% | 81.2% |  |
| _CHECK_STACK_SPACE | 17,168,400 | 1.2% | 82.4% |  |
| _INIT_CALL_PY_EXACT_ARGS | 17,168,400 | 1.2% | 83.6% |  |
| _PUSH_FRAME | 17,168,400 | 1.2% | 84.9% |  |
| _SAVE_RETURN_OFFSET | 17,168,400 | 1.2% | 86.1% |  |
| PUSH_NULL | 17,166,840 | 1.2% | 87.3% |  |
| LOAD_CONST | 14,928,320 | 1.1% | 88.4% |  |
| BUILD_LIST | 13,434,840 | 1.0% | 89.4% |  |
| CALL_INTRINSIC_1 | 13,434,840 | 1.0% | 90.3% |  |
| LIST_EXTEND | 13,434,840 | 1.0% | 91.3% |  |
| RESUME_CHECK | 13,434,840 | 1.0% | 92.3% |  |
| _GUARD_IS_TRUE_POP | 7,464,120 | 0.5% | 92.8% | 0.0% |
| _GUARD_GLOBALS_VERSION | 7,464,120 | 0.5% | 93.4% |  |
| _LOAD_GLOBAL_MODULE | 7,464,120 | 0.5% | 93.9% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 4,478,580 | 0.3% | 94.2% | 16.7% |
| _ITER_CHECK_TUPLE | 4,478,580 | 0.3% | 94.5% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 4,478,560 | 0.3% | 94.9% | 16.7% |
| _ITER_CHECK_LIST | 4,478,560 | 0.3% | 95.2% |  |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 3,733,560 | 0.3% | 95.4% |  |
| _GUARD_KEYS_VERSION | 3,733,560 | 0.3% | 95.7% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 3,733,560 | 0.3% | 96.0% |  |
| CONTAINS_OP | 3,732,120 | 0.3% | 96.2% |  |
| _GUARD_BOTH_INT | 3,732,120 | 0.3% | 96.5% |  |
| _BINARY_OP_SUBTRACT_INT | 3,732,120 | 0.3% | 96.8% |  |
| _ITER_NEXT_LIST | 3,732,120 | 0.3% | 97.1% |  |
| _ITER_NEXT_TUPLE | 3,732,120 | 0.3% | 97.3% |  |
| BINARY_SUBSCR_LIST_INT | 3,732,080 | 0.3% | 97.6% |  |
| COMPARE_OP_FLOAT | 3,732,080 | 0.3% | 97.9% |  |
