...
| RESUME_CHECK | 3,160 | 2.6% | 49.3% |  |
| LOAD_GLOBAL | 3,140 | 2.6% | 51.9% |  |
| LOAD_FAST_LOAD_FAST | 3,020 | 2.5% | 54.4% |  |
| LOAD_GLOBAL_BUILTIN | 3,000 | 2.5% | 56.9% | 26.7% |
| POP_TOP | 2,660 | 2.2% | 59.2% |  |
| LOAD_ATTR_INSTANCE_VALUE | 2,420 | 2.0% | 61.2% |  |
| LOAD_ATTR_MODULE | 2,260 | 1.9% | 63.1% |  |
| RETURN_VALUE | 2,180 | 1.8% | 64.9% |  |
| STORE_ATTR_INSTANCE_VALUE | 2,120 | 1.8% | 66.6% |  |
| PUSH_NULL | 2,080 | 1.7% | 68.4% |  |
| TO_BOOL | 2,040 | 1.7% | 70.1% |  |
...
| POP_JUMP_IF_NONE | 880 | 0.7% | 82.5% |  |
| CALL_BUILTIN_FAST | 880 | 0.7% | 83.2% |  |
| COMPARE_OP | 860 | 0.7% | 84.0% |  |
| POP_JUMP_IF_TRUE | 840 | 0.7% | 84.7% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 2,720 | 2.3% | 7.0% |
| LOAD_FAST LOAD_ATTR | 2,340 | 2.0% | 9.0% |
| LOAD_FAST LOAD_CONST | 2,340 | 2.0% | 11.0% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 1,820 | 1.5% | 12.5% |
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 1,600 | 1.3% | 13.8% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 1,500 | 1.3% | 15.1% |
...
| PUSH_NULL LOAD_FAST | 1,280 | 1.1% | 19.8% |
...
| LOAD_GLOBAL LOAD_GLOBAL_MODULE | 980 | 0.8% | 27.4% |
| POP_TOP LOAD_FAST | 960 | 0.8% | 28.2% |
| LOAD_CONST STORE_FAST | 960 | 0.8% | 29.0% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 940 | 0.8% | 29.8% |
| TO_BOOL POP_JUMP_IF_FALSE | 900 | 0.8% | 30.5% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST | 900 | 0.8% | 31.3% |
| CACHE RESUME_CHECK | 880 | 0.7% | 32.0% |
...
| LOAD_FAST LOAD_GLOBAL | 500 | 0.4% | 46.9% |
...
| TO_BOOL TO_BOOL_BOOL | 460 | 0.4% | 51.0% |
| COMPARE_OP POP_JUMP_IF_FALSE | 460 | 0.4% | 51.3% |
| LOAD_GLOBAL LOAD_FAST | 440 | 0.4% | 51.7% |
| LOAD_GLOBAL_BUILTIN CALL_ISINSTANCE | 440 | 0.4% | 52.1% |
| CALL POP_TOP | 420 | 0.4% | 52.4% |
| POP_JUMP_IF_FALSE LOAD_GLOBAL | 420 | 0.4% | 52.8% |
| POP_TOP RETURN_CONST | 400 | 0.3% | 53.1% |
| LOAD_ATTR PUSH_NULL | 400 | 0.3% | 53.4% |
| LOAD_FAST_LOAD_FAST BUILD_TUPLE | 400 | 0.3% | 53.8% |
| POP_JUMP_IF_FALSE RETURN_CONST | 400 | 0.3% | 54.1% |
| STORE_FAST LOAD_CONST | 400 | 0.3% | 54.4% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST | 400 | 0.3% | 54.8% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 400 | 0.3% | 55.1% |
| COMPARE_OP COMPARE_OP_INT | 380 | 0.3% | 55.4% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 380 | 0.3% | 55.7% |
| TO_BOOL_STR POP_JUMP_IF_FALSE | 380 | 0.3% | 56.1% |
| CALL CALL | 360 | 0.3% | 56.4% |
| CALL_METHOD_DESCRIPTOR_FAST STORE_FAST | 360 | 0.3% | 56.7% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 360 | 0.3% | 57.0% |
| LOAD_ATTR LOAD_ATTR | 340 | 0.3% | 57.2% |
| STORE_ATTR_INSTANCE_VALUE RETURN_CONST | 340 | 0.3% | 57.5% |
| DELETE_ATTR LOAD_FAST | 320 | 0.3% | 57.8% |
| DICT_MERGE CALL_FUNCTION_EX | 320 | 0.3% | 58.1% |
| LOAD_CONST CALL_KW | 320 | 0.3% | 58.3% |
| LOAD_FAST COPY | 320 | 0.3% | 58.6% |
| LOAD_FAST TO_BOOL_STR | 320 | 0.3% | 58.9% |
| POP_JUMP_IF_NONE LOAD_CONST | 320 | 0.3% | 59.1% |
| RETURN_CONST STORE_FAST | 320 | 0.3% | 59.4% |
| STORE_FAST NOP | 320 | 0.3% | 59.7% |
| CALL STORE_FAST | 300 | 0.3% | 59.9% |
| STORE_ATTR LOAD_FAST | 300 | 0.3% | 60.2% |
| RESUME LOAD_FAST | 300 | 0.3% | 60.4% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 300 | 0.3% | 60.7% |
| CALL LOAD_CONST | 280 | 0.2% | 60.9% |
| LOAD_ATTR TO_BOOL | 280 | 0.2% | 61.1% |
| LOAD_ATTR LOAD_FAST | 280 | 0.2% | 61.4% |
...
| Frees | 11,119 |  |
| New values | 200 |  |
| Interpreter increfs | 40,400 | 59.8% |
| Interpreter decrefs | 49,000 | 60.4% |
| Increfs | 27,151 | 40.2% |
| Decrefs | 32,085 | 39.6% |
...
| Method cache hits | 7,407 |  |
| Method cache misses | 1,573 |  |
| Method cache collisions | 1,482 |  |
| Method cache dunder hits | 2,223 |  |
