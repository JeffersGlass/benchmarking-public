...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,215,888 | 20.8% | 20.8% |  |
| LOAD_CONST | 39,087,356 | 16.2% | 36.9% |  |
| CALL_PY_EXACT_ARGS | 19,640,732 | 8.1% | 45.0% |  |
...
| LOAD_GLOBAL_MODULE | 10,294,136 | 4.3% | 89.4% |  |
| LOAD_GLOBAL | 9,774,140 | 4.0% | 93.5% |  |
| BINARY_OP_ADD_INT | 9,717,500 | 4.0% | 97.5% |  |
| STORE_FAST | 673,004 | 0.3% | 97.8% |  |
| POP_JUMP_IF_FALSE | 413,424 | 0.2% | 97.9% |  |
| LOAD_ATTR_MODULE | 387,248 | 0.2% | 98.1% | 3.2% |
...
| LOAD_ATTR_METHOD_NO_DICT | 176,152 | 0.1% | 99.0% |  |
| NOP | 174,460 | 0.1% | 99.0% |  |
| LOAD_FAST_LOAD_FAST | 166,940 | 0.1% | 99.1% |  |
| ENTER_EXECUTOR | 155,043 | 0.1% | 99.2% |  |
| POP_JUMP_IF_TRUE | 143,523 | 0.1% | 99.2% |  |
...
| STORE_FAST_STORE_FAST | 31,912 | 0.0% | 99.7% |  |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 16,432 | 0.0% | 99.9% |  |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,916 | 0.1% | 96.6% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 183,492 | 0.1% | 97.0% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 173,460 | 0.1% | 97.1% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 167,792 | 0.1% | 97.2% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 163,740 | 0.1% | 97.3% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 161,920 | 0.1% | 97.3% |
| POP_JUMP_IF_FALSE LOAD_FAST | 157,552 | 0.1% | 97.4% |
| LOAD_FAST CALL | 154,740 | 0.1% | 97.5% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,344 | 0.0% | 98.2% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 51,372 | 0.0% | 98.5% |
...
| LOAD_ATTR_MODULE LOAD_ATTR_MODULE | 43,752 | 0.0% | 98.9% |
...
| LOAD_CONST | 1,932 | 9.8% |
| LOAD_ATTR_INSTANCE_VALUE | 1,020 | 5.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 16,212 | 82.5% |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 5,112 | 8.5% |
| NOP | 1,540 | 2.6% |
| FOR_ITER | 1,080 | 1.8% |
...
| CALL_PY_EXACT_ARGS | 167,792 | 0.3% |
| CALL | 154,740 | 0.3% |
...
| COMPARE_OP_STR | 19,152 | 4.6% |
| CONTAINS_OP | 16,212 | 3.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 157,552 | 38.1% |
| RETURN_CONST | 66,560 | 16.1% |
| LOAD_FAST_LOAD_FAST | 64,580 | 15.6% |
| LOAD_GLOBAL_MODULE | 51,372 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 15,452 | 48.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,916 | 80.0% |
| LOAD_ATTR_MODULE | 43,752 | 11.3% |
...
| LOAD_FAST | 66,344 | 17.1% |
| LOAD_ATTR_MODULE | 43,752 | 11.3% |
| LOAD_CONST | 14,952 | 3.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 183,492 | 56.9% |
| CALL | 54,440 | 16.9% |
| CACHE | 38,640 | 12.0% |
| POP_TOP | 13,060 | 4.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 15,452 | 94.0% |
| STORE_FAST | 980 | 6.0% |
...
|---|---:|---:|
| Basic | 150,029,467 | 62.0% |
| Not specialized | 10,888,772 | 4.5% |
| Specialized hits | 81,048,544 | 33.5% |
...
| Calls to Python functions inlined | 19,716,632 | 99.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 737,360 | 1.8% |
| Frees to freelist | 734,400 |  |
| Allocations | 40,944,740 | 98.2% |
| Allocations to 512 bytes | 40,932,620 | 98.2% |
| Allocations to 4 kbytes | 7,080 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,922,623 |  |
| New values | 1,420 |  |
| Interpreter increfs | 44,075,383 | 15.8% |
| Interpreter decrefs | 64,424,863 | 24.5% |
| Increfs | 235,609,721 | 84.2% |
| Decrefs | 198,434,133 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,528,841 |  |
| Method cache misses | 11,139 |  |
| Method cache collisions | 10,367 |  |
| Method cache dunder hits | 175,991 |  |
| Method cache dunder misses | 1,249 |  |
...
| Traces executed | 155,043 |  |
| Uops executed | 8,798,317 | 56.75 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,144,152 | 24.4% | 24.4% |  |
| _SET_IP | 1,295,948 | 14.7% | 39.1% |  |
| _CHECK_VALIDITY | 1,236,336 | 14.1% | 53.2% |  |
| STORE_FAST | 828,572 | 9.4% | 62.6% |  |
| _GUARD_IS_FALSE_POP | 411,376 | 4.7% | 67.2% | 0.3% |
| _FOR_ITER_TIER_TWO | 372,820 | 4.2% | 71.5% | 12.5% |
| UNPACK_SEQUENCE_TWO_TUPLE | 326,768 | 3.7% | 75.2% |  |
| _JUMP_TO_TOP | 324,957 | 3.7% | 78.9% |  |
| CONTAINS_OP | 324,236 | 3.7% | 82.6% |  |
| STORE_SUBSCR_DICT | 320,660 | 3.6% | 86.2% |  |
| _GUARD_TYPE_VERSION | 103,648 | 1.2% | 87.4% |  |
| _GUARD_IS_TRUE_POP | 97,928 | 1.1% | 88.5% | 4.7% |
| TO_BOOL_STR | 88,780 | 1.0% | 89.5% |  |
| COMPARE_OP_STR | 85,408 | 1.0% | 90.5% |  |
| _EXIT_TRACE | 81,368 | 0.9% | 91.4% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,408 | 0.9% | 92.3% |  |
| _GUARD_GLOBALS_VERSION | 73,104 | 0.8% | 93.1% | 0.1% |
| _LOAD_GLOBAL_MODULE | 58,604 | 0.7% | 93.8% |  |
...
| LOAD_CONST | 13,704 | 0.2% | 97.9% |  |
| _CHECK_PEP_523 | 13,688 | 0.2% | 98.1% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 13,688 | 0.2% | 98.2% |  |
| _CHECK_STACK_SPACE | 13,688 | 0.2% | 98.4% |  |
| _INIT_CALL_PY_EXACT_ARGS | 13,688 | 0.2% | 98.5% |  |
| _PUSH_FRAME | 13,688 | 0.2% | 98.7% |  |
| _SAVE_RETURN_OFFSET | 13,688 | 0.2% | 98.9% |  |
| RESUME_CHECK | 12,380 | 0.1% | 99.0% |  |
| TO_BOOL_BOOL | 8,140 | 0.1% | 99.1% |  |
| _POP_FRAME | 8,140 | 0.1% | 99.2% |  |
| _CHECK_ATTR_MODULE | 7,732 | 0.1% | 99.3% | 44.5% |
| PUSH_NULL | 7,240 | 0.1% | 99.3% |  |
| _LOAD_ATTR | 6,060 | 0.1% | 99.4% |  |
| CALL_BUILTIN_CLASS | 5,680 | 0.1% | 99.5% |  |
| CALL_ISINSTANCE | 4,300 | 0.0% | 99.5% |  |
| _LOAD_ATTR_MODULE | 4,292 | 0.0% | 99.6% |  |
| CALL_BUILTIN_FAST | 3,820 | 0.0% | 99.6% |  |
| LIST_APPEND | 3,160 | 0.0% | 99.7% |  |
