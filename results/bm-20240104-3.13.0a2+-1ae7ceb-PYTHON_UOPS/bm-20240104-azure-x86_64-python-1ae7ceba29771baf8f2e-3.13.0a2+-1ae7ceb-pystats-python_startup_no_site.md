...
| LOAD_ATTR_MODULE | 7,300 | 2.3% | 55.0% |  |
| POP_TOP | 7,280 | 2.3% | 57.3% |  |
| CALL | 7,220 | 2.3% | 59.5% |  |
| STORE_ATTR_INSTANCE_VALUE | 6,740 | 2.1% | 61.7% |  |
| RETURN_VALUE | 5,960 | 1.9% | 63.6% |  |
| TO_BOOL_BOOL | 5,920 | 1.9% | 65.4% |  |
| PUSH_NULL | 5,720 | 1.8% | 67.3% |  |
| LOAD_ATTR | 5,440 | 1.7% | 69.0% |  |
...
| TO_BOOL | 3,140 | 1.0% | 79.7% |  |
| LOAD_GLOBAL | 3,140 | 1.0% | 80.6% |  |
| CALL_BUILTIN_FAST | 2,700 | 0.9% | 81.5% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 2,480 | 0.8% | 82.3% |  |
...
| CACHE RESUME_CHECK | 2,700 | 0.9% | 30.8% |
...
| LOAD_GLOBAL_BUILTIN CALL_ISINSTANCE | 1,420 | 0.4% | 45.9% |
| PUSH_NULL CALL | 1,360 | 0.4% | 46.3% |
| LOAD_FAST DELETE_ATTR | 1,320 | 0.4% | 46.7% |
| LOAD_FAST_LOAD_FAST LOAD_FAST_LOAD_FAST | 1,320 | 0.4% | 47.1% |
| POP_JUMP_IF_FALSE LOAD_FAST_LOAD_FAST | 1,320 | 0.4% | 47.6% |
| POP_JUMP_IF_NONE LOAD_FAST | 1,320 | 0.4% | 48.0% |
...
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 1,200 | 0.4% | 50.8% |
...
| TO_BOOL_STR POP_JUMP_IF_FALSE | 1,080 | 0.3% | 53.9% |
...
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 1,000 | 0.3% | 55.2% |
| LOAD_GLOBAL LOAD_GLOBAL_MODULE | 980 | 0.3% | 55.5% |
...
| Frees | 25,472 |  |
| New values | 480 |  |
| Interpreter increfs | 113,200 | 66.1% |
...
| Method cache hits | 15,310 |  |
| Method cache misses | 2,030 |  |
| Method cache collisions | 1,903 |  |
| Method cache dunder hits | 6,357 |  |
