...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,994,730 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,140,436 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,137,358 | 5.3% | 29.1% |  |
| RESUME_CHECK | 865,480 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,440 | 3.8% | 36.8% |  |
| LOAD_ATTR_INSTANCE_VALUE | 775,792 | 3.6% | 40.4% | 0.1% |
| LOAD_GLOBAL_MODULE | 749,260 | 3.5% | 43.9% | 0.1% |
| STORE_FAST | 735,780 | 3.4% | 47.3% |  |
| LOAD_ATTR | 662,620 | 3.1% | 50.4% |  |
| TO_BOOL_BOOL | 641,120 | 3.0% | 53.4% |  |
| LOAD_GLOBAL_BUILTIN | 615,855 | 2.9% | 56.2% | 0.4% |
...
| COMPARE_OP_INT | 247,296 | 1.1% | 74.6% | 0.1% |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 750,872 | 3.5% | 3.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 563,080 | 2.6% | 6.1% |
| LOAD_FAST LOAD_ATTR | 516,760 | 2.4% | 8.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,796 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 244,616 | 1.1% | 22.3% |
...
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 179,200 | 0.8% | 28.1% |
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,136 | 0.8% | 28.9% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,376 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,096 | 0.4% | 54.0% |
...
| LOAD_GLOBAL_BUILTIN | 400,796 | 10.0% |
| LOAD_CONST | 213,298 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 750,872 | 18.8% |
| LOAD_ATTR | 516,760 | 12.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 461,920 | 40.5% |
| COMPARE_OP_INT | 244,616 | 21.4% |
| IS_OP | 129,260 | 11.3% |
...
| LOAD_GLOBAL_BUILTIN | 179,136 | 15.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 102,376 | 53.2% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,176 | 8.2% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 244,616 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,136 | 29.1% |
...
|---|---:|---:|
| Basic | 10,678,168 | 49.5% |
| Not specialized | 3,503,914 | 16.2% |
| Specialized hits | 7,322,641 | 33.9% |
...
| Allocations | 1,597,470 | 67.3% |
| Allocations to 512 bytes | 1,407,261 | 59.3% |
| Allocations to 4 kbytes | 132,406 | 5.6% |
| Allocations over 4 kbytes | 57,803 | 2.4% |
| Frees | 1,536,569 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,353,159 | 76.8% |
| Interpreter decrefs | 14,169,032 | 78.3% |
| Increfs | 3,735,710 | 23.2% |
| Decrefs | 3,922,431 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,219,340 |  |
| Method cache misses | 40,960 |  |
| Method cache collisions | 47,528 |  |
| Method cache dunder hits | 354,734 |  |
| Method cache dunder misses | 9,046 |  |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 27,120 | 0.3% | 96.8% |  |
