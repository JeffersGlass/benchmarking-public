...
| POP_JUMP_IF_FALSE | 94,819,720 | 5.6% | 32.8% |  |
...
| STORE_FAST | 49,296,360 | 2.9% | 66.1% |  |
...
| LOAD_ATTR_METHOD_NO_DICT | 27,626,800 | 1.6% | 83.2% |  |
| CALL_METHOD_DESCRIPTOR_O | 27,620,140 | 1.6% | 84.8% | 0.0% |
| POP_JUMP_IF_NOT_NONE | 25,383,160 | 1.5% | 86.3% |  |
| TO_BOOL_NONE | 24,634,160 | 1.4% | 87.8% |  |
| LOAD_GLOBAL_MODULE | 23,148,420 | 1.4% | 89.1% |  |
...
| TO_BOOL | 11,205,020 | 0.7% | 94.3% |  |
| POP_JUMP_IF_TRUE | 9,708,340 | 0.6% | 94.9% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 9,707,000 | 0.6% | 95.4% | 0.0% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 68,683,900 | 4.0% | 15.4% |
...
| POP_TOP LOAD_FAST | 38,074,440 | 2.2% | 27.5% |
| LOAD_CONST LOAD_FAST | 37,327,780 | 2.2% | 29.7% |
| STORE_FAST LOAD_FAST | 34,355,280 | 2.0% | 31.7% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 34,349,280 | 2.0% | 33.7% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 27,623,980 | 1.6% | 45.5% |
...
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL | 11,199,120 | 0.7% | 72.0% |
| LOAD_CONST STORE_FAST | 10,458,960 | 0.6% | 72.6% |
| POP_JUMP_IF_FALSE LOAD_CONST | 10,454,480 | 0.6% | 73.2% |
| POP_TOP LOAD_CONST | 10,453,220 | 0.6% | 73.9% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 10,452,980 | 0.6% | 74.5% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 9,708,640 | 0.6% | 75.0% |
...
| LOAD_FAST LOAD_CONST | 5,974,380 | 0.3% | 86.1% |
| GET_AWAITABLE LOAD_CONST | 5,972,080 | 0.3% | 86.5% |
| TO_BOOL_LIST POP_JUMP_IF_FALSE | 5,228,660 | 0.3% | 86.8% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_LIST | 5,228,580 | 0.3% | 87.1% |
| PUSH_NULL CALL | 5,228,340 | 0.3% | 87.4% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 5,227,220 | 0.3% | 87.7% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_WITH_VALUES | 5,227,160 | 0.3% | 88.0% |
| CALL POP_TOP | 5,226,120 | 0.3% | 88.3% |
| STORE_ATTR_INSTANCE_VALUE LOAD_CONST | 5,226,060 | 0.3% | 88.6% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 5,225,980 | 0.3% | 88.9% |
| POP_JUMP_IF_NOT_NONE LOAD_GLOBAL_MODULE | 5,225,760 | 0.3% | 89.2% |
| END_SEND POP_TOP | 5,225,600 | 0.3% | 89.5% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NONE | 5,225,580 | 0.3% | 89.8% |
| SEND_GEN POP_TOP | 5,225,500 | 0.3% | 90.2% |
| LOAD_CONST SEND_GEN | 5,225,440 | 0.3% | 90.5% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 4,482,600 | 0.3% | 90.7% |
| STORE_FAST JUMP_FORWARD | 4,482,480 | 0.3% | 91.0% |
| JUMP_FORWARD LOAD_FAST | 4,480,960 | 0.3% | 91.2% |
| LOAD_CONST COMPARE_OP_INT | 4,480,920 | 0.3% | 91.5% |
| TO_BOOL POP_JUMP_IF_TRUE | 4,480,720 | 0.3% | 91.8% |
| LOAD_ATTR LOAD_FAST | 4,479,920 | 0.3% | 92.0% |
...
| POP_JUMP_IF_FALSE | 10,454,480 | 14.6% |
...
| POP_JUMP_IF_FALSE | 68,683,900 | 20.0% |
...
|---|---:|---:|
| Basic | 872,087,080 | 51.0% |
| Not specialized | 216,564,980 | 12.7% |
| Specialized hits | 618,951,140 | 36.2% |
...
| Allocations | 94,277,243 | 65.0% |
| Allocations to 512 bytes | 93,472,180 | 64.4% |
...
| Increfs | 276,218,599 | 20.4% |
| Decrefs | 346,495,068 | 23.4% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 57,498,836 |  |
| Method cache misses | 3,844 |  |
| Method cache collisions | 3,747 |  |
| Method cache dunder hits | 11,198,784 |  |
...
| _EXIT_TRACE | 13,435,840 | 1.8% | 74.5% | 100.0% |
