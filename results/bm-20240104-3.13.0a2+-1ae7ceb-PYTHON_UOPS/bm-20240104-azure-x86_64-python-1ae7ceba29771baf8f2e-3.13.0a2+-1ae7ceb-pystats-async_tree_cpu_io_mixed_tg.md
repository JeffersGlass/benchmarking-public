...
| LOAD_ATTR_INSTANCE_VALUE | 126,218,460 | 6.3% | 25.9% |  |
| POP_JUMP_IF_FALSE | 113,631,500 | 5.6% | 31.6% |  |
| RESUME_CHECK | 107,990,220 | 5.3% | 36.9% | 0.0% |
...
| LOAD_GLOBAL_MODULE | 49,714,860 | 2.5% | 71.3% |  |
...
| COMPARE_OP_INT | 12,366,200 | 0.6% | 91.1% |  |
...
| RESUME_CHECK LOAD_FAST | 82,912,820 | 4.1% | 10.1% |
| POP_JUMP_IF_FALSE LOAD_FAST | 79,694,480 | 3.9% | 14.1% |
...
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 21,289,920 | 1.1% | 55.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 12,366,200 | 0.6% | 67.1% |
...
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL | 11,199,400 | 0.6% | 69.4% |
| POP_JUMP_IF_FALSE LOAD_CONST | 11,024,480 | 0.5% | 70.0% |
| POP_TOP LOAD_CONST | 11,021,180 | 0.5% | 70.5% |
| LOAD_CONST STORE_FAST | 10,838,640 | 0.5% | 71.0% |
...
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 6,718,340 | 0.3% | 84.0% |
...
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 5,605,940 | 0.3% | 85.3% |
| LOAD_GLOBAL_MODULE LOAD_FAST | 5,605,420 | 0.3% | 85.5% |
...
| TO_BOOL_LIST POP_JUMP_IF_FALSE | 5,229,600 | 0.3% | 86.9% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_LIST | 5,229,500 | 0.3% | 87.1% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_WITH_VALUES | 5,227,400 | 0.3% | 87.4% |
| STORE_ATTR_INSTANCE_VALUE LOAD_CONST | 5,226,060 | 0.3% | 87.7% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NONE | 5,225,580 | 0.3% | 87.9% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 4,886,800 | 0.2% | 88.2% |
| PUSH_NULL LOAD_FAST | 4,720,740 | 0.2% | 88.4% |
| LOAD_ATTR LOAD_FAST | 4,669,380 | 0.2% | 88.6% |
| CALL RESUME_CHECK | 4,668,780 | 0.2% | 88.9% |
| STORE_FAST JUMP_FORWARD | 4,482,960 | 0.2% | 89.1% |
| JUMP_FORWARD LOAD_FAST | 4,481,200 | 0.2% | 89.3% |
| TO_BOOL POP_JUMP_IF_TRUE | 4,480,980 | 0.2% | 89.5% |
...
| POP_JUMP_IF_FALSE | 11,024,480 | 12.7% |
...
| POP_JUMP_IF_FALSE | 79,694,480 | 20.0% |
...
|---|---:|---:|
| Basic | 1,016,448,460 | 50.3% |
| Not specialized | 246,642,000 | 12.2% |
| Specialized hits | 752,402,220 | 37.3% |
...
| Allocations | 284,515,409 | 83.2% |
| Allocations to 512 bytes | 281,844,696 | 82.4% |
| Allocations to 4 kbytes | 2,670,582 | 0.8% |
| Allocations over 4 kbytes | 131 | 0.0% |
| Frees | 284,430,370 |  |
| New values | 320 |  |
| Interpreter increfs | 1,212,756,760 | 79.9% |
| Interpreter decrefs | 1,284,313,496 | 69.7% |
| Increfs | 305,409,858 | 20.1% |
| Decrefs | 557,012,662 | 30.3% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 63,543,803 |  |
| Method cache misses | 40,577 |  |
| Method cache collisions | 40,093 |  |
| Method cache dunder hits | 13,658,139 |  |
| Method cache dunder misses | 421 |  |
...
| _EXIT_TRACE | 13,714,920 | 1.7% | 76.3% | 100.0% |
