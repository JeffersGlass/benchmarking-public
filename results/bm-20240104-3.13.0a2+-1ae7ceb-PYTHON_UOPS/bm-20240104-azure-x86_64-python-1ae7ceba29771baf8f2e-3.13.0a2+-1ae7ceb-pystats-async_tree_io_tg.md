...
|---|---:|---:|---:|---:|
| LOAD_FAST | 791,224,080 | 19.6% | 19.6% |  |
| RESUME_CHECK | 247,554,600 | 6.1% | 25.8% | 0.0% |
| POP_JUMP_IF_FALSE | 219,191,080 | 5.4% | 31.2% |  |
...
| LOAD_GLOBAL_MODULE | 121,390,200 | 3.0% | 68.8% |  |
...
| TO_BOOL | 11,205,780 | 0.3% | 97.3% |  |
| SEND | 8,960,780 | 0.2% | 97.5% |  |
| NOP | 8,216,840 | 0.2% | 97.7% |  |
...
| RESUME | 1,980 | 0.0% | 100.0% | 3,757.8% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 151,995,980 | 3.8% | 16.5% |
...
| LOAD_FAST LOAD_GLOBAL_MODULE | 61,664,360 | 1.5% | 34.1% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 60,918,720 | 1.5% | 35.6% |
...
| POP_JUMP_IF_FALSE LOAD_CONST | 21,652,480 | 0.5% | 73.3% |
| POP_TOP LOAD_CONST | 21,650,900 | 0.5% | 73.8% |
...
| LOAD_CONST STORE_FAST | 17,925,120 | 0.4% | 76.4% |
...
| POP_JUMP_IF_FALSE | 21,652,480 | 15.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 151,995,980 | 19.2% |
...
| LOAD_GLOBAL_MODULE | 61,664,360 | 7.8% |
...
|---|---:|---:|
| Basic | 1,953,048,000 | 48.5% |
| Not specialized | 415,606,480 | 10.3% |
| Specialized hits | 1,658,573,436 | 41.2% |
| Specialized misses | 921,304 | 0.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 106,777,307 | 38.1% |
| Frees to freelist | 107,301,300 |  |
| Allocations | 173,513,833 | 61.9% |
| Allocations to 512 bytes | 172,651,702 | 61.6% |
| Allocations to 4 kbytes | 862,020 | 0.3% |
| Allocations over 4 kbytes | 111 | 0.0% |
| Frees | 173,428,861 |  |
| New values | 320 |  |
| Interpreter increfs | 2,600,617,140 | 79.1% |
| Interpreter decrefs | 2,721,358,089 | 77.2% |
| Increfs | 686,845,486 | 20.9% |
| Decrefs | 801,951,759 | 22.8% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 83,716,046 |  |
| Method cache misses | 5,474 |  |
| Method cache collisions | 5,273 |  |
...
|---:|---:|---:|---:|
| 0 | 94,990 | 2,040 | 678,221,764 |
| 1 | 8,640 | 0 | 730,982,710 |
| 2 | 660 | 0 | 2,414,406,732 |
...
| _EXIT_TRACE | 17,168,400 | 1.3% | 77.2% | 100.0% |
