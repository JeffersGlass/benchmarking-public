...
|---|---:|---:|---:|---:|
| LOAD_FAST | 4,890,700 | 16.7% | 16.7% |  |
| LOAD_GLOBAL_MODULE | 2,414,460 | 8.2% | 24.9% |  |
| LOAD_GLOBAL_BUILTIN | 2,393,760 | 8.2% | 33.1% |  |
| POP_JUMP_IF_FALSE | 1,954,620 | 6.7% | 39.8% |  |
| LOAD_FAST_LOAD_FAST | 1,861,320 | 6.4% | 46.1% |  |
...
| LOAD_CONST | 538,440 | 1.8% | 77.5% |  |
| CALL_PY_EXACT_ARGS | 485,580 | 1.7% | 79.2% |  |
| TO_BOOL_INT | 479,780 | 1.6% | 80.8% |  |
| JUMP_FORWARD | 479,700 | 1.6% | 82.5% |  |
| NOP | 476,380 | 1.6% | 84.1% |  |
| CALL | 475,680 | 1.6% | 85.7% |  |
| POP_JUMP_IF_NOT_NONE | 474,780 | 1.6% | 87.3% |  |
...
| ENTER_EXECUTOR | 64,080 | 0.2% | 98.7% |  |
| LOAD_ATTR_INSTANCE_VALUE | 39,200 | 0.1% | 98.9% |  |
| EXTENDED_ARG | 22,040 | 0.1% | 99.0% |  |
...
| IS_OP | 13,580 | 0.0% | 99.2% |  |
| COMPARE_OP_STR | 12,000 | 0.0% | 99.3% | 4.5% |
| POP_JUMP_IF_TRUE | 11,960 | 0.0% | 99.3% |  |
| CALL_LEN | 11,620 | 0.0% | 99.3% |  |
| CONTAINS_OP | 10,820 | 0.0% | 99.4% |  |
| CALL_LIST_APPEND | 10,220 | 0.0% | 99.4% |  |
| BINARY_SUBSCR_LIST_INT | 10,160 | 0.0% | 99.5% | 8.9% |
| UNPACK_SEQUENCE_TWO_TUPLE | 9,380 | 0.0% | 99.5% |  |
| BINARY_OP_ADD_INT | 8,460 | 0.0% | 99.5% |  |
| LOAD_ATTR | 7,780 | 0.0% | 99.5% |  |
| STORE_FAST_STORE_FAST | 7,740 | 0.0% | 99.6% |  |
| INTERPRETER_EXIT | 7,620 | 0.0% | 99.6% |  |
| FOR_ITER_LIST | 7,140 | 0.0% | 99.6% | 3.9% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 996,900 | 3.4% | 9.9% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 972,380 | 3.3% | 13.2% |
...
| STORE_FAST LOAD_GLOBAL_MODULE | 477,100 | 1.6% | 44.2% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 475,440 | 1.6% | 45.8% |
| TO_BOOL_INT POP_JUMP_IF_FALSE | 475,400 | 1.6% | 47.4% |
...
| POP_JUMP_IF_FALSE POP_TOP | 471,980 | 1.6% | 60.3% |
...
| POP_TOP ENTER_EXECUTOR | 49,220 | 0.2% | 96.9% |
...
| LOAD_GLOBAL_MODULE IS_OP | 12,800 | 0.0% | 97.4% |
...
| IS_OP POP_JUMP_IF_FALSE | 10,380 | 0.0% | 97.6% |
...
| EXTENDED_ARG ENTER_EXECUTOR | 6,840 | 0.0% | 98.0% |
...
| UNPACK_SEQUENCE_TWO_TUPLE STORE_FAST_STORE_FAST | 5,980 | 0.0% | 98.3% |
| LOAD_ATTR STORE_FAST | 5,900 | 0.0% | 98.3% |
| LOAD_FAST CALL_LEN | 5,900 | 0.0% | 98.3% |
| LOAD_GLOBAL_MODULE STORE_FAST | 5,840 | 0.0% | 98.3% |
| EXTENDED_ARG POP_JUMP_IF_FALSE | 5,700 | 0.0% | 98.3% |
| PUSH_NULL LOAD_GLOBAL_MODULE | 5,660 | 0.0% | 98.4% |
| ENTER_EXECUTOR POP_JUMP_IF_FALSE | 5,300 | 0.0% | 98.4% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 4,900 | 0.0% | 98.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 471,980 | 48.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 8,000 | 73.9% |
| LOAD_FAST_LOAD_FAST | 2,060 | 19.0% |
| LOAD_CONST | 740 | 6.8% |
| LOAD_GLOBAL | 20 | 0.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 8,380 | 77.4% |
| EXTENDED_ARG | 2,120 | 19.6% |
| RETURN_VALUE | 320 | 3.0% |
...
| POP_JUMP_IF_FALSE | 5,300 | 8.3% |
| EXTENDED_ARG | 3,280 | 5.1% |
| CALL_LIST_APPEND | 2,500 | 3.9% |
| BINARY_SUBSCR_GETITEM | 2,260 | 3.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_FORWARD | 4,040 | 18.3% |
| ENTER_EXECUTOR | 3,280 | 14.9% |
| POP_TOP | 3,220 | 14.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 6,840 | 31.0% |
| POP_JUMP_IF_FALSE | 5,700 | 25.9% |
| JUMP_FORWARD | 4,520 | 20.5% |
| FOR_ITER_LIST | 3,060 | 13.9% |
| FOR_ITER | 1,520 | 6.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| EXTENDED_ARG | 1,520 | 62.3% |
| GET_ITER | 780 | 32.0% |
| JUMP_BACKWARD | 100 | 4.1% |
| FOR_ITER | 20 | 0.8% |
| SWAP | 20 | 0.8% |

|Successors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 1,080 | 44.3% |
| RETURN_CONST | 420 | 17.2% |
| LOAD_FAST | 340 | 13.9% |
| LOAD_GLOBAL_MODULE | 340 | 13.9% |
| STORE_FAST | 60 | 2.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 12,800 | 94.3% |
| LOAD_FAST | 340 | 2.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 10,380 | 76.4% |
| POP_JUMP_IF_TRUE | 3,140 | 23.1% |
| COPY | 40 | 0.3% |
| RETURN_VALUE | 20 | 0.1% |
...
| POP_JUMP_IF_FALSE | 996,900 | 20.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 972,380 | 19.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_INT | 3,820 | 31.9% |
| IS_OP | 3,140 | 26.3% |
| TO_BOOL_BOOL | 2,020 | 16.9% |
| TO_BOOL_STR | 1,340 | 11.2% |
| TO_BOOL_LIST | 600 | 5.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 4,900 | 41.0% |
| ENTER_EXECUTOR | 2,920 | 24.4% |
| CALL_LEN | 1,220 | 10.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 5,980 | 77.3% |
| COPY | 1,160 | 15.0% |
| UNPACK_SEQUENCE_TUPLE | 480 | 6.2% |
| STORE_FAST_STORE_FAST | 80 | 1.0% |
| UNPACK_SEQUENCE | 40 | 0.5% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 4,880 | 63.0% |
| LOAD_FAST_LOAD_FAST | 1,780 | 23.0% |
| STORE_FAST | 400 | 5.2% |
| LOAD_GLOBAL_BUILTIN | 300 | 3.9% |
| NOP | 220 | 2.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| EXTENDED_ARG | 3,060 | 42.9% |
| GET_ITER | 1,900 | 26.6% |
| JUMP_BACKWARD | 1,160 | 16.2% |
| ENTER_EXECUTOR | 960 | 13.4% |
| FOR_ITER | 60 | 0.8% |

|Successors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 3,160 | 44.3% |
| LOAD_GLOBAL_BUILTIN | 1,160 | 16.2% |
| STORE_FAST | 1,080 | 15.1% |
| LOAD_FAST | 520 | 7.3% |
| LOAD_FAST_LOAD_FAST | 380 | 5.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 475,400 | 99.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 4,840 | 51.6% |
| FOR_ITER_LIST | 3,160 | 33.7% |
| FOR_ITER | 1,080 | 11.5% |
| BINARY_SUBSCR_LIST_INT | 260 | 2.8% |
| UNPACK_SEQUENCE | 40 | 0.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 5,980 | 63.8% |
| STORE_FAST | 3,400 | 36.2% |
...
|---|---:|---:|
| Basic | 14,174,980 | 48.4% |
| Not specialized | 2,958,180 | 10.1% |
| Specialized hits | 12,174,980 | 41.5% |
| Specialized misses | 2,700 | 0.0% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| BINARY_SUBSCR_LIST_INT | 900 | 33.3% |
| COMPARE_OP_STR | 540 | 20.0% |
| TO_BOOL_LIST | 360 | 13.3% |
| BINARY_SUBSCR_STR_INT | 340 | 12.6% |
| FOR_ITER_LIST | 280 | 10.4% |
| CALL_BUILTIN_FAST | 160 | 5.9% |
| TO_BOOL_STR | 120 | 4.4% |
| CACHE | 0 | 0.0% |
...
| Frees | 212,081,364 |  |
| New values | 860 |  |
| Interpreter increfs | 12,855,000 | 69.6% |
| Interpreter decrefs | 13,351,920 | 59.9% |
| Increfs | 5,612,517 | 30.4% |
| Decrefs | 8,929,207 | 40.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 8,101 |  |
| Method cache misses | 99 |  |
| Method cache collisions | 192 |  |
| Method cache dunder hits | 960,235 |  |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 241,980 | 22.2% | 22.2% |  |
| STORE_FAST | 131,260 | 12.0% | 34.2% |  |
| _SET_IP | 63,140 | 5.8% | 40.0% |  |
| _CHECK_VALIDITY | 56,600 | 5.2% | 45.2% |  |
| _ITER_CHECK_LIST | 52,620 | 4.8% | 50.1% | 0.2% |
| _GUARD_NOT_EXHAUSTED_LIST | 52,500 | 4.8% | 54.9% | 4.5% |
| _EXIT_TRACE | 52,460 | 4.8% | 59.7% | 100.0% |
| UNPACK_SEQUENCE_TWO_TUPLE | 51,300 | 4.7% | 64.4% |  |
| PUSH_NULL | 50,300 | 4.6% | 69.0% |  |
| _ITER_NEXT_LIST | 50,120 | 4.6% | 73.6% |  |
| _GUARD_TYPE_VERSION | 23,340 | 2.1% | 75.7% |  |
| LOAD_CONST | 19,120 | 1.8% | 77.5% |  |
| _GUARD_IS_FALSE_POP | 16,400 | 1.5% | 79.0% | 17.6% |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 11,980 | 1.1% | 80.1% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 11,980 | 1.1% | 81.2% |  |
| _GUARD_GLOBALS_VERSION | 10,900 | 1.0% | 82.2% |  |
| _LOAD_GLOBAL_MODULE | 10,820 | 1.0% | 83.2% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 10,660 | 1.0% | 84.2% | 10.5% |
| _ITER_CHECK_RANGE | 10,660 | 1.0% | 85.1% |  |
| _ITER_NEXT_RANGE | 9,540 | 0.9% | 86.0% |  |
| CONTAINS_OP | 7,940 | 0.7% | 86.7% |  |
| IS_OP | 7,600 | 0.7% | 87.4% |  |
| _CHECK_PEP_523 | 6,400 | 0.6% | 88.0% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 6,400 | 0.6% | 88.6% |  |
| _CHECK_STACK_SPACE | 6,400 | 0.6% | 89.2% |  |
| _INIT_CALL_PY_EXACT_ARGS | 6,400 | 0.6% | 89.8% |  |
| _PUSH_FRAME | 6,400 | 0.6% | 90.4% |  |
| _SAVE_RETURN_OFFSET | 6,400 | 0.6% | 91.0% |  |
| RESUME_CHECK | 5,960 | 0.5% | 91.5% |  |
| _JUMP_TO_TOP | 5,820 | 0.5% | 92.0% |  |
| POP_TOP | 5,520 | 0.5% | 92.6% |  |
| BINARY_SUBSCR_LIST_INT | 5,440 | 0.5% | 93.1% |  |
| _GUARD_IS_TRUE_POP | 5,360 | 0.5% | 93.5% | 72.0% |
| _POP_FRAME | 5,320 | 0.5% | 94.0% |  |
| _GUARD_DORV_VALUES | 5,320 | 0.5% | 94.5% |  |
| _STORE_ATTR_INSTANCE_VALUE | 5,320 | 0.5% | 95.0% |  |
| _STORE_SUBSCR | 4,720 | 0.4% | 95.4% |  |
| _GUARD_BOTH_INT | 4,400 | 0.4% | 95.8% |  |
| _BINARY_OP_ADD_INT | 3,960 | 0.4% | 96.2% |  |
| _GUARD_IS_NOT_NONE_POP | 3,620 | 0.3% | 96.5% | 9.4% |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 3,140 | 0.3% | 96.8% |  |
| _GUARD_KEYS_VERSION | 3,140 | 0.3% | 97.1% |  |
...
| BINARY_SUBSCR_DICT | 2,480 | 0.2% | 99.4% |  |
| _FOR_ITER_TIER_TWO | 2,420 | 0.2% | 99.7% | 24.0% |
