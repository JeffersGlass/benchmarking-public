...
| LOAD_ATTR_INSTANCE_VALUE | 129,912,992 | 5.9% | 26.1% |  |
| POP_JUMP_IF_FALSE | 125,146,796 | 5.7% | 31.8% |  |
...
| LOAD_ATTR_MODULE | 25,375,416 | 1.1% | 89.3% |  |
| COMPARE_OP_INT | 20,234,836 | 0.9% | 90.2% |  |
...
| LOAD_GLOBAL_BUILTIN | 6,706,332 | 0.3% | 97.3% | 0.0% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 90,950,468 | 4.1% | 9.8% |
| RESUME_CHECK LOAD_FAST | 89,570,076 | 4.0% | 13.8% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 65,294,172 | 2.9% | 16.8% |
...
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_BOOL | 40,682,796 | 1.8% | 30.8% |
| POP_TOP LOAD_FAST | 39,936,636 | 1.8% | 32.6% |
...
| RETURN_CONST POP_TOP | 26,872,656 | 1.2% | 48.1% |
| TO_BOOL_NONE POP_JUMP_IF_FALSE | 26,498,000 | 1.2% | 49.3% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 25,374,296 | 1.1% | 50.5% |
| LOAD_ATTR_MODULE PUSH_NULL | 24,255,996 | 1.1% | 51.6% |
...
| RETURN_VALUE STORE_FAST | 19,035,268 | 0.9% | 60.1% |
...
| LOAD_CONST COMPARE_OP_INT | 11,946,028 | 0.5% | 69.0% |
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 11,945,020 | 0.5% | 69.5% |
| POP_JUMP_IF_NONE LOAD_FAST | 11,943,920 | 0.5% | 70.0% |
| POP_JUMP_IF_FALSE LOAD_CONST | 11,573,636 | 0.5% | 70.6% |
| POP_TOP LOAD_CONST | 11,570,348 | 0.5% | 71.1% |
| LOAD_CONST STORE_FAST | 11,204,700 | 0.5% | 71.6% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL | 11,199,388 | 0.5% | 72.1% |
| LOAD_GLOBAL_MODULE LOAD_FAST | 11,197,900 | 0.5% | 72.6% |
| STORE_ATTR_SLOT LOAD_FAST | 11,194,288 | 0.5% | 73.1% |
...
| PUSH_NULL CALL | 6,345,468 | 0.3% | 83.6% |
...
| TO_BOOL_LIST POP_JUMP_IF_FALSE | 5,229,564 | 0.2% | 85.7% |
...
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 4,833,808 | 0.2% | 88.0% |
...
| POP_JUMP_IF_FALSE | 148 | 0.0% |
| POP_TOP | 100 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 4,481,188 | 100.0% |
...
| POP_JUMP_IF_FALSE | 11,573,636 | 11.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 65,294,172 | 52.2% |
| TO_BOOL_NONE | 26,498,000 | 21.2% |
| COMPARE_OP_INT | 20,234,836 | 16.2% |
| TO_BOOL | 6,719,520 | 5.4% |
| TO_BOOL_LIST | 5,229,564 | 4.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 90,950,468 | 72.7% |
| RETURN_CONST | 16,047,360 | 12.8% |
| LOAD_CONST | 11,573,636 | 9.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 25,374,296 | 100.0% |
| LOAD_ATTR | 1,000 | 0.0% |
| LOAD_FAST | 120 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| PUSH_NULL | 24,255,996 | 95.6% |
| IS_OP | 746,460 | 2.9% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 36,952,608 | 22.3% |
|          hit | 128,463,736 | 77.6% |
|         miss | 761,180 | 0.5% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 34,272,588 | 10.6% |
|          hit | 290,061,652 | 89.4% |
|         miss | 688,020 | 0.2% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 11,201,988 | 9.8% |
|          hit | 102,993,084 | 90.2% |
|         miss | 1,480 | 0.0% |
...
|---|---:|---:|
| Basic | 1,122,696,396 | 50.7% |
| Not specialized | 261,813,732 | 11.8% |
| Specialized hits | 823,303,821 | 37.2% |
| Specialized misses | 6,175,591 | 0.3% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| CALL | 36,952,608 | 41.2% |
| LOAD_ATTR | 34,272,588 | 38.2% |
| TO_BOOL | 11,201,988 | 12.5% |
...
| Calls to Python functions inlined | 73,524,972 | 58.6% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 56,534,655 | 34.8% |
| Frees to freelist | 56,875,160 |  |
| Allocations | 105,708,853 | 65.2% |
| Allocations to 512 bytes | 104,900,137 | 64.7% |
| Allocations to 4 kbytes | 808,588 | 0.5% |
| Allocations over 4 kbytes | 128 | 0.0% |
| Frees | 105,623,757 |  |
| New values | 320 |  |
| Interpreter increfs | 1,291,731,932 | 79.4% |
| Interpreter decrefs | 1,362,328,794 | 77.0% |
| Increfs | 334,546,592 | 20.6% |
| Decrefs | 405,995,948 | 23.0% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 68,750,675 |  |
| Method cache misses | 476,205 |  |
| Method cache collisions | 475,986 |  |
| Method cache dunder hits | 16,402,084 |  |
| Method cache dunder misses | 436 |  |
...
|---:|---:|---:|---:|
| 0 | 55,348 | 2,040 | 378,645,594 |
| 1 | 5,021 | 0 | 392,501,250 |
| 2 | 452 | 0 | 1,016,702,490 |
...
| Uops executed | 821,206,204 | 54.18 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 113,516,660 | 13.8% | 13.8% |  |
| _CHECK_VALIDITY | 105,302,764 | 12.8% | 26.6% |  |
| _GUARD_TYPE_VERSION | 91,782,264 | 11.2% | 37.8% | 0.4% |
| LOAD_FAST | 86,533,072 | 10.5% | 48.4% |  |
| _LOAD_ATTR_SLOT | 40,670,268 | 5.0% | 53.3% |  |
| STORE_FAST | 25,598,396 | 3.1% | 56.4% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 22,008,880 | 2.7% | 59.1% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 22,008,880 | 2.7% | 61.8% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 20,893,316 | 2.5% | 64.3% |  |
| _GUARD_IS_FALSE_POP | 20,749,844 | 2.5% | 66.9% | 0.2% |
| TO_BOOL_BOOL | 20,149,184 | 2.5% | 69.3% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 14,927,240 | 1.8% | 71.1% | 5.0% |
| _ITER_CHECK_RANGE | 14,927,240 | 1.8% | 72.9% |  |
| _ITER_NEXT_RANGE | 14,179,012 | 1.7% | 74.7% |  |
| _EXIT_TRACE | 13,986,780 | 1.7% | 76.4% | 100.0% |
...
| PUSH_NULL | 10,675,184 | 1.3% | 87.8% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 10,446,892 | 1.3% | 89.0% |  |
| BUILD_LIST | 10,074,592 | 1.2% | 90.3% |  |
| CALL_INTRINSIC_1 | 10,074,592 | 1.2% | 91.5% |  |
| LIST_EXTEND | 10,074,592 | 1.2% | 92.7% |  |
| RESUME_CHECK | 10,074,592 | 1.2% | 93.9% |  |
| _LOAD_ATTR | 10,074,592 | 1.2% | 95.2% |  |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 7,465,668 | 0.9% | 96.1% |  |
| _GUARD_KEYS_VERSION | 7,465,668 | 0.9% | 97.0% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 7,465,668 | 0.9% | 97.9% |  |
| LOAD_CONST | 4,475,852 | 0.5% | 98.4% |  |
...
| CALL_METHOD_DESCRIPTOR_O | 371,832 | 0.0% | 99.7% |  |
| TO_BOOL_LIST | 371,832 | 0.0% | 99.7% |  |
| _GUARD_GLOBALS_VERSION | 371,832 | 0.0% | 99.7% |  |
| _LOAD_GLOBAL_MODULE | 371,832 | 0.0% | 99.8% |  |
| _CHECK_ATTR_MODULE | 371,832 | 0.0% | 99.8% |  |
| _LOAD_ATTR_MODULE | 371,832 | 0.0% | 99.9% |  |
| _STORE_ATTR_SLOT | 371,832 | 0.0% | 99.9% |  |
