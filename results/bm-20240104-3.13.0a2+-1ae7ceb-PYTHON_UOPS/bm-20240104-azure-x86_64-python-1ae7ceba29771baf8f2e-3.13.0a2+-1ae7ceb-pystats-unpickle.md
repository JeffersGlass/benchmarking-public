...
| Increfs | 226,552,326 | 98.9% |
| Decrefs | 315,821,339 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 819,714 |  |
| Method cache misses | 409,746 |  |
| Method cache collisions | 412,614 |  |
| Method cache dunder hits | 816,350 |  |
| Method cache dunder misses | 3,570 |  |
