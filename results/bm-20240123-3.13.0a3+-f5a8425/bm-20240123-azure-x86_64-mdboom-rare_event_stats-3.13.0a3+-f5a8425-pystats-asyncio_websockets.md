...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,754 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,501,928 | 5.6% | 24.2% |  |
| LOAD_ATTR_SLOT | 1,299,760 | 4.8% | 29.0% | 0.4% |
| LOAD_CONST | 1,175,198 | 4.3% | 33.3% |  |
...
| COMPARE_OP_INT | 250,768 | 0.9% | 81.2% | 0.1% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,456 | 3.0% | 6.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,688 | 1.5% | 22.5% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 306,908 | 1.1% | 30.1% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,620 | 1.0% | 31.1% |
| LOAD_FAST LOAD_CONST | 261,080 | 1.0% | 32.0% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 248,088 | 0.9% | 33.0% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 105,848 | 0.4% | 60.2% |
...
| CALL_LEN LOAD_FAST | 92,208 | 0.3% | 63.9% |
...
| LOAD_GLOBAL_BUILTIN | 404,688 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,456 | 16.0% |
...
| LOAD_GLOBAL_BUILTIN | 306,908 | 20.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,848 | 54.0% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,288 | 8.1% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 248,088 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,908 | 41.1% |
...
|---|---:|---:|
| Basic | 13,035,592 | 48.2% |
| Not specialized | 4,447,726 | 16.4% |
| Specialized hits | 9,478,339 | 35.0% |
| Specialized misses | 83,102 | 0.3% |
...
| Allocations | 1,597,161 | 67.3% |
| Allocations to 512 bytes | 1,407,154 | 59.3% |
| Allocations to 4 kbytes | 132,208 | 5.6% |
| Allocations over 4 kbytes | 57,799 | 2.4% |
| Frees | 1,536,772 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,201,479 | 76.6% |
| Interpreter decrefs | 14,017,464 | 78.2% |
| Increfs | 3,725,469 | 23.4% |
| Decrefs | 3,912,320 | 21.8% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,227,601 |  |
| Method cache misses | 33,159 |  |
| Method cache collisions | 37,945 |  |
| Method cache dunder hits | 356,457 |  |
| Method cache dunder misses | 7,323 |  |
