...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,816,740 | 20.6% | 20.6% |  |
...
| CALL | 267,964 | 0.1% | 98.6% |  |
| LOAD_ATTR_METHOD_NO_DICT | 255,560 | 0.1% | 98.7% |  |
...
| STORE_FAST LOAD_FAST | 337,800 | 0.1% | 95.5% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 240,080 | 0.1% | 96.5% |
...
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 192,280 | 0.1% | 97.0% |
| LOAD_FAST CALL | 190,880 | 0.1% | 97.0% |
...
| CALL TO_BOOL_BOOL | 109,720 | 0.0% | 97.6% |
...
|---|---:|---:|
| Basic | 152,617,840 | 61.9% |
| Not specialized | 11,776,724 | 4.8% |
| Specialized hits | 82,237,760 | 33.3% |
...
| Allocations | 40,946,180 | 98.2% |
| Allocations to 512 bytes | 40,934,520 | 98.2% |
| Allocations to 4 kbytes | 6,620 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,923,886 |  |
| New values | 1,420 |  |
| Interpreter increfs | 43,921,620 | 15.7% |
| Interpreter decrefs | 64,272,060 | 24.5% |
| Increfs | 235,612,286 | 84.3% |
| Decrefs | 198,438,063 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,528,835 |  |
| Method cache misses | 11,205 |  |
| Method cache collisions | 10,256 |  |
| Method cache dunder hits | 176,662 |  |
| Method cache dunder misses | 1,278 |  |
