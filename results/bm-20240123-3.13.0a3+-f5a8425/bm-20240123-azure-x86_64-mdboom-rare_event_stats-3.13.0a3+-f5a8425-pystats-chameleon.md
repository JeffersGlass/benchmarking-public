...
| Increfs | 71,165,392 | 11.8% |
| Decrefs | 78,224,427 | 12.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 20 | 20 / 0 !! |
| Method cache hits | 649,861 |  |
| Method cache misses | 239 |  |
| Method cache collisions | 341 |  |
| Method cache dunder hits | 1,930,948 |  |
| Method cache dunder misses | 172 |  |
