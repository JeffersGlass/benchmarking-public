...
| POP_JUMP_IF_FALSE | 197,010,460 | 5.2% | 34.5% |  |
| RESUME_CHECK | 176,022,300 | 4.7% | 39.2% | 0.0% |
| LOAD_GLOBAL_BUILTIN | 143,020,380 | 3.8% | 43.0% | 0.0% |
| STORE_FAST | 115,899,000 | 3.1% | 46.0% |  |
| TO_BOOL_BOOL | 107,425,120 | 2.8% | 48.9% | 0.6% |
...
| POP_JUMP_IF_TRUE | 72,729,660 | 1.9% | 64.8% |  |
| POP_TOP | 69,968,900 | 1.9% | 66.7% |  |
| CALL_ISINSTANCE | 67,819,120 | 1.8% | 68.5% |  |
| ENTER_EXECUTOR | 59,874,440 | 1.6% | 70.1% |  |
...
| FOR_ITER | 19,449,840 | 0.5% | 88.0% |  |
| STORE_FAST_STORE_FAST | 19,277,560 | 0.5% | 88.5% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 18,792,120 | 0.5% | 89.0% |  |
...
| POP_JUMP_IF_NOT_NONE | 7,571,760 | 0.2% | 95.8% |  |
| FOR_ITER_GEN | 7,211,820 | 0.2% | 96.0% |  |
| BUILD_MAP | 6,963,200 | 0.2% | 96.2% |  |
| CALL | 6,751,140 | 0.2% | 96.4% |  |
| TO_BOOL | 6,701,940 | 0.2% | 96.5% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 117,906,940 | 3.1% | 13.0% |
| RESUME_CHECK LOAD_FAST | 99,355,180 | 2.6% | 15.6% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 90,725,760 | 2.4% | 18.0% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 76,220,160 | 2.0% | 20.0% |
...
| LOAD_FAST LOAD_GLOBAL_BUILTIN | 39,672,120 | 1.0% | 30.1% |
| POP_JUMP_IF_TRUE LOAD_FAST | 39,432,280 | 1.0% | 31.1% |
...
| LOAD_ATTR_METHOD_NO_DICT CALL_METHOD_DESCRIPTOR_NOARGS | 25,487,080 | 0.7% | 44.0% |
...
| RETURN_CONST POP_TOP | 22,906,640 | 0.6% | 46.5% |
...
| POP_TOP LOAD_FAST | 20,273,060 | 0.5% | 51.1% |
...
| RETURN_VALUE INTERPRETER_EXIT | 18,183,680 | 0.5% | 54.6% |
| LOAD_ATTR_SLOT TO_BOOL_ALWAYS_TRUE | 17,900,480 | 0.5% | 55.1% |
| POP_JUMP_IF_TRUE ENTER_EXECUTOR | 17,486,280 | 0.5% | 55.6% |
...
| BINARY_OP_SUBTRACT_INT BINARY_SUBSCR_STR_INT | 13,820,480 | 0.4% | 60.4% |
...
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 12,675,620 | 0.3% | 63.2% |
| LOAD_FAST TO_BOOL_NONE | 12,571,760 | 0.3% | 63.6% |
| LOAD_FAST TO_BOOL_ALWAYS_TRUE | 12,555,700 | 0.3% | 63.9% |
| LOAD_FAST TO_BOOL_BOOL | 12,277,160 | 0.3% | 64.2% |
| CONTAINS_OP POP_JUMP_IF_FALSE | 11,895,340 | 0.3% | 64.5% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 11,050,440 | 0.3% | 66.9% |
| STORE_FAST STORE_FAST | 11,045,680 | 0.3% | 67.2% |
...
| RESUME_CHECK JUMP_BACKWARD_NO_INTERRUPT | 10,837,200 | 0.3% | 69.5% |
...
| LOAD_FAST LOAD_CONST | 10,217,060 | 0.3% | 70.6% |
| POP_TOP RESUME_CHECK | 10,197,860 | 0.3% | 70.9% |
| STORE_FAST LOAD_FAST_LOAD_FAST | 10,197,040 | 0.3% | 71.2% |
| LOAD_ATTR_MODULE CALL_ISINSTANCE | 10,144,340 | 0.3% | 71.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 17,486,280 | 29.2% |
...
| POP_JUMP_IF_TRUE | 1,354,260 | 21.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 9,552,580 | 44.8% |
...
| POP_JUMP_IF_FALSE | 117,906,940 | 14.8% |
...
| COMPARE_OP | 21,885,100 | 11.1% |
| COMPARE_OP_INT | 19,635,320 | 10.0% |
| TO_BOOL_ALWAYS_TRUE | 13,650,200 | 6.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 117,906,940 | 59.8% |
| RETURN_CONST | 21,844,180 | 11.1% |
| LOAD_GLOBAL_BUILTIN | 11,050,440 | 5.6% |
| JUMP_FORWARD | 9,552,580 | 4.8% |
...
|---|---:|---:|
| Basic | 1,747,923,240 | 46.3% |
| Not specialized | 366,431,340 | 9.7% |
| Specialized hits | 1,611,270,660 | 42.6% |
...
| Increfs | 528,882,003 | 21.4% |
| Decrefs | 575,519,991 | 21.0% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 84,648,051 |  |
| Method cache misses | 3,274,209 |  |
| Method cache collisions | 3,607,366 |  |
| Method cache dunder hits | 149,421,577 |  |
| Method cache dunder misses | 346,703 |  |
