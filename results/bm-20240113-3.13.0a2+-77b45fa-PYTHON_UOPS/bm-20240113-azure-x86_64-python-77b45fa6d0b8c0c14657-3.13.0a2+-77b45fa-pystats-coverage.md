...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,216,726 | 20.8% | 20.8% |  |
| LOAD_CONST | 39,087,360 | 16.2% | 36.9% |  |
...
| LOAD_GLOBAL_MODULE | 10,294,110 | 4.3% | 89.4% |  |
| LOAD_GLOBAL | 9,774,140 | 4.0% | 93.5% |  |
| BINARY_OP_ADD_INT | 9,717,500 | 4.0% | 97.5% |  |
| STORE_FAST | 673,068 | 0.3% | 97.8% |  |
| POP_JUMP_IF_FALSE | 414,170 | 0.2% | 97.9% |  |
| LOAD_ATTR_MODULE | 387,210 | 0.2% | 98.1% | 3.2% |
| TO_BOOL_BOOL | 338,748 | 0.1% | 98.2% |  |
| LOAD_GLOBAL_BUILTIN | 327,520 | 0.1% | 98.4% | 0.7% |
| RESUME_CHECK | 322,300 | 0.1% | 98.5% | 2.4% |
| CALL | 268,041 | 0.1% | 98.6% |  |
| PUSH_NULL | 235,920 | 0.1% | 98.7% |  |
| RETURN_VALUE | 199,120 | 0.1% | 98.8% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 177,360 | 0.1% | 98.9% | 0.0% |
| LOAD_ATTR_METHOD_NO_DICT | 176,218 | 0.1% | 98.9% |  |
| NOP | 174,460 | 0.1% | 99.0% |  |
| LOAD_FAST_LOAD_FAST | 166,960 | 0.1% | 99.1% |  |
| ENTER_EXECUTOR | 155,648 | 0.1% | 99.2% |  |
...
| INSTRUMENTED_POP_JUMP_IF_TRUE | 13,488 | 0.0% | 99.9% |  |
...
| INSTRUMENTED_FOR_ITER | 11,328 | 0.0% | 99.9% |  |
| SWAP | 10,080 | 0.0% | 99.9% |  |
| INSTRUMENTED_JUMP_BACKWARD | 10,048 | 0.0% | 99.9% |  |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,890 | 0.1% | 96.6% |
| STORE_FAST LOAD_FAST | 272,758 | 0.1% | 96.7% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 183,480 | 0.1% | 97.0% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 161,988 | 0.1% | 97.3% |
| POP_JUMP_IF_FALSE LOAD_FAST | 157,690 | 0.1% | 97.4% |
| LOAD_FAST CALL | 154,808 | 0.1% | 97.4% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 153,560 | 0.1% | 97.5% |
| STORE_FAST LOAD_GLOBAL_MODULE | 149,870 | 0.1% | 97.6% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 149,058 | 0.1% | 97.6% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 121,620 | 0.1% | 97.7% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 114,120 | 0.0% | 97.7% |
| CALL TO_BOOL_BOOL | 109,788 | 0.0% | 97.8% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,330 | 0.0% | 98.2% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 51,360 | 0.0% | 98.5% |
...
| LOAD_CONST LOAD_CONST | 49,660 | 0.0% | 98.6% |
...
| POP_JUMP_IF_TRUE LOAD_GLOBAL_BUILTIN | 48,140 | 0.0% | 98.7% |
...
| LOAD_ATTR CALL_ISINSTANCE | 31,140 | 0.0% | 98.9% |
...
| LOAD_CONST LOAD_FAST | 23,780 | 0.0% | 99.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 32,000 | 43.0% |
| CACHE | 13,200 | 17.7% |
| RETURN_CONST | 6,900 | 9.3% |
| POP_JUMP_IF_FALSE | 6,120 | 8.2% |
| CALL_BUILTIN_O | 3,640 | 4.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 29,100 | 39.1% |
| RESUME_CHECK | 13,060 | 17.6% |
| LOAD_FAST | 11,380 | 15.3% |
| JUMP_BACKWARD | 6,260 | 8.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 3,520 | 59.3% |
| CALL_BUILTIN_CLASS | 1,180 | 19.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 58,580 | 29.4% |
| CALL_ISINSTANCE | 35,120 | 17.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 46,260 | 29.7% |
| BINARY_OP_INPLACE_ADD_UNICODE | 45,660 | 29.3% |
| POP_TOP | 29,100 | 18.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 6,000 | 89.3% |
| BUILD_TUPLE | 400 | 6.0% |
| CALL_METHOD_DESCRIPTOR_FAST | 320 | 4.8% |

|Successors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 4,280 | 63.7% |
| JUMP_BACKWARD | 2,040 | 30.4% |
| INSTRUMENTED_JUMP_BACKWARD | 400 | 6.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 161,988 | 91.9% |
| LOAD_CONST | 6,430 | 3.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,890 | 80.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 114,120 | 34.8% |
| LOAD_FAST | 99,640 | 30.4% |
...
| INSTRUMENTED_POP_JUMP_IF_TRUE | 7,148 | 2.1% |
...
|---|---:|---:|
| Basic | 150,034,896 | 62.0% |
| Not specialized | 10,889,539 | 4.5% |
| Specialized hits | 81,049,286 | 33.5% |
...
| Frame objects created | 19,430,740 | 98.3% |
| Frames pushed | 19,669,700 | 99.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 738,708 | 1.8% |
| Frees to freelist | 735,748 |  |
| Allocations | 40,950,200 | 98.2% |
| Allocations to 512 bytes | 40,938,080 | 98.2% |
| Allocations to 4 kbytes | 7,080 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,928,816 |  |
| New values | 1,420 |  |
| Interpreter increfs | 44,079,072 | 15.8% |
| Interpreter decrefs | 64,430,220 | 24.5% |
| Increfs | 235,615,410 | 84.2% |
| Decrefs | 198,445,031 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,529,628 |  |
| Method cache misses | 10,352 |  |
| Method cache collisions | 9,727 |  |
| Method cache dunder hits | 177,342 |  |
...
| Traces executed | 155,648 |  |
| Uops executed | 8,836,422 | 56.77 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,149,490 | 24.3% | 24.3% |  |
| _SET_IP | 1,300,780 | 14.7% | 39.0% |  |
| _CHECK_VALIDITY | 1,239,250 | 14.0% | 53.1% |  |
| STORE_FAST | 830,520 | 9.4% | 62.5% |  |
| _GUARD_IS_FALSE_POP | 411,680 | 4.7% | 67.1% | 0.3% |
| _FOR_ITER_TIER_TWO | 373,140 | 4.2% | 71.4% | 12.5% |
| UNPACK_SEQUENCE_TWO_TUPLE | 327,100 | 3.7% | 75.1% |  |
| _JUMP_TO_TOP | 325,912 | 3.7% | 78.7% |  |
| CONTAINS_OP | 324,570 | 3.7% | 82.4% |  |
| STORE_SUBSCR_DICT | 320,980 | 3.6% | 86.0% |  |
| _GUARD_TYPE_VERSION | 103,610 | 1.2% | 87.2% |  |
| _GUARD_IS_TRUE_POP | 97,940 | 1.1% | 88.3% | 4.7% |
| TO_BOOL_STR | 88,780 | 1.0% | 89.3% |  |
| COMPARE_OP_STR | 85,410 | 1.0% | 90.3% |  |
| _EXIT_TRACE | 81,360 | 0.9% | 91.2% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,410 | 0.9% | 92.1% |  |
| _GUARD_GLOBALS_VERSION | 74,390 | 0.8% | 93.0% | 0.1% |
| _ITER_CHECK_LIST | 58,800 | 0.7% | 93.6% | 1.1% |
| _LOAD_GLOBAL_MODULE | 58,630 | 0.7% | 94.3% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 58,140 | 0.7% | 94.9% | 23.0% |
| _ITER_NEXT_LIST | 44,780 | 0.5% | 95.5% |  |
| CALL_METHOD_DESCRIPTOR_O | 42,260 | 0.5% | 95.9% |  |
| UNPACK_SEQUENCE_TUPLE | 42,040 | 0.5% | 96.4% |  |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 20,200 | 0.2% | 96.6% |  |
| _GUARD_KEYS_VERSION | 20,200 | 0.2% | 96.9% |  |
| _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES | 19,520 | 0.2% | 97.1% |  |
| LOAD_DEREF | 16,580 | 0.2% | 97.3% |  |
| _GUARD_BUILTINS_VERSION | 15,700 | 0.2% | 97.5% | 0.3% |
| _LOAD_GLOBAL_BUILTINS | 15,660 | 0.2% | 97.6% |  |
| _CHECK_PEP_523 | 14,980 | 0.2% | 97.8% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 14,980 | 0.2% | 98.0% |  |
| _CHECK_STACK_SPACE | 14,980 | 0.2% | 98.1% |  |
| _INIT_CALL_PY_EXACT_ARGS | 14,980 | 0.2% | 98.3% |  |
| _PUSH_FRAME | 14,980 | 0.2% | 98.5% |  |
| _SAVE_RETURN_OFFSET | 14,980 | 0.2% | 98.6% |  |
| LOAD_CONST | 13,720 | 0.2% | 98.8% |  |
| RESUME_CHECK | 13,660 | 0.2% | 99.0% |  |
| _POP_FRAME | 8,780 | 0.1% | 99.1% |  |
| PUSH_NULL | 8,520 | 0.1% | 99.2% |  |
| TO_BOOL_BOOL | 8,140 | 0.1% | 99.2% |  |
| _CHECK_ATTR_MODULE | 7,770 | 0.1% | 99.3% | 44.3% |
| CALL_BUILTIN_CLASS | 6,960 | 0.1% | 99.4% |  |
| _LOAD_ATTR | 6,060 | 0.1% | 99.5% |  |
| _LOAD_ATTR_MODULE | 4,330 | 0.0% | 99.5% |  |
| CALL_ISINSTANCE | 4,300 | 0.0% | 99.6% |  |
| CALL_BUILTIN_FAST | 3,820 | 0.0% | 99.6% |  |
| LIST_APPEND | 3,800 | 0.0% | 99.7% |  |
