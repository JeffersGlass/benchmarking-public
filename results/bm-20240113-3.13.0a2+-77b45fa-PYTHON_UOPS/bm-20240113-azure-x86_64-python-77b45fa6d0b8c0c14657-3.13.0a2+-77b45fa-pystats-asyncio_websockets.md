...
| LOAD_ATTR_INSTANCE_VALUE | 775,880 | 3.6% | 40.5% | 0.1% |
...
| LOAD_GLOBAL_BUILTIN | 615,779 | 2.9% | 56.2% | 0.4% |
...
| COMPARE_OP_INT | 247,220 | 1.1% | 74.7% | 0.1% |
| LOAD_ATTR_METHOD_NO_DICT | 235,961 | 1.1% | 75.8% | 0.4% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,720 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 244,540 | 1.1% | 22.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,060 | 0.8% | 28.9% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,300 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,020 | 0.4% | 54.0% |
...
| JUMP_FORWARD LOAD_FAST | 56,221 | 0.3% | 67.0% |
...
| LOAD_GLOBAL_BUILTIN | 400,720 | 10.0% |
...
| LOAD_GLOBAL_BUILTIN | 179,060 | 15.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 102,300 | 53.2% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,100 | 8.1% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 244,540 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,060 | 29.1% |
...
|---|---:|---:|
| Basic | 10,671,096 | 49.4% |
| Not specialized | 3,504,178 | 16.2% |
| Specialized hits | 7,322,640 | 33.9% |
| Specialized misses | 83,101 | 0.4% |
...
| Allocations | 1,597,393 | 67.3% |
| Allocations to 512 bytes | 1,407,185 | 59.3% |
| Allocations to 4 kbytes | 132,404 | 5.6% |
| Allocations over 4 kbytes | 57,804 | 2.4% |
| Frees | 1,536,549 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,352,559 | 76.8% |
| Interpreter decrefs | 14,168,336 | 78.3% |
| Increfs | 3,728,603 | 23.2% |
| Decrefs | 3,915,424 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,225,400 |  |
| Method cache misses | 34,900 |  |
| Method cache collisions | 38,274 |  |
| Method cache dunder hits | 357,747 |  |
| Method cache dunder misses | 6,033 |  |
...
| CALL_BUILTIN_FAST | 127,500 | 1.3% | 87.7% |  |
