...
| Increfs | 232,038,596 | 97.8% |
| Decrefs | 246,741,823 | 97.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 5,734,453 |  |
| Method cache misses | 819,267 |  |
| Method cache collisions | 982,350 |  |
| Method cache dunder hits | 7,209,560 |  |
| Method cache dunder misses | 163,240 |  |
