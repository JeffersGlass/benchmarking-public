...
| POP_JUMP_IF_FALSE | 253,524,680 | 5.5% | 36.9% |  |
...
| LOAD_GLOBAL_MODULE | 125,122,200 | 2.7% | 70.1% |  |
...
| STORE_ATTR_INSTANCE_VALUE | 11,946,640 | 0.3% | 97.5% |  |
| POP_JUMP_IF_NONE | 11,944,720 | 0.3% | 97.8% |  |
| TO_BOOL | 11,205,780 | 0.2% | 98.0% |  |
| TO_BOOL_LIST | 8,961,660 | 0.2% | 98.2% |  |
...
| RESUME | 1,980 | 0.0% | 100.0% | 3,757.0% |
...
| LOAD_FAST LOAD_GLOBAL_MODULE | 61,664,360 | 1.3% | 38.6% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 60,918,720 | 1.3% | 39.9% |
| LOAD_ATTR_SLOT LOAD_FAST | 60,916,020 | 1.3% | 41.2% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 58,975,760 | 1.3% | 42.5% |
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 58,230,960 | 1.3% | 43.8% |
...
| POP_TOP LOAD_FAST | 56,737,000 | 1.2% | 51.2% |
...
| POP_JUMP_IF_FALSE LOAD_CONST | 21,652,480 | 0.5% | 71.6% |
| NOP LOAD_FAST | 21,651,200 | 0.5% | 72.1% |
| POP_TOP LOAD_CONST | 21,650,900 | 0.5% | 72.5% |
| PUSH_NULL LOAD_FAST_LOAD_FAST | 21,648,560 | 0.5% | 73.0% |
| BUILD_LIST LOAD_FAST | 21,648,560 | 0.5% | 73.5% |
| POP_TOP JUMP_BACKWARD | 21,648,240 | 0.5% | 73.9% |
| JUMP_BACKWARD FOR_ITER_RANGE | 21,648,200 | 0.5% | 74.4% |
| FOR_ITER_RANGE STORE_FAST | 21,648,200 | 0.5% | 74.9% |
...
| LOAD_FAST LOAD_CONST | 17,171,780 | 0.4% | 79.1% |
...
| GET_AWAITABLE LOAD_CONST | 17,169,520 | 0.4% | 81.7% |
...
| POP_JUMP_IF_FALSE | 21,652,480 | 14.1% |
...
| LOAD_GLOBAL_MODULE | 61,664,360 | 6.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 56,832,160 | 7.6% |
|          hit | 694,341,800 | 92.4% |
|         miss | 93,440 | 0.0% |
...
|---|---:|---:|
| Basic | 2,230,707,720 | 48.2% |
| Not specialized | 463,378,200 | 10.0% |
| Specialized hits | 1,932,436,511 | 41.8% |
| Specialized misses | 988,689 | 0.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 106,777,302 | 38.1% |
| Frees to freelist | 107,301,300 |  |
| Allocations | 173,513,673 | 61.9% |
| Allocations to 512 bytes | 172,651,599 | 61.6% |
| Allocations to 4 kbytes | 861,960 | 0.3% |
| Allocations over 4 kbytes | 114 | 0.0% |
| Frees | 173,428,770 |  |
| New values | 320 |  |
| Interpreter increfs | 2,578,914,760 | 79.0% |
| Interpreter decrefs | 2,699,708,791 | 77.1% |
| Increfs | 686,965,555 | 21.0% |
| Decrefs | 802,018,640 | 22.9% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 83,774,071 |  |
| Method cache misses | 18,129 |  |
| Method cache collisions | 19,989 |  |
| Method cache dunder hits | 75,845,097 |  |
| Method cache dunder misses | 2,503 |  |
...
|---:|---:|---:|---:|
| 0 | 94,985 | 2,040 | 677,879,822 |
| 1 | 8,640 | 0 | 731,062,648 |
| 2 | 660 | 0 | 2,416,303,672 |
