...
|---|---:|---:|---:|---:|
| LOAD_FAST | 26,150,240 | 22.3% | 22.3% |  |
| POP_JUMP_IF_NOT_NONE | 8,256,000 | 7.1% | 29.4% |  |
| CALL | 6,886,140 | 5.9% | 35.3% |  |
| LOAD_FAST_LOAD_FAST | 5,505,680 | 4.7% | 40.0% |  |
| PUSH_NULL | 4,130,880 | 3.5% | 43.5% |  |
| LOAD_ATTR_METHOD_NO_DICT | 4,129,320 | 3.5% | 47.1% |  |
| LOAD_CONST | 4,128,480 | 3.5% | 50.6% |  |
| RESUME_CHECK | 4,128,360 | 3.5% | 54.1% |  |
| RETURN_VALUE | 4,128,320 | 3.5% | 57.6% |  |
| LOAD_GLOBAL_BUILTIN | 4,128,060 | 3.5% | 61.2% |  |
| POP_JUMP_IF_FALSE | 4,128,000 | 3.5% | 64.7% |  |
| STORE_FAST | 2,757,600 | 2.4% | 67.1% |  |
| LOAD_GLOBAL_MODULE | 2,754,800 | 2.4% | 69.4% |  |
| STORE_FAST_STORE_FAST | 2,752,160 | 2.4% | 71.8% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 2,752,100 | 2.4% | 74.1% |  |
| CALL_METHOD_DESCRIPTOR_FAST | 2,752,020 | 2.4% | 76.5% |  |
| POP_JUMP_IF_TRUE | 2,752,000 | 2.4% | 78.8% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 2,751,960 | 2.4% | 81.2% |  |
| TO_BOOL_BOOL | 2,751,960 | 2.4% | 83.5% |  |
| LOAD_ATTR_MODULE | 1,378,620 | 1.2% | 84.7% |  |
| JUMP_BACKWARD | 1,377,280 | 1.2% | 85.9% |  |
| FOR_ITER_LIST | 1,377,260 | 1.2% | 87.1% |  |
| TO_BOOL | 1,376,640 | 1.2% | 88.2% |  |
| POP_TOP | 1,376,280 | 1.2% | 89.4% |  |
| LOAD_ATTR_INSTANCE_VALUE | 1,376,140 | 1.2% | 90.6% |  |
| NOP | 1,376,080 | 1.2% | 91.8% |  |
| BUILD_TUPLE | 1,376,080 | 1.2% | 92.9% |  |
| CALL_KW | 1,376,000 | 1.2% | 94.1% |  |
| CALL_ISINSTANCE | 1,375,980 | 1.2% | 95.3% |  |
| CALL_LEN | 1,375,980 | 1.2% | 96.5% |  |
| CALL_PY_WITH_DEFAULTS | 1,375,980 | 1.2% | 97.6% |  |
...
|---|---:|---:|---:|
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 8,256,000 | 7.1% | 7.1% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 8,256,000 | 7.1% | 14.1% |
| POP_JUMP_IF_FALSE LOAD_FAST | 4,128,000 | 3.5% | 17.6% |
| STORE_FAST LOAD_FAST | 2,754,720 | 2.4% | 20.0% |
| PUSH_NULL LOAD_FAST | 2,752,160 | 2.4% | 22.3% |
| UNPACK_SEQUENCE_TWO_TUPLE STORE_FAST_STORE_FAST | 2,752,100 | 2.4% | 24.7% |
| LOAD_CONST CALL | 2,752,080 | 2.4% | 27.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 2,752,020 | 2.4% | 29.4% |
| LOAD_FAST_LOAD_FAST CALL | 2,752,000 | 2.4% | 31.8% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 2,751,960 | 2.4% | 34.1% |
| CALL LOAD_ATTR_METHOD_NO_DICT | 2,751,920 | 2.4% | 36.5% |
| LOAD_FAST LOAD_GLOBAL_BUILTIN | 2,751,920 | 2.4% | 38.8% |
| POP_JUMP_IF_TRUE LOAD_GLOBAL_MODULE | 2,751,920 | 2.4% | 41.2% |
| LOAD_ATTR_METHOD_NO_DICT CALL_METHOD_DESCRIPTOR_FAST | 2,751,920 | 2.4% | 43.5% |
| LOAD_ATTR_MODULE PUSH_NULL | 1,378,620 | 1.2% | 44.7% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 1,378,520 | 1.2% | 45.9% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 1,377,240 | 1.2% | 47.0% |
| LOAD_FAST CALL | 1,376,200 | 1.2% | 48.2% |
| LOAD_FAST RETURN_VALUE | 1,376,160 | 1.2% | 49.4% |
| RETURN_VALUE RETURN_VALUE | 1,376,080 | 1.2% | 50.6% |
| BUILD_TUPLE RETURN_VALUE | 1,376,080 | 1.2% | 51.8% |
| LOAD_FAST_LOAD_FAST BUILD_TUPLE | 1,376,080 | 1.2% | 52.9% |
| STORE_FAST_STORE_FAST LOAD_FAST | 1,376,080 | 1.2% | 54.1% |
| STORE_FAST_STORE_FAST LOAD_FAST_LOAD_FAST | 1,376,080 | 1.2% | 55.3% |
| RESUME_CHECK LOAD_FAST | 1,376,060 | 1.2% | 56.5% |
| LOAD_FAST TO_BOOL | 1,376,040 | 1.2% | 57.6% |
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 1,376,040 | 1.2% | 58.8% |
| CALL_METHOD_DESCRIPTOR_FAST STORE_FAST | 1,376,040 | 1.2% | 60.0% |
| POP_TOP JUMP_BACKWARD | 1,376,020 | 1.2% | 61.2% |
| TO_BOOL POP_JUMP_IF_TRUE | 1,376,020 | 1.2% | 62.3% |
| NOP LOAD_FAST | 1,376,000 | 1.2% | 63.5% |
| PUSH_NULL LOAD_FAST_LOAD_FAST | 1,376,000 | 1.2% | 64.7% |
| RETURN_VALUE POP_TOP | 1,376,000 | 1.2% | 65.9% |
| RETURN_VALUE UNPACK_SEQUENCE_TWO_TUPLE | 1,376,000 | 1.2% | 67.0% |
| LOAD_CONST CALL_KW | 1,376,000 | 1.2% | 68.2% |
| LOAD_FAST PUSH_NULL | 1,376,000 | 1.2% | 69.4% |
| LOAD_FAST LOAD_CONST | 1,376,000 | 1.2% | 70.6% |
| LOAD_FAST_LOAD_FAST PUSH_NULL | 1,376,000 | 1.2% | 71.7% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 1,376,000 | 1.2% | 72.9% |
| CALL RESUME_CHECK | 1,375,980 | 1.2% | 74.1% |
| CALL_KW RESUME_CHECK | 1,375,980 | 1.2% | 75.3% |
| JUMP_BACKWARD FOR_ITER_LIST | 1,375,980 | 1.2% | 76.4% |
| CALL_METHOD_DESCRIPTOR_FAST LOAD_CONST | 1,375,980 | 1.2% | 77.6% |
| CALL_PY_WITH_DEFAULTS RESUME_CHECK | 1,375,980 | 1.2% | 78.8% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 1,375,980 | 1.2% | 80.0% |
| FOR_ITER_LIST STORE_FAST | 1,375,980 | 1.2% | 81.2% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST_LOAD_FAST | 1,375,980 | 1.2% | 82.3% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_CONST | 1,375,980 | 1.2% | 83.5% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST | 1,375,980 | 1.2% | 84.7% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST_LOAD_FAST | 1,375,980 | 1.2% | 85.9% |
| RESUME_CHECK NOP | 1,375,980 | 1.2% | 87.0% |
| TO_BOOL_STR POP_JUMP_IF_TRUE | 1,375,980 | 1.2% | 88.2% |
| CALL TO_BOOL_BOOL | 1,375,960 | 1.2% | 89.4% |
| CALL UNPACK_SEQUENCE_TWO_TUPLE | 1,375,960 | 1.2% | 90.6% |
| LOAD_FAST CALL_LEN | 1,375,960 | 1.2% | 91.7% |
| LOAD_FAST CALL_PY_WITH_DEFAULTS | 1,375,960 | 1.2% | 92.9% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 1,375,960 | 1.2% | 94.1% |
| LOAD_FAST TO_BOOL_STR | 1,375,960 | 1.2% | 95.3% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 1,375,960 | 1.2% | 96.4% |
...
| POP_JUMP_IF_FALSE | 4,128,000 | 15.8% |
...
|---|---:|---:|
| Basic | 56,437,840 | 48.2% |
| Not specialized | 23,400,640 | 20.0% |
| Specialized hits | 37,166,260 | 31.8% |
...
| Increfs | 128,111,144 | 68.9% |
| Decrefs | 188,768,553 | 74.5% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 4,089 |  |
| Method cache misses | 251 |  |
| Method cache collisions | 198 |  |
| Method cache dunder hits | 390 |  |
| Method cache dunder misses | 10 |  |
