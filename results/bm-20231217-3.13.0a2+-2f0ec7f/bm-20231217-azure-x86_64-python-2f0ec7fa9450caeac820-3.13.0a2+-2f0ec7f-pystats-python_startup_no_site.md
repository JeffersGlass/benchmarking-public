...
| LOAD_GLOBAL_BUILTIN | 9,160 | 2.9% | 47.4% | 20.5% |
| LOAD_FAST_LOAD_FAST | 8,200 | 2.6% | 50.0% |  |
| LOAD_ATTR_INSTANCE_VALUE | 7,880 | 2.5% | 52.5% |  |
| LOAD_ATTR_MODULE | 7,300 | 2.3% | 54.8% |  |
| POP_TOP | 7,280 | 2.3% | 57.1% |  |
| CALL | 7,220 | 2.3% | 59.4% |  |
| STORE_ATTR_INSTANCE_VALUE | 6,740 | 2.1% | 61.6% |  |
| RETURN_VALUE | 5,960 | 1.9% | 63.5% |  |
| PUSH_NULL | 5,720 | 1.8% | 65.3% |  |
| TO_BOOL_BOOL | 5,720 | 1.8% | 67.1% |  |
| LOAD_ATTR | 5,440 | 1.7% | 68.8% |  |
| POP_JUMP_IF_NOT_NONE | 4,620 | 1.5% | 70.3% |  |
| RETURN_CONST | 4,620 | 1.5% | 71.8% |  |
| NOP | 3,960 | 1.3% | 73.0% |  |
| COMPARE_OP_INT | 3,800 | 1.2% | 74.2% |  |
| INTERPRETER_EXIT | 3,600 | 1.1% | 75.4% |  |
| LOAD_ATTR_METHOD_NO_DICT | 3,360 | 1.1% | 76.4% | 13.1% |
| LOAD_DEREF | 3,300 | 1.0% | 77.5% |  |
| CALL_PY_EXACT_ARGS | 3,300 | 1.0% | 78.5% |  |
| TO_BOOL | 3,100 | 1.0% | 79.5% |  |
| LOAD_GLOBAL | 3,100 | 1.0% | 80.5% |  |
| CALL_BUILTIN_FAST | 2,700 | 0.9% | 81.3% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 2,480 | 0.8% | 82.1% |  |
| POP_JUMP_IF_TRUE | 2,460 | 0.8% | 82.9% |  |
| POP_JUMP_IF_NONE | 2,420 | 0.8% | 83.7% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 2,400 | 0.8% | 84.4% |  |
...
| STORE_FAST_STORE_FAST | 1,760 | 0.6% | 87.4% |  |
| BINARY_OP | 1,740 | 0.6% | 88.0% |  |
| BUILD_LIST | 1,320 | 0.4% | 88.4% |  |
| CALL_FUNCTION_EX | 1,320 | 0.4% | 88.8% |  |
...
| TO_BOOL_STR | 1,080 | 0.3% | 91.4% | 20.4% |
...
| COPY_FREE_VARS | 880 | 0.3% | 93.5% |  |
| DICT_MERGE | 880 | 0.3% | 93.8% |  |
| CALL_LEN | 860 | 0.3% | 94.1% |  |
| CALL_METHOD_DESCRIPTOR_O | 800 | 0.3% | 94.3% |  |
...
| STORE_FAST LOAD_GLOBAL_MODULE | 2,680 | 0.9% | 32.4% |
...
| LOAD_FAST CALL_PY_EXACT_ARGS | 1,600 | 0.5% | 43.9% |
| RETURN_VALUE INTERPRETER_EXIT | 1,580 | 0.5% | 44.4% |
| RETURN_CONST INTERPRETER_EXIT | 1,580 | 0.5% | 44.9% |
| TO_BOOL POP_JUMP_IF_FALSE | 1,560 | 0.5% | 45.4% |
| LOAD_GLOBAL_BUILTIN CALL_ISINSTANCE | 1,420 | 0.5% | 45.8% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 1,400 | 0.4% | 46.2% |
| PUSH_NULL CALL | 1,360 | 0.4% | 46.7% |
| LOAD_FAST DELETE_ATTR | 1,320 | 0.4% | 47.1% |
| LOAD_FAST_LOAD_FAST LOAD_FAST_LOAD_FAST | 1,320 | 0.4% | 47.5% |
| POP_JUMP_IF_FALSE LOAD_FAST_LOAD_FAST | 1,320 | 0.4% | 47.9% |
| POP_JUMP_IF_NONE LOAD_FAST | 1,320 | 0.4% | 48.4% |
| RETURN_CONST POP_TOP | 1,320 | 0.4% | 48.8% |
| STORE_FAST STORE_FAST | 1,320 | 0.4% | 49.2% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST | 1,240 | 0.4% | 49.6% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 1,240 | 0.4% | 50.0% |
| LOAD_FAST STORE_ATTR | 1,220 | 0.4% | 50.4% |
| POP_TOP RETURN_CONST | 1,100 | 0.3% | 50.7% |
| LOAD_FAST_LOAD_FAST BUILD_TUPLE | 1,100 | 0.3% | 51.1% |
| POP_JUMP_IF_FALSE RETURN_CONST | 1,100 | 0.3% | 51.4% |
| STORE_FAST LOAD_CONST | 1,100 | 0.3% | 51.8% |
| LOAD_FAST TO_BOOL | 1,080 | 0.3% | 52.1% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 1,080 | 0.3% | 52.4% |
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 1,080 | 0.3% | 52.8% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 1,080 | 0.3% | 53.1% |
| TO_BOOL_STR POP_JUMP_IF_FALSE | 1,080 | 0.3% | 53.5% |
| CALL_METHOD_DESCRIPTOR_FAST STORE_FAST | 1,060 | 0.3% | 53.8% |
| STORE_ATTR_INSTANCE_VALUE RETURN_CONST | 1,040 | 0.3% | 54.1% |
| LOAD_CONST CALL | 1,000 | 0.3% | 54.5% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 1,000 | 0.3% | 54.8% |
| LOAD_GLOBAL LOAD_GLOBAL_MODULE | 960 | 0.3% | 55.1% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_BOOL | 900 | 0.3% | 55.4% |
| LOAD_GLOBAL_MODULE TO_BOOL_BOOL | 900 | 0.3% | 55.6% |
| DELETE_ATTR LOAD_FAST | 880 | 0.3% | 55.9% |
| DICT_MERGE CALL_FUNCTION_EX | 880 | 0.3% | 56.2% |
| LOAD_CONST CALL_KW | 880 | 0.3% | 56.5% |
| LOAD_FAST COPY | 880 | 0.3% | 56.8% |
| LOAD_FAST TO_BOOL_STR | 880 | 0.3% | 57.0% |
| POP_JUMP_IF_NONE LOAD_CONST | 880 | 0.3% | 57.3% |
| RETURN_CONST STORE_FAST | 880 | 0.3% | 57.6% |
| STORE_FAST NOP | 880 | 0.3% | 57.9% |
| CALL POP_TOP | 840 | 0.3% | 58.1% |
| LOAD_FAST CALL_LEN | 840 | 0.3% | 58.4% |
| COPY_FREE_VARS RESUME_CHECK | 820 | 0.3% | 58.7% |
| CALL_BUILTIN_FAST STORE_FAST | 820 | 0.3% | 58.9% |
| LOAD_ATTR_MODULE LOAD_FAST | 820 | 0.3% | 59.2% |
| NOP LOAD_GLOBAL_BUILTIN | 800 | 0.3% | 59.4% |
| CALL_BUILTIN_CLASS STORE_FAST | 800 | 0.3% | 59.7% |
| CALL_PY_WITH_DEFAULTS RESUME_CHECK | 800 | 0.3% | 60.0% |
| LOAD_ATTR_INSTANCE_VALUE CALL_BUILTIN_FAST | 800 | 0.3% | 60.2% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST | 800 | 0.3% | 60.5% |
| TO_BOOL_INT POP_JUMP_IF_FALSE | 800 | 0.3% | 60.7% |
| LOAD_CONST CALL_BUILTIN_FAST | 760 | 0.2% | 61.0% |
| LOAD_FAST CALL_BUILTIN_CLASS | 760 | 0.2% | 61.2% |
| LOAD_GLOBAL_BUILTIN LOAD_GLOBAL_BUILTIN | 760 | 0.2% | 61.4% |
| LOAD_GLOBAL_MODULE LOAD_ATTR | 760 | 0.2% | 61.7% |
| LOAD_FAST TO_BOOL_BOOL | 720 | 0.2% | 61.9% |
| STORE_FAST LOAD_GLOBAL_BUILTIN | 720 | 0.2% | 62.1% |
| LOAD_ATTR_MODULE LOAD_ATTR_MODULE | 720 | 0.2% | 62.4% |
| CALL LOAD_CONST | 700 | 0.2% | 62.6% |
| LOAD_ATTR LOAD_ATTR_INSTANCE_VALUE | 700 | 0.2% | 62.8% |
...
|---|---:|---:|
| CALL | 5,800 | 29.0% |
| LOAD_ATTR | 3,840 | 19.2% |
| LOAD_GLOBAL | 3,420 | 17.1% |
| TO_BOOL | 2,420 | 12.1% |
| BINARY_OP | 1,540 | 7.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 14,900 | 36.6% |
| Frees to freelist | 15,040 |  |
| Allocations | 25,860 | 63.4% |
| Allocations to 512 bytes | 24,980 | 61.3% |
| Allocations to 4 kbytes | 220 | 0.5% |
| Allocations over 4 kbytes | 660 | 1.6% |
| Frees | 25,469 |  |
| New values | 480 |  |
| Interpreter increfs | 112,980 | 65.9% |
...
| Method cache hits | 15,474 |  |
| Method cache misses | 1,866 |  |
| Method cache collisions | 2,212 |  |
| Method cache dunder hits | 5,791 |  |
