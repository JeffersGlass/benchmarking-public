...
| LOAD_ATTR_MODULE | 2,260 | 1.9% | 62.9% |  |
| RETURN_VALUE | 2,180 | 1.8% | 64.8% |  |
| STORE_ATTR_INSTANCE_VALUE | 2,120 | 1.8% | 66.5% |  |
| PUSH_NULL | 2,080 | 1.7% | 68.3% |  |
| TO_BOOL | 2,000 | 1.7% | 70.0% |  |
| TO_BOOL_BOOL | 1,800 | 1.5% | 71.5% |  |
| POP_JUMP_IF_NOT_NONE | 1,680 | 1.4% | 72.9% |  |
| RETURN_CONST | 1,680 | 1.4% | 74.3% |  |
| NOP | 1,440 | 1.2% | 75.5% |  |
| STORE_ATTR | 1,440 | 1.2% | 76.7% |  |
| INTERPRETER_EXIT | 1,360 | 1.1% | 77.8% |  |
| LOAD_DEREF | 1,200 | 1.0% | 78.8% |  |
| COMPARE_OP_INT | 1,140 | 1.0% | 79.8% |  |
| LOAD_ATTR_METHOD_NO_DICT | 1,120 | 0.9% | 80.7% | 14.3% |
| CALL_PY_EXACT_ARGS | 1,060 | 0.9% | 81.6% |  |
| POP_JUMP_IF_TRUE | 920 | 0.8% | 82.4% |  |
| POP_JUMP_IF_NONE | 880 | 0.7% | 83.1% |  |
| CALL_BUILTIN_FAST | 880 | 0.7% | 83.8% |  |
| COMPARE_OP | 860 | 0.7% | 84.6% |  |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 560 | 0.5% | 89.1% |  |
| BUILD_LIST | 480 | 0.4% | 89.5% |  |
| CALL_FUNCTION_EX | 480 | 0.4% | 89.9% |  |
| DELETE_ATTR | 480 | 0.4% | 90.3% |  |
| JUMP_FORWARD | 480 | 0.4% | 90.7% |  |
...
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 1,480 | 1.2% | 15.1% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 1,480 | 1.2% | 16.3% |
| LOAD_FAST CALL | 1,400 | 1.2% | 17.5% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 1,380 | 1.2% | 18.6% |
...
| POP_TOP LOAD_FAST | 960 | 0.8% | 27.3% |
| LOAD_CONST STORE_FAST | 960 | 0.8% | 28.1% |
| LOAD_GLOBAL LOAD_GLOBAL_MODULE | 960 | 0.8% | 28.9% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 940 | 0.8% | 29.7% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST | 900 | 0.8% | 30.4% |
| CACHE RESUME_CHECK | 880 | 0.7% | 31.2% |
| TO_BOOL POP_JUMP_IF_FALSE | 860 | 0.7% | 31.9% |
...
| COMPARE_OP POP_JUMP_IF_FALSE | 460 | 0.4% | 50.9% |
...
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 420 | 0.4% | 52.7% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL | 380 | 0.3% | 55.7% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 380 | 0.3% | 56.0% |
| TO_BOOL_STR POP_JUMP_IF_FALSE | 380 | 0.3% | 56.3% |
| CALL CALL | 360 | 0.3% | 56.6% |
| CALL_METHOD_DESCRIPTOR_FAST STORE_FAST | 360 | 0.3% | 56.9% |
...
| LOAD_FAST COPY | 320 | 0.3% | 58.5% |
| LOAD_FAST TO_BOOL_STR | 320 | 0.3% | 58.8% |
| POP_JUMP_IF_NONE LOAD_CONST | 320 | 0.3% | 59.1% |
| RETURN_CONST STORE_FAST | 320 | 0.3% | 59.4% |
| STORE_FAST NOP | 320 | 0.3% | 59.6% |
| CALL STORE_FAST | 300 | 0.3% | 59.9% |
| STORE_ATTR LOAD_FAST | 300 | 0.3% | 60.1% |
| RESUME LOAD_FAST | 300 | 0.3% | 60.4% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 300 | 0.3% | 60.6% |
| TO_BOOL POP_JUMP_IF_TRUE | 280 | 0.2% | 60.9% |
...
|---|---:|---:|
| CALL | 2,860 | 24.8% |
| LOAD_ATTR | 2,580 | 22.4% |
| LOAD_GLOBAL | 2,340 | 20.3% |
| TO_BOOL | 1,300 | 11.3% |
| STORE_ATTR | 840 | 7.3% |
| BINARY_OP | 560 | 4.9% |
| COMPARE_OP | 540 | 4.7% |
...
| Frees | 11,089 |  |
| New values | 200 |  |
| Interpreter increfs | 40,320 | 59.7% |
| Interpreter decrefs | 48,920 | 60.4% |
| Increfs | 27,187 | 40.3% |
| Decrefs | 32,084 | 39.6% |
...
| Method cache hits | 7,649 |  |
| Method cache misses | 1,331 |  |
| Method cache collisions | 1,467 |  |
| Method cache dunder hits | 1,990 |  |
| Method cache dunder misses | 650 |  |
