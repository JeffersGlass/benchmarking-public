...
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,143,797,540 | 19.9% | 19.9% |  |
| STORE_FAST | 590,727,500 | 5.5% | 25.3% |  |
| LOAD_ATTR_INSTANCE_VALUE | 463,124,600 | 4.3% | 29.6% | 30.2% |
| RESUME_CHECK | 424,294,120 | 3.9% | 33.5% | 0.0% |
| LOAD_FAST_LOAD_FAST | 396,257,680 | 3.7% | 37.2% |  |
| LOAD_CONST | 382,338,780 | 3.5% | 40.7% |  |
...
| CALL_PY_EXACT_ARGS | 261,026,920 | 2.4% | 54.3% | 4.9% |
...
| LOAD_ATTR_METHOD_NO_DICT | 197,025,060 | 1.8% | 64.4% | 0.8% |
| RETURN_VALUE | 196,854,680 | 1.8% | 66.3% |  |
| LOAD_ATTR | 187,907,420 | 1.7% | 68.0% |  |
| POP_JUMP_IF_TRUE | 177,309,800 | 1.6% | 69.6% |  |
| GET_ITER | 164,125,800 | 1.5% | 71.2% |  |
| NOP | 161,434,480 | 1.5% | 72.7% |  |
| CALL_ISINSTANCE | 126,156,980 | 1.2% | 73.8% |  |
| LOAD_GLOBAL_MODULE | 125,738,440 | 1.2% | 75.0% | 0.0% |
...
| LOAD_ATTR_MODULE | 38,516,920 | 0.4% | 92.0% | 0.0% |
...
| STORE_FAST LOAD_FAST | 280,760,120 | 2.6% | 6.2% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 217,329,460 | 2.0% | 8.2% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 210,161,560 | 1.9% | 10.1% |
| RESUME_CHECK LOAD_FAST | 194,879,700 | 1.8% | 11.9% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 122,846,140 | 1.1% | 25.7% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 119,833,640 | 1.1% | 26.8% |
| RETURN_CONST POP_TOP | 113,377,940 | 1.0% | 27.9% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST_LOAD_FAST | 112,164,320 | 1.0% | 28.9% |
| LOAD_FAST LOAD_ATTR | 110,765,400 | 1.0% | 29.9% |
| LOAD_FAST LOAD_CONST | 110,132,460 | 1.0% | 30.9% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 96,713,940 | 0.9% | 31.8% |
| NOP LOAD_FAST | 94,508,380 | 0.9% | 32.7% |
...
| POP_TOP LOAD_FAST | 85,696,820 | 0.8% | 36.0% |
...
| LOAD_FAST LOAD_ATTR_SLOT | 68,424,400 | 0.6% | 40.9% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 66,769,080 | 0.6% | 41.5% |
...
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 64,128,720 | 0.6% | 43.9% |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 38,345,680 | 0.4% | 59.6% |
...
| LOAD_ATTR LOAD_FAST | 30,481,140 | 0.3% | 64.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 280,760,120 | 13.1% |
| RESUME_CHECK | 194,879,700 | 9.1% |
...
| LOAD_ATTR_METHOD_NO_DICT | 119,833,640 | 5.6% |
| LOAD_ATTR | 110,765,400 | 5.2% |
...
| LOAD_FAST_LOAD_FAST | 15,204,860 | 5.8% |
| LOAD_ATTR_INSTANCE_VALUE | 8,236,900 | 3.2% |
| BUILD_LIST | 5,385,360 | 2.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 210,161,560 | 80.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 38,345,680 | 99.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_MODULE | 38,345,680 | 30.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 210,161,560 | 49.5% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 104,821,160 | 11.9% |
|          hit | 772,376,280 | 88.0% |
|         miss | 23,715,140 | 2.7% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 499,520 | 89.0% |
| Failure | 61,540 | 11.0% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 556,674,960 | 37.9% |
|        deopt | 500 | 0.0% |
|          hit | 903,982,160 | 61.6% |
...
|---|---:|---:|
| Basic | 5,592,732,340 | 51.8% |
| Not specialized | 1,041,854,760 | 9.6% |
| Specialized hits | 3,624,223,040 | 33.6% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 556,674,960 | 60.0% |
| FOR_ITER | 109,921,880 | 11.8% |
| CALL | 104,821,160 | 11.3% |
...
| Calls to Python functions inlined | 420,211,040 | 88.7% |
...
| Frames pushed | 308,318,560 | 65.1% |
...
| Allocations | 851,666,940 | 69.7% |
| Allocations to 512 bytes | 850,503,320 | 69.6% |
| Allocations to 4 kbytes | 698,840 | 0.1% |
| Allocations over 4 kbytes | 464,780 | 0.0% |
| Frees | 895,299,443 |  |
| New values | 10,550,680 |  |
| Interpreter increfs | 4,352,489,120 | 60.8% |
| Interpreter decrefs | 5,466,809,640 | 67.5% |
| Increfs | 2,806,455,389 | 39.2% |
| Decrefs | 2,634,326,121 | 32.5% |
| Materialize dict (on request) | 113,800 | 1.1% |
| Materialize dict (new key) | 150,400 | 1.4% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 78,600 | 0.7% |
| Method cache hits | 591,637,329 |  |
| Method cache misses | 44,918,991 |  |
| Method cache collisions | 47,561,131 |  |
| Method cache dunder hits | 286,690,703 |  |
| Method cache dunder misses | 2,664,957 |  |
