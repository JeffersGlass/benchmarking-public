...
| Increfs | 226,960,180 | 97.8% |
| Decrefs | 239,206,738 | 96.9% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 3,276,880 |  |
| Method cache misses | 819,240 |  |
| Method cache collisions | 832,831 |  |
| Method cache dunder hits | 7,359,014 |  |
| Method cache dunder misses | 13,786 |  |
