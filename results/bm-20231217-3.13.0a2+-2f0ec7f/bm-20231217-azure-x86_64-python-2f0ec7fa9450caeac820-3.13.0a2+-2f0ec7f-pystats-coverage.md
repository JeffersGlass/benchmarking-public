...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,815,548 | 20.6% | 20.6% |  |
| LOAD_CONST | 39,100,480 | 15.9% | 36.5% |  |
...
| LOAD_FAST_LOAD_FAST | 934,580 | 0.4% | 96.3% |  |
| POP_JUMP_IF_FALSE | 908,960 | 0.4% | 96.7% |  |
| STORE_FAST | 757,904 | 0.3% | 97.0% |  |
| JUMP_BACKWARD | 499,360 | 0.2% | 97.2% |  |
| FOR_ITER | 432,040 | 0.2% | 97.4% |  |
| STORE_FAST_STORE_FAST | 399,760 | 0.2% | 97.5% |  |
| LOAD_ATTR_MODULE | 391,540 | 0.2% | 97.7% | 3.2% |
| TO_BOOL_BOOL | 346,864 | 0.1% | 97.8% |  |
| CONTAINS_OP | 342,920 | 0.1% | 98.0% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 342,240 | 0.1% | 98.1% |  |
| LOAD_GLOBAL_BUILTIN | 342,220 | 0.1% | 98.2% | 0.6% |
| STORE_SUBSCR_DICT | 339,000 | 0.1% | 98.4% |  |
| RESUME_CHECK | 335,300 | 0.1% | 98.5% | 2.3% |
| CALL | 267,953 | 0.1% | 98.6% |  |
| LOAD_ATTR_METHOD_NO_DICT | 255,604 | 0.1% | 98.7% |  |
...
| INSTRUMENTED_POP_JUMP_IF_TRUE | 13,464 | 0.0% | 99.9% |  |
| RETURN_GENERATOR | 13,200 | 0.0% | 99.9% |  |
| POP_JUMP_IF_NOT_NONE | 12,720 | 0.0% | 99.9% |  |
| BUILD_MAP | 12,700 | 0.0% | 99.9% |  |
| INSTRUMENTED_FOR_ITER | 11,304 | 0.0% | 99.9% |  |
| BUILD_LIST | 10,040 | 0.0% | 99.9% |  |
| INSTRUMENTED_JUMP_BACKWARD | 10,024 | 0.0% | 99.9% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST_LOAD_FAST | 468,360 | 0.2% | 94.8% |
| JUMP_BACKWARD FOR_ITER | 379,820 | 0.2% | 95.0% |
| LOAD_FAST_LOAD_FAST LOAD_FAST | 376,640 | 0.2% | 95.1% |
| UNPACK_SEQUENCE_TWO_TUPLE STORE_FAST_STORE_FAST | 341,260 | 0.1% | 95.3% |
| CONTAINS_OP POP_JUMP_IF_FALSE | 339,220 | 0.1% | 95.4% |
| STORE_FAST LOAD_FAST | 337,844 | 0.1% | 95.5% |
| LOAD_FAST STORE_SUBSCR_DICT | 330,500 | 0.1% | 95.7% |
| FOR_ITER UNPACK_SEQUENCE_TWO_TUPLE | 330,140 | 0.1% | 95.8% |
| STORE_SUBSCR_DICT JUMP_BACKWARD | 329,100 | 0.1% | 95.9% |
| STORE_FAST_STORE_FAST LOAD_FAST_LOAD_FAST | 324,020 | 0.1% | 96.1% |
| LOAD_FAST_LOAD_FAST CONTAINS_OP | 323,180 | 0.1% | 96.2% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 313,000 | 0.1% | 96.3% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 244,700 | 0.1% | 96.4% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 240,124 | 0.1% | 96.5% |
...
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 192,324 | 0.1% | 97.0% |
| LOAD_FAST CALL | 190,924 | 0.1% | 97.0% |
...
| CALL TO_BOOL_BOOL | 109,764 | 0.0% | 97.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 323,180 | 94.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 339,220 | 98.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 330,140 | 76.4% |
| STORE_FAST | 50,360 | 11.7% |
| NOP | 47,280 | 10.9% |
| FOR_ITER | 1,420 | 0.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_SUBSCR_DICT | 329,100 | 65.9% |
...
| LOAD_FAST_LOAD_FAST | 376,640 | 0.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 38,910,100 | 76.6% |
| INSTRUMENTED_RETURN_VALUE | 9,717,760 | 19.1% |
| STORE_SUBSCR_DICT | 330,500 | 0.7% |
| LOAD_ATTR_METHOD_NO_DICT | 192,324 | 0.4% |
| CALL | 190,924 | 0.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 468,360 | 50.1% |
| STORE_FAST_STORE_FAST | 324,020 | 34.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 376,640 | 40.3% |
| CONTAINS_OP | 323,180 | 34.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 468,360 | 51.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 341,260 | 85.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 324,020 | 81.1% |
| STORE_FAST | 52,600 | 13.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 244,700 | 70.5% |
| POP_JUMP_IF_TRUE | 76,860 | 22.2% |
| INSTRUMENTED_POP_JUMP_IF_FALSE | 18,040 | 5.2% |
| INSTRUMENTED_POP_JUMP_IF_TRUE | 7,124 | 2.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 341,260 | 99.7% |
| STORE_FAST | 980 | 0.3% |
...
|---|---:|---:|
| Basic | 152,609,404 | 61.9% |
| Not specialized | 11,825,613 | 4.8% |
| Specialized hits | 82,183,668 | 33.3% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 738,044 | 1.8% |
| Frees to freelist | 735,084 |  |
| Allocations | 40,943,800 | 98.2% |
| Allocations to 512 bytes | 40,932,140 | 98.2% |
| Allocations to 4 kbytes | 6,620 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,921,622 |  |
| New values | 1,420 |  |
| Interpreter increfs | 43,917,152 | 15.7% |
| Interpreter decrefs | 64,266,936 | 24.5% |
| Increfs | 235,603,878 | 84.3% |
| Decrefs | 198,428,108 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,528,545 |  |
| Method cache misses | 11,475 |  |
| Method cache collisions | 10,510 |  |
| Method cache dunder hits | 176,914 |  |
