...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,377 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,501,739 | 5.6% | 24.2% |  |
...
| COMPARE_OP_INT | 250,581 | 0.9% | 81.2% | 0.1% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,077 | 3.0% | 6.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 786,577 | 2.9% | 9.5% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 451,679 | 1.7% | 19.5% |
| IS_OP POP_JUMP_IF_FALSE | 416,300 | 1.5% | 21.0% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,500 | 1.5% | 22.5% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 306,720 | 1.1% | 30.1% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,620 | 1.0% | 31.1% |
| LOAD_FAST LOAD_CONST | 261,081 | 1.0% | 32.0% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 247,901 | 0.9% | 33.0% |
...
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_BOOL | 178,539 | 0.7% | 41.9% |
| POP_TOP LOAD_FAST | 177,940 | 0.7% | 42.5% |
...
| POP_JUMP_IF_FALSE LOAD_CONST | 151,721 | 0.6% | 49.2% |
...
| LOAD_FAST CALL_PY_EXACT_ARGS | 141,799 | 0.5% | 53.0% |
...
| LOAD_CONST COMPARE_OP_INT | 127,861 | 0.5% | 56.0% |
...
| LOAD_FAST CALL | 72,541 | 0.3% | 68.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 261,081 | 22.2% |
| POP_JUMP_IF_FALSE | 151,721 | 12.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 786,577 | 15.6% |
| STORE_FAST | 729,260 | 14.5% |
| RESUME_CHECK | 469,160 | 9.3% |
| POP_JUMP_IF_TRUE | 451,679 | 9.0% |
| LOAD_GLOBAL_BUILTIN | 404,500 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,077 | 16.0% |
| LOAD_ATTR | 547,780 | 10.9% |
| LOAD_CONST | 261,081 | 5.2% |
...
| IS_OP | 416,300 | 27.7% |
| COMPARE_OP_INT | 247,901 | 16.5% |
| TO_BOOL_NONE | 75,540 | 5.0% |
| CONTAINS_OP | 65,300 | 4.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 786,577 | 52.4% |
| LOAD_GLOBAL_BUILTIN | 306,720 | 20.4% |
| LOAD_CONST | 151,721 | 10.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,660 | 54.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 127,861 | 51.0% |
| LOAD_FAST | 67,880 | 27.1% |
| LOAD_ATTR_INSTANCE_VALUE | 20,100 | 8.0% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 247,901 | 98.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 178,539 | 21.5% |
| CALL_LEN | 105,660 | 12.7% |
| LOAD_ATTR_METHOD_NO_DICT | 100,879 | 12.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 100,879 | 36.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,720 | 41.1% |
...
| LOAD_ATTR_INSTANCE_VALUE | 178,539 | 21.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 18,279 | 92.9% |
| LOAD_FAST | 1,060 | 5.4% |
| TO_BOOL | 340 | 1.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 18,999 | 96.5% |
...
|---|---:|---:|
| Basic | 13,035,859 | 48.2% |
| Not specialized | 4,447,660 | 16.4% |
| Specialized hits | 9,477,271 | 35.0% |
...
| Allocations | 1,597,049 | 67.3% |
| Allocations to 512 bytes | 1,407,045 | 59.3% |
| Allocations to 4 kbytes | 132,200 | 5.6% |
| Allocations over 4 kbytes | 57,804 | 2.4% |
| Frees | 1,536,588 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,200,530 | 76.6% |
| Interpreter decrefs | 14,016,329 | 78.2% |
| Increfs | 3,731,231 | 23.4% |
| Decrefs | 3,918,067 | 21.8% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,224,157 |  |
| Method cache misses | 36,603 |  |
| Method cache collisions | 42,030 |  |
| Method cache dunder hits | 355,552 |  |
| Method cache dunder misses | 8,228 |  |
