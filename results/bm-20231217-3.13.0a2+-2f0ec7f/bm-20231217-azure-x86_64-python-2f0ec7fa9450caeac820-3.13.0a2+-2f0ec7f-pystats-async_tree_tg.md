...
|---|---:|---:|---:|---:|
| LOAD_FAST | 422,574,080 | 20.6% | 20.6% |  |
| LOAD_ATTR_INSTANCE_VALUE | 141,854,020 | 6.9% | 27.6% |  |
| POP_JUMP_IF_FALSE | 114,224,760 | 5.6% | 33.2% |  |
...
| LOAD_ATTR_SLOT | 67,931,320 | 3.3% | 64.2% |  |
...
| RETURN_VALUE | 45,542,900 | 2.2% | 76.6% |  |
| INTERPRETER_EXIT | 44,790,380 | 2.2% | 78.8% |  |
| LOAD_ATTR | 38,093,400 | 1.9% | 80.7% |  |
| CALL | 33,612,060 | 1.6% | 82.3% |  |
| PUSH_NULL | 31,356,900 | 1.5% | 83.8% |  |
| CALL_METHOD_DESCRIPTOR_O | 27,620,140 | 1.3% | 85.2% | 0.0% |
| POP_JUMP_IF_NOT_NONE | 25,383,160 | 1.2% | 86.4% |  |
| TO_BOOL_NONE | 24,634,160 | 1.2% | 87.6% |  |
| LOAD_GLOBAL_MODULE | 23,148,420 | 1.1% | 88.8% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 19,409,520 | 0.9% | 89.7% | 0.0% |
| LOAD_ATTR_MODULE | 17,919,400 | 0.9% | 90.6% |  |
| FOR_ITER_RANGE | 14,931,320 | 0.7% | 91.3% |  |
| JUMP_BACKWARD | 14,184,840 | 0.7% | 92.0% |  |
| STORE_ATTR_INSTANCE_VALUE | 11,946,640 | 0.6% | 92.6% |  |
| POP_JUMP_IF_NONE | 11,944,720 | 0.6% | 93.2% |  |
| TO_BOOL | 11,205,020 | 0.5% | 93.7% |  |
| NOP | 10,454,080 | 0.5% | 94.2% |  |
| BUILD_LIST | 10,452,720 | 0.5% | 94.7% |  |
| POP_JUMP_IF_TRUE | 9,708,340 | 0.5% | 95.2% |  |
| CALL_FUNCTION_EX | 9,704,640 | 0.5% | 95.7% |  |
| RETURN_GENERATOR | 9,704,560 | 0.5% | 96.2% |  |
| CALL_KW | 9,704,480 | 0.5% | 96.6% |  |
...
| CACHE RESUME_CHECK | 38,818,080 | 1.9% | 30.8% |
...
| LOAD_FAST RETURN_VALUE | 29,115,620 | 1.4% | 41.4% |
...
| RETURN_CONST INTERPRETER_EXIT | 27,620,880 | 1.3% | 47.0% |
| CALL_METHOD_DESCRIPTOR_O POP_TOP | 27,620,120 | 1.3% | 48.4% |
...
| CALL STORE_FAST | 18,662,920 | 0.9% | 58.0% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 17,918,440 | 0.9% | 58.9% |
| LOAD_ATTR_MODULE PUSH_NULL | 17,172,260 | 0.8% | 59.8% |
...
| RETURN_VALUE STORE_FAST | 14,185,660 | 0.7% | 62.6% |
...
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 11,945,020 | 0.6% | 68.0% |
| POP_JUMP_IF_NONE LOAD_FAST | 11,943,920 | 0.6% | 68.6% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL | 11,199,120 | 0.5% | 69.2% |
| PUSH_NULL LOAD_FAST | 11,198,080 | 0.5% | 69.7% |
| LOAD_CONST STORE_FAST | 10,458,960 | 0.5% | 70.2% |
| POP_JUMP_IF_FALSE LOAD_CONST | 10,454,480 | 0.5% | 70.7% |
| NOP LOAD_FAST | 10,453,520 | 0.5% | 71.2% |
| POP_TOP LOAD_CONST | 10,453,220 | 0.5% | 71.8% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 10,452,980 | 0.5% | 72.3% |
| BUILD_LIST LOAD_FAST | 10,451,120 | 0.5% | 72.8% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 9,708,640 | 0.5% | 73.3% |
...
| TO_BOOL POP_JUMP_IF_FALSE | 6,719,300 | 0.3% | 88.1% |
| LOAD_FAST POP_JUMP_IF_NONE | 6,718,880 | 0.3% | 88.4% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 6,718,340 | 0.3% | 88.8% |
| GET_AWAITABLE LOAD_CONST | 5,972,080 | 0.3% | 89.0% |
| TO_BOOL_LIST POP_JUMP_IF_FALSE | 5,228,660 | 0.3% | 89.3% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL_LIST | 5,228,580 | 0.3% | 89.6% |
| PUSH_NULL CALL | 5,228,340 | 0.3% | 89.8% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 5,227,220 | 0.3% | 90.1% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_WITH_VALUES | 5,227,160 | 0.3% | 90.3% |
| CALL POP_TOP | 5,226,120 | 0.3% | 90.6% |
| STORE_ATTR_INSTANCE_VALUE LOAD_CONST | 5,226,060 | 0.3% | 90.8% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 5,225,980 | 0.3% | 91.1% |
| POP_JUMP_IF_NOT_NONE LOAD_GLOBAL_MODULE | 5,225,760 | 0.3% | 91.3% |
| END_SEND POP_TOP | 5,225,600 | 0.3% | 91.6% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NONE | 5,225,580 | 0.3% | 91.9% |
| SEND_GEN POP_TOP | 5,225,500 | 0.3% | 92.1% |
...
| POP_JUMP_IF_FALSE | 10,454,480 | 13.9% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 38,077,320 | 10.5% |
|          hit | 326,253,520 | 89.5% |
...
|---|---:|---:|
| Basic | 1,026,584,180 | 50.2% |
| Not specialized | 245,675,000 | 12.0% |
| Specialized hits | 773,449,420 | 37.8% |
...
| Allocations | 94,277,185 | 65.0% |
| Allocations to 512 bytes | 93,472,160 | 64.4% |
| Allocations to 4 kbytes | 804,920 | 0.6% |
| Allocations over 4 kbytes | 105 | 0.0% |
| Frees | 94,234,106 |  |
| New values | 320 |  |
| Interpreter increfs | 1,065,361,560 | 79.4% |
| Interpreter decrefs | 1,122,638,920 | 76.4% |
| Increfs | 276,218,526 | 20.6% |
| Decrefs | 346,494,979 | 23.6% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 57,501,338 |  |
| Method cache misses | 3,802 |  |
| Method cache collisions | 3,605 |  |
| Method cache dunder hits | 11,198,781 |  |
| Method cache dunder misses | 419 |  |
