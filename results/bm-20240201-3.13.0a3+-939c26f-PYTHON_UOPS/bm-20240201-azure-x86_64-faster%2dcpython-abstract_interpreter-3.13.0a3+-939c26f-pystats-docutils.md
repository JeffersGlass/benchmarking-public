...
| Allocations to 512 bytes | 850,463,020 | 69.6% |
| Allocations to 4 kbytes | 700,360 | 0.1% |
| Allocations over 4 kbytes | 464,760 | 0.0% |
| Frees | 895,273,012 |  |
| New values | 10,550,460 |  |
| Interpreter increfs | 4,577,769,300 | 62.1% |
| Interpreter decrefs | 5,675,293,780 | 68.3% |
| Increfs | 2,790,022,212 | 37.9% |
| Decrefs | 2,634,665,376 | 31.7% |
| Materialize dict (on request) | 113,800 | 1.1% |
| Materialize dict (new key) | 150,400 | 1.4% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 78,600 | 0.7% |
| Method cache hits | 584,028,747 |  |
| Method cache misses | 42,878,453 |  |
| Method cache collisions | 46,134,057 |  |
| Method cache dunder hits | 286,060,011 |  |
| Method cache dunder misses | 3,278,469 |  |
...
| Uops executed | 2,949,561,980 | 13.97 |
...
| _ITER_NEXT_LIST | 95,791,000 | 3.2% | 63.0% |  |
| _ITER_CHECK_TUPLE | 64,514,880 | 2.2% | 65.1% | 17.4% |
| _JUMP_TO_TOP | 59,558,040 | 2.0% | 67.2% |  |
| _GUARD_GLOBALS_VERSION | 56,409,520 | 1.9% | 69.1% | 0.0% |
| _GUARD_NOT_EXHAUSTED_TUPLE | 53,305,560 | 1.8% | 70.9% | 23.8% |
| _FOR_ITER_TIER_TWO | 49,654,120 | 1.7% | 72.6% | 9.7% |
| _GUARD_IS_FALSE_POP | 43,041,020 | 1.5% | 74.0% | 4.3% |
...
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 16,570,960 | 0.6% | 90.5% | 0.1% |
...
| _INIT_CALL_PY_EXACT_ARGS | 10,802,900 | 0.4% | 94.9% |  |
...
| _GUARD_NOS_INT | 417,960 | 0.0% | 99.8% |  |
| _LOAD_ATTR_CLASS | 378,440 | 0.0% | 99.8% |  |
...
| _GUARD_BOTH_INT | 294,140 | 0.0% | 99.9% |  |
...
| _GUARD_TOS_INT | 94,380 | 0.0% | 100.0% |  |
