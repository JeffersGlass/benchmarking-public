...
| Increfs | 10,003,866 | 2.5% |
| Decrefs | 30,829,973 | 6.4% |
...
| Uops executed | 756,127,040 | 83.70 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 171,265,080 | 22.7% | 22.7% |  |
| _SET_IP | 99,808,800 | 13.2% | 35.9% |  |
| _GUARD_TYPE_VERSION | 44,431,560 | 5.9% | 41.7% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 40,031,960 | 5.3% | 47.0% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 40,031,960 | 5.3% | 52.3% |  |
| _GUARD_BOTH_FLOAT | 36,000,000 | 4.8% | 57.1% |  |
| _BINARY_OP_SUBTRACT_INT | 32,000,000 | 4.2% | 61.3% |  |
| STORE_FAST | 29,421,820 | 3.9% | 65.2% |  |
| _BINARY_OP_MULTIPLY_FLOAT | 24,000,000 | 3.2% | 68.4% |  |
| _BINARY_OP_ADD_INT | 22,458,700 | 3.0% | 71.3% |  |
| _CHECK_VALIDITY | 21,302,340 | 2.8% | 74.2% |  |
| BINARY_SUBSCR_LIST_INT | 20,031,960 | 2.6% | 76.8% |  |
| _LOAD_CONST_INLINE_BORROW | 18,182,860 | 2.4% | 79.2% |  |
| _BINARY_OP | 16,020,080 | 2.1% | 81.3% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 13,285,980 | 1.8% | 83.1% | 30.2% |
| _ITER_CHECK_RANGE | 13,285,980 | 1.8% | 84.8% |  |
| _GUARD_TOS_INT | 13,095,920 | 1.7% | 86.6% |  |
| _BINARY_OP_ADD_FLOAT | 12,000,000 | 1.6% | 88.2% |  |
| _ITER_NEXT_RANGE | 9,278,380 | 1.2% | 89.4% |  |
| _GUARD_BOTH_INT | 8,000,000 | 1.1% | 90.5% |  |
| _GUARD_GLOBALS_VERSION | 5,810,480 | 0.8% | 91.2% |  |
| _EXIT_TRACE | 4,698,480 | 0.6% | 91.8% | 100.0% |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 4,399,600 | 0.6% | 92.4% |  |
| _GUARD_KEYS_VERSION | 4,399,600 | 0.6% | 93.0% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 4,399,600 | 0.6% | 93.6% |  |
| _LOAD_GLOBAL_MODULE | 4,210,480 | 0.6% | 94.1% |  |
| RESUME_CHECK | 4,000,000 | 0.5% | 94.7% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 4,000,000 | 0.5% | 95.2% |  |
| _CHECK_STACK_SPACE | 4,000,000 | 0.5% | 95.7% |  |
| _INIT_CALL_PY_EXACT_ARGS | 4,000,000 | 0.5% | 96.3% |  |
| _PUSH_FRAME | 4,000,000 | 0.5% | 96.8% |  |
| _GUARD_IS_NOT_NONE_POP | 4,000,000 | 0.5% | 97.3% |  |
| _SAVE_RETURN_OFFSET | 4,000,000 | 0.5% | 97.8% |  |
| _JUMP_TO_TOP | 2,795,260 | 0.4% | 98.2% |  |
| LIST_APPEND | 2,420,080 | 0.3% | 98.5% |  |
| GET_ITER | 1,600,000 | 0.2% | 98.7% |  |
