...
| Increfs | 230,240,127 | 98.9% |
| Decrefs | 320,738,300 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,047,833 |  |
| Method cache misses | 410,667 |  |
| Method cache collisions | 412,012 |  |
| Method cache dunder hits | 817,952 |  |
| Method cache dunder misses | 1,968 |  |
