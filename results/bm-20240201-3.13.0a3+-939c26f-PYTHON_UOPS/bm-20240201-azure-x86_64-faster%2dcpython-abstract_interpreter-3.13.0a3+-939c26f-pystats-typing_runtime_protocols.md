...
| Increfs | 126,671,243 | 37.4% |
| Decrefs | 147,354,916 | 37.5% |
| Materialize dict (on request) | 1,040 | 35.9% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 16,007,613 |  |
| Method cache misses | 40,127 |  |
| Method cache collisions | 64,952 |  |
| Method cache dunder hits | 22,759,620 |  |
| Method cache dunder misses | 29,883 |  |
