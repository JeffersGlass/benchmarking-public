...
| CALL | 16,195,860 | 0.7% | 89.2% |  |
| RETURN_VALUE | 16,175,240 | 0.7% | 89.9% |  |
...
| CALL_ALLOC_AND_ENTER_INIT | 8,009,660 | 0.4% | 97.5% | 0.0% |
| EXIT_INIT_CHECK | 8,009,560 | 0.4% | 97.9% |  |
...
| CACHE RESUME_CHECK | 141,572,380 | 6.4% | 12.7% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 42,912,620 | 1.9% | 62.6% |
...
| RETURN_CONST INTERPRETER_EXIT | 24,063,780 | 1.1% | 67.6% |
...
| CALL STORE_FAST | 8,026,180 | 0.4% | 81.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 45,340 | 53.1% |
| LOAD_GLOBAL_MODULE | 17,560 | 20.6% |
...
| POP_JUMP_IF_FALSE | 42,912,620 | 15.0% |
...
|---|---:|---:|
| Basic | 1,485,916,420 | 66.7% |
| Not specialized | 254,606,660 | 11.4% |
| Specialized hits | 480,851,240 | 21.6% |
...
| Calls to Python functions inlined | 32,214,060 | 17.0% |
...
| Allocations to 512 bytes | 236,242,220 | 47.7% |
| Allocations to 4 kbytes | 38,100 | 0.0% |
| Allocations over 4 kbytes | 2,920 | 0.0% |
| Frees | 235,699,411 |  |
| New values | 10,260 |  |
| Interpreter increfs | 1,134,557,860 | 61.5% |
| Interpreter decrefs | 1,589,063,580 | 64.1% |
| Increfs | 710,327,968 | 38.5% |
| Decrefs | 891,856,870 | 35.9% |
| Materialize dict (on request) | 140 | 1.4% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 80 | 0.8% |
| Method cache hits | 176,206 |  |
| Method cache misses | 58,414 |  |
| Method cache collisions | 68,390 |  |
| Method cache dunder hits | 8,314,748 |  |
| Method cache dunder misses | 23,452 |  |
...
| Uops executed | 631,354,200 | 5.03 |
...
| _LOAD_CONST_INLINE | 17,320 | 0.0% | 99.9% |  |
...
| _GUARD_BOTH_INT | 15,920 | 0.0% | 100.0% |  |
...
| _GUARD_NOS_INT | 1,060 | 0.0% | 100.0% |  |
