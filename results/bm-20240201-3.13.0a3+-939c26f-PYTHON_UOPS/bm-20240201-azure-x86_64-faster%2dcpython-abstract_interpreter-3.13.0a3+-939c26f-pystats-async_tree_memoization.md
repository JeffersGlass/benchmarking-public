...
|---|---:|---:|---:|---:|
| LOAD_FAST | 447,083,900 | 18.5% | 18.5% |  |
...
| JUMP_FORWARD | 4,483,200 | 0.2% | 96.5% |  |
...
| RESUME | 1,980 | 0.0% | 100.0% | 2,573.8% |
...
| POP_TOP LOAD_FAST | 25,753,480 | 1.1% | 42.7% |
...
|---|---:|---:|
| Basic | 1,257,065,880 | 52.1% |
| Not specialized | 285,652,240 | 11.8% |
| Specialized hits | 858,371,198 | 35.6% |
| Specialized misses | 9,999,842 | 0.4% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 64,061,913 | 36.8% |
| Frees to freelist | 64,521,433 |  |
| Allocations | 110,119,765 | 63.2% |
| Allocations to 512 bytes | 110,057,718 | 63.2% |
| Allocations to 4 kbytes | 61,918 | 0.0% |
| Allocations over 4 kbytes | 129 | 0.0% |
| Frees | 112,222,098 |  |
| New values | 300 |  |
| Interpreter increfs | 1,388,028,160 | 78.9% |
| Interpreter decrefs | 1,451,905,407 | 76.0% |
| Increfs | 370,665,817 | 21.1% |
| Decrefs | 458,521,771 | 24.0% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 94,526,210 |  |
| Method cache misses | 828,010 |  |
| Method cache collisions | 823,521 |  |
| Method cache dunder hits | 15,655,442 |  |
| Method cache dunder misses | 558 |  |
...
|---:|---:|---:|---:|
| 0 | 53,332 | 2,040 | 366,096,324 |
| 1 | 4,840 | 0 | 373,547,568 |
| 2 | 440 | 0 | 903,739,206 |
...
| _GUARD_GLOBALS_VERSION | 4,103,940 | 0.5% | 95.4% |  |
| _LOAD_GLOBAL_MODULE | 4,103,940 | 0.5% | 95.9% |  |
