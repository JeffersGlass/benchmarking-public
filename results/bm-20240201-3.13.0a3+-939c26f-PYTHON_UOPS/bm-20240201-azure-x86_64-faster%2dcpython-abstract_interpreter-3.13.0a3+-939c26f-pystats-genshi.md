...
|---|---:|---:|---:|---:|
| LOAD_FAST | 478,809,160 | 18.9% | 18.9% |  |
| LOAD_GLOBAL_MODULE | 170,512,440 | 6.7% | 25.7% | 0.0% |
| POP_JUMP_IF_FALSE | 167,809,260 | 6.6% | 32.3% |  |
| STORE_FAST | 160,329,140 | 6.3% | 38.6% |  |
| RESUME_CHECK | 149,195,580 | 5.9% | 44.5% | 0.0% |
| POP_TOP | 125,674,440 | 5.0% | 49.5% |  |
...
| CALL_BUILTIN_FAST | 14,589,360 | 0.6% | 90.4% | 0.0% |
...
| CONTAINS_OP | 9,295,940 | 0.4% | 95.6% |  |
...
| POP_TOP JUMP_BACKWARD | 57,931,320 | 2.3% | 34.5% |
...
| POP_TOP ENTER_EXECUTOR | 37,772,260 | 1.5% | 45.6% |
| EXTENDED_ARG FOR_ITER_GEN | 32,964,280 | 1.3% | 46.9% |
| LOAD_FAST_LOAD_FAST LOAD_FAST | 29,944,420 | 1.2% | 48.1% |
...
| YIELD_VALUE INTERPRETER_EXIT | 21,128,480 | 0.8% | 62.2% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 8,982,140 | 0.4% | 78.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 57,931,320 | 46.1% |
| ENTER_EXECUTOR | 37,772,260 | 30.1% |
...
| LOAD_FAST_LOAD_FAST | 29,944,420 | 6.3% |
...
| LOAD_GLOBAL_BUILTIN | 8,982,140 | 5.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 8,982,140 | 27.1% |
...
| LOAD_FAST_LOAD_FAST | 493,540 | 1.5% |
...
|---|---:|---:|
| Basic | 1,525,956,820 | 60.3% |
| Not specialized | 274,858,880 | 10.9% |
| Specialized hits | 728,080,100 | 28.8% |
...
| Allocations | 66,930,020 | 50.4% |
| Allocations to 512 bytes | 66,921,120 | 50.4% |
| Allocations to 4 kbytes | 5,540 | 0.0% |
| Allocations over 4 kbytes | 3,360 | 0.0% |
| Frees | 74,679,997 |  |
| New values | 2,820 |  |
| Interpreter increfs | 1,091,265,780 | 81.3% |
| Interpreter decrefs | 1,138,667,040 | 78.5% |
| Increfs | 250,850,166 | 18.7% |
| Decrefs | 311,728,121 | 21.5% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 42,861,530 |  |
| Method cache misses | 15,770 |  |
| Method cache collisions | 12,807 |  |
| Method cache dunder hits | 10,974,829 |  |
| Method cache dunder misses | 2,211 |  |
...
| Uops executed | 263,248,860 | 6.60 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 40,050,380 | 15.2% | 15.2% |  |
| STORE_FAST | 32,664,440 | 12.4% | 27.6% |  |
| _ITER_CHECK_LIST | 27,047,820 | 10.3% | 37.9% | 40.2% |
| _SET_IP | 19,081,780 | 7.2% | 45.1% |  |
| _EXIT_TRACE | 18,724,220 | 7.1% | 52.3% | 100.0% |
| _CHECK_VALIDITY | 18,114,000 | 6.9% | 59.1% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 16,167,960 | 6.1% | 65.3% | 32.7% |
| _FOR_ITER_TIER_TWO | 11,690,760 | 4.4% | 69.7% | 8.3% |
| _ITER_NEXT_LIST | 10,884,300 | 4.1% | 73.9% |  |
| _GUARD_GLOBALS_VERSION | 9,468,300 | 3.6% | 77.5% | 0.0% |
| _GUARD_IS_FALSE_POP | 7,374,540 | 2.8% | 80.3% | 26.1% |
| _LOAD_GLOBAL_MODULE | 7,367,280 | 2.8% | 83.1% |  |
| PUSH_NULL | 6,720,580 | 2.6% | 85.6% |  |
| IS_OP | 5,446,020 | 2.1% | 87.7% |  |
| UNPACK_SEQUENCE_TUPLE | 5,442,100 | 2.1% | 89.7% |  |
| _LOAD_CONST_INLINE_BORROW | 5,434,900 | 2.1% | 91.8% |  |
| _GUARD_IS_TRUE_POP | 4,002,660 | 1.5% | 93.3% | 52.0% |
| TO_BOOL_LIST | 3,520,220 | 1.3% | 94.7% |  |
| _GUARD_BUILTINS_VERSION | 2,097,540 | 0.8% | 95.5% |  |
| _LOAD_GLOBAL_BUILTINS | 2,097,540 | 0.8% | 96.3% |  |
| _LOAD_CONST_INLINE | 2,080,420 | 0.8% | 97.0% |  |
| CALL_BUILTIN_FAST | 1,922,920 | 0.7% | 97.8% |  |
| CALL_LEN | 1,920,200 | 0.7% | 98.5% |  |
| COMPARE_OP_INT | 1,920,040 | 0.7% | 99.2% |  |
| GET_ITER | 961,000 | 0.4% | 99.6% |  |
| CONTAINS_OP | 484,940 | 0.2% | 99.8% |  |
