...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,215,992 | 20.8% | 20.8% |  |
| LOAD_CONST | 39,087,480 | 16.2% | 36.9% |  |
| CALL_PY_EXACT_ARGS | 19,640,716 | 8.1% | 45.0% |  |
...
| STORE_FAST_STORE_FAST | 31,896 | 0.0% | 99.7% |  |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 16,416 | 0.0% | 99.9% |  |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,884 | 0.1% | 96.6% |
| STORE_FAST LOAD_FAST | 272,712 | 0.1% | 96.7% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 183,476 | 0.1% | 97.1% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 173,480 | 0.1% | 97.1% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 167,776 | 0.1% | 97.2% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 163,740 | 0.1% | 97.3% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 161,980 | 0.1% | 97.3% |
| LOAD_FAST CALL | 154,760 | 0.1% | 97.4% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,328 | 0.0% | 98.2% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 51,296 | 0.0% | 98.6% |
...
| LOAD_ATTR_MODULE LOAD_ATTR_MODULE | 43,736 | 0.0% | 98.9% |
...
| LOAD_CONST | 1,916 | 9.8% |
| LOAD_ATTR_INSTANCE_VALUE | 1,020 | 5.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 16,196 | 82.5% |
| EXTENDED_ARG | 1,000 | 5.1% |
| POP_JUMP_IF_TRUE | 932 | 4.7% |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 5,096 | 8.5% |
| NOP | 1,540 | 2.6% |
| FOR_ITER | 1,080 | 1.8% |
...
| CALL_PY_EXACT_ARGS | 167,776 | 0.3% |
| CALL | 154,760 | 0.3% |
...
| LOAD_GLOBAL_MODULE | 51,296 | 12.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 15,436 | 48.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,884 | 80.0% |
| LOAD_ATTR_MODULE | 43,736 | 11.3% |
...
| LOAD_FAST | 66,328 | 17.1% |
| LOAD_ATTR_MODULE | 43,736 | 11.3% |
| LOAD_CONST | 14,936 | 3.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 183,476 | 56.9% |
| CALL | 54,440 | 16.9% |
| CACHE | 38,640 | 12.0% |
| POP_TOP | 13,060 | 4.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 15,436 | 94.0% |
| STORE_FAST | 980 | 6.0% |
...
|---|---:|---:|
| Basic | 150,024,723 | 62.0% |
| Not specialized | 10,882,925 | 4.5% |
| Specialized hits | 81,048,572 | 33.5% |
...
| Calls to Python functions inlined | 19,716,616 | 99.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 737,380 | 1.8% |
| Frees to freelist | 734,420 |  |
| Allocations | 40,943,920 | 98.2% |
| Allocations to 512 bytes | 40,931,760 | 98.2% |
| Allocations to 4 kbytes | 7,120 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,921,661 |  |
| New values | 1,420 |  |
| Interpreter increfs | 44,078,323 | 15.8% |
| Interpreter decrefs | 64,430,663 | 24.5% |
| Increfs | 235,610,476 | 84.2% |
| Decrefs | 198,430,941 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,529,773 |  |
| Method cache misses | 10,167 |  |
| Method cache collisions | 9,066 |  |
| Method cache dunder hits | 175,992 |  |
| Method cache dunder misses | 1,248 |  |
...
| Traces executed | 155,003 |  |
| Uops executed | 8,827,261 | 56.95 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,155,248 | 24.4% | 24.4% |  |
| _SET_IP | 1,302,700 | 14.8% | 39.2% |  |
| _CHECK_VALIDITY | 1,243,088 | 14.1% | 53.3% |  |
| STORE_FAST | 833,084 | 9.4% | 62.7% |  |
| _GUARD_IS_FALSE_POP | 413,596 | 4.7% | 67.4% | 0.3% |
| _FOR_ITER_TIER_TWO | 375,060 | 4.2% | 71.6% | 12.4% |
| UNPACK_SEQUENCE_TWO_TUPLE | 329,024 | 3.7% | 75.4% |  |
| _JUMP_TO_TOP | 327,197 | 3.7% | 79.1% |  |
| CONTAINS_OP | 326,492 | 3.7% | 82.8% |  |
| STORE_SUBSCR_DICT | 322,900 | 3.7% | 86.4% |  |
| _GUARD_TYPE_VERSION | 103,608 | 1.2% | 87.6% |  |
| _GUARD_IS_TRUE_POP | 97,944 | 1.1% | 88.7% | 4.7% |
| TO_BOOL_STR | 88,780 | 1.0% | 89.7% |  |
| COMPARE_OP_STR | 85,408 | 1.0% | 90.7% |  |
| _EXIT_TRACE | 81,364 | 0.9% | 91.6% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,408 | 0.9% | 92.5% |  |
| _GUARD_GLOBALS_VERSION | 73,116 | 0.8% | 93.3% | 0.1% |
| _LOAD_GLOBAL_MODULE | 58,636 | 0.7% | 94.0% |  |
| _ITER_CHECK_LIST | 57,520 | 0.7% | 94.6% | 1.1% |
| _GUARD_NOT_EXHAUSTED_LIST | 56,860 | 0.6% | 95.3% | 23.5% |
| _ITER_NEXT_LIST | 43,500 | 0.5% | 95.8% |  |
...
| _GUARD_KEYS_VERSION | 20,200 | 0.2% | 97.2% |  |
| _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES | 19,520 | 0.2% | 97.4% |  |
| LOAD_DEREF | 16,580 | 0.2% | 97.6% |  |
| _GUARD_BUILTINS_VERSION | 14,420 | 0.2% | 97.8% | 0.3% |
| _LOAD_GLOBAL_BUILTINS | 14,380 | 0.2% | 97.9% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 13,704 | 0.2% | 98.1% |  |
| _CHECK_STACK_SPACE | 13,704 | 0.2% | 98.2% |  |
| _INIT_CALL_PY_EXACT_ARGS | 13,704 | 0.2% | 98.4% |  |
| _PUSH_FRAME | 13,704 | 0.2% | 98.5% |  |
| _SAVE_RETURN_OFFSET | 13,704 | 0.2% | 98.7% |  |
| RESUME_CHECK | 12,380 | 0.1% | 98.8% |  |
| _LOAD_CONST_INLINE_BORROW | 11,056 | 0.1% | 99.0% |  |
| TO_BOOL_BOOL | 8,140 | 0.1% | 99.1% |  |
| _POP_FRAME | 8,140 | 0.1% | 99.2% |  |
| _CHECK_ATTR_MODULE | 7,780 | 0.1% | 99.2% | 44.2% |
| PUSH_NULL | 7,240 | 0.1% | 99.3% |  |
| _LOAD_ATTR | 6,060 | 0.1% | 99.4% |  |
| CALL_BUILTIN_CLASS | 5,680 | 0.1% | 99.5% |  |
| _LOAD_ATTR_MODULE | 4,340 | 0.0% | 99.5% |  |
...
| _LOAD_CONST_INLINE | 2,664 | 0.0% | 99.7% |  |
