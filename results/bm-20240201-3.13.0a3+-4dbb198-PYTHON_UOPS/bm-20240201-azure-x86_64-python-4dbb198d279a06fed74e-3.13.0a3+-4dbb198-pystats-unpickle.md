...
| Increfs | 230,246,698 | 98.9% |
| Decrefs | 320,745,520 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,041,261 |  |
| Method cache misses | 417,239 |  |
| Method cache collisions | 419,617 |  |
| Method cache dunder hits | 817,006 |  |
| Method cache dunder misses | 2,914 |  |
