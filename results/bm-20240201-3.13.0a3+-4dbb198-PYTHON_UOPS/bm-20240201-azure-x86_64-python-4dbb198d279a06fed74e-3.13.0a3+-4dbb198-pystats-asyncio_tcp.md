...
| JUMP_FORWARD | 2,613,912 | 0.6% | 87.3% |  |
| TO_BOOL | 2,436,464 | 0.6% | 87.9% |  |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 1,025,712 | 0.2% | 95.9% | 0.1% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 9,752,896 | 2.4% | 19.1% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 8,925,336 | 2.2% | 21.2% |
...
| TO_BOOL POP_JUMP_IF_TRUE | 2,411,168 | 0.6% | 55.2% |
...
| JUMP_FORWARD LOAD_FAST | 1,971,992 | 0.5% | 61.8% |
...
| LOAD_FAST TO_BOOL | 1,359,264 | 0.3% | 69.2% |
| POP_JUMP_IF_FALSE POP_TOP | 1,358,124 | 0.3% | 69.5% |
...
| LOAD_FAST STORE_FAST | 1,313,452 | 0.3% | 72.4% |
...
| POP_JUMP_IF_FALSE | 1,358,124 | 10.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 2,411,168 | 99.0% |
...
| POP_JUMP_IF_FALSE | 9,752,896 | 11.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 8,925,336 | 67.7% |
...
|---|---:|---:|
| Basic | 201,411,288 | 48.7% |
| Not specialized | 47,108,546 | 11.4% |
| Specialized hits | 165,019,912 | 39.9% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 5,501,248 | 32.0% |
| CALL | 4,362,046 | 25.3% |
| BINARY_OP | 4,225,824 | 24.5% |
| TO_BOOL | 2,430,684 | 14.1% |
| SEND | 658,060 | 3.8% |
...
| Frees to freelist | 9,627,204 |  |
| Allocations | 12,701,227 | 56.9% |
| Allocations to 512 bytes | 12,059,395 | 54.0% |
| Allocations to 4 kbytes | 580 | 0.0% |
| Allocations over 4 kbytes | 641,252 | 2.9% |
| Frees | 13,164,211 |  |
| New values | 700 |  |
| Interpreter increfs | 175,877,144 | 84.5% |
| Interpreter decrefs | 191,828,556 | 83.9% |
| Increfs | 32,319,472 | 15.5% |
| Decrefs | 36,723,848 | 16.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 6,249,526 |  |
| Method cache misses | 7,950 |  |
| Method cache collisions | 7,338 |  |
| Method cache dunder hits | 1,695,402 |  |
| Method cache dunder misses | 802 |  |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 3,214,566 | 14.2% | 14.2% |  |
| _CHECK_VALIDITY | 1,924,606 | 8.5% | 22.7% |  |
| _GUARD_TYPE_VERSION | 1,519,318 | 6.7% | 29.4% |  |
| LOAD_FAST | 1,488,086 | 6.6% | 35.9% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 1,038,190 | 4.6% | 40.5% |  |
| _CHECK_STACK_SPACE | 1,038,190 | 4.6% | 45.1% |  |
| _INIT_CALL_PY_EXACT_ARGS | 1,038,190 | 4.6% | 49.7% |  |
| _PUSH_FRAME | 1,038,190 | 4.6% | 54.3% |  |
| _SAVE_RETURN_OFFSET | 1,038,190 | 4.6% | 58.8% |  |
| _EXIT_TRACE | 1,030,488 | 4.5% | 63.4% | 100.0% |
...
| _GUARD_NOT_EXHAUSTED_LIST | 745,860 | 3.3% | 79.6% | 100.0% |
| _ITER_CHECK_LIST | 745,860 | 3.3% | 82.9% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 711,010 | 3.1% | 86.0% | 90.2% |
| _ITER_CHECK_RANGE | 711,010 | 3.1% | 89.2% |  |
| _GUARD_GLOBALS_VERSION | 350,560 | 1.5% | 90.7% |  |
| _LOAD_GLOBAL_MODULE | 320,160 | 1.4% | 92.1% |  |
| _LOAD_ATTR_SLOT | 248,820 | 1.1% | 93.2% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 162,440 | 0.7% | 93.9% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 162,440 | 0.7% | 94.7% |  |
| _GUARD_IS_FALSE_POP | 147,360 | 0.7% | 95.3% | 0.2% |
| TO_BOOL_BOOL | 139,640 | 0.6% | 95.9% |  |
| STORE_FAST | 133,060 | 0.6% | 96.5% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 132,058 | 0.6% | 97.1% |  |
| RESUME_CHECK | 77,390 | 0.3% | 97.4% |  |
| _LOAD_ATTR | 69,928 | 0.3% | 97.7% |  |
| _ITER_NEXT_RANGE | 69,850 | 0.3% | 98.0% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 62,250 | 0.3% | 98.3% |  |
| PUSH_NULL | 62,190 | 0.3% | 98.6% |  |
| BUILD_LIST | 62,190 | 0.3% | 98.9% |  |
| CALL_INTRINSIC_1 | 62,190 | 0.3% | 99.1% |  |
