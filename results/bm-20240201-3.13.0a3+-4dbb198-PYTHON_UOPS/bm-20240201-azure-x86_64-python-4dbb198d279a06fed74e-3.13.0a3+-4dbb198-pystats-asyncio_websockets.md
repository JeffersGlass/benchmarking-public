...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,991,930 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,137,856 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,135,438 | 5.3% | 29.1% |  |
| RESUME_CHECK | 863,540 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,560 | 3.8% | 36.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,552 | 3.6% | 40.5% | 0.1% |
...
| LOAD_GLOBAL_BUILTIN | 616,115 | 2.9% | 56.3% | 0.4% |
...
| COMPARE_OP_INT | 245,616 | 1.1% | 74.6% | 0.1% |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,632 | 3.5% | 3.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 401,056 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 242,936 | 1.1% | 22.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,356 | 0.8% | 28.1% |
...
| CACHE RESUME_CHECK | 164,540 | 0.8% | 34.5% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,636 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,356 | 0.4% | 54.0% |
...
| LOAD_GLOBAL_BUILTIN | 401,056 | 10.0% |
| LOAD_CONST | 213,298 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,632 | 18.8% |
...
| LOAD_GLOBAL_BUILTIN | 179,356 | 15.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 102,636 | 53.3% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,436 | 8.3% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 242,936 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,356 | 29.1% |
...
|---|---:|---:|
| Basic | 10,666,748 | 49.5% |
| Not specialized | 3,468,674 | 16.1% |
| Specialized hits | 7,320,401 | 34.0% |
| Specialized misses | 83,300 | 0.4% |
...
| Allocations | 1,597,856 | 67.3% |
| Allocations to 512 bytes | 1,407,665 | 59.3% |
| Allocations to 4 kbytes | 132,396 | 5.6% |
| Allocations over 4 kbytes | 57,795 | 2.4% |
| Frees | 1,536,780 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,354,558 | 76.8% |
| Interpreter decrefs | 14,170,369 | 78.4% |
| Increfs | 3,725,353 | 23.2% |
| Decrefs | 3,912,437 | 21.6% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,228,235 |  |
| Method cache misses | 31,825 |  |
| Method cache collisions | 34,971 |  |
| Method cache dunder hits | 357,257 |  |
| Method cache dunder misses | 6,563 |  |
...
| _SET_IP | 1,018,400 | 10.3% | 37.3% |  |
| _CHECK_VALIDITY | 948,520 | 9.6% | 46.9% |  |
