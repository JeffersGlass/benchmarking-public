...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,216,300 | 20.8% | 20.8% |  |
| LOAD_CONST | 39,087,464 | 16.2% | 36.9% |  |
...
| ENTER_EXECUTOR | 155,323 | 0.1% | 99.2% |  |
| POP_JUMP_IF_TRUE | 143,448 | 0.1% | 99.2% |  |
...
| COMPARE_OP_STR | 29,088 | 0.0% | 99.8% | 0.1% |
...
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 1,988 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_CONST | 38,900,728 | 16.1% | 16.1% |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,864 | 0.1% | 96.6% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 161,984 | 0.1% | 97.3% |
| LOAD_FAST CALL | 154,764 | 0.1% | 97.4% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS STORE_FAST | 153,580 | 0.1% | 97.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 152,228 | 0.1% | 97.5% |
| STORE_FAST LOAD_GLOBAL_MODULE | 149,868 | 0.1% | 97.6% |
...
| LOAD_FAST STORE_FAST | 108,848 | 0.0% | 97.8% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,316 | 0.0% | 98.2% |
...
| FOR_ITER STORE_FAST | 50,168 | 0.0% | 98.6% |
...
| COMPARE_OP_STR POP_JUMP_IF_FALSE | 19,148 | 0.0% | 99.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 50,168 | 83.8% |
| UNPACK_SEQUENCE_TWO_TUPLE | 5,088 | 8.5% |
| NOP | 1,540 | 2.6% |
| FOR_ITER | 1,080 | 1.8% |
| RETURN_CONST | 652 | 1.1% |
...
| COMPARE_OP_STR | 19,148 | 4.7% |
| CONTAINS_OP | 16,188 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 152,228 | 37.3% |
...
| LOAD_GLOBAL_MODULE | 149,868 | 22.3% |
| NOP | 106,240 | 15.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,864 | 80.0% |
...
|---|---:|---:|
| Basic | 150,027,563 | 62.0% |
| Not specialized | 10,883,235 | 4.5% |
| Specialized hits | 81,048,824 | 33.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 738,024 | 1.8% |
| Frees to freelist | 735,064 |  |
...
| Frees | 40,925,198 |  |
| New values | 1,420 |  |
| Interpreter increfs | 44,080,575 | 15.8% |
| Interpreter decrefs | 64,433,239 | 24.5% |
| Increfs | 235,614,162 | 84.2% |
| Decrefs | 198,438,168 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,529,655 |  |
| Method cache misses | 10,285 |  |
| Method cache collisions | 9,445 |  |
| Method cache dunder hits | 176,565 |  |
| Method cache dunder misses | 1,315 |  |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,157,188 | 24.4% | 24.4% |  |
| _SET_IP | 1,304,652 | 14.8% | 39.1% |  |
| _CHECK_VALIDITY | 1,244,084 | 14.1% | 53.2% |  |
| STORE_FAST | 833,748 | 9.4% | 62.6% |  |
| _GUARD_IS_FALSE_POP | 413,604 | 4.7% | 67.3% | 0.3% |
| _FOR_ITER_TIER_TWO | 375,060 | 4.2% | 71.6% | 12.4% |
| UNPACK_SEQUENCE_TWO_TUPLE | 329,032 | 3.7% | 75.3% |  |
| _JUMP_TO_TOP | 327,517 | 3.7% | 79.0% |  |
| CONTAINS_OP | 326,504 | 3.7% | 82.7% |  |
| STORE_SUBSCR_DICT | 322,900 | 3.7% | 86.3% |  |
| _GUARD_TYPE_VERSION | 103,612 | 1.2% | 87.5% |  |
| _GUARD_IS_TRUE_POP | 97,952 | 1.1% | 88.6% | 4.7% |
| TO_BOOL_STR | 88,780 | 1.0% | 89.6% |  |
| COMPARE_OP_STR | 85,412 | 1.0% | 90.6% |  |
| _EXIT_TRACE | 81,372 | 0.9% | 91.5% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,412 | 0.9% | 92.4% |  |
| _GUARD_GLOBALS_VERSION | 73,776 | 0.8% | 93.2% | 0.1% |
| _LOAD_GLOBAL_MODULE | 58,656 | 0.7% | 93.9% |  |
...
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 72 | 0.0% | 100.0% |  |
