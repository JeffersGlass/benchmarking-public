...
| Increfs | 248,459,851 | 37.0% |
| Decrefs | 205,325,914 | 28.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 237,058 |  |
| Method cache misses | 6,682 |  |
| Method cache collisions | 7,024 |  |
| Method cache dunder hits | 598,772 |  |
| Method cache dunder misses | 688 |  |
