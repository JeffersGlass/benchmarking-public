...
| Increfs | 230,239,246 | 98.9% |
| Decrefs | 320,736,895 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,048,689 |  |
| Method cache misses | 409,811 |  |
| Method cache collisions | 416,245 |  |
| Method cache dunder hits | 812,785 |  |
| Method cache dunder misses | 7,135 |  |
