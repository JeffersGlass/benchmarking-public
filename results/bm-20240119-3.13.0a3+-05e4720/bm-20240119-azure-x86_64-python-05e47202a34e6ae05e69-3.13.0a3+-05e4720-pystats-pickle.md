...
| Increfs | 231,956,988 | 97.9% |
| Decrefs | 246,660,488 | 97.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 5,652,872 |  |
| Method cache misses | 900,848 |  |
| Method cache collisions | 928,312 |  |
| Method cache dunder hits | 7,345,114 |  |
| Method cache dunder misses | 27,686 |  |
