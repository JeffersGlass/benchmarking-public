...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,813,572 | 20.6% | 20.6% |  |
| LOAD_CONST | 39,100,560 | 15.9% | 36.5% |  |
| CALL_PY_EXACT_ARGS | 19,653,160 | 8.0% | 44.4% |  |
...
| JUMP_BACKWARD | 499,300 | 0.2% | 97.2% |  |
...
| LOAD_GLOBAL_BUILTIN | 340,300 | 0.1% | 98.3% | 0.7% |
| STORE_SUBSCR_DICT | 340,280 | 0.1% | 98.4% |  |
| RESUME_CHECK | 334,040 | 0.1% | 98.5% | 2.3% |
| CALL | 267,982 | 0.1% | 98.6% |  |
| LOAD_ATTR_METHOD_NO_DICT | 255,576 | 0.1% | 98.7% |  |
| PUSH_NULL | 242,520 | 0.1% | 98.8% |  |
| RETURN_VALUE | 205,460 | 0.1% | 98.9% |  |
| TO_BOOL_STR | 189,680 | 0.1% | 99.0% | 0.3% |
| NOP | 180,420 | 0.1% | 99.1% |  |
...
| LIST_APPEND | 8,600 | 0.0% | 99.9% |  |
| IS_OP | 8,520 | 0.0% | 99.9% |  |
| STORE_FAST_LOAD_FAST | 7,920 | 0.0% | 99.9% |  |
...
| LOAD_GLOBAL_MODULE LOAD_FAST | 9,900,500 | 4.0% | 67.1% |
...
| STORE_SUBSCR_DICT JUMP_BACKWARD | 330,380 | 0.1% | 96.0% |
...
| PUSH_NULL LOAD_FAST | 228,120 | 0.1% | 96.6% |
| LOAD_ATTR_MODULE PUSH_NULL | 222,720 | 0.1% | 96.7% |
| POP_JUMP_IF_FALSE LOAD_FAST | 206,200 | 0.1% | 96.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 195,920 | 0.1% | 96.9% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 192,296 | 0.1% | 97.0% |
| LOAD_FAST CALL | 190,896 | 0.1% | 97.0% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 178,360 | 0.1% | 97.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 176,820 | 0.1% | 97.2% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 173,500 | 0.1% | 97.3% |
...
| JUMP_BACKWARD FOR_ITER_LIST | 64,040 | 0.0% | 98.2% |
...
| LOAD_FAST CALL_BUILTIN_CLASS | 58,180 | 0.0% | 98.3% |
...
| EXTENDED_ARG POP_JUMP_IF_FALSE | 54,440 | 0.0% | 98.5% |
...
| CACHE RESUME_CHECK | 38,640 | 0.0% | 99.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 108,920 | 60.4% |
| LOAD_GLOBAL_MODULE | 55,620 | 30.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_SUBSCR_DICT | 330,380 | 66.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER | 381,100 | 76.3% |
| FOR_ITER_LIST | 64,040 | 12.8% |
...
|---|---:|---:|
| Basic | 152,603,856 | 61.9% |
| Not specialized | 11,776,102 | 4.8% |
| Specialized hits | 82,230,752 | 33.3% |
...
| Calls to Python functions inlined | 19,729,680 | 99.7% |
...
| Frame objects created | 19,429,780 | 98.2% |
| Frames pushed | 19,667,780 | 99.4% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 736,736 | 1.8% |
| Frees to freelist | 733,776 |  |
| Allocations | 40,939,460 | 98.2% |
| Allocations to 512 bytes | 40,927,800 | 98.2% |
| Allocations to 4 kbytes | 6,620 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,916,588 |  |
| New values | 1,420 |  |
| Interpreter increfs | 43,916,868 | 15.7% |
| Interpreter decrefs | 64,266,684 | 24.5% |
| Increfs | 235,603,597 | 84.3% |
| Decrefs | 198,422,050 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,529,461 |  |
| Method cache misses | 10,579 |  |
| Method cache collisions | 9,728 |  |
| Method cache dunder hits | 175,055 |  |
| Method cache dunder misses | 1,605 |  |
