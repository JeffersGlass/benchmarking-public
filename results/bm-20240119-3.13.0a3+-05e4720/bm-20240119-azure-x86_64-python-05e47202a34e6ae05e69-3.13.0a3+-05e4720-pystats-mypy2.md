...
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,524,760,774 | 20.5% | 20.5% |  |
| LOAD_CONST | 366,969,208 | 4.9% | 25.5% |  |
| RESUME_CHECK | 351,232,946 | 4.7% | 30.2% | 0.0% |
| LOAD_GLOBAL_MODULE | 321,006,898 | 4.3% | 34.5% | 0.0% |
| STORE_ATTR_SLOT | 305,609,398 | 4.1% | 38.6% | 21.5% |
| LOAD_FAST_LOAD_FAST | 293,151,040 | 3.9% | 42.6% |  |
| LOAD_GLOBAL_BUILTIN | 287,583,437 | 3.9% | 46.5% | 0.0% |
| POP_JUMP_IF_FALSE | 286,112,830 | 3.9% | 50.3% |  |
| STORE_FAST | 278,237,052 | 3.7% | 54.1% |  |
| LOAD_ATTR_SLOT | 257,472,175 | 3.5% | 57.5% | 1.7% |
| CALL_PY_EXACT_ARGS | 223,519,934 | 3.0% | 60.5% | 10.1% |
| TO_BOOL_BOOL | 214,897,958 | 2.9% | 63.4% | 0.0% |
| RETURN_VALUE | 198,856,250 | 2.7% | 66.1% |  |
| RETURN_CONST | 149,955,856 | 2.0% | 68.1% |  |
| CALL_ISINSTANCE | 146,051,774 | 2.0% | 70.1% |  |
| LOAD_ATTR_METHOD_NO_DICT | 138,321,662 | 1.9% | 72.0% | 21.0% |
| POP_JUMP_IF_TRUE | 117,998,700 | 1.6% | 73.5% |  |
| POP_TOP | 111,029,252 | 1.5% | 75.0% |  |
| FOR_ITER_LIST | 85,693,586 | 1.2% | 76.2% | 1.2% |
| LOAD_ATTR_INSTANCE_VALUE | 83,165,080 | 1.1% | 77.3% | 3.5% |
| JUMP_BACKWARD | 70,394,320 | 0.9% | 78.3% |  |
| LOAD_DEREF | 66,165,204 | 0.9% | 79.1% |  |
| GET_ITER | 61,162,476 | 0.8% | 80.0% |  |
| INTERPRETER_EXIT | 60,472,058 | 0.8% | 80.8% |  |
| BINARY_SUBSCR_DICT | 60,383,720 | 0.8% | 81.6% |  |
| LOAD_ATTR | 58,783,580 | 0.8% | 82.4% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 58,090,461 | 0.8% | 83.2% | 12.4% |
| CONTAINS_OP | 50,748,124 | 0.7% | 83.9% |  |
...
| COMPARE_OP_STR | 27,771,261 | 0.4% | 90.2% | 0.2% |
| NOP | 26,746,920 | 0.4% | 90.6% |  |
| COPY | 25,474,112 | 0.3% | 90.9% |  |
| JUMP_FORWARD | 24,531,680 | 0.3% | 91.3% |  |
| TO_BOOL_LIST | 23,217,080 | 0.3% | 91.6% | 0.7% |
| COMPARE_OP | 21,529,194 | 0.3% | 91.9% |  |
| COMPARE_OP_INT | 21,443,841 | 0.3% | 92.2% | 1.9% |
| BINARY_SUBSCR | 20,449,600 | 0.3% | 92.4% |  |
| CALL_BUILTIN_CLASS | 20,200,392 | 0.3% | 92.7% |  |
| PUSH_NULL | 20,054,020 | 0.3% | 93.0% |  |
| FOR_ITER | 18,987,489 | 0.3% | 93.2% |  |
| EXTENDED_ARG | 18,915,400 | 0.3% | 93.5% |  |
| CALL_LEN | 18,094,940 | 0.2% | 93.7% |  |
| STORE_FAST_STORE_FAST | 18,061,360 | 0.2% | 94.0% |  |
| TO_BOOL_NONE | 17,749,996 | 0.2% | 94.2% | 7.7% |
| FOR_ITER_TUPLE | 17,649,088 | 0.2% | 94.4% | 5.6% |
| MAKE_CELL | 16,642,380 | 0.2% | 94.7% |  |
| BUILD_TUPLE | 16,155,199 | 0.2% | 94.9% |  |
...
| YIELD_VALUE | 5,615,620 | 0.1% | 98.9% |  |
...
| SEND_GEN | 230,580 | 0.0% | 100.0% |  |
| STORE_SUBSCR_LIST_INT | 217,380 | 0.0% | 100.0% |  |
| JUMP_BACKWARD_NO_INTERRUPT | 190,280 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_SLOT | 228,033,849 | 3.1% | 3.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 199,685,681 | 2.7% | 5.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 194,446,808 | 2.6% | 8.4% |
| LOAD_FAST STORE_ATTR_SLOT | 179,841,203 | 2.4% | 10.8% |
| RESUME_CHECK LOAD_FAST | 152,917,792 | 2.1% | 12.9% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 147,485,654 | 2.0% | 14.8% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 142,643,486 | 1.9% | 16.8% |
| LOAD_CONST LOAD_FAST | 141,403,220 | 1.9% | 18.7% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 139,280,374 | 1.9% | 20.5% |
| STORE_FAST LOAD_FAST | 139,176,132 | 1.9% | 22.4% |
| POP_JUMP_IF_FALSE LOAD_FAST | 132,972,551 | 1.8% | 24.2% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_SLOT | 124,082,140 | 1.7% | 25.9% |
| LOAD_GLOBAL_MODULE CALL_ISINSTANCE | 121,353,434 | 1.6% | 27.5% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 100,857,672 | 1.4% | 28.9% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 87,743,954 | 1.2% | 30.1% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 68,059,112 | 0.9% | 35.4% |
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 65,300,940 | 0.9% | 36.2% |
...
| STORE_ATTR_SLOT LOAD_FAST | 56,500,743 | 0.8% | 40.3% |
...
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 51,283,304 | 0.7% | 43.1% |
| POP_JUMP_IF_TRUE LOAD_FAST | 50,952,124 | 0.7% | 43.8% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 47,656,320 | 0.6% | 44.4% |
| FOR_ITER_LIST STORE_FAST | 46,860,389 | 0.6% | 45.1% |
| POP_TOP LOAD_FAST | 46,815,932 | 0.6% | 45.7% |
| COPY_FREE_VARS RESUME_CHECK | 46,553,660 | 0.6% | 46.3% |
| LOAD_GLOBAL_BUILTIN LOAD_DEREF | 46,073,720 | 0.6% | 47.0% |
| JUMP_BACKWARD FOR_ITER_LIST | 45,995,613 | 0.6% | 47.6% |
...
| RETURN_VALUE RETURN_VALUE | 40,345,808 | 0.5% | 51.6% |
...
| LOAD_ATTR_METHOD_NO_DICT CALL_PY_EXACT_ARGS | 37,184,272 | 0.5% | 54.2% |
| STORE_FAST LOAD_GLOBAL_MODULE | 35,868,062 | 0.5% | 54.7% |
| LOAD_SUPER_ATTR_METHOD LOAD_FAST_LOAD_FAST | 35,852,400 | 0.5% | 55.2% |
| CACHE RESUME_CHECK | 34,880,238 | 0.5% | 55.6% |
...
| LOAD_ATTR_SLOT LOAD_FAST | 30,558,576 | 0.4% | 57.3% |
...
| RETURN_VALUE LOAD_FAST | 25,055,820 | 0.3% | 59.9% |
| RETURN_VALUE INTERPRETER_EXIT | 24,629,878 | 0.3% | 60.2% |
| LOAD_ATTR_SLOT STORE_FAST | 24,427,620 | 0.3% | 60.5% |
| LOAD_FAST CONTAINS_OP | 23,977,560 | 0.3% | 60.9% |
| LOAD_ATTR_SLOT GET_ITER | 23,975,336 | 0.3% | 61.2% |
...
| GET_ITER FOR_ITER_LIST | 22,716,040 | 0.3% | 62.7% |
...
| LOAD_ATTR_SLOT RETURN_VALUE | 18,244,663 | 0.2% | 67.4% |
...
| LOAD_ATTR_SLOT LOAD_ATTR_SLOT | 17,359,549 | 0.2% | 68.3% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST | 16,669,870 | 0.2% | 69.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 23,975,336 | 39.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 22,716,040 | 37.1% |
| LOAD_FAST_AND_CLEAR | 13,391,480 | 21.9% |
| FOR_ITER_TUPLE | 9,690,097 | 15.8% |
| FOR_ITER | 7,324,699 | 12.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RETURN_CONST | 52,794,620 | 47.6% |
| RETURN_VALUE | 17,268,440 | 15.6% |
| POP_JUMP_IF_FALSE | 10,357,200 | 9.3% |
| POP_JUMP_IF_TRUE | 8,678,292 | 7.8% |
| RESUME_CHECK | 4,005,720 | 3.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 46,815,932 | 42.2% |
...
| RETURN_VALUE | 40,345,808 | 20.3% |
| RETURN_CONST | 21,420,800 | 10.8% |
| LOAD_ATTR_SLOT | 18,244,663 | 9.2% |
| CALL | 6,285,840 | 3.2% |
...
| RETURN_VALUE | 40,345,808 | 20.3% |
| LOAD_FAST | 25,055,820 | 12.6% |
| INTERPRETER_EXIT | 24,629,878 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 9,125,383 | 42.4% |
| LOAD_GLOBAL_MODULE | 4,324,160 | 20.1% |
| LOAD_CONST | 3,875,967 | 18.0% |
| LOAD_ATTR_MODULE | 1,646,700 | 7.6% |
| LOAD_FAST | 1,086,460 | 5.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| COPY | 8,442,962 | 39.2% |
| POP_JUMP_IF_FALSE | 6,840,207 | 31.8% |
| RETURN_VALUE | 4,202,685 | 19.5% |
...
| POP_JUMP_IF_TRUE | 7,850,984 | 15.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 8,049,778 | 42.4% |
| GET_ITER | 7,324,699 | 38.6% |
...
| STORE_FAST | 2,970,425 | 15.6% |
| RETURN_CONST | 2,803,100 | 14.8% |
| LOAD_FAST | 2,349,833 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 19,052,940 | 27.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 45,995,613 | 65.3% |
| FOR_ITER | 8,049,778 | 11.4% |
| FOR_ITER_TUPLE | 6,581,101 | 9.3% |
...
| LOAD_FAST | 3,211,184 | 4.9% |
| LOAD_GLOBAL_MODULE | 2,560,200 | 3.9% |
| POP_JUMP_IF_FALSE | 1,324,456 | 2.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 199,685,681 | 13.1% |
| RESUME_CHECK | 152,917,792 | 10.0% |
| LOAD_CONST | 141,403,220 | 9.3% |
| STORE_FAST | 139,176,132 | 9.1% |
| POP_JUMP_IF_FALSE | 132,972,551 | 8.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 228,033,849 | 15.0% |
| STORE_ATTR_SLOT | 179,841,203 | 11.8% |
| LOAD_GLOBAL_MODULE | 139,280,374 | 9.1% |
| LOAD_ATTR_METHOD_NO_DICT | 100,857,672 | 6.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 147,485,654 | 51.5% |
| CONTAINS_OP | 41,062,580 | 14.4% |
| IS_OP | 19,099,360 | 6.7% |
| COMPARE_OP_INT | 13,456,749 | 4.7% |
| TO_BOOL_ALWAYS_TRUE | 12,610,110 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 132,972,551 | 46.5% |
| LOAD_GLOBAL_BUILTIN | 68,059,112 | 23.8% |
| LOAD_GLOBAL_MODULE | 25,161,580 | 8.8% |
| LOAD_FAST_LOAD_FAST | 15,884,340 | 5.6% |
| POP_TOP | 10,357,200 | 3.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 51,283,304 | 43.5% |
| TO_BOOL_LIST | 17,441,920 | 14.8% |
| COMPARE_OP_STR | 16,223,172 | 13.7% |
| CONTAINS_OP | 7,850,984 | 6.7% |
| IS_OP | 5,854,640 | 5.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 50,952,124 | 43.2% |
| JUMP_BACKWARD | 19,052,940 | 16.1% |
| LOAD_GLOBAL_MODULE | 13,709,460 | 11.6% |
| POP_TOP | 8,678,292 | 7.4% |
| NOP | 7,043,520 | 6.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 139,176,132 | 50.0% |
| LOAD_GLOBAL_BUILTIN | 39,219,060 | 14.1% |
| LOAD_GLOBAL_MODULE | 35,868,062 | 12.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 121,353,434 | 83.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 142,643,486 | 97.7% |
| COPY | 2,145,320 | 1.5% |
| YIELD_VALUE | 629,920 | 0.4% |
| RETURN_VALUE | 373,228 | 0.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 9,290,769 | 43.3% |
| CALL_LEN | 3,056,360 | 14.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 13,456,749 | 62.8% |
| POP_JUMP_IF_TRUE | 5,780,900 | 27.0% |
| COPY | 1,052,830 | 4.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 19,959,496 | 71.9% |
| LOAD_FAST | 4,531,692 | 16.3% |
| BINARY_SUBSCR_TUPLE_INT | 1,646,960 | 5.9% |
| RETURN_VALUE | 478,820 | 1.7% |
| LOAD_ATTR_INSTANCE_VALUE | 419,330 | 1.5% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 16,223,172 | 58.4% |
| POP_JUMP_IF_FALSE | 8,950,620 | 32.2% |
| COPY | 1,547,764 | 5.6% |
| RETURN_VALUE | 614,885 | 2.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 45,995,613 | 53.7% |
| GET_ITER | 22,716,040 | 26.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 46,860,389 | 54.7% |
| LOAD_FAST | 13,545,884 | 15.8% |
| SWAP | 8,945,260 | 10.4% |
| RETURN_CONST | 7,250,516 | 8.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| GET_ITER | 9,690,097 | 54.9% |
| JUMP_BACKWARD | 6,581,101 | 37.3% |
| SWAP | 1,314,320 | 7.4% |
| EXTENDED_ARG | 34,520 | 0.2% |
| FOR_ITER_LIST | 17,924 | 0.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 8,764,143 | 49.7% |
| STORE_FAST | 4,323,498 | 24.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 100,857,672 | 72.9% |
| LOAD_ATTR_SLOT | 15,260,496 | 11.0% |
...
| CALL_PY_EXACT_ARGS | 37,184,272 | 26.9% |
| LOAD_CONST | 13,122,436 | 9.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 9,948,840 | 72.3% |
| LOAD_ATTR_SLOT | 3,393,002 | 24.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 12,867,960 | 93.5% |
| RETURN_VALUE | 533,605 | 3.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 228,033,849 | 88.6% |
| LOAD_ATTR_SLOT | 17,359,549 | 6.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 30,558,576 | 11.9% |
| STORE_FAST | 24,427,620 | 9.5% |
| GET_ITER | 23,975,336 | 9.3% |
| RETURN_VALUE | 18,244,663 | 7.1% |
| LOAD_ATTR_SLOT | 17,359,549 | 6.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 87,743,954 | 30.5% |
| POP_JUMP_IF_FALSE | 68,059,112 | 23.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 139,280,374 | 43.4% |
| STORE_FAST | 35,868,062 | 11.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 121,353,434 | 37.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 194,446,808 | 55.4% |
| COPY_FREE_VARS | 46,553,660 | 13.3% |
| CACHE | 34,880,238 | 9.9% |
| CALL_KW | 21,713,260 | 6.2% |
| CALL_BOUND_METHOD_EXACT_ARGS | 13,891,440 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 152,917,792 | 43.5% |
| LOAD_GLOBAL_BUILTIN | 87,743,954 | 25.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD_NO_INTERRUPT | 182,600 | 79.2% |
| LOAD_CONST | 47,920 | 20.8% |
| SEND | 60 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 182,600 | 79.2% |
| POP_TOP | 47,940 | 20.8% |
| RESUME | 40 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 179,841,203 | 58.8% |
| LOAD_FAST_LOAD_FAST | 124,082,140 | 40.6% |
| STORE_ATTR_SLOT | 1,242,015 | 0.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 142,643,486 | 66.4% |
| COPY | 19,281,512 | 9.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 147,485,654 | 68.6% |
| POP_JUMP_IF_TRUE | 51,283,304 | 23.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 11,574,930 | 65.2% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 64,155,566 | 11.0% |
|          hit | 516,494,107 | 88.8% |
|         miss | 30,527,172 | 5.3% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 20,921,316 | 16.2% |
|          hit | 108,455,672 | 83.8% |
|         miss | 2,016,722 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 102,470,569 | 15.8% |
|        deopt | 780 | 0.0% |
|          hit | 545,098,544 | 84.0% |
|         miss | 44,848,896 | 6.9% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,000,427 | 86.1% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 71,281,884 | 20.3% |
|          hit | 278,698,299 | 79.3% |
|         miss | 66,739,959 | 19.0% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,281,395 | 98.4% |
| Failure | 20,420 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 13,805,576 | 4.8% |
|          hit | 273,547,062 | 95.1% |
|         miss | 3,712,356 | 1.3% |
...
|---|---:|---:|
| Basic | 3,723,160,725 | 50.1% |
| Not specialized | 676,540,333 | 9.1% |
| Specialized hits | 2,878,844,683 | 38.8% |
| Specialized misses | 148,381,209 | 2.0% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 102,470,569 | 32.1% |
| STORE_ATTR | 71,281,884 | 22.3% |
| CALL | 64,155,566 | 20.1% |
| COMPARE_OP | 21,920,580 | 6.9% |
| FOR_ITER | 20,921,316 | 6.5% |
| BINARY_SUBSCR | 20,416,720 | 6.4% |
| TO_BOOL | 13,805,576 | 4.3% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| STORE_ATTR_SLOT | 65,847,479 | 44.4% |
| LOAD_ATTR_METHOD_NO_DICT | 29,041,181 | 19.6% |
| CALL_PY_EXACT_ARGS | 22,563,472 | 15.2% |
| LOAD_ATTR_METHOD_WITH_VALUES | 7,217,584 | 4.9% |
| LOAD_ATTR_SLOT | 4,295,409 | 2.9% |
...
| TO_BOOL_ALWAYS_TRUE | 1,927,846 | 1.3% |
| TO_BOOL_NONE | 1,374,290 | 0.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 60,498,478 | 17.0% |
| Calls to Python functions inlined | 294,689,948 | 83.0% |
| Calls via PyEval_EvalFrame (total) | 60,498,478 | 17.0% |
| Calls via PyEval_EvalFrame (vector) | 53,288,238 | 15.0% |
| Calls via PyEval_EvalFrame (generator) | 7,210,240 | 2.0% |
| Calls via PyEval_EvalFrame (legacy) | 100 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 53,288,098 | 15.0% |
| Calls via PyEval_EvalFrame (build class) | 40 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 6,953,494 | 2.0% |
| Calls via PyEval_EvalFrame (function ex) | 1,237,660 | 0.3% |
| Calls via PyEval_EvalFrame (api) | 11,829,044 | 3.3% |
| Calls via PyEval_EvalFrame (method) | 100 | 0.0% |
| Frame objects created | 2,373,920 | 0.7% |
| Frames pushed | 243,152,262 | 68.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 153,532,228 | 28.5% |
| Frees to freelist | 153,577,539 |  |
| Allocations | 384,694,617 | 71.5% |
| Allocations to 512 bytes | 384,173,273 | 71.4% |
| Allocations to 4 kbytes | 362,124 | 0.1% |
| Allocations over 4 kbytes | 159,220 | 0.0% |
| Frees | 379,268,387 |  |
| New values | 4,435,060 |  |
| Interpreter increfs | 3,598,203,905 | 73.8% |
| Interpreter decrefs | 3,968,998,171 | 74.9% |
| Increfs | 1,279,647,824 | 26.2% |
| Decrefs | 1,333,551,452 | 25.1% |
| Materialize dict (on request) | 340 | 0.0% |
| Materialize dict (new key) | 1,160 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 220 | 0.0% |
| Method cache hits | 211,086,136 |  |
| Method cache misses | 4,557,099 |  |
| Method cache collisions | 5,901,748 |  |
| Method cache dunder hits | 177,672,189 |  |
| Method cache dunder misses | 1,365,573 |  |
