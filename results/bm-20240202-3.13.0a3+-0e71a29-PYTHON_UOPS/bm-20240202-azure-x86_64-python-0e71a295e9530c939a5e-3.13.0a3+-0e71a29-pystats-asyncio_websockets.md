...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,992,269 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,138,079 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,135,763 | 5.3% | 29.1% |  |
| RESUME_CHECK | 863,865 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,884 | 3.8% | 36.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,648 | 3.6% | 40.5% | 0.1% |
...
| LOAD_GLOBAL_BUILTIN | 615,720 | 2.9% | 56.3% | 0.4% |
...
| COMPARE_OP_INT | 245,460 | 1.1% | 74.6% | 0.1% |
| LOAD_ATTR_METHOD_NO_DICT | 236,283 | 1.1% | 75.7% | 0.4% |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 115,537 | 0.5% | 88.9% | 8.6% |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,648 | 3.5% | 3.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,783 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 242,783 | 1.1% | 22.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,203 | 0.8% | 28.9% |
...
| LOAD_GLOBAL_BUILTIN | 400,783 | 10.0% |
| LOAD_CONST | 213,302 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,648 | 18.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 561,595 | 49.3% |
| LOAD_GLOBAL_BUILTIN | 179,203 | 15.7% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,284 | 8.3% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 242,783 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,203 | 29.1% |
...
|---|---:|---:|
| Basic | 10,670,486 | 49.5% |
| Not specialized | 3,470,083 | 16.1% |
| Specialized hits | 7,324,290 | 34.0% |
...
| Allocations | 1,603,733 | 67.4% |
| Allocations to 512 bytes | 1,413,468 | 59.4% |
| Allocations to 4 kbytes | 132,427 | 5.6% |
| Allocations over 4 kbytes | 57,838 | 2.4% |
| Frees | 1,542,725 |  |
| New values | 34,900 |  |
| Interpreter increfs | 12,352,753 | 76.8% |
| Interpreter decrefs | 14,168,509 | 78.3% |
| Increfs | 3,739,878 | 23.2% |
| Decrefs | 3,929,333 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,218,184 |  |
| Method cache misses | 41,949 |  |
| Method cache collisions | 51,130 |  |
| Method cache dunder hits | 352,296 |  |
| Method cache dunder misses | 11,589 |  |
