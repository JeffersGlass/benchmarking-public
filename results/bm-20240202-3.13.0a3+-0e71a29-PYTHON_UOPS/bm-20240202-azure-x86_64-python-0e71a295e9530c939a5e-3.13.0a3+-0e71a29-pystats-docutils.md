...
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,888,349,700 | 19.9% | 19.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 434,264,380 | 4.6% | 24.5% | 30.9% |
| STORE_FAST | 421,044,320 | 4.4% | 28.9% |  |
| RESUME_CHECK | 415,660,420 | 4.4% | 33.3% | 0.0% |
| LOAD_CONST | 355,942,820 | 3.8% | 37.1% |  |
| LOAD_FAST_LOAD_FAST | 330,394,580 | 3.5% | 40.6% |  |
...
| CALL_PY_EXACT_ARGS | 250,438,880 | 2.6% | 55.0% | 4.9% |
| RETURN_CONST | 215,473,120 | 2.3% | 57.2% |  |
| ENTER_EXECUTOR | 211,111,880 | 2.2% | 59.5% |  |
| TO_BOOL_BOOL | 201,383,520 | 2.1% | 61.6% | 0.0% |
| RETURN_VALUE | 194,583,060 | 2.1% | 63.6% |  |
| LOAD_ATTR | 186,691,300 | 2.0% | 65.6% |  |
| NOP | 165,968,380 | 1.8% | 67.3% |  |
| GET_ITER | 163,392,260 | 1.7% | 69.1% |  |
| LOAD_ATTR_METHOD_NO_DICT | 157,804,960 | 1.7% | 70.7% | 0.1% |
| POP_JUMP_IF_TRUE | 152,980,580 | 1.6% | 72.3% |  |
...
| CALL_ISINSTANCE | 106,056,780 | 1.1% | 77.3% |  |
...
| TO_BOOL_STR | 17,119,320 | 0.2% | 96.7% | 5.0% |
...
| CALL_TYPE_1 | 5,605,220 | 0.1% | 99.2% |  |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 199,585,980 | 2.1% | 5.6% |
| STORE_FAST LOAD_FAST | 196,341,260 | 2.1% | 7.6% |
| RESUME_CHECK LOAD_FAST | 188,853,380 | 2.0% | 9.6% |
...
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 136,626,040 | 1.4% | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST | 117,554,220 | 1.2% | 20.4% |
| RETURN_CONST POP_TOP | 112,851,080 | 1.2% | 21.6% |
| LOAD_FAST LOAD_ATTR | 109,540,160 | 1.2% | 22.8% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 104,593,040 | 1.1% | 23.9% |
...
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 93,848,860 | 1.0% | 28.0% |
...
| LOAD_FAST RETURN_VALUE | 28,805,680 | 0.3% | 64.3% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 27,446,300 | 0.3% | 66.4% |
...
| LOAD_GLOBAL_BUILTIN | 2,260 | 0.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 709,660 | 63.0% |
...
| LOAD_ATTR_METHOD_NO_DICT | 23,558,560 | 6.6% |
...
| LOAD_GLOBAL_BUILTIN | 18,596,580 | 17.5% |
| LOAD_ATTR_MODULE | 6,818,060 | 6.4% |
| LOAD_FAST | 1,340,120 | 1.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 104,593,040 | 98.6% |
...
| LOAD_GLOBAL_BUILTIN | 11,860 | 0.2% |
| PUSH_NULL | 6,380 | 0.1% |
...
| CALL_ISINSTANCE | 18,596,580 | 6.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 199,585,980 | 48.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 104,593,040 | 51.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 136,626,040 | 67.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 8,795,040 | 51.4% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 104,233,140 | 13.1% |
|          hit | 690,702,880 | 86.8% |
|         miss | 23,095,560 | 2.9% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 487,880 | 88.8% |
| Failure | 61,740 | 11.2% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 545,937,880 | 40.2% |
|        deopt | 500 | 0.0% |
|          hit | 805,923,180 | 59.3% |
...
|---|---:|---:|
| Basic | 4,925,531,600 | 51.9% |
| Not specialized | 904,164,360 | 9.5% |
| Specialized hits | 3,129,104,560 | 33.0% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 545,937,880 | 63.5% |
| CALL | 104,233,140 | 12.1% |
...
| Calls to Python functions inlined | 409,370,060 | 88.4% |
...
| Frames pushed | 308,877,600 | 66.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 369,618,700 | 30.3% |
| Frees to freelist | 372,571,480 |  |
| Allocations | 851,628,100 | 69.7% |
| Allocations to 512 bytes | 850,462,920 | 69.6% |
| Allocations to 4 kbytes | 700,420 | 0.1% |
| Allocations over 4 kbytes | 464,760 | 0.0% |
| Frees | 895,272,908 |  |
| New values | 10,573,940 |  |
| Interpreter increfs | 4,577,786,760 | 62.1% |
| Interpreter decrefs | 5,675,311,240 | 68.3% |
| Increfs | 2,795,448,421 | 37.9% |
| Decrefs | 2,640,114,976 | 31.7% |
| Materialize dict (on request) | 113,800 | 1.1% |
| Materialize dict (new key) | 150,400 | 1.4% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 78,600 | 0.7% |
| Method cache hits | 577,687,613 |  |
| Method cache misses | 49,219,627 |  |
| Method cache collisions | 51,927,566 |  |
| Method cache dunder hits | 286,630,186 |  |
| Method cache dunder misses | 2,731,454 |  |
...
| Uops executed | 2,944,564,800 | 13.95 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 405,015,700 | 13.8% | 13.8% |  |
| _SET_IP | 352,778,640 | 12.0% | 25.7% |  |
| STORE_FAST | 257,172,120 | 8.7% | 34.5% |  |
| _CHECK_VALIDITY | 254,512,160 | 8.6% | 43.1% |  |
...
| RESUME_CHECK | 8,629,400 | 0.3% | 96.3% |  |
