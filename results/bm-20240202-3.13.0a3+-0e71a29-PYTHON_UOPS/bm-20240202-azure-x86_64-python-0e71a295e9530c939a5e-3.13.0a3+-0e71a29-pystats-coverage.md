...
|---|---:|---:|---:|---:|
| LOAD_FAST | 98,772,521 | 20.8% | 20.8% |  |
| LOAD_CONST | 77,932,998 | 16.4% | 37.2% |  |
| CALL_PY_EXACT_ARGS | 39,063,476 | 8.2% | 45.4% |  |
...
| LOAD_GLOBAL_MODULE | 20,005,323 | 4.2% | 90.5% |  |
| LOAD_GLOBAL | 19,485,580 | 4.1% | 94.6% |  |
| BINARY_OP_ADD_INT | 19,428,860 | 4.1% | 98.7% |  |
| STORE_FAST | 672,918 | 0.1% | 98.9% |  |
| POP_JUMP_IF_FALSE | 407,627 | 0.1% | 99.0% |  |
| LOAD_ATTR_MODULE | 387,199 | 0.1% | 99.0% | 3.2% |
| TO_BOOL_BOOL | 338,636 | 0.1% | 99.1% |  |
| LOAD_GLOBAL_BUILTIN | 326,800 | 0.1% | 99.2% | 0.7% |
| RESUME_CHECK | 322,200 | 0.1% | 99.2% | 2.4% |
| CALL | 269,041 | 0.1% | 99.3% |  |
| PUSH_NULL | 235,900 | 0.0% | 99.4% |  |
| RETURN_VALUE | 197,500 | 0.0% | 99.4% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 177,360 | 0.0% | 99.4% | 0.0% |
| LOAD_ATTR_METHOD_NO_DICT | 176,187 | 0.0% | 99.5% |  |
| NOP | 174,660 | 0.0% | 99.5% |  |
| LOAD_FAST_LOAD_FAST | 166,880 | 0.0% | 99.5% |  |
| ENTER_EXECUTOR | 155,001 | 0.0% | 99.6% |  |
...
| EXTENDED_ARG | 34,520 | 0.0% | 99.8% |  |
| YIELD_VALUE | 32,660 | 0.0% | 99.8% |  |
| BUILD_TUPLE | 32,460 | 0.0% | 99.9% |  |
| STORE_FAST_STORE_FAST | 31,896 | 0.0% | 99.9% |  |
...
| INSTRUMENTED_FOR_ITER | 11,356 | 0.0% | 99.9% |  |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,863 | 0.1% | 98.3% |
| STORE_FAST LOAD_FAST | 272,587 | 0.1% | 98.3% |
...
| CALL_PY_EXACT_ARGS RESUME_CHECK | 183,436 | 0.0% | 98.5% |
| LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 173,460 | 0.0% | 98.5% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 167,796 | 0.0% | 98.6% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 163,700 | 0.0% | 98.6% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 161,976 | 0.0% | 98.6% |
| LOAD_FAST CALL | 155,156 | 0.0% | 98.7% |
...
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 148,987 | 0.0% | 98.8% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,307 | 0.0% | 99.1% |
...
| LOAD_FAST CALL_BUILTIN_CLASS | 53,140 | 0.0% | 99.3% |
| CALL_BUILTIN_CLASS GET_ITER | 51,340 | 0.0% | 99.3% |
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 51,296 | 0.0% | 99.3% |
...
| LOAD_CONST LOAD_CONST | 49,780 | 0.0% | 99.3% |
...
| LOAD_ATTR_MODULE LOAD_ATTR_MODULE | 43,756 | 0.0% | 99.4% |
...
| LOAD_CONST MAP_ADD | 19,720 | 0.0% | 99.6% |
| COMPARE_OP_STR POP_JUMP_IF_FALSE | 19,111 | 0.0% | 99.6% |
| LOAD_GLOBAL_MODULE LOAD_FAST_LOAD_FAST | 19,020 | 0.0% | 99.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 29,100 | 39.4% |
| RESUME_CHECK | 13,060 | 17.7% |
| LOAD_FAST | 10,740 | 14.5% |
| JUMP_BACKWARD | 6,340 | 8.6% |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 5,116 | 8.5% |
| NOP | 1,540 | 2.6% |
| FOR_ITER | 1,080 | 1.8% |
...
| CALL_PY_EXACT_ARGS | 167,796 | 0.2% |
| CALL | 155,156 | 0.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,863 | 80.0% |
| LOAD_ATTR_MODULE | 43,756 | 11.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| PUSH_NULL | 222,040 | 57.3% |
| LOAD_FAST | 66,307 | 17.1% |
| LOAD_ATTR_MODULE | 43,756 | 11.3% |
| LOAD_CONST | 14,956 | 3.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 183,436 | 56.9% |
| CALL | 54,440 | 16.9% |
| CACHE | 39,340 | 12.2% |
| POP_TOP | 13,060 | 4.1% |
...
|---|---:|---:|
| Basic | 295,694,269 | 62.2% |
| Not specialized | 20,595,199 | 4.3% |
| Specialized hits | 158,737,799 | 33.4% |
...
| Calls to Python functions inlined | 39,138,416 | 99.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 738,176 | 0.9% |
| Frees to freelist | 735,216 |  |
| Allocations | 79,820,560 | 99.1% |
| Allocations to 512 bytes | 79,808,400 | 99.1% |
| Allocations to 4 kbytes | 7,120 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 79,798,280 |  |
| New values | 2,340 |  |
| Interpreter increfs | 82,926,309 | 15.0% |
| Interpreter decrefs | 122,730,885 | 23.8% |
| Increfs | 468,687,694 | 85.0% |
| Decrefs | 392,664,846 | 76.2% |
| Materialize dict (on request) | 240 | 10.3% |
| Materialize dict (new key) | 220 | 9.4% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 2.6% |
| Method cache hits | 38,951,877 |  |
| Method cache misses | 10,863 |  |
| Method cache collisions | 10,054 |  |
| Method cache dunder hits | 176,622 |  |
| Method cache dunder misses | 1,398 |  |
...
| Traces executed | 155,001 |  |
| Uops executed | 8,818,426 | 56.89 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,155,831 | 24.4% | 24.4% |  |
| _SET_IP | 1,303,164 | 14.8% | 39.2% |  |
| _CHECK_VALIDITY | 1,243,553 | 14.1% | 53.3% |  |
| STORE_FAST | 833,266 | 9.4% | 62.8% |  |
| _GUARD_IS_FALSE_POP | 413,698 | 4.7% | 67.5% | 0.3% |
| _FOR_ITER_TIER_TWO | 375,060 | 4.3% | 71.7% | 12.4% |
| UNPACK_SEQUENCE_TWO_TUPLE | 329,024 | 3.7% | 75.5% |  |
| _JUMP_TO_TOP | 327,199 | 3.7% | 79.2% |  |
| CONTAINS_OP | 326,493 | 3.7% | 82.9% |  |
| STORE_SUBSCR_DICT | 322,900 | 3.7% | 86.5% |  |
| _GUARD_TYPE_VERSION | 103,769 | 1.2% | 87.7% |  |
| _GUARD_IS_TRUE_POP | 97,984 | 1.1% | 88.8% | 4.7% |
| TO_BOOL_STR | 88,800 | 1.0% | 89.8% |  |
| COMPARE_OP_STR | 85,449 | 1.0% | 90.8% |  |
| _EXIT_TRACE | 81,424 | 0.9% | 91.7% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,429 | 0.9% | 92.6% |  |
| _CHECK_GLOBALS | 60,433 | 0.7% | 93.3% |  |
| _ITER_CHECK_LIST | 57,540 | 0.7% | 94.0% | 1.1% |
| _GUARD_NOT_EXHAUSTED_LIST | 56,880 | 0.6% | 94.6% | 23.5% |
| _LOAD_CONST_INLINE_WITH_NULL | 56,420 | 0.6% | 95.2% |  |
| _ITER_NEXT_LIST | 43,520 | 0.5% | 95.7% |  |
| CALL_METHOD_DESCRIPTOR_O | 42,280 | 0.5% | 96.2% |  |
| UNPACK_SEQUENCE_TUPLE | 42,040 | 0.5% | 96.7% |  |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 20,220 | 0.2% | 96.9% |  |
| _GUARD_KEYS_VERSION | 20,220 | 0.2% | 97.1% |  |
| _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES | 19,520 | 0.2% | 97.4% |  |
| LOAD_DEREF | 16,580 | 0.2% | 97.6% |  |
| _CHECK_BUILTINS | 14,400 | 0.2% | 97.7% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 13,784 | 0.2% | 97.9% |  |
| _CHECK_STACK_SPACE | 13,784 | 0.2% | 98.0% |  |
| _INIT_CALL_PY_EXACT_ARGS | 13,784 | 0.2% | 98.2% |  |
| _PUSH_FRAME | 13,784 | 0.2% | 98.3% |  |
| _SAVE_RETURN_OFFSET | 13,784 | 0.2% | 98.5% |  |
| _LOAD_CONST_INLINE | 13,321 | 0.2% | 98.6% |  |
| RESUME_CHECK | 12,480 | 0.1% | 98.8% |  |
| _LOAD_CONST_INLINE_BORROW | 11,638 | 0.1% | 98.9% |  |
| _POP_FRAME | 8,220 | 0.1% | 99.0% |  |
| TO_BOOL_BOOL | 8,200 | 0.1% | 99.1% |  |
| _CHECK_ATTR_MODULE | 7,781 | 0.1% | 99.2% | 44.2% |
| PUSH_NULL | 7,260 | 0.1% | 99.3% |  |
| _LOAD_ATTR | 6,100 | 0.1% | 99.3% |  |
| CALL_BUILTIN_CLASS | 5,680 | 0.1% | 99.4% |  |
| _LOAD_CONST_INLINE_BORROW_WITH_NULL | 5,680 | 0.1% | 99.5% |  |
| _LOAD_ATTR_MODULE | 4,341 | 0.0% | 99.5% |  |
