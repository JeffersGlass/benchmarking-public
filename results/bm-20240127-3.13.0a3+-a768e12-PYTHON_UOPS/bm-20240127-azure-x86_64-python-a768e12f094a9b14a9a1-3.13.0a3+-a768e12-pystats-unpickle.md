...
| Increfs | 230,239,269 | 98.9% |
| Decrefs | 320,737,076 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 2,048,693 |  |
| Method cache misses | 409,807 |  |
| Method cache collisions | 412,503 |  |
| Method cache dunder hits | 816,564 |  |
| Method cache dunder misses | 3,356 |  |
