...
| LOAD_FAST | 48,233,250 | 11.5% | 25.4% |  |
...
| POP_JUMP_IF_FALSE | 20,425,830 | 4.9% | 58.7% |  |
| POP_JUMP_IF_TRUE | 19,816,800 | 4.7% | 63.4% |  |
| RESUME_CHECK | 17,262,810 | 4.1% | 67.5% |  |
| RETURN_VALUE | 16,401,550 | 3.9% | 71.4% |  |
| LOAD_CONST | 13,164,560 | 3.1% | 74.6% |  |
| CALL_PY_EXACT_ARGS | 12,183,680 | 2.9% | 77.5% | 0.0% |
| LOAD_ATTR | 10,622,570 | 2.5% | 80.0% |  |
| CONTAINS_OP | 8,434,990 | 2.0% | 82.0% |  |
| TO_BOOL_BOOL | 8,032,060 | 1.9% | 83.9% |  |
| CALL_BUILTIN_FAST | 8,006,130 | 1.9% | 85.8% | 0.0% |
| ENTER_EXECUTOR | 6,922,720 | 1.7% | 87.5% |  |
| CALL_TYPE_1 | 4,752,960 | 1.1% | 88.6% |  |
| FOR_ITER_TUPLE | 4,643,830 | 1.1% | 89.7% |  |
| NOP | 4,438,810 | 1.1% | 90.8% |  |
| GET_ITER | 4,438,160 | 1.1% | 91.9% |  |
| POP_TOP | 3,851,400 | 0.9% | 92.8% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 9,528,070 | 2.3% | 30.2% |
...
| LOAD_ATTR CONTAINS_OP | 6,044,330 | 1.4% | 49.5% |
| POP_JUMP_IF_TRUE LOAD_FAST_LOAD_FAST | 6,043,240 | 1.4% | 50.9% |
| RETURN_VALUE LOAD_GLOBAL_MODULE | 6,041,640 | 1.4% | 52.3% |
| POP_JUMP_IF_TRUE ENTER_EXECUTOR | 5,923,980 | 1.4% | 53.7% |
| LOAD_CONST LOAD_CONST | 5,348,530 | 1.3% | 55.0% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 5,344,340 | 1.3% | 56.3% |
...
| STORE_FAST NOP | 4,428,410 | 1.1% | 65.6% |
| CALL STORE_FAST | 4,427,240 | 1.1% | 66.6% |
| ENTER_EXECUTOR CALL | 3,671,740 | 0.9% | 67.5% |
...
| POP_JUMP_IF_TRUE LOAD_GLOBAL_BUILTIN | 2,665,270 | 0.6% | 72.6% |
...
| LOAD_CONST CALL | 2,378,560 | 0.6% | 76.6% |
| LOAD_GLOBAL_MODULE CALL_METHOD_DESCRIPTOR_FAST | 2,378,440 | 0.6% | 77.2% |
...
| CALL | 8,426,510 | 30.2% |
| ENTER_EXECUTOR | 3,671,740 | 13.2% |
| LOAD_CONST | 2,378,560 | 8.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 5,923,980 | 85.6% |
| POP_JUMP_IF_NONE | 532,180 | 7.7% |
| FOR_ITER_LIST | 245,080 | 3.5% |
| ENTER_EXECUTOR | 204,580 | 3.0% |
| POP_TOP | 5,540 | 0.1% |
...
| POP_JUMP_IF_FALSE | 9,528,070 | 19.8% |
...
| POP_JUMP_IF_TRUE | 6,043,240 | 26.9% |
| LOAD_ATTR_CLASS | 2,375,660 | 10.6% |
| PUSH_NULL | 2,050,130 | 9.1% |
| POP_JUMP_IF_FALSE | 1,849,020 | 8.2% |
...
| TO_BOOL_BOOL | 5,344,340 | 27.0% |
| TO_BOOL_STR | 4,480 | 0.0% |
| COMPARE_OP_INT | 1,120 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 6,043,240 | 30.5% |
| ENTER_EXECUTOR | 5,923,980 | 29.9% |
| LOAD_GLOBAL_MODULE | 5,041,800 | 25.4% |
| LOAD_GLOBAL_BUILTIN | 2,665,270 | 13.4% |
...
| LOAD_GLOBAL_MODULE | 2,540 | 23.6% |
| LOAD_ATTR_MODULE | 1,240 | 11.5% |
| LOAD_FAST_LOAD_FAST | 920 | 8.6% |
| LOAD_NAME | 480 | 4.5% |

|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 9,560 | 89.0% |
| POP_TOP | 940 | 8.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 9,980 | 38.6% |
| LOAD_ATTR | 6,060 | 23.4% |
| LOAD_GLOBAL_MODULE | 2,880 | 11.1% |
| LOAD_ATTR_INSTANCE_VALUE | 2,120 | 8.2% |
| LOAD_CONST | 1,780 | 6.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 10,000 | 38.7% |
| LOAD_CONST | 7,580 | 29.3% |
| LOAD_GLOBAL_MODULE | 3,660 | 14.2% |
...
| POP_JUMP_IF_TRUE | 2,665,270 | 12.7% |
| NOP | 2,376,060 | 11.3% |
...
| CALL_ISINSTANCE | 9,560 | 0.1% |
| COPY | 7,800 | 0.1% |
| LOAD_FAST | 3,760 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 5,344,340 | 66.5% |
...
|---|---:|---:|
| Basic | 196,230,460 | 46.8% |
| Not specialized | 81,520,830 | 19.4% |
| Specialized hits | 141,709,370 | 33.8% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 30,661,070 | 57.0% |
| Frees to freelist | 30,658,130 |  |
| Allocations | 23,173,080 | 43.0% |
| Allocations to 512 bytes | 23,159,260 | 43.0% |
| Allocations to 4 kbytes | 12,860 | 0.0% |
| Allocations over 4 kbytes | 960 | 0.0% |
| Frees | 23,012,205 |  |
| New values | 2,900 |  |
| Interpreter increfs | 212,735,160 | 62.7% |
| Interpreter decrefs | 245,513,040 | 62.5% |
| Increfs | 126,798,845 | 37.3% |
| Decrefs | 147,490,374 | 37.5% |
| Materialize dict (on request) | 1,040 | 35.9% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 16,020,222 |  |
| Method cache misses | 28,038 |  |
| Method cache collisions | 40,678 |  |
| Method cache dunder hits | 22,798,625 |  |
| Method cache dunder misses | 17,505 |  |
...
| Traces executed | 6,922,720 |  |
| Uops executed | 140,420,900 | 20.28 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _GUARD_GLOBALS_VERSION | 17,345,390 | 12.4% | 12.4% | 0.0% |
| LOAD_FAST | 13,977,950 | 10.0% | 22.3% |  |
| _LOAD_GLOBAL_MODULE | 11,009,210 | 7.8% | 30.1% |  |
| _SET_IP | 7,342,160 | 5.2% | 35.4% |  |
| _CHECK_VALIDITY | 7,117,390 | 5.1% | 40.4% |  |
| STORE_FAST | 6,959,900 | 5.0% | 45.4% |  |
| _GUARD_BUILTINS_VERSION | 6,334,440 | 4.5% | 49.9% | 0.0% |
| _LOAD_GLOBAL_BUILTINS | 6,334,220 | 4.5% | 54.4% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 5,935,180 | 4.2% | 58.6% | 38.0% |
| _ITER_CHECK_TUPLE | 5,935,180 | 4.2% | 62.9% |  |
| _EXIT_TRACE | 4,205,190 | 3.0% | 65.9% | 100.0% |
| _ITER_NEXT_TUPLE | 3,676,960 | 2.6% | 68.5% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 3,668,300 | 2.6% | 71.1% |  |
| _CHECK_STACK_SPACE | 3,668,300 | 2.6% | 73.7% |  |
| _INIT_CALL_PY_EXACT_ARGS | 3,668,300 | 2.6% | 76.3% |  |
| _PUSH_FRAME | 3,668,300 | 2.6% | 78.9% |  |
| _SAVE_RETURN_OFFSET | 3,668,300 | 2.6% | 81.6% |  |
| RESUME_CHECK | 3,668,140 | 2.6% | 84.2% |  |
| CALL_TYPE_1 | 3,666,900 | 2.6% | 86.8% |  |
...
| CALL_ISINSTANCE | 2,664,270 | 1.9% | 97.1% |  |
| _JUMP_TO_TOP | 2,494,180 | 1.8% | 98.8% |  |
| _FOR_ITER_TIER_TWO | 559,460 | 0.4% | 99.2% | 36.9% |
| PUSH_NULL | 350,290 | 0.2% | 99.5% |  |
...
| _LOAD_ATTR_MODULE | 21,940 | 0.0% | 99.8% |  |
| TO_BOOL_BOOL | 21,650 | 0.0% | 99.8% |  |
| _LOAD_CONST_INLINE_BORROW | 21,110 | 0.0% | 99.9% |  |
...
| _GUARD_IS_TRUE_POP | 10,430 | 0.0% | 99.9% | 6.3% |
