...
| POP_JUMP_IF_FALSE | 57,981,520 | 6.6% | 46.5% |  |
...
| POP_JUMP_IF_TRUE | 10,829,880 | 1.2% | 79.2% |  |
| JUMP_FORWARD | 9,769,900 | 1.1% | 80.3% |  |
| POP_TOP | 9,338,020 | 1.1% | 81.4% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 42,068,480 | 4.8% | 12.8% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 3,897,740 | 0.4% | 64.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 42,068,480 | 20.6% |
...
|---|---:|---:|
| Basic | 442,692,700 | 50.4% |
| Not specialized | 99,176,660 | 11.3% |
| Specialized hits | 330,218,500 | 37.6% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 13,776,540 | 27.9% |
| Frees to freelist | 13,792,220 |  |
| Allocations | 35,598,920 | 72.1% |
| Allocations to 512 bytes | 35,307,640 | 71.5% |
| Allocations to 4 kbytes | 279,580 | 0.6% |
| Allocations over 4 kbytes | 11,700 | 0.0% |
| Frees | 34,732,206 |  |
| New values | 1,220 |  |
| Interpreter increfs | 442,758,960 | 83.0% |
| Interpreter decrefs | 491,799,860 | 85.6% |
| Increfs | 90,600,625 | 17.0% |
| Decrefs | 82,871,182 | 14.4% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 9,410,756 |  |
| Method cache misses | 14,124 |  |
| Method cache collisions | 14,154 |  |
| Method cache dunder hits | 2,278,858 |  |
| Method cache dunder misses | 1,722 |  |
...
| Uops executed | 229,570,200 | 29.98 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 31,655,800 | 13.8% | 13.8% |  |
...
| _SET_IP | 21,964,040 | 9.6% | 60.2% |  |
| _GUARD_IS_FALSE_POP | 17,769,800 | 7.7% | 67.9% | 8.8% |
| _CHECK_VALIDITY | 15,100,720 | 6.6% | 74.5% |  |
...
| _JUMP_TO_TOP | 3,312,460 | 1.4% | 90.7% |  |
...
| CONTAINS_OP | 1,024,640 | 0.4% | 98.4% |  |
...
| _EXIT_TRACE | 35,720 | 0.0% | 99.7% | 100.0% |
