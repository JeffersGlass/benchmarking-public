...
| LOAD_GLOBAL_BUILTIN | 286,200 | 5.2% | 35.8% | 0.1% |
...
| POP_JUMP_IF_FALSE | 141,780 | 2.6% | 65.3% |  |
...
| POP_JUMP_IF_NOT_NONE | 2,420 | 0.0% | 99.5% |  |
...
| CALL_FUNCTION_EX | 1,040 | 0.0% | 99.8% |  |
...
| POP_TOP ENTER_EXECUTOR | 128,040 | 2.3% | 21.9% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 41,620 | 0.8% | 52.5% |
| LOAD_CONST LOAD_FAST | 41,300 | 0.8% | 53.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_MODULE | 32,800 | 0.6% | 66.0% |
...
| LOAD_CONST STORE_FAST | 20,260 | 0.4% | 72.1% |
...
| PUSH_NULL LOAD_GLOBAL_MODULE | 18,520 | 0.3% | 80.2% |
...
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 17,320 | 0.3% | 81.8% |
...
| CALL RETURN_VALUE | 16,820 | 0.3% | 84.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 41,620 | 29.4% |
| LOAD_CONST | 32,900 | 23.2% |
| LOAD_GLOBAL_MODULE | 32,800 | 23.1% |
...
|---|---:|---:|
| Basic | 2,885,980 | 52.8% |
| Not specialized | 564,820 | 10.3% |
...
| Increfs | 124,236,251 | 37.0% |
| Decrefs | 102,685,989 | 28.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 122,338 |  |
| Method cache misses | 3,962 |  |
| Method cache collisions | 4,172 |  |
| Method cache dunder hits | 302,717 |  |
...
| Uops executed | 1,010,702,320 | 4,525.40 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 158,775,080 | 15.7% | 15.7% |  |
| _CHECK_VALIDITY | 158,677,400 | 15.7% | 31.4% |  |
| LOAD_FAST | 101,086,740 | 10.0% | 41.4% |  |
| _LOAD_CONST_INLINE | 64,978,300 | 6.4% | 47.8% |  |
| PUSH_NULL | 50,580,540 | 5.0% | 52.8% |  |
| STORE_FAST | 50,519,740 | 5.0% | 57.8% |  |
| POP_TOP | 43,319,760 | 4.3% | 62.1% |  |
| CALL_BUILTIN_O | 43,319,680 | 4.3% | 66.4% |  |
| _GUARD_TYPE_VERSION | 36,011,240 | 3.6% | 70.0% |  |
| _LOAD_CONST_INLINE_BORROW | 35,996,020 | 3.6% | 73.5% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 35,995,280 | 3.6% | 77.1% |  |
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 35,995,200 | 3.6% | 80.7% |  |
| _GUARD_GLOBALS_VERSION | 21,658,720 | 2.1% | 82.8% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 14,525,800 | 1.4% | 84.2% | 0.7% |
| _ITER_CHECK_RANGE | 14,525,800 | 1.4% | 85.7% |  |
| _ITER_NEXT_RANGE | 14,429,080 | 1.4% | 87.1% |  |
| _GUARD_BUILTINS_VERSION | 14,428,800 | 1.4% | 88.5% |  |
| _LOAD_GLOBAL_BUILTINS | 14,428,800 | 1.4% | 90.0% |  |
| CALL_STR_1 | 14,413,440 | 1.4% | 91.4% |  |
| _JUMP_TO_TOP | 14,303,640 | 1.4% | 92.8% |  |
| _LOAD_GLOBAL_MODULE | 7,229,920 | 0.7% | 93.5% |  |
| _CHECK_ATTR_MODULE | 7,229,760 | 0.7% | 94.2% |  |
| _LOAD_ATTR_MODULE | 7,229,760 | 0.7% | 94.9% |  |
| RESUME_CHECK | 7,214,600 | 0.7% | 95.7% |  |
...
| _ITER_CHECK_LIST | 95,640 | 0.0% | 100.0% |  |
