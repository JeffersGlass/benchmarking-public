...
|---|---:|---:|---:|---:|
| LOAD_FAST | 50,818,068 | 20.6% | 20.6% |  |
| LOAD_CONST | 39,100,540 | 15.9% | 36.5% |  |
| CALL_PY_EXACT_ARGS | 19,655,080 | 8.0% | 44.4% |  |
...
| LOAD_FAST_LOAD_FAST | 936,500 | 0.4% | 96.3% |  |
| POP_JUMP_IF_FALSE | 910,240 | 0.4% | 96.7% |  |
| STORE_FAST | 757,884 | 0.3% | 97.0% |  |
| JUMP_BACKWARD | 500,960 | 0.2% | 97.2% |  |
| FOR_ITER | 433,000 | 0.2% | 97.4% |  |
| STORE_FAST_STORE_FAST | 400,720 | 0.2% | 97.5% |  |
| LOAD_ATTR_MODULE | 391,540 | 0.2% | 97.7% | 3.2% |
| TO_BOOL_BOOL | 346,844 | 0.1% | 97.8% |  |
| CONTAINS_OP | 343,880 | 0.1% | 98.0% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 343,200 | 0.1% | 98.1% |  |
| LOAD_GLOBAL_BUILTIN | 343,180 | 0.1% | 98.2% | 0.6% |
| STORE_SUBSCR_DICT | 339,960 | 0.1% | 98.4% |  |
| RESUME_CHECK | 335,960 | 0.1% | 98.5% | 2.3% |
| CALL | 267,993 | 0.1% | 98.6% |  |
| LOAD_ATTR_METHOD_NO_DICT | 255,584 | 0.1% | 98.7% |  |
| PUSH_NULL | 244,440 | 0.1% | 98.8% |  |
| RETURN_VALUE | 207,380 | 0.1% | 98.9% |  |
| TO_BOOL_STR | 189,680 | 0.1% | 99.0% | 0.3% |
| NOP | 182,340 | 0.1% | 99.1% |  |
...
| LIST_APPEND | 10,520 | 0.0% | 99.9% |  |
| SWAP | 10,080 | 0.0% | 99.9% |  |
| BUILD_LIST | 10,040 | 0.0% | 99.9% |  |
| INSTRUMENTED_JUMP_BACKWARD | 10,004 | 0.0% | 99.9% |  |
| STORE_FAST_LOAD_FAST | 9,840 | 0.0% | 99.9% |  |
...
| CHECK_EXC_MATCH | 5,940 | 0.0% | 100.0% |  |
| POP_EXCEPT | 5,940 | 0.0% | 100.0% |  |
| PUSH_EXC_INFO | 5,940 | 0.0% | 100.0% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST_LOAD_FAST | 469,320 | 0.2% | 94.8% |
| JUMP_BACKWARD FOR_ITER | 380,780 | 0.2% | 95.0% |
| LOAD_FAST_LOAD_FAST LOAD_FAST | 377,600 | 0.2% | 95.1% |
| UNPACK_SEQUENCE_TWO_TUPLE STORE_FAST_STORE_FAST | 342,220 | 0.1% | 95.3% |
| CONTAINS_OP POP_JUMP_IF_FALSE | 340,180 | 0.1% | 95.4% |
| STORE_FAST LOAD_FAST | 337,824 | 0.1% | 95.5% |
| LOAD_FAST STORE_SUBSCR_DICT | 331,460 | 0.1% | 95.7% |
| FOR_ITER UNPACK_SEQUENCE_TWO_TUPLE | 331,100 | 0.1% | 95.8% |
| STORE_SUBSCR_DICT JUMP_BACKWARD | 330,060 | 0.1% | 95.9% |
| STORE_FAST_STORE_FAST LOAD_FAST_LOAD_FAST | 324,980 | 0.1% | 96.1% |
| LOAD_FAST_LOAD_FAST CONTAINS_OP | 324,140 | 0.1% | 96.2% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 313,000 | 0.1% | 96.3% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 244,700 | 0.1% | 96.4% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 240,104 | 0.1% | 96.5% |
| PUSH_NULL LOAD_FAST | 230,040 | 0.1% | 96.6% |
| LOAD_ATTR_MODULE PUSH_NULL | 222,720 | 0.1% | 96.7% |
| POP_JUMP_IF_FALSE LOAD_FAST | 206,080 | 0.1% | 96.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 197,840 | 0.1% | 96.9% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 192,304 | 0.1% | 96.9% |
| LOAD_FAST CALL | 190,904 | 0.1% | 97.0% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 180,280 | 0.1% | 97.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 178,740 | 0.1% | 97.2% |
...
| CALL TO_BOOL_BOOL | 109,744 | 0.0% | 97.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 5,840 | 98.3% |
| LOAD_GLOBAL | 100 | 1.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 5,940 | 100.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 106,780 | 58.6% |
| FOR_ITER | 47,280 | 25.9% |
| RESUME_CHECK | 16,020 | 8.8% |
| POP_JUMP_IF_FALSE | 4,800 | 2.6% |
| INSTRUMENTED_FOR_ITER | 4,080 | 2.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 108,920 | 59.7% |
| LOAD_GLOBAL_MODULE | 55,620 | 30.5% |
| LOAD_GLOBAL_BUILTIN | 9,160 | 5.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 5,100 | 85.9% |
| RERAISE | 300 | 5.1% |
| JUMP_BACKWARD | 280 | 4.7% |
| RETURN_CONST | 200 | 3.4% |
| JUMP_FORWARD | 40 | 0.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 32,000 | 42.3% |
| CACHE | 13,200 | 17.4% |
| RETURN_CONST | 7,400 | 9.8% |
| POP_JUMP_IF_FALSE | 6,140 | 8.1% |
| CALL_BUILTIN_O | 3,740 | 4.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 35,420 | 46.8% |
| RESUME_CHECK | 13,060 | 17.3% |
| LOAD_FAST | 12,400 | 16.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_BUILTIN_CLASS | 4,700 | 79.1% |
| BINARY_SUBSCR_DICT | 380 | 6.4% |
| CALL_KW | 320 | 5.4% |
| RERAISE | 300 | 5.1% |
| CALL_BUILTIN_FAST | 140 | 2.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 5,760 | 97.0% |
| LOAD_GLOBAL | 180 | 3.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_MODULE | 222,720 | 91.1% |
| STORE_FAST_LOAD_FAST | 9,160 | 3.7% |
| LOAD_FAST | 8,740 | 3.6% |
| LOAD_ATTR | 3,340 | 1.4% |
| LOAD_DEREF | 460 | 0.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 59,100 | 28.5% |
| CALL_ISINSTANCE | 39,400 | 19.0% |
| RETURN_VALUE | 21,240 | 10.2% |
| CALL | 18,820 | 9.1% |
| POP_JUMP_IF_TRUE | 11,700 | 5.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 70,100 | 33.8% |
| TO_BOOL_BOOL | 53,840 | 26.0% |
| RETURN_VALUE | 21,240 | 10.2% |
| LIST_APPEND | 9,440 | 4.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 324,140 | 94.3% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 340,180 | 98.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 331,100 | 76.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_SUBSCR_DICT | 330,060 | 65.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER | 380,780 | 76.0% |
| FOR_ITER_LIST | 65,960 | 13.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 9,440 | 89.7% |
| CALL_METHOD_DESCRIPTOR_FAST | 680 | 6.5% |
| BUILD_TUPLE | 400 | 3.8% |

|Successors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 10,120 | 96.2% |
| INSTRUMENTED_JUMP_BACKWARD | 400 | 3.8% |
...
| LOAD_FAST_LOAD_FAST | 377,600 | 0.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 38,910,100 | 76.6% |
| INSTRUMENTED_RETURN_VALUE | 9,717,760 | 19.1% |
| STORE_SUBSCR_DICT | 331,460 | 0.7% |
| LOAD_ATTR_METHOD_NO_DICT | 192,304 | 0.4% |
| CALL | 190,904 | 0.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 469,320 | 50.1% |
| STORE_FAST_STORE_FAST | 324,980 | 34.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 377,600 | 40.3% |
| CONTAINS_OP | 324,140 | 34.6% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 469,320 | 51.6% |
| LOAD_FAST | 206,080 | 22.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 8,700 | 88.4% |
| FOR_ITER_TUPLE | 680 | 6.9% |
| CALL_LEN | 440 | 4.5% |
| FOR_ITER | 20 | 0.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| PUSH_NULL | 9,160 | 93.1% |
| TO_BOOL_STR | 680 | 6.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| UNPACK_SEQUENCE_TWO_TUPLE | 342,220 | 85.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST_LOAD_FAST | 324,980 | 81.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 5,220 | 51.8% |
| BUILD_LIST | 1,520 | 15.1% |
| LOAD_FAST_AND_CLEAR | 1,520 | 15.1% |
| FOR_ITER_LIST | 720 | 7.1% |
| FOR_ITER | 400 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_EXCEPT | 5,100 | 50.6% |
| BUILD_LIST | 1,440 | 14.3% |
| STORE_FAST | 1,440 | 14.3% |
| FOR_ITER_LIST | 700 | 6.9% |
| FOR_ITER | 420 | 4.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| GET_ITER | 51,340 | 83.3% |
| PUSH_EXC_INFO | 4,700 | 7.6% |
| RETURN_VALUE | 4,020 | 6.5% |
| LOAD_FAST | 840 | 1.4% |
| LOAD_CONST | 260 | 0.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 65,960 | 78.3% |
| LOAD_FAST | 12,880 | 15.3% |
| GET_ITER | 2,740 | 3.3% |
| EXTENDED_ARG | 1,640 | 1.9% |
| SWAP | 700 | 0.8% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 57,140 | 67.8% |
| RETURN_CONST | 14,040 | 16.7% |
| STORE_FAST_LOAD_FAST | 8,700 | 10.3% |
| UNPACK_SEQUENCE_TWO_TUPLE | 1,640 | 1.9% |
| SWAP | 720 | 0.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 118,400 | 34.5% |
| LOAD_FAST | 99,660 | 29.0% |
| POP_JUMP_IF_TRUE | 51,860 | 15.1% |
| STORE_FAST | 28,000 | 8.2% |
| POP_JUMP_IF_FALSE | 14,740 | 4.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 178,740 | 52.1% |
| CALL_ISINSTANCE | 97,900 | 28.5% |
| LOAD_GLOBAL_MODULE | 49,000 | 14.3% |
| CHECK_EXC_MATCH | 5,840 | 1.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 197,840 | 58.9% |
| CALL | 54,440 | 16.2% |
| CACHE | 38,640 | 11.5% |
| POP_TOP | 13,060 | 3.9% |
...
| LOAD_GLOBAL_BUILTIN | 118,400 | 35.2% |
...
| INSTRUMENTED_POP_JUMP_IF_TRUE | 7,104 | 2.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST_STORE_FAST | 342,220 | 99.7% |
| STORE_FAST | 980 | 0.3% |
...
|---|---:|---:|
| Basic | 152,622,124 | 61.9% |
| Not specialized | 11,776,433 | 4.8% |
| Specialized hits | 82,240,688 | 33.3% |
...
| Calls to Python functions inlined | 19,731,600 | 99.7% |
...
| Frame objects created | 19,430,740 | 98.2% |
| Frames pushed | 19,669,700 | 99.4% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 738,664 | 1.8% |
| Frees to freelist | 735,704 |  |
| Allocations | 40,948,080 | 98.2% |
| Allocations to 512 bytes | 40,936,420 | 98.2% |
| Allocations to 4 kbytes | 6,620 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 40,926,168 |  |
| New values | 1,420 |  |
| Interpreter increfs | 43,921,052 | 15.7% |
| Interpreter decrefs | 64,272,476 | 24.5% |
| Increfs | 235,611,971 | 84.3% |
| Decrefs | 198,439,377 | 75.5% |
| Materialize dict (on request) | 240 | 16.9% |
| Materialize dict (new key) | 220 | 15.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 4.2% |
| Method cache hits | 19,527,520 |  |
| Method cache misses | 12,520 |  |
| Method cache collisions | 11,873 |  |
| Method cache dunder hits | 177,299 |  |
| Method cache dunder misses | 1,281 |  |
