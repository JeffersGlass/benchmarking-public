...
| RETURN_VALUE | 69,027,320 | 2.7% | 65.7% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 63,077,800 | 2.4% | 68.1% |  |
| CALL_PY_EXACT_ARGS | 61,582,780 | 2.4% | 70.5% |  |
| RETURN_CONST | 57,476,060 | 2.2% | 72.7% |  |
| LOAD_ATTR_METHOD_NO_DICT | 56,732,880 | 2.2% | 74.9% | 0.0% |
| INTERPRETER_EXIT | 51,855,200 | 2.0% | 76.9% |  |
| LOAD_GLOBAL_MODULE | 50,737,480 | 2.0% | 78.9% |  |
| PUSH_NULL | 44,712,720 | 1.7% | 80.6% |  |
| LOAD_ATTR | 43,691,100 | 1.7% | 82.3% |  |
| CALL | 36,221,060 | 1.4% | 83.7% |  |
| POP_JUMP_IF_NOT_NONE | 30,605,080 | 1.2% | 84.9% |  |
| CALL_METHOD_DESCRIPTOR_O | 28,364,720 | 1.1% | 86.0% | 0.0% |
| TO_BOOL_NONE | 26,498,020 | 1.0% | 87.0% | 0.0% |
| LOAD_ATTR_MODULE | 25,747,260 | 1.0% | 88.0% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 24,258,860 | 0.9% | 89.0% | 0.0% |
| COMPARE_OP_INT | 20,463,620 | 0.8% | 89.8% |  |
...
| TO_BOOL | 11,205,740 | 0.4% | 93.9% |  |
| CALL_FUNCTION_EX | 10,821,540 | 0.4% | 94.3% |  |
| CALL_INTRINSIC_1 | 10,821,300 | 0.4% | 94.7% |  |
...
| RESUME | 2,040 | 0.0% | 100.0% | 1,519.1% |
...
| CACHE RESUME_CHECK | 45,510,520 | 1.8% | 29.0% |
...
| LOAD_FAST_LOAD_FAST STORE_ATTR_SLOT | 42,168,420 | 1.6% | 35.5% |
| POP_TOP LOAD_FAST | 40,308,480 | 1.6% | 37.1% |
...
| STORE_ATTR_SLOT LOAD_FAST_LOAD_FAST | 31,347,180 | 1.2% | 43.5% |
| RETURN_CONST INTERPRETER_EXIT | 28,737,780 | 1.1% | 44.7% |
...
| TO_BOOL_NONE POP_JUMP_IF_FALSE | 26,498,000 | 1.0% | 48.9% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 25,746,140 | 1.0% | 49.9% |
| LOAD_ATTR_MODULE PUSH_NULL | 24,627,840 | 1.0% | 50.8% |
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 23,886,320 | 0.9% | 51.8% |
...
| CALL STORE_FAST | 20,152,260 | 0.8% | 56.7% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 19,407,260 | 0.8% | 57.5% |
| RETURN_VALUE STORE_FAST | 19,035,280 | 0.7% | 58.2% |
...
| LOAD_ATTR_INSTANCE_VALUE RETURN_VALUE | 16,419,540 | 0.6% | 61.0% |
| CALL_BUILTIN_O STORE_FAST | 16,352,820 | 0.6% | 61.6% |
| LOAD_FAST CALL_BUILTIN_O | 16,352,740 | 0.6% | 62.2% |
| POP_JUMP_IF_FALSE RETURN_CONST | 16,047,360 | 0.6% | 62.9% |
...
| LOAD_FAST CALL_PY_EXACT_ARGS | 14,186,120 | 0.5% | 67.4% |
| LOAD_ATTR_METHOD_NO_DICT CALL_METHOD_DESCRIPTOR_NOARGS | 14,181,840 | 0.5% | 68.0% |
| CALL_METHOD_DESCRIPTOR_NOARGS STORE_FAST | 14,181,440 | 0.5% | 68.5% |
| LOAD_ATTR_METHOD_WITH_VALUES LOAD_FAST | 13,439,320 | 0.5% | 69.1% |
| LOAD_FAST_LOAD_FAST LOAD_CONST | 12,690,400 | 0.5% | 69.6% |
| LOAD_CONST COMPARE_OP_INT | 11,946,040 | 0.5% | 70.0% |
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 11,945,020 | 0.5% | 70.5% |
| POP_JUMP_IF_NONE LOAD_FAST | 11,943,920 | 0.5% | 70.9% |
| POP_JUMP_IF_FALSE LOAD_CONST | 11,573,660 | 0.4% | 71.4% |
| NOP LOAD_FAST | 11,570,580 | 0.4% | 71.8% |
| POP_TOP LOAD_CONST | 11,570,360 | 0.4% | 72.3% |
| BUILD_LIST LOAD_FAST | 11,568,020 | 0.4% | 72.7% |
| STORE_ATTR_SLOT LOAD_FAST | 11,566,120 | 0.4% | 73.2% |
| LOAD_ATTR_SLOT TO_BOOL_BOOL | 11,565,940 | 0.4% | 73.6% |
| LOAD_CONST STORE_FAST | 11,204,760 | 0.4% | 74.1% |
| LOAD_ATTR_INSTANCE_VALUE TO_BOOL | 11,199,400 | 0.4% | 74.5% |
| LOAD_GLOBAL_MODULE LOAD_FAST | 11,197,900 | 0.4% | 74.9% |
| STORE_ATTR_SLOT RETURN_CONST | 11,193,840 | 0.4% | 75.4% |
| LOAD_ATTR_SLOT LOAD_ATTR_METHOD_WITH_VALUES | 11,193,640 | 0.4% | 75.8% |
...
| LOAD_FAST PUSH_NULL | 9,262,580 | 0.4% | 84.6% |
| LOAD_ATTR CALL | 8,959,720 | 0.3% | 84.9% |
| STORE_FAST LOAD_FAST_LOAD_FAST | 8,888,300 | 0.3% | 85.3% |
| CALL_PY_EXACT_ARGS RETURN_GENERATOR | 8,583,660 | 0.3% | 85.6% |
| GET_AWAITABLE LOAD_CONST | 7,088,980 | 0.3% | 85.9% |
| TO_BOOL POP_JUMP_IF_FALSE | 6,719,520 | 0.3% | 86.1% |
| LOAD_FAST POP_JUMP_IF_NONE | 6,718,880 | 0.3% | 86.4% |
| LOAD_ATTR_INSTANCE_VALUE POP_JUMP_IF_NOT_NONE | 6,718,340 | 0.3% | 86.6% |
| PUSH_NULL CALL | 6,345,480 | 0.2% | 86.9% |
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 5,972,060 | 0.2% | 87.1% |
...
| POP_JUMP_IF_FALSE | 11,573,660 | 11.4% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 36,952,620 | 19.4% |
|          hit | 153,691,300 | 80.6% |
|         miss | 761,180 | 0.4% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 44,413,340 | 10.4% |
|          hit | 381,405,720 | 89.6% |
|         miss | 755,480 | 0.2% |
...
|---|---:|---:|
| Basic | 1,290,792,820 | 50.0% |
| Not specialized | 292,962,360 | 11.4% |
| Specialized hits | 990,098,691 | 38.4% |
| Specialized misses | 6,243,089 | 0.2% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 44,413,340 | 44.5% |
| CALL | 36,952,620 | 37.0% |
| TO_BOOL | 11,202,000 | 11.2% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 56,534,701 | 34.8% |
| Frees to freelist | 56,910,716 |  |
| Allocations | 105,707,162 | 65.2% |
| Allocations to 512 bytes | 104,898,693 | 64.7% |
| Allocations to 4 kbytes | 808,347 | 0.5% |
| Allocations over 4 kbytes | 122 | 0.0% |
| Frees | 105,632,946 |  |
| New values | 320 |  |
| Interpreter increfs | 1,276,521,800 | 79.2% |
| Interpreter decrefs | 1,347,170,412 | 76.8% |
| Increfs | 334,507,310 | 20.8% |
| Decrefs | 405,903,541 | 23.2% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 68,845,741 |  |
| Method cache misses | 451,059 |  |
| Method cache collisions | 450,868 |  |
| Method cache dunder hits | 16,402,076 |  |
| Method cache dunder misses | 444 |  |
...
|---:|---:|---:|---:|
| 0 | 55,372 | 2,040 | 377,983,578 |
| 1 | 5,040 | 0 | 393,776,028 |
| 2 | 459 | 0 | 995,875,682 |
