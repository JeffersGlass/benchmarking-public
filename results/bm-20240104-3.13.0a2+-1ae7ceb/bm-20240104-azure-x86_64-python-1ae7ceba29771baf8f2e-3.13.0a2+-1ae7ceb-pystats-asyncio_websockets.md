...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,648 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,501,876 | 5.6% | 24.2% |  |
| LOAD_ATTR_SLOT | 1,299,760 | 4.8% | 29.0% | 0.4% |
| LOAD_CONST | 1,175,196 | 4.3% | 33.3% |  |
...
| COMPARE_OP_INT | 250,716 | 0.9% | 81.2% | 0.1% |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 142,662 | 0.5% | 90.5% | 7.0% |
| POP_JUMP_IF_NOT_NONE | 131,160 | 0.5% | 91.0% |  |
| NOP | 119,920 | 0.4% | 91.4% |  |
| JUMP_FORWARD | 108,422 | 0.4% | 91.8% |  |
...
| DELETE_SUBSCR | 33,918 | 0.1% | 97.0% |  |
| BUILD_SLICE | 33,658 | 0.1% | 97.1% |  |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,352 | 3.0% | 6.5% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 451,680 | 1.7% | 19.5% |
| IS_OP POP_JUMP_IF_FALSE | 416,300 | 1.5% | 21.0% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,636 | 1.5% | 22.5% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 105,796 | 0.4% | 60.2% |
| LOAD_GLOBAL_BUILTIN LOAD_GLOBAL_BUILTIN | 105,118 | 0.4% | 60.6% |
...
| CALL_LEN LOAD_FAST | 92,156 | 0.3% | 63.9% |
...
| LOAD_ATTR_METHOD_NO_DICT CALL_METHOD_DESCRIPTOR_NOARGS | 69,562 | 0.3% | 69.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| BUILD_SLICE | 33,598 | 99.1% |
| LOAD_FAST | 260 | 0.8% |
| CALL | 60 | 0.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 33,598 | 99.1% |
| LOAD_CONST | 140 | 0.4% |
...
| POP_JUMP_IF_TRUE | 451,680 | 9.0% |
| LOAD_GLOBAL_BUILTIN | 404,636 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,352 | 16.0% |
...
| LOAD_GLOBAL_BUILTIN | 306,856 | 20.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,796 | 54.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_METHOD_NO_DICT | 69,562 | 48.8% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,236 | 8.1% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 248,036 | 98.9% |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 69,562 | 25.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,856 | 41.1% |
| RESUME_CHECK | 150,320 | 20.1% |
| LOAD_GLOBAL_BUILTIN | 105,118 | 14.1% |
| LOAD_FAST | 48,560 | 6.5% |
| STORE_FAST | 44,020 | 5.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 404,636 | 54.1% |
...
|---|---:|---:|
| Basic | 13,035,044 | 48.2% |
| Not specialized | 4,447,672 | 16.4% |
| Specialized hits | 9,478,082 | 35.0% |
| Specialized misses | 83,100 | 0.3% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,138 | 32.7% |
| Frees to freelist | 780,298 |  |
| Allocations | 1,597,106 | 67.3% |
| Allocations to 512 bytes | 1,407,097 | 59.3% |
| Allocations to 4 kbytes | 132,208 | 5.6% |
| Allocations over 4 kbytes | 57,801 | 2.4% |
| Frees | 1,536,602 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,201,218 | 76.6% |
| Interpreter decrefs | 14,017,148 | 78.2% |
| Increfs | 3,727,587 | 23.4% |
| Decrefs | 3,914,310 | 21.8% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,227,946 |  |
| Method cache misses | 32,814 |  |
| Method cache collisions | 37,878 |  |
| Method cache dunder hits | 356,076 |  |
| Method cache dunder misses | 7,704 |  |
