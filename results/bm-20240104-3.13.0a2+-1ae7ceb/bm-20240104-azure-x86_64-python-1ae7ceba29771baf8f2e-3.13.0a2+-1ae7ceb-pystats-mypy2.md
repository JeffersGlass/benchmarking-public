...
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,525,022,842 | 20.5% | 20.5% |  |
| LOAD_CONST | 367,507,858 | 4.9% | 25.5% |  |
| RESUME_CHECK | 351,235,664 | 4.7% | 30.2% | 0.0% |
| LOAD_GLOBAL_MODULE | 321,007,732 | 4.3% | 34.5% | 0.0% |
| STORE_ATTR_SLOT | 306,147,969 | 4.1% | 38.6% | 21.5% |
| LOAD_FAST_LOAD_FAST | 293,431,360 | 4.0% | 42.6% |  |
| LOAD_GLOBAL_BUILTIN | 287,584,516 | 3.9% | 46.5% | 0.0% |
| POP_JUMP_IF_FALSE | 285,860,712 | 3.8% | 50.3% |  |
| STORE_FAST | 278,330,524 | 3.7% | 54.1% |  |
| LOAD_ATTR_SLOT | 257,475,175 | 3.5% | 57.5% | 1.7% |
| CALL_PY_EXACT_ARGS | 223,613,425 | 3.0% | 60.5% | 10.1% |
| TO_BOOL_BOOL | 214,899,448 | 2.9% | 63.4% | 0.0% |
| RETURN_VALUE | 198,763,784 | 2.7% | 66.1% |  |
| RETURN_CONST | 150,049,312 | 2.0% | 68.1% |  |
| CALL_ISINSTANCE | 146,052,624 | 2.0% | 70.1% |  |
| LOAD_ATTR_METHOD_NO_DICT | 138,415,101 | 1.9% | 72.0% | 21.0% |
| POP_JUMP_IF_TRUE | 118,252,478 | 1.6% | 73.6% |  |
| POP_TOP | 111,123,550 | 1.5% | 75.0% |  |
| FOR_ITER_LIST | 85,692,600 | 1.2% | 76.2% | 1.2% |
| LOAD_ATTR_INSTANCE_VALUE | 83,165,128 | 1.1% | 77.3% | 3.5% |
| JUMP_BACKWARD | 70,402,136 | 0.9% | 78.3% |  |
| LOAD_DEREF | 66,165,284 | 0.9% | 79.2% |  |
| GET_ITER | 61,162,492 | 0.8% | 80.0% |  |
| INTERPRETER_EXIT | 60,472,961 | 0.8% | 80.8% |  |
| BINARY_SUBSCR_DICT | 60,383,720 | 0.8% | 81.6% |  |
| LOAD_ATTR | 58,783,672 | 0.8% | 82.4% |  |
| LOAD_ATTR_METHOD_WITH_VALUES | 58,090,483 | 0.8% | 83.2% | 12.4% |
...
| COMPARE_OP_STR | 27,772,200 | 0.4% | 90.2% | 0.2% |
| NOP | 26,746,920 | 0.4% | 90.6% |  |
| COPY | 25,474,966 | 0.3% | 90.9% |  |
| JUMP_FORWARD | 23,738,840 | 0.3% | 91.3% |  |
| TO_BOOL_LIST | 23,217,080 | 0.3% | 91.6% | 0.7% |
| COMPARE_OP_INT | 21,494,415 | 0.3% | 91.9% | 2.0% |
| COMPARE_OP | 21,481,635 | 0.3% | 92.2% |  |
| BINARY_SUBSCR | 20,449,600 | 0.3% | 92.4% |  |
| CALL_BUILTIN_CLASS | 20,200,446 | 0.3% | 92.7% |  |
| PUSH_NULL | 20,054,020 | 0.3% | 93.0% |  |
| EXTENDED_ARG | 19,220,840 | 0.3% | 93.2% |  |
| FOR_ITER | 18,987,376 | 0.3% | 93.5% |  |
| STORE_FAST_STORE_FAST | 18,154,800 | 0.2% | 93.7% |  |
| CALL_LEN | 18,094,940 | 0.2% | 94.0% |  |
| TO_BOOL_NONE | 17,749,938 | 0.2% | 94.2% | 7.7% |
| FOR_ITER_TUPLE | 17,650,304 | 0.2% | 94.4% | 5.6% |
| MAKE_CELL | 16,642,380 | 0.2% | 94.7% |  |
| BUILD_TUPLE | 16,155,204 | 0.2% | 94.9% |  |
...
| TO_BOOL_ALWAYS_TRUE | 14,602,102 | 0.2% | 96.5% | 13.2% |
| LOAD_FAST_AND_CLEAR | 14,018,780 | 0.2% | 96.7% |  |
| LOAD_ATTR_PROPERTY | 13,670,063 | 0.2% | 96.9% | 6.6% |
...
| CALL_BUILTIN_O | 9,042,578 | 0.1% | 97.8% | 7.3% |
...
| YIELD_VALUE | 5,617,348 | 0.1% | 98.9% |  |
...
| SEND_GEN | 232,308 | 0.0% | 100.0% |  |
| STORE_SUBSCR_LIST_INT | 217,380 | 0.0% | 100.0% |  |
| JUMP_BACKWARD_NO_INTERRUPT | 184,368 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_SLOT | 228,036,844 | 3.1% | 3.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 199,686,586 | 2.7% | 5.8% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 194,540,276 | 2.6% | 8.4% |
| LOAD_FAST STORE_ATTR_SLOT | 180,099,532 | 2.4% | 10.8% |
| RESUME_CHECK LOAD_FAST | 152,917,946 | 2.1% | 12.9% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 146,986,798 | 2.0% | 14.8% |
| CALL_ISINSTANCE TO_BOOL_BOOL | 142,644,122 | 1.9% | 16.8% |
| LOAD_CONST LOAD_FAST | 141,941,780 | 1.9% | 18.7% |
| LOAD_FAST LOAD_GLOBAL_MODULE | 139,281,224 | 1.9% | 20.5% |
| STORE_FAST LOAD_FAST | 139,082,724 | 1.9% | 22.4% |
| POP_JUMP_IF_FALSE LOAD_FAST | 133,748,182 | 1.8% | 24.2% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_SLOT | 124,362,340 | 1.7% | 25.9% |
| LOAD_GLOBAL_MODULE CALL_ISINSTANCE | 121,354,284 | 1.6% | 27.5% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 100,951,104 | 1.4% | 28.9% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 87,744,790 | 1.2% | 30.1% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 68,059,280 | 0.9% | 35.4% |
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 65,300,988 | 0.9% | 36.3% |
| LOAD_GLOBAL_MODULE LOAD_FAST | 63,879,200 | 0.9% | 37.1% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 62,552,920 | 0.8% | 38.0% |
| STORE_ATTR_SLOT RETURN_CONST | 60,469,620 | 0.8% | 38.8% |
| LOAD_FAST RETURN_VALUE | 59,811,320 | 0.8% | 39.6% |
| STORE_ATTR_SLOT LOAD_FAST | 56,220,492 | 0.8% | 40.3% |
...
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 51,094,930 | 0.7% | 43.1% |
| POP_JUMP_IF_TRUE LOAD_FAST | 51,028,610 | 0.7% | 43.8% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 47,656,320 | 0.6% | 44.5% |
| POP_TOP LOAD_FAST | 46,910,230 | 0.6% | 45.1% |
| FOR_ITER_LIST STORE_FAST | 46,859,876 | 0.6% | 45.7% |
| COPY_FREE_VARS RESUME_CHECK | 46,553,660 | 0.6% | 46.4% |
| LOAD_GLOBAL_BUILTIN LOAD_DEREF | 46,073,720 | 0.6% | 47.0% |
| JUMP_BACKWARD FOR_ITER_LIST | 45,995,215 | 0.6% | 47.6% |
...
| RETURN_VALUE RETURN_VALUE | 40,345,795 | 0.5% | 51.6% |
...
| LOAD_FAST LOAD_ATTR | 38,072,292 | 0.5% | 53.7% |
| LOAD_ATTR_METHOD_NO_DICT CALL_PY_EXACT_ARGS | 37,277,704 | 0.5% | 54.2% |
| STORE_FAST LOAD_GLOBAL_MODULE | 35,868,064 | 0.5% | 54.7% |
| LOAD_SUPER_ATTR_METHOD LOAD_FAST_LOAD_FAST | 35,852,400 | 0.5% | 55.2% |
| CACHE RESUME_CHECK | 34,881,161 | 0.5% | 55.6% |
...
| LOAD_ATTR_SLOT LOAD_FAST | 30,559,770 | 0.4% | 57.3% |
| RESUME_CHECK LOAD_FAST_LOAD_FAST | 30,287,000 | 0.4% | 57.8% |
| LOAD_ATTR LOAD_FAST | 27,269,896 | 0.4% | 58.1% |
...
| RETURN_VALUE LOAD_FAST | 25,055,860 | 0.3% | 59.9% |
| RETURN_VALUE INTERPRETER_EXIT | 24,630,781 | 0.3% | 60.2% |
| LOAD_ATTR_SLOT STORE_FAST | 24,427,620 | 0.3% | 60.5% |
| LOAD_FAST CONTAINS_OP | 23,977,560 | 0.3% | 60.9% |
| LOAD_ATTR_SLOT GET_ITER | 23,975,352 | 0.3% | 61.2% |
...
| LOAD_FAST LOAD_GLOBAL_BUILTIN | 23,042,600 | 0.3% | 62.5% |
| GET_ITER FOR_ITER_LIST | 22,715,458 | 0.3% | 62.8% |
...
| LOAD_CONST COMPARE_OP_STR | 19,959,512 | 0.3% | 65.3% |
| LOAD_FAST_LOAD_FAST LOAD_FAST | 19,869,960 | 0.3% | 65.6% |
| COPY TO_BOOL_BOOL | 19,282,366 | 0.3% | 65.9% |
...
| POP_JUMP_IF_TRUE JUMP_BACKWARD | 19,044,636 | 0.3% | 66.9% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST_LOAD_FAST | 18,310,120 | 0.2% | 67.1% |
| LOAD_ATTR_SLOT RETURN_VALUE | 18,245,146 | 0.2% | 67.4% |
...
| LOAD_ATTR_SLOT LOAD_ATTR_SLOT | 17,359,560 | 0.2% | 68.3% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_FAST | 16,669,894 | 0.2% | 69.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 23,975,352 | 39.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 22,715,458 | 37.1% |
| LOAD_FAST_AND_CLEAR | 13,391,480 | 21.9% |
| FOR_ITER_TUPLE | 9,690,706 | 15.8% |
| FOR_ITER | 7,324,688 | 12.0% |
...
| POP_JUMP_IF_FALSE | 10,358,046 | 9.3% |
| POP_JUMP_IF_TRUE | 8,678,304 | 7.8% |
| RESUME_CHECK | 4,005,720 | 3.6% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 46,910,230 | 42.2% |
...
| RETURN_VALUE | 40,345,795 | 20.3% |
| RETURN_CONST | 21,420,800 | 10.8% |
| LOAD_ATTR_SLOT | 18,245,146 | 9.2% |
| CALL | 6,285,840 | 3.2% |
...
| RETURN_VALUE | 40,345,795 | 20.3% |
| LOAD_FAST | 25,055,860 | 12.6% |
| INTERPRETER_EXIT | 24,630,781 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 9,124,506 | 42.5% |
| LOAD_GLOBAL_MODULE | 4,324,160 | 20.1% |
| LOAD_CONST | 3,827,266 | 17.8% |
...
|---|---:|---:|
| COPY | 8,443,730 | 39.3% |
| POP_JUMP_IF_FALSE | 6,768,666 | 31.5% |
| RETURN_VALUE | 4,201,072 | 19.6% |
...
| POP_JUMP_IF_TRUE | 7,851,144 | 15.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| COMPARE_OP | 8,443,730 | 33.1% |
| LOAD_FAST | 3,112,260 | 12.2% |
| CALL_ISINSTANCE | 2,145,320 | 8.4% |
| SWAP | 1,796,160 | 7.1% |
| COMPARE_OP_STR | 1,547,788 | 6.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 19,282,366 | 75.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 8,049,624 | 42.4% |
| GET_ITER | 7,324,688 | 38.6% |
...
| STORE_FAST | 2,970,332 | 15.6% |
| RETURN_CONST | 2,803,100 | 14.8% |
| LOAD_FAST | 2,349,762 | 12.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 19,044,636 | 27.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| FOR_ITER_LIST | 45,995,215 | 65.3% |
| FOR_ITER | 8,049,624 | 11.4% |
| FOR_ITER_TUPLE | 6,581,685 | 9.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 184,308 | 100.0% |
| RESUME | 60 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| SEND_GEN | 184,328 | 100.0% |
| SEND | 40 | 0.0% |
...
| LOAD_GLOBAL_MODULE | 479,144 | 2.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 199,686,586 | 13.1% |
| RESUME_CHECK | 152,917,946 | 10.0% |
| LOAD_CONST | 141,941,780 | 9.3% |
| STORE_FAST | 139,082,724 | 9.1% |
| POP_JUMP_IF_FALSE | 133,748,182 | 8.8% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 228,036,844 | 15.0% |
| STORE_ATTR_SLOT | 180,099,532 | 11.8% |
| LOAD_GLOBAL_MODULE | 139,281,224 | 9.1% |
| LOAD_ATTR_METHOD_NO_DICT | 100,951,104 | 6.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 146,986,798 | 51.4% |
| CONTAINS_OP | 41,046,500 | 14.4% |
| IS_OP | 19,087,520 | 6.7% |
| COMPARE_OP_INT | 13,251,708 | 4.6% |
| TO_BOOL_ALWAYS_TRUE | 12,604,307 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 133,748,182 | 46.8% |
| LOAD_GLOBAL_BUILTIN | 68,059,280 | 23.8% |
| LOAD_GLOBAL_MODULE | 25,161,580 | 8.8% |
| LOAD_FAST_LOAD_FAST | 15,652,500 | 5.5% |
| POP_TOP | 10,358,046 | 3.6% |
...
| LOAD_GLOBAL_BUILTIN | 2,656,892 | 6.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 51,094,930 | 43.2% |
| TO_BOOL_LIST | 17,441,920 | 14.7% |
| COMPARE_OP_STR | 16,223,204 | 13.7% |
| CONTAINS_OP | 7,851,144 | 6.6% |
| COMPARE_OP_INT | 6,024,340 | 5.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 51,028,610 | 43.2% |
| JUMP_BACKWARD | 19,044,636 | 16.1% |
| LOAD_GLOBAL_MODULE | 13,711,372 | 11.6% |
| POP_TOP | 8,678,304 | 7.3% |
| NOP | 7,043,520 | 6.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 139,082,724 | 50.0% |
| LOAD_GLOBAL_BUILTIN | 39,219,060 | 14.1% |
| LOAD_GLOBAL_MODULE | 35,868,064 | 12.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| BUILD_TUPLE | 2,834,864 | 31.4% |
| RETURN_GENERATOR | 2,372,800 | 26.2% |
| CALL_STR_1 | 1,224,320 | 13.5% |
| LOAD_FAST | 1,062,980 | 11.8% |
| LOAD_GLOBAL_MODULE | 602,328 | 6.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RETURN_VALUE | 3,486,446 | 38.6% |
| LOAD_FAST | 2,478,172 | 27.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 121,354,284 | 83.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 13,251,708 | 61.7% |
| POP_JUMP_IF_TRUE | 6,024,340 | 28.0% |
| COPY | 1,052,876 | 4.9% |
| RETURN_VALUE | 640,930 | 3.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 19,959,512 | 71.9% |
| LOAD_FAST | 4,531,724 | 16.3% |
| BINARY_SUBSCR_TUPLE_INT | 1,646,960 | 5.9% |
| RETURN_VALUE | 478,820 | 1.7% |
| LOAD_ATTR_INSTANCE_VALUE | 419,354 | 1.5% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_TRUE | 16,223,204 | 58.4% |
| POP_JUMP_IF_FALSE | 8,950,620 | 32.2% |
| COPY | 1,547,788 | 5.6% |
| RETURN_VALUE | 615,768 | 2.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 45,995,215 | 53.7% |
| GET_ITER | 22,715,458 | 26.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 46,859,876 | 54.7% |
| LOAD_FAST | 13,545,400 | 15.8% |
| SWAP | 8,945,260 | 10.4% |
| RETURN_CONST | 7,250,532 | 8.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| GET_ITER | 9,690,706 | 54.9% |
| JUMP_BACKWARD | 6,581,685 | 37.3% |
| SWAP | 1,314,320 | 7.4% |
| EXTENDED_ARG | 34,520 | 0.2% |
| FOR_ITER_LIST | 17,886 | 0.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 8,764,698 | 49.7% |
| STORE_FAST | 4,324,136 | 24.5% |
| STORE_FAST_LOAD_FAST | 2,285,460 | 12.9% |
| SWAP | 1,302,000 | 7.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 100,951,104 | 72.9% |
| LOAD_ATTR_SLOT | 15,260,512 | 11.0% |
...
| CALL_PY_EXACT_ARGS | 37,277,704 | 26.9% |
| LOAD_CONST | 13,122,452 | 9.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 9,855,130 | 72.1% |
| LOAD_ATTR_SLOT | 3,392,993 | 24.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 12,774,559 | 93.4% |
| RETURN_VALUE | 533,273 | 3.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 228,036,844 | 88.6% |
| LOAD_ATTR_SLOT | 17,359,560 | 6.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 30,559,770 | 11.9% |
| STORE_FAST | 24,427,620 | 9.5% |
| GET_ITER | 23,975,352 | 9.3% |
| RETURN_VALUE | 18,245,146 | 7.1% |
| LOAD_ATTR_SLOT | 17,359,560 | 6.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 87,744,790 | 30.5% |
| POP_JUMP_IF_FALSE | 68,059,280 | 23.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 139,281,224 | 43.4% |
| STORE_FAST | 35,868,064 | 11.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 121,354,284 | 37.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 194,540,276 | 55.4% |
| COPY_FREE_VARS | 46,553,660 | 13.3% |
| CACHE | 34,881,161 | 9.9% |
| CALL_KW | 21,713,260 | 6.2% |
| CALL_BOUND_METHOD_EXACT_ARGS | 13,891,440 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 152,917,946 | 43.5% |
| LOAD_GLOBAL_BUILTIN | 87,744,790 | 25.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD_NO_INTERRUPT | 184,328 | 79.3% |
| LOAD_CONST | 47,920 | 20.6% |
| SEND | 60 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| RESUME_CHECK | 184,328 | 79.3% |
| POP_TOP | 47,940 | 20.6% |
| RESUME | 40 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 180,099,532 | 58.8% |
| LOAD_FAST_LOAD_FAST | 124,362,340 | 40.6% |
| STORE_ATTR_SLOT | 1,242,037 | 0.4% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 12,604,307 | 86.3% |
| POP_JUMP_IF_TRUE | 1,469,020 | 10.1% |
| EXTENDED_ARG | 493,020 | 3.4% |
| TO_BOOL_NONE | 18,509 | 0.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_ISINSTANCE | 142,644,122 | 66.4% |
| COPY | 19,282,366 | 9.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 146,986,798 | 68.4% |
| POP_JUMP_IF_TRUE | 51,094,930 | 23.8% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 11,538,833 | 65.0% |
| POP_JUMP_IF_TRUE | 5,791,920 | 32.6% |
| EXTENDED_ARG | 391,440 | 2.2% |
| TO_BOOL_ALWAYS_TRUE | 18,825 | 0.1% |
| TO_BOOL | 2,980 | 0.0% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 64,156,831 | 11.0% |
|          hit | 516,587,225 | 88.8% |
|         miss | 30,528,440 | 5.2% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 688,529 | 88.2% |
| Failure | 92,260 | 11.8% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 20,922,062 | 16.2% |
|          hit | 108,454,974 | 83.8% |
|         miss | 2,017,650 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 102,469,466 | 15.8% |
|        deopt | 780 | 0.0% |
|          hit | 545,102,536 | 84.0% |
|         miss | 44,847,674 | 6.9% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,000,400 | 86.1% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 71,283,050 | 20.3% |
|          hit | 279,235,702 | 79.4% |
|         miss | 66,741,127 | 19.0% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 1,281,437 | 98.4% |
| Failure | 20,420 | 1.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 13,805,592 | 4.8% |
|          hit | 273,548,536 | 95.1% |
|         miss | 3,712,372 | 1.3% |
...
|---|---:|---:|
| Basic | 3,724,042,133 | 50.1% |
| Not specialized | 676,494,493 | 9.1% |
| Specialized hits | 2,879,506,949 | 38.8% |
| Specialized misses | 148,414,262 | 2.0% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_ATTR | 102,469,466 | 32.1% |
| STORE_ATTR | 71,283,050 | 22.3% |
| CALL | 64,156,831 | 20.1% |
| COMPARE_OP | 21,901,346 | 6.9% |
| FOR_ITER | 20,922,062 | 6.5% |
| BINARY_SUBSCR | 20,416,720 | 6.4% |
| TO_BOOL | 13,805,592 | 4.3% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| STORE_ATTR_SLOT | 65,848,647 | 44.4% |
| LOAD_ATTR_METHOD_NO_DICT | 29,039,738 | 19.6% |
| CALL_PY_EXACT_ARGS | 22,564,740 | 15.2% |
| LOAD_ATTR_METHOD_WITH_VALUES | 7,218,760 | 4.9% |
| LOAD_ATTR_SLOT | 4,294,792 | 2.9% |
...
| TO_BOOL_ALWAYS_TRUE | 1,927,915 | 1.3% |
| TO_BOOL_NONE | 1,374,237 | 0.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 60,499,381 | 17.0% |
| Calls to Python functions inlined | 294,691,763 | 83.0% |
| Calls via PyEval_EvalFrame (total) | 60,499,381 | 17.0% |
| Calls via PyEval_EvalFrame (vector) | 53,289,141 | 15.0% |
| Calls via PyEval_EvalFrame (generator) | 7,210,240 | 2.0% |
| Calls via PyEval_EvalFrame (legacy) | 100 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 53,289,001 | 15.0% |
| Calls via PyEval_EvalFrame (build class) | 40 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 6,954,344 | 2.0% |
| Calls via PyEval_EvalFrame (function ex) | 1,237,660 | 0.3% |
| Calls via PyEval_EvalFrame (api) | 11,829,097 | 3.3% |
| Calls via PyEval_EvalFrame (method) | 100 | 0.0% |
| Frame objects created | 2,373,920 | 0.7% |
| Frames pushed | 243,151,084 | 68.5% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 153,532,230 | 28.5% |
| Frees to freelist | 153,577,544 |  |
| Allocations | 384,695,166 | 71.5% |
| Allocations to 512 bytes | 384,173,641 | 71.4% |
| Allocations to 4 kbytes | 362,305 | 0.1% |
| Allocations over 4 kbytes | 159,220 | 0.0% |
| Frees | 379,268,754 |  |
| New values | 4,435,060 |  |
| Interpreter increfs | 3,598,850,560 | 73.8% |
| Interpreter decrefs | 3,969,645,490 | 74.9% |
| Increfs | 1,279,071,935 | 26.2% |
| Decrefs | 1,332,974,825 | 25.1% |
| Materialize dict (on request) | 340 | 0.0% |
| Materialize dict (new key) | 1,160 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 220 | 0.0% |
| Method cache hits | 211,593,381 |  |
| Method cache misses | 4,049,932 |  |
| Method cache collisions | 5,586,871 |  |
| Method cache dunder hits | 177,480,203 |  |
| Method cache dunder misses | 1,558,637 |  |
